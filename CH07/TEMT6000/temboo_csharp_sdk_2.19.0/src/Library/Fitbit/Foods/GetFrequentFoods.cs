...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetFrequentFoods : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFrequentFoods Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFrequentFoods(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetFrequentFoods")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFrequentFoodsResultSet containing execution metadata and results.</returns>
        new public GetFrequentFoodsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFrequentFoodsResultSet results = new JavaScriptSerializer().Deserialize<GetFrequentFoodsResultSet>(json);
    ...
    /// </summary>
    public class GetFrequentFoodsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
