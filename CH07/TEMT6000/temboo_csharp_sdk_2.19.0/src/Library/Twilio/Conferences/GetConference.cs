...
namespace Temboo.Library.Twilio.Conferences
{
    ...
    /// </summary>
    public class GetConference : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetConference Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetConference(TembooSession session) : base(session, "/Library/Twilio/Conferences/GetConference")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetConferenceResultSet containing execution metadata and results.</returns>
        new public GetConferenceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetConferenceResultSet results = new JavaScriptSerializer().Deserialize<GetConferenceResultSet>(json);
    ...
    /// </summary>
    public class GetConferenceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
