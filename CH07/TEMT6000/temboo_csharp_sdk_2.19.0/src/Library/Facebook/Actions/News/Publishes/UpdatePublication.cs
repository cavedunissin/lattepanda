...
namespace Temboo.Library.Facebook.Actions.News.Publishes
{
    /// <summary>
    /// UpdatePublication
    /// Updates an existing news publishing action.
    /// </summary>
    public class UpdatePublication : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdatePublication Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdatePublication(TembooSession session) : base(session, "/Library/Facebook/Actions/News/Publishes/UpdatePublication")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Article input for this Choreo.</param>
         public void setArticle(String value) {
             base.addInput ("Article", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdatePublicationResultSet containing execution metadata and results.</returns>
        new public UpdatePublicationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdatePublicationResultSet results = new JavaScriptSerializer().Deserialize<UpdatePublicationResultSet>(json);
    ...
    /// </summary>
    public class UpdatePublicationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
