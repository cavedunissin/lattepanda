...
namespace Temboo.Library.GitHub.ReposAPI.Repos
{
    ...
    /// </summary>
    public class ListLanguages : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListLanguages Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListLanguages(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Repos/ListLanguages")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListLanguagesResultSet containing execution metadata and results.</returns>
        new public ListLanguagesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListLanguagesResultSet results = new JavaScriptSerializer().Deserialize<ListLanguagesResultSet>(json);
    ...
    /// </summary>
    public class ListLanguagesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
