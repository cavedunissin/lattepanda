...
namespace Temboo.Library.Google.Sheets
{
    ...
    /// </summary>
    public class GetSpreadsheet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSpreadsheet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSpreadsheet(TembooSession session) : base(session, "/Library/Google/Sheets/GetSpreadsheet")
        {
        }
         ...
         /// <summary>
         /// (optional, boolean) Set to True if grid data should be returned.
         /// </summary>
         /// <param name="value">Value of the IncludeGridData input for this Choreo.</param>
         public void setIncludeGridData(String value) {
             base.addInput ("IncludeGridData", value);
         }
         /// <summary>
         /// (optional, string) The A1 notation of the values to retrieve formatted as an array (e.g. ["Sheet1!A2:C3"]). Note, this input support up to 10 ranges.
         /// </summary>
         /// <param name="value">Value of the Ranges input for this Choreo.</param>
         public void setRanges(String value) {
             base.addInput ("Ranges", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetSpreadsheetResultSet containing execution metadata and results.</returns>
        new public GetSpreadsheetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSpreadsheetResultSet results = new JavaScriptSerializer().Deserialize<GetSpreadsheetResultSet>(json);
    ...
    /// </summary>
    public class GetSpreadsheetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
