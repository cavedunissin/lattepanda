...
namespace Temboo.Library.Salesforce.Queries
{
    /// <summary>
    /// GetNextResults
    /// Retrieves the remaining query results using a query locator ID.
    /// </summary>
    public class GetNextResults : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNextResults Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNextResults(TembooSession session) : base(session, "/Library/Salesforce/Queries/GetNextResults")
        {
        }
         ...
         /// <summary>
         /// (required, string) The query locator ID to use for retrieving the next batch of records. This ID is returned by the Query Choreo.
         /// </summary>
         /// <param name="value">Value of the QueryLocator input for this Choreo.</param>
         public void setQueryLocator(String value) {
             base.addInput ("QueryLocator", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetNextResultsResultSet containing execution metadata and results.</returns>
        new public GetNextResultsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNextResultsResultSet results = new JavaScriptSerializer().Deserialize<GetNextResultsResultSet>(json);
    ...
    /// </summary>
    public class GetNextResultsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (string) The next query locator to use when there are more results to retrieve.</returns>
        /// </summary>
        public String NextQueryLocator
        {
            get
            {
                return (String) base.Output["NextQueryLocator"];
            }
        }
        /// <summary> 
