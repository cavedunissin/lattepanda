...
namespace Temboo.Library.Utilities.Text
{
    ...
    /// </summary>
    public class Substitute : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Substitute Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Substitute(TembooSession session) : base(session, "/Library/Utilities/Text/Substitute")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Old input for this Choreo.</param>
         public void setOld(String value) {
             base.addInput ("Old", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A SubstituteResultSet containing execution metadata and results.</returns>
        new public SubstituteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SubstituteResultSet results = new JavaScriptSerializer().Deserialize<SubstituteResultSet>(json);
    ...
    /// </summary>
    public class SubstituteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
