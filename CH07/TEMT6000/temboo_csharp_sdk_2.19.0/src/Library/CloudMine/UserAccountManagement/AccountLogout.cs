...
namespace Temboo.Library.CloudMine.UserAccountManagement
{
    ...
    /// </summary>
    public class AccountLogout : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AccountLogout Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AccountLogout(TembooSession session) : base(session, "/Library/CloudMine/UserAccountManagement/AccountLogout")
        {
        }
        ...
        /// </summary>
        /// <returns>A AccountLogoutResultSet containing execution metadata and results.</returns>
        new public AccountLogoutResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AccountLogoutResultSet results = new JavaScriptSerializer().Deserialize<AccountLogoutResultSet>(json);
    ...
    /// </summary>
    public class AccountLogoutResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
