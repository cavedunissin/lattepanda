...
namespace Temboo.Library.Box.Files
{
    ...
    /// </summary>
    public class DownloadFile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DownloadFile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DownloadFile(TembooSession session) : base(session, "/Library/Box/Files/DownloadFile")
        {
        }
        ...
        /// </summary>
        /// <returns>A DownloadFileResultSet containing execution metadata and results.</returns>
        new public DownloadFileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DownloadFileResultSet results = new JavaScriptSerializer().Deserialize<DownloadFileResultSet>(json);
    ...
    /// </summary>
    public class DownloadFileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Response" output from this Choreo execution
        /// <returns>String - (string) The Base64 encoded contents of the downloaded file.</returns>
        /// </summary>
