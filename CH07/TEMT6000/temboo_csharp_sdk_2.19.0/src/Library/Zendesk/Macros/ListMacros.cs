...
namespace Temboo.Library.Zendesk.Macros
{
    ...
    /// </summary>
    public class ListMacros : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMacros Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMacros(TembooSession session) : base(session, "/Library/Zendesk/Macros/ListMacros")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMacrosResultSet containing execution metadata and results.</returns>
        new public ListMacrosResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMacrosResultSet results = new JavaScriptSerializer().Deserialize<ListMacrosResultSet>(json);
    ...
    /// </summary>
    public class ListMacrosResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
