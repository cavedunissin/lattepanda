...
namespace Temboo.Library.Zendesk.ActivityStream
{
    /// <summary>
    /// ListActivity
    /// Returns a list of activities for the authenticating user.
    /// </summary>
    public class ListActivity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListActivity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListActivity(TembooSession session) : base(session, "/Library/Zendesk/ActivityStream/ListActivity")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListActivityResultSet containing execution metadata and results.</returns>
        new public ListActivityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListActivityResultSet results = new JavaScriptSerializer().Deserialize<ListActivityResultSet>(json);
    ...
    /// </summary>
    public class ListActivityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
