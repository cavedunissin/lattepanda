...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DescribeInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DescribeInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DescribeInstances(TembooSession session) : base(session, "/Library/Amazon/EC2/DescribeInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A DescribeInstancesResultSet containing execution metadata and results.</returns>
        new public DescribeInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DescribeInstancesResultSet results = new JavaScriptSerializer().Deserialize<DescribeInstancesResultSet>(json);
    ...
    /// </summary>
    public class DescribeInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
