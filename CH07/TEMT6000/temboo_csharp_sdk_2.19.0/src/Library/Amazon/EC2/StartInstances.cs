...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class StartInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the StartInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public StartInstances(TembooSession session) : base(session, "/Library/Amazon/EC2/StartInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A StartInstancesResultSet containing execution metadata and results.</returns>
        new public StartInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            StartInstancesResultSet results = new JavaScriptSerializer().Deserialize<StartInstancesResultSet>(json);
    ...
    /// </summary>
    public class StartInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
