...
namespace Temboo.Library.Box.Collaborations
{
    ...
    /// </summary>
    public class DeleteCollaboration : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteCollaboration Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteCollaboration(TembooSession session) : base(session, "/Library/Box/Collaborations/DeleteCollaboration")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteCollaborationResultSet containing execution metadata and results.</returns>
        new public DeleteCollaborationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteCollaborationResultSet results = new JavaScriptSerializer().Deserialize<DeleteCollaborationResultSet>(json);
    ...
    /// </summary>
    public class DeleteCollaborationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
