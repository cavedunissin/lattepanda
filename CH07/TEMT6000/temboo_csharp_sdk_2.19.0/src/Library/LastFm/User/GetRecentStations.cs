...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetRecentStations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRecentStations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRecentStations(TembooSession session) : base(session, "/Library/LastFm/User/GetRecentStations")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRecentStationsResultSet containing execution metadata and results.</returns>
        new public GetRecentStationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRecentStationsResultSet results = new JavaScriptSerializer().Deserialize<GetRecentStationsResultSet>(json);
    ...
    /// </summary>
    public class GetRecentStationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
