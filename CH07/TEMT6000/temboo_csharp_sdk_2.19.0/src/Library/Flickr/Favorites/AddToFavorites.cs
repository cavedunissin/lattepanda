...
namespace Temboo.Library.Flickr.Favorites
{
    ...
    /// </summary>
    public class AddToFavorites : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddToFavorites Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddToFavorites(TembooSession session) : base(session, "/Library/Flickr/Favorites/AddToFavorites")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddToFavoritesResultSet containing execution metadata and results.</returns>
        new public AddToFavoritesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddToFavoritesResultSet results = new JavaScriptSerializer().Deserialize<AddToFavoritesResultSet>(json);
    ...
    /// </summary>
    public class AddToFavoritesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
