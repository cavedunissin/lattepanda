...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class DeleteFriendship : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteFriendship Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteFriendship(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/DeleteFriendship")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteFriendshipResultSet containing execution metadata and results.</returns>
        new public DeleteFriendshipResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteFriendshipResultSet results = new JavaScriptSerializer().Deserialize<DeleteFriendshipResultSet>(json);
    ...
    /// </summary>
    public class DeleteFriendshipResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
