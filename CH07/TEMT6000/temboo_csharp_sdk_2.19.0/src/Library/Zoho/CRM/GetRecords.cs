...
namespace Temboo.Library.Zoho.CRM
{
    ...
    /// </summary>
    public class GetRecords : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRecords Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRecords(TembooSession session) : base(session, "/Library/Zoho/CRM/GetRecords")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRecordsResultSet containing execution metadata and results.</returns>
        new public GetRecordsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRecordsResultSet results = new JavaScriptSerializer().Deserialize<GetRecordsResultSet>(json);
    ...
    /// </summary>
    public class GetRecordsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
