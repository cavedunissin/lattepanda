...
namespace Temboo.Library.Genability.TariffData
{
    ...
    /// </summary>
    public class GetLoadServingEntities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLoadServingEntities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLoadServingEntities(TembooSession session) : base(session, "/Library/Genability/TariffData/GetLoadServingEntities")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLoadServingEntitiesResultSet containing execution metadata and results.</returns>
        new public GetLoadServingEntitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLoadServingEntitiesResultSet results = new JavaScriptSerializer().Deserialize<GetLoadServingEntitiesResultSet>(json);
    ...
    /// </summary>
    public class GetLoadServingEntitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
