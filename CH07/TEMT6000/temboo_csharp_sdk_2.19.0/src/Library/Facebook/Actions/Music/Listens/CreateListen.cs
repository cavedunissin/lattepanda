...
namespace Temboo.Library.Facebook.Actions.Music.Listens
{
    ...
    /// </summary>
    public class CreateListen : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateListen Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateListen(TembooSession session) : base(session, "/Library/Facebook/Actions/Music/Listens/CreateListen")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateListenResultSet containing execution metadata and results.</returns>
        new public CreateListenResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateListenResultSet results = new JavaScriptSerializer().Deserialize<CreateListenResultSet>(json);
    ...
    /// </summary>
    public class CreateListenResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
