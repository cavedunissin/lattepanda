...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class Unfriend : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Unfriend Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Unfriend(TembooSession session) : base(session, "/Library/Foursquare/Users/Unfriend")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of a user to unfriend.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A UnfriendResultSet containing execution metadata and results.</returns>
        new public UnfriendResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnfriendResultSet results = new JavaScriptSerializer().Deserialize<UnfriendResultSet>(json);
    ...
    /// </summary>
    public class UnfriendResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
