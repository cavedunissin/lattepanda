...
namespace Temboo.Library.Amazon.Marketplace.Reports
{
    ...
    /// </summary>
    public class MerchantListingsLiteReport : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the MerchantListingsLiteReport Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public MerchantListingsLiteReport(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Reports/MerchantListingsLiteReport")
        {
        }
        ...
        /// </summary>
        /// <returns>A MerchantListingsLiteReportResultSet containing execution metadata and results.</returns>
        new public MerchantListingsLiteReportResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MerchantListingsLiteReportResultSet results = new JavaScriptSerializer().Deserialize<MerchantListingsLiteReportResultSet>(json);
    ...
    /// </summary>
    public class MerchantListingsLiteReportResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
