...
namespace Temboo.Library.Zendesk.Groups
{
    ...
    /// </summary>
    public class ShowAssignableGroups : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ShowAssignableGroups Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ShowAssignableGroups(TembooSession session) : base(session, "/Library/Zendesk/Groups/ShowAssignableGroups")
        {
        }
        ...
        /// </summary>
        /// <returns>A ShowAssignableGroupsResultSet containing execution metadata and results.</returns>
        new public ShowAssignableGroupsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ShowAssignableGroupsResultSet results = new JavaScriptSerializer().Deserialize<ShowAssignableGroupsResultSet>(json);
    ...
    /// </summary>
    public class ShowAssignableGroupsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
