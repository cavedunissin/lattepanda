...
namespace Temboo.Library.Amazon.SNS
{
    ...
    /// </summary>
    public class GetTopicAttributes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTopicAttributes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTopicAttributes(TembooSession session) : base(session, "/Library/Amazon/SNS/GetTopicAttributes")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTopicAttributesResultSet containing execution metadata and results.</returns>
        new public GetTopicAttributesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTopicAttributesResultSet results = new JavaScriptSerializer().Deserialize<GetTopicAttributesResultSet>(json);
    ...
    /// </summary>
    public class GetTopicAttributesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
