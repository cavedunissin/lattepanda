...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class LikeMedia : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LikeMedia Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LikeMedia(TembooSession session) : base(session, "/Library/Instagram/LikeMedia")
        {
        }
        ...
        /// </summary>
        /// <returns>A LikeMediaResultSet containing execution metadata and results.</returns>
        new public LikeMediaResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LikeMediaResultSet results = new JavaScriptSerializer().Deserialize<LikeMediaResultSet>(json);
    ...
    /// </summary>
    public class LikeMediaResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
