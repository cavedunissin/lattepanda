...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetFriends : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFriends Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFriends(TembooSession session) : base(session, "/Library/LastFm/User/GetFriends")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RecentTracks input for this Choreo.</param>
         public void setRecentTracks(String value) {
             base.addInput ("RecentTracks", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetFriendsResultSet containing execution metadata and results.</returns>
        new public GetFriendsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFriendsResultSet results = new JavaScriptSerializer().Deserialize<GetFriendsResultSet>(json);
    ...
    /// </summary>
    public class GetFriendsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
