...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class GetStatistics : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetStatistics Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetStatistics(TembooSession session) : base(session, "/Library/LinkedIn/Companies/GetStatistics")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetStatisticsResultSet containing execution metadata and results.</returns>
        new public GetStatisticsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetStatisticsResultSet results = new JavaScriptSerializer().Deserialize<GetStatisticsResultSet>(json);
    ...
    /// </summary>
    public class GetStatisticsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
