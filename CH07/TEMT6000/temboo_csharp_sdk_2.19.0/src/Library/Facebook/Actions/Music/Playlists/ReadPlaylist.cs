...
namespace Temboo.Library.Facebook.Actions.Music.Playlists
{
    ...
    /// </summary>
    public class ReadPlaylist : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadPlaylist Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadPlaylist(TembooSession session) : base(session, "/Library/Facebook/Actions/Music/Playlists/ReadPlaylist")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadPlaylistResultSet containing execution metadata and results.</returns>
        new public ReadPlaylistResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadPlaylistResultSet results = new JavaScriptSerializer().Deserialize<ReadPlaylistResultSet>(json);
    ...
    /// </summary>
    public class ReadPlaylistResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
