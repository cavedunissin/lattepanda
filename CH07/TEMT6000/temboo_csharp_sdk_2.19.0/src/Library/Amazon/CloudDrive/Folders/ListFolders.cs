...
namespace Temboo.Library.Amazon.CloudDrive.Folders
{
    ...
    /// </summary>
    public class ListFolders : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListFolders Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListFolders(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Folders/ListFolders")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListFoldersResultSet containing execution metadata and results.</returns>
        new public ListFoldersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListFoldersResultSet results = new JavaScriptSerializer().Deserialize<ListFoldersResultSet>(json);
    ...
    /// </summary>
    public class ListFoldersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
