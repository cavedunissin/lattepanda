...
namespace Temboo.Library.Google.ComputeEngine.RegionOperations
{
    ...
    /// </summary>
    public class GetRegionOperation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRegionOperation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRegionOperation(TembooSession session) : base(session, "/Library/Google/ComputeEngine/RegionOperations/GetRegionOperation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRegionOperationResultSet containing execution metadata and results.</returns>
        new public GetRegionOperationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRegionOperationResultSet results = new JavaScriptSerializer().Deserialize<GetRegionOperationResultSet>(json);
    ...
    /// </summary>
    public class GetRegionOperationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
