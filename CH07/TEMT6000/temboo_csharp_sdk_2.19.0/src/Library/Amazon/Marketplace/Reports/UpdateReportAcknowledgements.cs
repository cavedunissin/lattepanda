...
namespace Temboo.Library.Amazon.Marketplace.Reports
{
    ...
    /// </summary>
    public class UpdateReportAcknowledgements : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateReportAcknowledgements Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateReportAcknowledgements(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Reports/UpdateReportAcknowledgements")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateReportAcknowledgementsResultSet containing execution metadata and results.</returns>
        new public UpdateReportAcknowledgementsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateReportAcknowledgementsResultSet results = new JavaScriptSerializer().Deserialize<UpdateReportAcknowledgementsResultSet>(json);
    ...
    /// </summary>
    public class UpdateReportAcknowledgementsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
