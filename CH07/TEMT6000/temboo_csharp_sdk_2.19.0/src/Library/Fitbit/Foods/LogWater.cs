...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class LogWater : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LogWater Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LogWater(TembooSession session) : base(session, "/Library/Fitbit/Foods/LogWater")
        {
        }
        ...
        /// </summary>
        /// <returns>A LogWaterResultSet containing execution metadata and results.</returns>
        new public LogWaterResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LogWaterResultSet results = new JavaScriptSerializer().Deserialize<LogWaterResultSet>(json);
    ...
    /// </summary>
    public class LogWaterResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
