...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class GetFollowersByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFollowersByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFollowersByID(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/GetFollowersByID")
        {
        }
         ...
         /// <summary>
         /// (optional, integer) Specifies the number of IDs to retrieve, up to a maximum of 5,000 per distinct request.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetFollowersByIDResultSet containing execution metadata and results.</returns>
        new public GetFollowersByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFollowersByIDResultSet results = new JavaScriptSerializer().Deserialize<GetFollowersByIDResultSet>(json);
    ...
    /// </summary>
    public class GetFollowersByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
