...
namespace Temboo.Library.Twilio.OutgoingCallerIDs
{
    ...
    /// </summary>
    public class UpdateCallerID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateCallerID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateCallerID(TembooSession session) : base(session, "/Library/Twilio/OutgoingCallerIDs/UpdateCallerID")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the OutgoingCallerSID input for this Choreo.</param>
         public void setOutgoingCallerSID(String value) {
             base.addInput ("OutgoingCallerSID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateCallerIDResultSet containing execution metadata and results.</returns>
        new public UpdateCallerIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateCallerIDResultSet results = new JavaScriptSerializer().Deserialize<UpdateCallerIDResultSet>(json);
    ...
    /// </summary>
    public class UpdateCallerIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
