...
namespace Temboo.Library.Zoho.CRM
{
    ...
    /// </summary>
    public class DeleteRecords : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRecords Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRecords(TembooSession session) : base(session, "/Library/Zoho/CRM/DeleteRecords")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteRecordsResultSet containing execution metadata and results.</returns>
        new public DeleteRecordsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRecordsResultSet results = new JavaScriptSerializer().Deserialize<DeleteRecordsResultSet>(json);
    ...
    /// </summary>
    public class DeleteRecordsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
