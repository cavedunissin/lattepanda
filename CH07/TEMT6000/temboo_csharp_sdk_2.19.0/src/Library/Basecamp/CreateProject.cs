...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class CreateProject : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateProject Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateProject(TembooSession session) : base(session, "/Library/Basecamp/CreateProject")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ProjectName input for this Choreo.</param>
         public void setProjectName(String value) {
             base.addInput ("ProjectName", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreateProjectResultSet containing execution metadata and results.</returns>
        new public CreateProjectResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateProjectResultSet results = new JavaScriptSerializer().Deserialize<CreateProjectResultSet>(json);
    ...
    /// </summary>
    public class CreateProjectResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
