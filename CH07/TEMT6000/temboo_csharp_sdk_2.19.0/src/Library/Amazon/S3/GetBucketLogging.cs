...
namespace Temboo.Library.Amazon.S3
{
    ...
    /// </summary>
    public class GetBucketLogging : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBucketLogging Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBucketLogging(TembooSession session) : base(session, "/Library/Amazon/S3/GetBucketLogging")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBucketLoggingResultSet containing execution metadata and results.</returns>
        new public GetBucketLoggingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBucketLoggingResultSet results = new JavaScriptSerializer().Deserialize<GetBucketLoggingResultSet>(json);
    ...
    /// </summary>
    public class GetBucketLoggingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
