...
namespace Temboo.Library.Amazon.Marketplace.Reports
{
    ...
    /// </summary>
    public class UnshippedOrdersReport : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnshippedOrdersReport Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnshippedOrdersReport(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Reports/UnshippedOrdersReport")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnshippedOrdersReportResultSet containing execution metadata and results.</returns>
        new public UnshippedOrdersReportResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnshippedOrdersReportResultSet results = new JavaScriptSerializer().Deserialize<UnshippedOrdersReportResultSet>(json);
    ...
    /// </summary>
    public class UnshippedOrdersReportResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
