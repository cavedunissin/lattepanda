...
namespace Temboo.Library._23andMe
{
    ...
    /// </summary>
    public class Genomes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Genomes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Genomes(TembooSession session) : base(session, "/Library/23andMe/Genomes")
        {
        }
        ...
        /// </summary>
        /// <returns>A GenomesResultSet containing execution metadata and results.</returns>
        new public GenomesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GenomesResultSet results = new JavaScriptSerializer().Deserialize<GenomesResultSet>(json);
    ...
    /// </summary>
    public class GenomesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
