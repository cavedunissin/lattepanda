...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class UserFollows : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UserFollows Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UserFollows(TembooSession session) : base(session, "/Library/Instagram/UserFollows")
        {
        }
        ...
        /// </summary>
        /// <returns>A UserFollowsResultSet containing execution metadata and results.</returns>
        new public UserFollowsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UserFollowsResultSet results = new JavaScriptSerializer().Deserialize<UserFollowsResultSet>(json);
    ...
    /// </summary>
    public class UserFollowsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
