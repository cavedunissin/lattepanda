...
namespace Temboo.Library.Foursquare.Venues
{
    ...
    /// </summary>
    public class HereNow : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the HereNow Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public HereNow(TembooSession session) : base(session, "/Library/Foursquare/Venues/HereNow")
        {
        }
        ...
        /// </summary>
        /// <returns>A HereNowResultSet containing execution metadata and results.</returns>
        new public HereNowResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            HereNowResultSet results = new JavaScriptSerializer().Deserialize<HereNowResultSet>(json);
    ...
    /// </summary>
    public class HereNowResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
