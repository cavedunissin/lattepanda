...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class DeleteWaterLog : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteWaterLog Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteWaterLog(TembooSession session) : base(session, "/Library/Fitbit/Foods/DeleteWaterLog")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the WaterLogID input for this Choreo.</param>
         public void setWaterLogID(String value) {
             base.addInput ("WaterLogID", value);
         }
        ...
        /// </summary>
        /// <returns>A DeleteWaterLogResultSet containing execution metadata and results.</returns>
        new public DeleteWaterLogResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteWaterLogResultSet results = new JavaScriptSerializer().Deserialize<DeleteWaterLogResultSet>(json);
    ...
    /// </summary>
    public class DeleteWaterLogResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
