...
namespace Temboo.Library.YouTube.VideoCategories
{
    /// <summary>
    /// ListCategoriesByRegion
    /// Returns a list of categories available in the specified country.
    /// </summary>
    public class ListCategoriesByRegion : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCategoriesByRegion Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCategoriesByRegion(TembooSession session) : base(session, "/Library/YouTube/VideoCategories/ListCategoriesByRegion")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListCategoriesByRegionResultSet containing execution metadata and results.</returns>
        new public ListCategoriesByRegionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCategoriesByRegionResultSet results = new JavaScriptSerializer().Deserialize<ListCategoriesByRegionResultSet>(json);
    ...
    /// </summary>
    public class ListCategoriesByRegionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
