...
namespace Temboo.Library.Salesforce.Queries
{
    ...
    public class Query : Temboo.Core.Choreography
    {
        ...
        public Query(TembooSession session) : base(session, "/Library/Salesforce/Queries/Query")
        {
        }
         ...
         /// <summary>
         /// (required, string) The SOQL statement used to retrieve the set of records matching a specific criteria (e.g. select FirstName, LastName from Lead limit 1).
         /// </summary>
         /// <param name="value">Value of the SOQL input for this Choreo.</param>
         public void setSOQL(String value) {
             base.addInput ("SOQL", value);
         }
    ...
    public class QueryResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The query locator ID that can be used to retrieve the next batch of records. This will only be present when more than 2000 records meet the criteria of a query causing the response to be truncated.</returns>
        /// </summary>
        public String QueryLocator
        {
            get
            {
                return (String) base.Output["QueryLocator"];
            }
        }
        /// <summary> 
