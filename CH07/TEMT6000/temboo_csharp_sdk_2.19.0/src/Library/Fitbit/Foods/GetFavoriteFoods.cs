...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetFavoriteFoods : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFavoriteFoods Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFavoriteFoods(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetFavoriteFoods")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFavoriteFoodsResultSet containing execution metadata and results.</returns>
        new public GetFavoriteFoodsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFavoriteFoodsResultSet results = new JavaScriptSerializer().Deserialize<GetFavoriteFoodsResultSet>(json);
    ...
    /// </summary>
    public class GetFavoriteFoodsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
