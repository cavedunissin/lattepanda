...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class PhotoAlbums : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PhotoAlbums Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PhotoAlbums(TembooSession session) : base(session, "/Library/Facebook/Reading/PhotoAlbums")
        {
        }
        ...
        /// </summary>
        /// <returns>A PhotoAlbumsResultSet containing execution metadata and results.</returns>
        new public PhotoAlbumsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PhotoAlbumsResultSet results = new JavaScriptSerializer().Deserialize<PhotoAlbumsResultSet>(json);
    ...
    /// </summary>
    public class PhotoAlbumsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
