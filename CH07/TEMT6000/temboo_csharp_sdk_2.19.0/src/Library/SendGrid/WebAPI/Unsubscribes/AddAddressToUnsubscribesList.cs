...
namespace Temboo.Library.SendGrid.WebAPI.Unsubscribes
{
    ...
    /// </summary>
    public class AddAddressToUnsubscribesList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddAddressToUnsubscribesList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddAddressToUnsubscribesList(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Unsubscribes/AddAddressToUnsubscribesList")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddAddressToUnsubscribesListResultSet containing execution metadata and results.</returns>
        new public AddAddressToUnsubscribesListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddAddressToUnsubscribesListResultSet results = new JavaScriptSerializer().Deserialize<AddAddressToUnsubscribesListResultSet>(json);
    ...
    /// </summary>
    public class AddAddressToUnsubscribesListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
