...
namespace Temboo.Library.Google.Calendar
{
    ...
    /// </summary>
    public class GetEvent : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEvent Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEvent(TembooSession session) : base(session, "/Library/Google/Calendar/GetEvent")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetEventResultSet containing execution metadata and results.</returns>
        new public GetEventResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEventResultSet results = new JavaScriptSerializer().Deserialize<GetEventResultSet>(json);
    ...
    /// </summary>
    public class GetEventResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
