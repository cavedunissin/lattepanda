...
namespace Temboo.Library.NYTimes.CampaignFinance.Candidates
{
    ...
    /// </summary>
    public class CandidateDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CandidateDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CandidateDetails(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Candidates/CandidateDetails")
        {
        }
        ...
        /// </summary>
        /// <returns>A CandidateDetailsResultSet containing execution metadata and results.</returns>
        new public CandidateDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CandidateDetailsResultSet results = new JavaScriptSerializer().Deserialize<CandidateDetailsResultSet>(json);
    ...
    /// </summary>
    public class CandidateDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
