...
namespace Temboo.Library.Foursquare.Venues
{
    ...
    /// </summary>
    public class PhotosFromVenue : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PhotosFromVenue Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PhotosFromVenue(TembooSession session) : base(session, "/Library/Foursquare/Venues/PhotosFromVenue")
        {
        }
         ...
         /// <summary>
         /// (optional, string) By default, public venue photos are returned ordered by relevance. Pass "venue" for public venue photos, ordered by most recent. Pass "checkin" for venue photos from friends, ordered by most recenct.
         /// </summary>
         ...
         /// <summary>
         /// (optional, integer) Used in combination with the Limit input to page through results.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The ID of the venue to retrieve photos for.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A PhotosFromVenueResultSet containing execution metadata and results.</returns>
        new public PhotosFromVenueResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PhotosFromVenueResultSet results = new JavaScriptSerializer().Deserialize<PhotosFromVenueResultSet>(json);
    ...
    /// </summary>
    public class PhotosFromVenueResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
