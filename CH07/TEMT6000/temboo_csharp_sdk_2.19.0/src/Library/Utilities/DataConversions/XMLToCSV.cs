...
namespace Temboo.Library.Utilities.DataConversions
{
    ...
    /// </summary>
    public class XMLToCSV : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the XMLToCSV Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public XMLToCSV(TembooSession session) : base(session, "/Library/Utilities/DataConversions/XMLToCSV")
        {
        }
        ...
        /// </summary>
        /// <returns>A XMLToCSVResultSet containing execution metadata and results.</returns>
        new public XMLToCSVResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            XMLToCSVResultSet results = new JavaScriptSerializer().Deserialize<XMLToCSVResultSet>(json);
    ...
    /// </summary>
    public class XMLToCSVResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "CSV" output from this Choreo execution
        /// <returns>String - (multiline) The CSV data generated from the XML input.</returns>
        /// </summary>
        public String CSV
        {
            get
