...
namespace Temboo.Library.Yelp
{
    ...
    /// </summary>
    public class SearchByAddress : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchByAddress Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchByAddress(TembooSession session) : base(session, "/Library/Yelp/SearchByAddress")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Offsets the list of returned business results by this amount.
         /// </summary>
         ...
         /// <summary>
         /// (optional, integer) Narrow or expand a search by specifying a range in either feet, meters, miles, or kilometers, depending on the value of the Units input. Maximum is 25 miles (40000 meters).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A SearchByAddressResultSet containing execution metadata and results.</returns>
        new public SearchByAddressResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchByAddressResultSet results = new JavaScriptSerializer().Deserialize<SearchByAddressResultSet>(json);
    ...
    /// </summary>
    public class SearchByAddressResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
