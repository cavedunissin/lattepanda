...
namespace Temboo.Library.Facebook.Actions.Books.WantsToRead
{
    /// <summary>
    /// UpdateWantsToRead
    /// Updates an existing wants_to_read action.
    /// </summary>
    public class UpdateWantsToRead : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateWantsToRead Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateWantsToRead(TembooSession session) : base(session, "/Library/Facebook/Actions/Books/WantsToRead/UpdateWantsToRead")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateWantsToReadResultSet containing execution metadata and results.</returns>
        new public UpdateWantsToReadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateWantsToReadResultSet results = new JavaScriptSerializer().Deserialize<UpdateWantsToReadResultSet>(json);
    ...
    /// </summary>
    public class UpdateWantsToReadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
