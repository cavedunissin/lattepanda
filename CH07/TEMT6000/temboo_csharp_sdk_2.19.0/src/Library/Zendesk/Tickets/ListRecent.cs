...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class ListRecent : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRecent Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRecent(TembooSession session) : base(session, "/Library/Zendesk/Tickets/ListRecent")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRecentResultSet containing execution metadata and results.</returns>
        new public ListRecentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRecentResultSet results = new JavaScriptSerializer().Deserialize<ListRecentResultSet>(json);
    ...
    /// </summary>
    public class ListRecentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
