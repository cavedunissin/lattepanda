...
namespace Temboo.Library.CorpWatch.Company
{
    ...
    /// </summary>
    public class GetCompanyByCWID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCompanyByCWID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCompanyByCWID(TembooSession session) : base(session, "/Library/CorpWatch/Company/GetCompanyByCWID")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCompanyByCWIDResultSet containing execution metadata and results.</returns>
        new public GetCompanyByCWIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCompanyByCWIDResultSet results = new JavaScriptSerializer().Deserialize<GetCompanyByCWIDResultSet>(json);
    ...
    /// </summary>
    public class GetCompanyByCWIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
