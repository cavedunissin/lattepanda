...
namespace Temboo.Library.Wordnik.Words
{
    ...
    /// </summary>
    public class GetWordOfTheDay : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetWordOfTheDay Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetWordOfTheDay(TembooSession session) : base(session, "/Library/Wordnik/Words/GetWordOfTheDay")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetWordOfTheDayResultSet containing execution metadata and results.</returns>
        new public GetWordOfTheDayResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetWordOfTheDayResultSet results = new JavaScriptSerializer().Deserialize<GetWordOfTheDayResultSet>(json);
    ...
    /// </summary>
    public class GetWordOfTheDayResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
