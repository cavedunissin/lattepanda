...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class DeleteBodyFatLog : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteBodyFatLog Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteBodyFatLog(TembooSession session) : base(session, "/Library/Fitbit/Body/DeleteBodyFatLog")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the BodyFatLogID input for this Choreo.</param>
         public void setBodyFatLogID(String value) {
             base.addInput ("BodyFatLogID", value);
         }
         /// <summary>
         /// (required, string) Deprecated (retained for backward compatibility only).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A DeleteBodyFatLogResultSet containing execution metadata and results.</returns>
        new public DeleteBodyFatLogResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteBodyFatLogResultSet results = new JavaScriptSerializer().Deserialize<DeleteBodyFatLogResultSet>(json);
    ...
    /// </summary>
    public class DeleteBodyFatLogResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
