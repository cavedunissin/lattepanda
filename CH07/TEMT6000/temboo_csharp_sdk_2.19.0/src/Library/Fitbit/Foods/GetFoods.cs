...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetFoods : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFoods Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFoods(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetFoods")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFoodsResultSet containing execution metadata and results.</returns>
        new public GetFoodsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFoodsResultSet results = new JavaScriptSerializer().Deserialize<GetFoodsResultSet>(json);
    ...
    /// </summary>
    public class GetFoodsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
