...
namespace Temboo.Library.Google.Gmailv2.Threads
{
    ...
    /// </summary>
    public class UnTrashThread : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnTrashThread Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnTrashThread(TembooSession session) : base(session, "/Library/Google/Gmailv2/Threads/UnTrashThread")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnTrashThreadResultSet containing execution metadata and results.</returns>
        new public UnTrashThreadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnTrashThreadResultSet results = new JavaScriptSerializer().Deserialize<UnTrashThreadResultSet>(json);
    ...
    /// </summary>
    public class UnTrashThreadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
