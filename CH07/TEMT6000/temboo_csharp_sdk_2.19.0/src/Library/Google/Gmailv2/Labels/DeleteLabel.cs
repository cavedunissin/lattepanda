...
namespace Temboo.Library.Google.Gmailv2.Labels
{
    ...
    /// </summary>
    public class DeleteLabel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteLabel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteLabel(TembooSession session) : base(session, "/Library/Google/Gmailv2/Labels/DeleteLabel")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteLabelResultSet containing execution metadata and results.</returns>
        new public DeleteLabelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteLabelResultSet results = new JavaScriptSerializer().Deserialize<DeleteLabelResultSet>(json);
    ...
    /// </summary>
    public class DeleteLabelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
