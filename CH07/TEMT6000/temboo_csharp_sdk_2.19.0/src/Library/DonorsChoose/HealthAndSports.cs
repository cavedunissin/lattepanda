...
namespace Temboo.Library.DonorsChoose
{
    ...
    /// </summary>
    public class HealthAndSports : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the HealthAndSports Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public HealthAndSports(TembooSession session) : base(session, "/Library/DonorsChoose/HealthAndSports")
        {
        }
        ...
        /// </summary>
        /// <returns>A HealthAndSportsResultSet containing execution metadata and results.</returns>
        new public HealthAndSportsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            HealthAndSportsResultSet results = new JavaScriptSerializer().Deserialize<HealthAndSportsResultSet>(json);
    ...
    /// </summary>
    public class HealthAndSportsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
