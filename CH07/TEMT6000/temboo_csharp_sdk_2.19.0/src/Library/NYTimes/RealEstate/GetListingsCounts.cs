...
namespace Temboo.Library.NYTimes.RealEstate
{
    ...
    /// </summary>
    public class GetListingsCounts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetListingsCounts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetListingsCounts(TembooSession session) : base(session, "/Library/NYTimes/RealEstate/GetListingsCounts")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetListingsCountsResultSet containing execution metadata and results.</returns>
        new public GetListingsCountsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetListingsCountsResultSet results = new JavaScriptSerializer().Deserialize<GetListingsCountsResultSet>(json);
    ...
    /// </summary>
    public class GetListingsCountsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
