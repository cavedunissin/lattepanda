...
namespace Temboo.Library.Tumblr.User
{
    ...
    /// </summary>
    public class RetrieveUserLikes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveUserLikes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveUserLikes(TembooSession session) : base(session, "/Library/Tumblr/User/RetrieveUserLikes")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveUserLikesResultSet containing execution metadata and results.</returns>
        new public RetrieveUserLikesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveUserLikesResultSet results = new JavaScriptSerializer().Deserialize<RetrieveUserLikesResultSet>(json);
    ...
    /// </summary>
    public class RetrieveUserLikesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
