...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListGroupPolicies : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGroupPolicies Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGroupPolicies(TembooSession session) : base(session, "/Library/Amazon/IAM/ListGroupPolicies")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGroupPoliciesResultSet containing execution metadata and results.</returns>
        new public ListGroupPoliciesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGroupPoliciesResultSet results = new JavaScriptSerializer().Deserialize<ListGroupPoliciesResultSet>(json);
    ...
    /// </summary>
    public class ListGroupPoliciesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
