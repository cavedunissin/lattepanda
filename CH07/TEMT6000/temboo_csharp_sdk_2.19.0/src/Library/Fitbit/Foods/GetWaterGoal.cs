...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetWaterGoal : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetWaterGoal Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetWaterGoal(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetWaterGoal")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetWaterGoalResultSet containing execution metadata and results.</returns>
        new public GetWaterGoalResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetWaterGoalResultSet results = new JavaScriptSerializer().Deserialize<GetWaterGoalResultSet>(json);
    ...
    /// </summary>
    public class GetWaterGoalResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
