...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class UpdateWorksheet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateWorksheet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateWorksheet(TembooSession session) : base(session, "/Library/Google/Spreadsheets/UpdateWorksheet")
        {
        }

         /// <summary>
         /// (optional, string) A valid Access Token retrieved during the OAuth process. This is required when authenticating with OAuth unless providing the ClientID, ClientSecret, and RefreshToken.
         /// </summary>
         ...
         /// </summary>
         /// <param name="value">Value of the ColumnCount input for this Choreo.</param>
         public void setColumnCount(String value) {
             base.addInput ("ColumnCount", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the RowCount input for this Choreo.</param>
         public void setRowCount(String value) {
             base.addInput ("RowCount", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateWorksheetResultSet containing execution metadata and results.</returns>
        new public UpdateWorksheetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateWorksheetResultSet results = new JavaScriptSerializer().Deserialize<UpdateWorksheetResultSet>(json);
    ...
    /// </summary>
    public class UpdateWorksheetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
