...
namespace Temboo.Library.Google.Gmailv2.Drafts
{
    ...
    /// </summary>
    public class SendDraft : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SendDraft Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SendDraft(TembooSession session) : base(session, "/Library/Google/Gmailv2/Drafts/SendDraft")
        {
        }
        ...
        /// </summary>
        /// <returns>A SendDraftResultSet containing execution metadata and results.</returns>
        new public SendDraftResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SendDraftResultSet results = new JavaScriptSerializer().Deserialize<SendDraftResultSet>(json);
    ...
    /// </summary>
    public class SendDraftResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
