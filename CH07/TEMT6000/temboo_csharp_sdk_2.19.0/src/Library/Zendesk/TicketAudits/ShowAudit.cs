...
namespace Temboo.Library.Zendesk.TicketAudits
{
    ...
    /// </summary>
    public class ShowAudit : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ShowAudit Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ShowAudit(TembooSession session) : base(session, "/Library/Zendesk/TicketAudits/ShowAudit")
        {
        }
        ...
        /// </summary>
        /// <returns>A ShowAuditResultSet containing execution metadata and results.</returns>
        new public ShowAuditResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ShowAuditResultSet results = new JavaScriptSerializer().Deserialize<ShowAuditResultSet>(json);
    ...
    /// </summary>
    public class ShowAuditResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
