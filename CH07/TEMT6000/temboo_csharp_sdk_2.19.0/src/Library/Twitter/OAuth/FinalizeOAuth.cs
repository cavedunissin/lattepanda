...
namespace Temboo.Library.Twitter.OAuth
{
    /// <summary>
    /// FinalizeOAuth
    ...
    public class FinalizeOAuth : Temboo.Core.Choreography
    {
        ...
        public FinalizeOAuth(TembooSession session) : base(session, "/Library/Twitter/OAuth/FinalizeOAuth")
        {
        }
    ...
    public class FinalizeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The Twitter screen name associated with the access token that is being retrieved.</returns>
        /// </summary>
        ...
        /// <returns>String - (integer) The Twitter user id associated with the AccessToken that is being retrieved.</returns>
        /// </summary>
