...
namespace Temboo.Library.Twilio.Applications
{
    ...
    /// </summary>
    public class CreateApplication : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateApplication Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateApplication(TembooSession session) : base(session, "/Library/Twilio/Applications/CreateApplication")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateApplicationResultSet containing execution metadata and results.</returns>
        new public CreateApplicationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateApplicationResultSet results = new JavaScriptSerializer().Deserialize<CreateApplicationResultSet>(json);
    ...
    /// </summary>
    public class CreateApplicationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
