...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class GetAllMilestones : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAllMilestones Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAllMilestones(TembooSession session) : base(session, "/Library/Basecamp/GetAllMilestones")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAllMilestonesResultSet containing execution metadata and results.</returns>
        new public GetAllMilestonesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAllMilestonesResultSet results = new JavaScriptSerializer().Deserialize<GetAllMilestonesResultSet>(json);
    ...
    /// </summary>
    public class GetAllMilestonesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
