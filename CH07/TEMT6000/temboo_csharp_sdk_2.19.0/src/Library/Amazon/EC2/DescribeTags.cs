...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DescribeTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DescribeTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DescribeTags(TembooSession session) : base(session, "/Library/Amazon/EC2/DescribeTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A DescribeTagsResultSet containing execution metadata and results.</returns>
        new public DescribeTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DescribeTagsResultSet results = new JavaScriptSerializer().Deserialize<DescribeTagsResultSet>(json);
    ...
    /// </summary>
    public class DescribeTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
