...
namespace Temboo.Library.Flickr.Places
{
    ...
    /// </summary>
    public class FindByURL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FindByURL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FindByURL(TembooSession session) : base(session, "/Library/Flickr/Places/FindByURL")
        {
        }
        ...
        /// </summary>
        /// <returns>A FindByURLResultSet containing execution metadata and results.</returns>
        new public FindByURLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FindByURLResultSet results = new JavaScriptSerializer().Deserialize<FindByURLResultSet>(json);
    ...
    /// </summary>
    public class FindByURLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
