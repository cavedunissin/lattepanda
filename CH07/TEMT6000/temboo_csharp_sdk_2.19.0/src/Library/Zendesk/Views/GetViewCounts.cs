...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class GetViewCounts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetViewCounts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetViewCounts(TembooSession session) : base(session, "/Library/Zendesk/Views/GetViewCounts")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetViewCountsResultSet containing execution metadata and results.</returns>
        new public GetViewCountsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetViewCountsResultSet results = new JavaScriptSerializer().Deserialize<GetViewCountsResultSet>(json);
    ...
    /// </summary>
    public class GetViewCountsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
