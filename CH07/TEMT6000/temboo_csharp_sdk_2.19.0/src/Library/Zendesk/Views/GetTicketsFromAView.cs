...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class GetTicketsFromAView : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTicketsFromAView Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTicketsFromAView(TembooSession session) : base(session, "/Library/Zendesk/Views/GetTicketsFromAView")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTicketsFromAViewResultSet containing execution metadata and results.</returns>
        new public GetTicketsFromAViewResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTicketsFromAViewResultSet results = new JavaScriptSerializer().Deserialize<GetTicketsFromAViewResultSet>(json);
    ...
    /// </summary>
    public class GetTicketsFromAViewResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
