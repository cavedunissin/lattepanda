...
namespace Temboo.Library.Foursquare.Checkins
{
    ...
    /// </summary>
    public class Likes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Likes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Likes(TembooSession session) : base(session, "/Library/Foursquare/Checkins/Likes")
        {
        }
        ...
        /// </summary>
        /// <returns>A LikesResultSet containing execution metadata and results.</returns>
        new public LikesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LikesResultSet results = new JavaScriptSerializer().Deserialize<LikesResultSet>(json);
    ...
    /// </summary>
    public class LikesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
