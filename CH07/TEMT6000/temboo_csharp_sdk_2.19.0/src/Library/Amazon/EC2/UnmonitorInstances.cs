...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class UnmonitorInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnmonitorInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnmonitorInstances(TembooSession session) : base(session, "/Library/Amazon/EC2/UnmonitorInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnmonitorInstancesResultSet containing execution metadata and results.</returns>
        new public UnmonitorInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnmonitorInstancesResultSet results = new JavaScriptSerializer().Deserialize<UnmonitorInstancesResultSet>(json);
    ...
    /// </summary>
    public class UnmonitorInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
