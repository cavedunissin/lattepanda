...
namespace Temboo.Library.Twitter.Timelines
{
    ...
    /// </summary>
    public class HomeTimelineLatestTweet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the HomeTimelineLatestTweet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public HomeTimelineLatestTweet(TembooSession session) : base(session, "/Library/Twitter/Timelines/HomeTimelineLatestTweet")
        {
        }
        ...
        /// </summary>
        /// <returns>A HomeTimelineLatestTweetResultSet containing execution metadata and results.</returns>
        new public HomeTimelineLatestTweetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            HomeTimelineLatestTweetResultSet results = new JavaScriptSerializer().Deserialize<HomeTimelineLatestTweetResultSet>(json);
    ...
    /// </summary>
    public class HomeTimelineLatestTweetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
