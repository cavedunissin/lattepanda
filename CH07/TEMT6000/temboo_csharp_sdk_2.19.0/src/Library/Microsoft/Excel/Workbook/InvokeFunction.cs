...
namespace Temboo.Library.Microsoft.Excel.Workbook
{
    /// <summary>
    /// InvokeFunction
    /// Invokes a workbook function.
    /// </summary>
    public class InvokeFunction : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the InvokeFunction Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public InvokeFunction(TembooSession session) : base(session, "/Library/Microsoft/Excel/Workbook/InvokeFunction")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Arguments input for this Choreo.</param>
         public void setArguments(String value) {
             base.addInput ("Arguments", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the Function input for this Choreo.</param>
         public void setFunction(String value) {
             base.addInput ("Function", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A InvokeFunctionResultSet containing execution metadata and results.</returns>
        new public InvokeFunctionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InvokeFunctionResultSet results = new JavaScriptSerializer().Deserialize<InvokeFunctionResultSet>(json);
    ...
    /// </summary>
    public class InvokeFunctionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
