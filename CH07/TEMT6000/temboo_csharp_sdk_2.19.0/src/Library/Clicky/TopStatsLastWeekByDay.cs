...
namespace Temboo.Library.Clicky
{
    ...
    /// </summary>
    public class TopStatsLastWeekByDay : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TopStatsLastWeekByDay Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TopStatsLastWeekByDay(TembooSession session) : base(session, "/Library/Clicky/TopStatsLastWeekByDay")
        {
        }
        ...
        /// </summary>
        /// <returns>A TopStatsLastWeekByDayResultSet containing execution metadata and results.</returns>
        new public TopStatsLastWeekByDayResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TopStatsLastWeekByDayResultSet results = new JavaScriptSerializer().Deserialize<TopStatsLastWeekByDayResultSet>(json);
    ...
    /// </summary>
    public class TopStatsLastWeekByDayResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
