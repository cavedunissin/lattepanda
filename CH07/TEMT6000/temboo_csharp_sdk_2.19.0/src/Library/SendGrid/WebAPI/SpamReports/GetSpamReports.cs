...
namespace Temboo.Library.SendGrid.WebAPI.SpamReports
{
    ...
    /// </summary>
    public class GetSpamReports : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSpamReports Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSpamReports(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/SpamReports/GetSpamReports")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSpamReportsResultSet containing execution metadata and results.</returns>
        new public GetSpamReportsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSpamReportsResultSet results = new JavaScriptSerializer().Deserialize<GetSpamReportsResultSet>(json);
    ...
    /// </summary>
    public class GetSpamReportsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
