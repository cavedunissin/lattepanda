...
namespace Temboo.Library.Google.Plus.Domains.People
{
    ...
    public class List : Temboo.Core.Choreography
    {
        ...
        public List(TembooSession session) : base(session, "/Library/Google/Plus/Domains/People/List")
        {
        }
         ...
         /// <summary>
         /// (required, string) The collection to list people for. Currently the only allowed value for this parameter is: "circled".
         /// </summary>
