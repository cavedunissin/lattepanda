...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class Leaderboard : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Leaderboard Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Leaderboard(TembooSession session) : base(session, "/Library/Foursquare/Users/Leaderboard")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Neighbors input for this Choreo.</param>
         public void setNeighbors(String value) {
             base.addInput ("Neighbors", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A LeaderboardResultSet containing execution metadata and results.</returns>
        new public LeaderboardResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LeaderboardResultSet results = new JavaScriptSerializer().Deserialize<LeaderboardResultSet>(json);
    ...
    /// </summary>
    public class LeaderboardResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
