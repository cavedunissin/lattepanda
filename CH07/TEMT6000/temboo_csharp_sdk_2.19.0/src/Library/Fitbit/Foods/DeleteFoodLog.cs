...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class DeleteFoodLog : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteFoodLog Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteFoodLog(TembooSession session) : base(session, "/Library/Fitbit/Foods/DeleteFoodLog")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the FoodLogID input for this Choreo.</param>
         public void setFoodLogID(String value) {
             base.addInput ("FoodLogID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DeleteFoodLogResultSet containing execution metadata and results.</returns>
        new public DeleteFoodLogResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteFoodLogResultSet results = new JavaScriptSerializer().Deserialize<DeleteFoodLogResultSet>(json);
    ...
    /// </summary>
    public class DeleteFoodLogResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
