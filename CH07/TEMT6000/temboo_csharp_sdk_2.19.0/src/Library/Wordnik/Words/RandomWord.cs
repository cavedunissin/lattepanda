...
namespace Temboo.Library.Wordnik.Words
{
    ...
    /// </summary>
    public class RandomWord : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RandomWord Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RandomWord(TembooSession session) : base(session, "/Library/Wordnik/Words/RandomWord")
        {
        }
        ...
        /// </summary>
        /// <returns>A RandomWordResultSet containing execution metadata and results.</returns>
        new public RandomWordResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RandomWordResultSet results = new JavaScriptSerializer().Deserialize<RandomWordResultSet>(json);
    ...
    /// </summary>
    public class RandomWordResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
