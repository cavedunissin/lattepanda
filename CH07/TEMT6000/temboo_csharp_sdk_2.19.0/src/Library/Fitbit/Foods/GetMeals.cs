...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetMeals : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMeals Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMeals(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetMeals")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMealsResultSet containing execution metadata and results.</returns>
        new public GetMealsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMealsResultSet results = new JavaScriptSerializer().Deserialize<GetMealsResultSet>(json);
    ...
    /// </summary>
    public class GetMealsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
