...
namespace Temboo.Library.NYTimes.CampaignFinance.Committees
{
    ...
    /// </summary>
    public class CommitteeDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CommitteeDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CommitteeDetails(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Committees/CommitteeDetails")
        {
        }
        ...
        /// </summary>
        /// <returns>A CommitteeDetailsResultSet containing execution metadata and results.</returns>
        new public CommitteeDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CommitteeDetailsResultSet results = new JavaScriptSerializer().Deserialize<CommitteeDetailsResultSet>(json);
    ...
    /// </summary>
    public class CommitteeDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
