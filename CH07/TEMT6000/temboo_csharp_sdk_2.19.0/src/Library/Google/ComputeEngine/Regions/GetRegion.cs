...
namespace Temboo.Library.Google.ComputeEngine.Regions
{
    ...
    /// </summary>
    public class GetRegion : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRegion Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRegion(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Regions/GetRegion")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRegionResultSet containing execution metadata and results.</returns>
        new public GetRegionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRegionResultSet results = new JavaScriptSerializer().Deserialize<GetRegionResultSet>(json);
    ...
    /// </summary>
    public class GetRegionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
