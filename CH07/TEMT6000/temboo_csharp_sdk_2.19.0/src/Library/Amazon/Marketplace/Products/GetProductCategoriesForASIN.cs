...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    /// </summary>
    public class GetProductCategoriesForASIN : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetProductCategoriesForASIN Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetProductCategoriesForASIN(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/GetProductCategoriesForASIN")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetProductCategoriesForASINResultSet containing execution metadata and results.</returns>
        new public GetProductCategoriesForASINResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetProductCategoriesForASINResultSet results = new JavaScriptSerializer().Deserialize<GetProductCategoriesForASINResultSet>(json);
    ...
    /// </summary>
    public class GetProductCategoriesForASINResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
