...
namespace Temboo.Library.NYTimes.MostPopular
{
    ...
    /// </summary>
    public class GetMostEmailed : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMostEmailed Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMostEmailed(TembooSession session) : base(session, "/Library/NYTimes/MostPopular/GetMostEmailed")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMostEmailedResultSet containing execution metadata and results.</returns>
        new public GetMostEmailedResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMostEmailedResultSet results = new JavaScriptSerializer().Deserialize<GetMostEmailedResultSet>(json);
    ...
    /// </summary>
    public class GetMostEmailedResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
