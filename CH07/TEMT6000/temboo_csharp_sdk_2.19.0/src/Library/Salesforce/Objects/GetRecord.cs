...
namespace Temboo.Library.Salesforce.Objects
{
    ...
    /// </summary>
    public class GetRecord : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRecord Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRecord(TembooSession session) : base(session, "/Library/Salesforce/Objects/GetRecord")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Comma-separated list of up to 10 field names.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The id of the object that you want to retrieve.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) The name of the Salesforce object type being retrieved (e.g. Account, Contact, Lead, etc).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetRecordResultSet containing execution metadata and results.</returns>
        new public GetRecordResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRecordResultSet results = new JavaScriptSerializer().Deserialize<GetRecordResultSet>(json);
    ...
    /// </summary>
    public class GetRecordResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
