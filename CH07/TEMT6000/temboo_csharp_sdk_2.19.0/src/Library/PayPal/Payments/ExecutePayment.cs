...
namespace Temboo.Library.PayPal.Payments
{
    ...
    /// </summary>
    public class ExecutePayment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ExecutePayment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ExecutePayment(TembooSession session) : base(session, "/Library/PayPal/Payments/ExecutePayment")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the PayerID input for this Choreo.</param>
         public void setPayerID(String value) {
             base.addInput ("PayerID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ExecutePaymentResultSet containing execution metadata and results.</returns>
        new public ExecutePaymentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ExecutePaymentResultSet results = new JavaScriptSerializer().Deserialize<ExecutePaymentResultSet>(json);
    ...
    /// </summary>
    public class ExecutePaymentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (string) The id of the sale that was just executed. This can be used to Lookup the sales transaction if needed.</returns>
        /// </summary>
        public String SaleID
        {
            get
            {
                return (String) base.Output["SaleID"];
            }
        }
        /// <summary> 
