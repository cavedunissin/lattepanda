...
namespace Temboo.Library.Amazon.CloudDrive.Trash
{
    ...
    /// </summary>
    public class Restore : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Restore Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Restore(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Trash/Restore")
        {
        }
        ...
        /// </summary>
        /// <returns>A RestoreResultSet containing execution metadata and results.</returns>
        new public RestoreResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RestoreResultSet results = new JavaScriptSerializer().Deserialize<RestoreResultSet>(json);
    ...
    /// </summary>
    public class RestoreResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
