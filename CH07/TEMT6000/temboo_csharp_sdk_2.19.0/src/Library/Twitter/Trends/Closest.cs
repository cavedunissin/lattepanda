...
namespace Temboo.Library.Twitter.Trends
{
    ...
    /// </summary>
    public class Closest : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Closest Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Closest(TembooSession session) : base(session, "/Library/Twitter/Trends/Closest")
        {
        }
        ...
        /// </summary>
        /// <returns>A ClosestResultSet containing execution metadata and results.</returns>
        new public ClosestResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ClosestResultSet results = new JavaScriptSerializer().Deserialize<ClosestResultSet>(json);
    ...
    /// </summary>
    public class ClosestResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
