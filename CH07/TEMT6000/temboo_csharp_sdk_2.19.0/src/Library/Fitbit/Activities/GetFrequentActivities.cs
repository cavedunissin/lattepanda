...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class GetFrequentActivities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFrequentActivities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFrequentActivities(TembooSession session) : base(session, "/Library/Fitbit/Activities/GetFrequentActivities")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFrequentActivitiesResultSet containing execution metadata and results.</returns>
        new public GetFrequentActivitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFrequentActivitiesResultSet results = new JavaScriptSerializer().Deserialize<GetFrequentActivitiesResultSet>(json);
    ...
    /// </summary>
    public class GetFrequentActivitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
