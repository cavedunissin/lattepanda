...
namespace Temboo.Library.Facebook.Actions.Fitness.Walks
{
    /// <summary>
    /// UpdateWalk
    /// Updates an existing walk action.
    /// </summary>
    public class UpdateWalk : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateWalk Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateWalk(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Walks/UpdateWalk")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateWalkResultSet containing execution metadata and results.</returns>
        new public UpdateWalkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateWalkResultSet results = new JavaScriptSerializer().Deserialize<UpdateWalkResultSet>(json);
    ...
    /// </summary>
    public class UpdateWalkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
