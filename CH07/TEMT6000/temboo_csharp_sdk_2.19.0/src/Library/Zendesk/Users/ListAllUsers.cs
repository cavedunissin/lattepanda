...
namespace Temboo.Library.Zendesk.Users
{
    ...
    /// </summary>
    public class ListAllUsers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllUsers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllUsers(TembooSession session) : base(session, "/Library/Zendesk/Users/ListAllUsers")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllUsersResultSet containing execution metadata and results.</returns>
        new public ListAllUsersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllUsersResultSet results = new JavaScriptSerializer().Deserialize<ListAllUsersResultSet>(json);
    ...
    /// </summary>
    public class ListAllUsersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
