...
namespace Temboo.Library.Google.ComputeEngine.ZoneOperations
{
    ...
    /// </summary>
    public class ListZoneOperations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListZoneOperations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListZoneOperations(TembooSession session) : base(session, "/Library/Google/ComputeEngine/ZoneOperations/ListZoneOperations")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListZoneOperationsResultSet containing execution metadata and results.</returns>
        new public ListZoneOperationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListZoneOperationsResultSet results = new JavaScriptSerializer().Deserialize<ListZoneOperationsResultSet>(json);
    ...
    /// </summary>
    public class ListZoneOperationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
