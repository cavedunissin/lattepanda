...
namespace Temboo.Library.GitHub.ReposAPI.Repos
{
    ...
    /// </summary>
    public class ListTeams : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTeams Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTeams(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Repos/ListTeams")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTeamsResultSet containing execution metadata and results.</returns>
        new public ListTeamsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTeamsResultSet results = new JavaScriptSerializer().Deserialize<ListTeamsResultSet>(json);
    ...
    /// </summary>
    public class ListTeamsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
