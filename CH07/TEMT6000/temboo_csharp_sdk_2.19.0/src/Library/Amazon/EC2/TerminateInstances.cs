...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class TerminateInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TerminateInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TerminateInstances(TembooSession session) : base(session, "/Library/Amazon/EC2/TerminateInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A TerminateInstancesResultSet containing execution metadata and results.</returns>
        new public TerminateInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TerminateInstancesResultSet results = new JavaScriptSerializer().Deserialize<TerminateInstancesResultSet>(json);
    ...
    /// </summary>
    public class TerminateInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
