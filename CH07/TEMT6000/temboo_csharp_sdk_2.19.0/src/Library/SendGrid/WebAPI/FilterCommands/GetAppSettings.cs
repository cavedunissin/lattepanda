...
namespace Temboo.Library.SendGrid.WebAPI.FilterCommands
{
    ...
    /// </summary>
    public class GetAppSettings : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAppSettings Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAppSettings(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/FilterCommands/GetAppSettings")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAppSettingsResultSet containing execution metadata and results.</returns>
        new public GetAppSettingsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAppSettingsResultSet results = new JavaScriptSerializer().Deserialize<GetAppSettingsResultSet>(json);
    ...
    /// </summary>
    public class GetAppSettingsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
