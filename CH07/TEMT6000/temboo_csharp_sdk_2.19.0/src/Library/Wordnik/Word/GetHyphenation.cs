...
namespace Temboo.Library.Wordnik.Word
{
    ...
    /// </summary>
    public class GetHyphenation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetHyphenation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetHyphenation(TembooSession session) : base(session, "/Library/Wordnik/Word/GetHyphenation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetHyphenationResultSet containing execution metadata and results.</returns>
        new public GetHyphenationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetHyphenationResultSet results = new JavaScriptSerializer().Deserialize<GetHyphenationResultSet>(json);
    ...
    /// </summary>
    public class GetHyphenationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
