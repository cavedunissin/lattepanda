...
namespace Temboo.Library.SendGrid.NewsletterAPI.Identity
{
    ...
    /// </summary>
    public class ListAllIdentities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllIdentities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllIdentities(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Identity/ListAllIdentities")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllIdentitiesResultSet containing execution metadata and results.</returns>
        new public ListAllIdentitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllIdentitiesResultSet results = new JavaScriptSerializer().Deserialize<ListAllIdentitiesResultSet>(json);
    ...
    /// </summary>
    public class ListAllIdentitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
