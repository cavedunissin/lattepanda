...
namespace Temboo.Library.Dwolla.Transactions
{
    ...
    /// </summary>
    public class Stats : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Stats Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Stats(TembooSession session) : base(session, "/Library/Dwolla/Transactions/Stats")
        {
        }
        ...
        /// </summary>
        /// <returns>A StatsResultSet containing execution metadata and results.</returns>
        new public StatsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            StatsResultSet results = new JavaScriptSerializer().Deserialize<StatsResultSet>(json);
    ...
    /// </summary>
    public class StatsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
