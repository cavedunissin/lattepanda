...
namespace Temboo.Library.Amazon.DynamoDB
{
    ...
    /// </summary>
    public class BatchGetItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the BatchGetItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public BatchGetItem(TembooSession session) : base(session, "/Library/Amazon/DynamoDB/BatchGetItem")
        {
        }
        ...
        /// </summary>
        /// <returns>A BatchGetItemResultSet containing execution metadata and results.</returns>
        new public BatchGetItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BatchGetItemResultSet results = new JavaScriptSerializer().Deserialize<BatchGetItemResultSet>(json);
    ...
    /// </summary>
    public class BatchGetItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
