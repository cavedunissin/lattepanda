...
namespace Temboo.Library.CorpWatch.Relationships
{
    ...
    /// </summary>
    public class TopParent : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TopParent Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TopParent(TembooSession session) : base(session, "/Library/CorpWatch/Relationships/TopParent")
        {
        }
        ...
        /// </summary>
        /// <returns>A TopParentResultSet containing execution metadata and results.</returns>
        new public TopParentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TopParentResultSet results = new JavaScriptSerializer().Deserialize<TopParentResultSet>(json);
    ...
    /// </summary>
    public class TopParentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
