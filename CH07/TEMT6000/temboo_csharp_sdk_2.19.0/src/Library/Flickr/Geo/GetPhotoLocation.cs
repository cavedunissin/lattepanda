...
namespace Temboo.Library.Flickr.Geo
{
    ...
    /// </summary>
    public class GetPhotoLocation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPhotoLocation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPhotoLocation(TembooSession session) : base(session, "/Library/Flickr/Geo/GetPhotoLocation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPhotoLocationResultSet containing execution metadata and results.</returns>
        new public GetPhotoLocationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPhotoLocationResultSet results = new JavaScriptSerializer().Deserialize<GetPhotoLocationResultSet>(json);
    ...
    /// </summary>
    public class GetPhotoLocationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
