...
namespace Temboo.Library.Factual
{
    ...
    /// </summary>
    public class FindRestaurantsByName : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FindRestaurantsByName Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FindRestaurantsByName(TembooSession session) : base(session, "/Library/Factual/FindRestaurantsByName")
        {
        }
        ...
        /// </summary>
        /// <returns>A FindRestaurantsByNameResultSet containing execution metadata and results.</returns>
        new public FindRestaurantsByNameResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FindRestaurantsByNameResultSet results = new JavaScriptSerializer().Deserialize<FindRestaurantsByNameResultSet>(json);
    ...
    /// </summary>
    public class FindRestaurantsByNameResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
