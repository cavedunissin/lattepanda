...
namespace Temboo.Library.Amazon.SNS
{
    ...
    /// </summary>
    public class ListTopics : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTopics Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTopics(TembooSession session) : base(session, "/Library/Amazon/SNS/ListTopics")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTopicsResultSet containing execution metadata and results.</returns>
        new public ListTopicsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTopicsResultSet results = new JavaScriptSerializer().Deserialize<ListTopicsResultSet>(json);
    ...
    /// </summary>
    public class ListTopicsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
