...
namespace Temboo.Library.AuthorizeNet.AutomatedRecurringBilling
{
    ...
    /// </summary>
    public class GetSubscriptionStatus : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSubscriptionStatus Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSubscriptionStatus(TembooSession session) : base(session, "/Library/AuthorizeNet/AutomatedRecurringBilling/GetSubscriptionStatus")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSubscriptionStatusResultSet containing execution metadata and results.</returns>
        new public GetSubscriptionStatusResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSubscriptionStatusResultSet results = new JavaScriptSerializer().Deserialize<GetSubscriptionStatusResultSet>(json);
    ...
    /// </summary>
    public class GetSubscriptionStatusResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
