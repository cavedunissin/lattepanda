...
namespace Temboo.Library.NYTimes.CampaignFinance.IndividualContributors
{
    ...
    /// </summary>
    public class ContributionsToPresidentialCandidates : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ContributionsToPresidentialCandidates Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ContributionsToPresidentialCandidates(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/IndividualContributors/ContributionsToPresidentialCandidates")
        {
        }
        ...
        /// </summary>
        /// <returns>A ContributionsToPresidentialCandidatesResultSet containing execution metadata and results.</returns>
        new public ContributionsToPresidentialCandidatesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ContributionsToPresidentialCandidatesResultSet results = new JavaScriptSerializer().Deserialize<ContributionsToPresidentialCandidatesResultSet>(json);
    ...
    /// </summary>
    public class ContributionsToPresidentialCandidatesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
