...
namespace Temboo.Library.GitHub.GistsAPI.Gists
{
    ...
    /// </summary>
    public class CheckGist : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CheckGist Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CheckGist(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Gists/CheckGist")
        {
        }
        ...
        /// </summary>
        /// <returns>A CheckGistResultSet containing execution metadata and results.</returns>
        new public CheckGistResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CheckGistResultSet results = new JavaScriptSerializer().Deserialize<CheckGistResultSet>(json);
    ...
    /// </summary>
    public class CheckGistResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (string) A boolean flag that indicates whether or not the gist is starred.</returns>
        /// </summary>
