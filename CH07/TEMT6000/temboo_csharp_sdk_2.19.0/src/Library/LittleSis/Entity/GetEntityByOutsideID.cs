...
namespace Temboo.Library.LittleSis.Entity
{
    ...
    /// </summary>
    public class GetEntityByOutsideID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEntityByOutsideID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEntityByOutsideID(TembooSession session) : base(session, "/Library/LittleSis/Entity/GetEntityByOutsideID")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the IDType input for this Choreo.</param>
         public void setIDType(String value) {
             base.addInput ("IDType", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetEntityByOutsideIDResultSet containing execution metadata and results.</returns>
        new public GetEntityByOutsideIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEntityByOutsideIDResultSet results = new JavaScriptSerializer().Deserialize<GetEntityByOutsideIDResultSet>(json);
    ...
    /// </summary>
    public class GetEntityByOutsideIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
