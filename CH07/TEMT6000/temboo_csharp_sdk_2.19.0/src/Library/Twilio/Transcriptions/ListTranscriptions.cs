...
namespace Temboo.Library.Twilio.Transcriptions
{
    ...
    /// </summary>
    public class ListTranscriptions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTranscriptions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTranscriptions(TembooSession session) : base(session, "/Library/Twilio/Transcriptions/ListTranscriptions")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTranscriptionsResultSet containing execution metadata and results.</returns>
        new public ListTranscriptionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTranscriptionsResultSet results = new JavaScriptSerializer().Deserialize<ListTranscriptionsResultSet>(json);
    ...
    /// </summary>
    public class ListTranscriptionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
