...
namespace Temboo.Library.FilesAnywhere
{
    ...
    /// </summary>
    public class ViewFile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ViewFile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ViewFile(TembooSession session) : base(session, "/Library/FilesAnywhere/ViewFile")
        {
        }
        ...
        /// </summary>
        /// <returns>A ViewFileResultSet containing execution metadata and results.</returns>
        new public ViewFileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ViewFileResultSet results = new JavaScriptSerializer().Deserialize<ViewFileResultSet>(json);
    ...
    /// </summary>
    public class ViewFileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
