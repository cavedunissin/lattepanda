...
namespace Temboo.Library.Google.ComputeEngine.Firewalls
{
    ...
    /// </summary>
    public class ListFirewalls : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListFirewalls Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListFirewalls(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Firewalls/ListFirewalls")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListFirewallsResultSet containing execution metadata and results.</returns>
        new public ListFirewallsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListFirewallsResultSet results = new JavaScriptSerializer().Deserialize<ListFirewallsResultSet>(json);
    ...
    /// </summary>
    public class ListFirewallsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
