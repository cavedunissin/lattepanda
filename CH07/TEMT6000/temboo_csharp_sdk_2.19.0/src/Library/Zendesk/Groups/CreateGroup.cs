...
namespace Temboo.Library.Zendesk.Groups
{
    ...
    /// Creates a new group.
    /// </summary>
    public class CreateGroup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateGroup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateGroup(TembooSession session) : base(session, "/Library/Zendesk/Groups/CreateGroup")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateGroupResultSet containing execution metadata and results.</returns>
        new public CreateGroupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateGroupResultSet results = new JavaScriptSerializer().Deserialize<CreateGroupResultSet>(json);
    ...
    /// </summary>
    public class CreateGroupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
