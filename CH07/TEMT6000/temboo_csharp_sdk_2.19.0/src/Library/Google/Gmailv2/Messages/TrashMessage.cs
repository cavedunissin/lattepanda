...
namespace Temboo.Library.Google.Gmailv2.Messages
{
    ...
    /// </summary>
    public class TrashMessage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TrashMessage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TrashMessage(TembooSession session) : base(session, "/Library/Google/Gmailv2/Messages/TrashMessage")
        {
        }
        ...
        /// </summary>
        /// <returns>A TrashMessageResultSet containing execution metadata and results.</returns>
        new public TrashMessageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TrashMessageResultSet results = new JavaScriptSerializer().Deserialize<TrashMessageResultSet>(json);
    ...
    /// </summary>
    public class TrashMessageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
