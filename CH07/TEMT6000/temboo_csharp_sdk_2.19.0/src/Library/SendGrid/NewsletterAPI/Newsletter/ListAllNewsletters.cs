...
namespace Temboo.Library.SendGrid.NewsletterAPI.Newsletter
{
    ...
    /// </summary>
    public class ListAllNewsletters : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllNewsletters Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllNewsletters(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Newsletter/ListAllNewsletters")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllNewslettersResultSet containing execution metadata and results.</returns>
        new public ListAllNewslettersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllNewslettersResultSet results = new JavaScriptSerializer().Deserialize<ListAllNewslettersResultSet>(json);
    ...
    /// </summary>
    public class ListAllNewslettersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
