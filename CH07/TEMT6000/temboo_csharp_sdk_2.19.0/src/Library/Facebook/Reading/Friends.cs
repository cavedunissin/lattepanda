...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Friends : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Friends Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Friends(TembooSession session) : base(session, "/Library/Facebook/Reading/Friends")
        {
        }
        ...
        /// </summary>
        /// <returns>A FriendsResultSet containing execution metadata and results.</returns>
        new public FriendsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FriendsResultSet results = new JavaScriptSerializer().Deserialize<FriendsResultSet>(json);
    ...
    /// </summary>
    public class FriendsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
