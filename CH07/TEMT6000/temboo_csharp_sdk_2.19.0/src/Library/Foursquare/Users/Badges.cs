...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class Badges : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Badges Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Badges(TembooSession session) : base(session, "/Library/Foursquare/Users/Badges")
        {
        }
        ...
        /// </summary>
        /// <returns>A BadgesResultSet containing execution metadata and results.</returns>
        new public BadgesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BadgesResultSet results = new JavaScriptSerializer().Deserialize<BadgesResultSet>(json);
    ...
    /// </summary>
    public class BadgesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
