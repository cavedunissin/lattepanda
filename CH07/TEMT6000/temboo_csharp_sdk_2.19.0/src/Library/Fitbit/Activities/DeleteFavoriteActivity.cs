...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class DeleteFavoriteActivity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteFavoriteActivity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteFavoriteActivity(TembooSession session) : base(session, "/Library/Fitbit/Activities/DeleteFavoriteActivity")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteFavoriteActivityResultSet containing execution metadata and results.</returns>
        new public DeleteFavoriteActivityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteFavoriteActivityResultSet results = new JavaScriptSerializer().Deserialize<DeleteFavoriteActivityResultSet>(json);
    ...
    /// </summary>
    public class DeleteFavoriteActivityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
