...
namespace Temboo.Library.GitHub.GistsAPI.Gists
{
    ...
    /// </summary>
    public class GetGist : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetGist Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetGist(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Gists/GetGist")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetGistResultSet containing execution metadata and results.</returns>
        new public GetGistResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetGistResultSet results = new JavaScriptSerializer().Deserialize<GetGistResultSet>(json);
    ...
    /// </summary>
    public class GetGistResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
