...
namespace Temboo.Library.Twitter.PlacesAndGeo
{
    ...
    /// </summary>
    public class ReverseGeocode : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReverseGeocode Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReverseGeocode(TembooSession session) : base(session, "/Library/Twitter/PlacesAndGeo/ReverseGeocode")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReverseGeocodeResultSet containing execution metadata and results.</returns>
        new public ReverseGeocodeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReverseGeocodeResultSet results = new JavaScriptSerializer().Deserialize<ReverseGeocodeResultSet>(json);
    ...
    /// </summary>
    public class ReverseGeocodeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
