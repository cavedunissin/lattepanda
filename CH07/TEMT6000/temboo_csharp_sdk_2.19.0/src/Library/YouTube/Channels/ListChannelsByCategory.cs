...
namespace Temboo.Library.YouTube.Channels
{
    /// <summary>
    /// ListChannelsByCategory
    /// Returns a list of channels associated with a particular category.
    /// </summary>
    public class ListChannelsByCategory : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListChannelsByCategory Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListChannelsByCategory(TembooSession session) : base(session, "/Library/YouTube/Channels/ListChannelsByCategory")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListChannelsByCategoryResultSet containing execution metadata and results.</returns>
        new public ListChannelsByCategoryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListChannelsByCategoryResultSet results = new JavaScriptSerializer().Deserialize<ListChannelsByCategoryResultSet>(json);
    ...
    /// </summary>
    public class ListChannelsByCategoryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
