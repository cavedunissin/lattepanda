...
namespace Temboo.Library.Google.ComputeEngine.Instances
{
    ...
    /// </summary>
    public class DeleteInstance : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteInstance Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteInstance(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Instances/DeleteInstance")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteInstanceResultSet containing execution metadata and results.</returns>
        new public DeleteInstanceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteInstanceResultSet results = new JavaScriptSerializer().Deserialize<DeleteInstanceResultSet>(json);
    ...
    /// </summary>
    public class DeleteInstanceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
