...
namespace Temboo.Library.Twilio.OutgoingCallerIDs
{
    ...
    /// </summary>
    public class DeleteCallerID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteCallerID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteCallerID(TembooSession session) : base(session, "/Library/Twilio/OutgoingCallerIDs/DeleteCallerID")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteCallerIDResultSet containing execution metadata and results.</returns>
        new public DeleteCallerIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteCallerIDResultSet results = new JavaScriptSerializer().Deserialize<DeleteCallerIDResultSet>(json);
    ...
    /// </summary>
    public class DeleteCallerIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
