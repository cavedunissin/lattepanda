...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class ReorderLists : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReorderLists Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReorderLists(TembooSession session) : base(session, "/Library/Basecamp/ReorderLists")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the FirstListID input for this Choreo.</param>
         public void setFirstListID(String value) {
             base.addInput ("FirstListID", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the SecondListID input for this Choreo.</param>
         public void setSecondListID(String value) {
             base.addInput ("SecondListID", value);
         }
         /// <summary>
         /// (optional, integer) The ID number for the project's third To-Do list.
         /// </summary>
         /// <param name="value">Value of the ThirdListID input for this Choreo.</param>
         public void setThirdListID(String value) {
             base.addInput ("ThirdListID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ReorderListsResultSet containing execution metadata and results.</returns>
        new public ReorderListsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReorderListsResultSet results = new JavaScriptSerializer().Deserialize<ReorderListsResultSet>(json);
    ...
    /// </summary>
    public class ReorderListsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
