...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class CreateFriendship : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateFriendship Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateFriendship(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/CreateFriendship")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Follow input for this Choreo.</param>
         public void setFollow(String value) {
             base.addInput ("Follow", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreateFriendshipResultSet containing execution metadata and results.</returns>
        new public CreateFriendshipResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateFriendshipResultSet results = new JavaScriptSerializer().Deserialize<CreateFriendshipResultSet>(json);
    ...
    /// </summary>
    public class CreateFriendshipResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
