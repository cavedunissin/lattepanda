...
namespace Temboo.Library.Google.ComputeEngine.RegionOperations
{
    ...
    /// </summary>
    public class ListRegionOperations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRegionOperations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRegionOperations(TembooSession session) : base(session, "/Library/Google/ComputeEngine/RegionOperations/ListRegionOperations")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRegionOperationsResultSet containing execution metadata and results.</returns>
        new public ListRegionOperationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRegionOperationsResultSet results = new JavaScriptSerializer().Deserialize<ListRegionOperationsResultSet>(json);
    ...
    /// </summary>
    public class ListRegionOperationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
