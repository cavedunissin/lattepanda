...
namespace Temboo.Library.SendGrid.WebAPI.Profile
{
    ...
    /// </summary>
    public class UpdateContactProfileEmailAddress : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateContactProfileEmailAddress Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateContactProfileEmailAddress(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Profile/UpdateContactProfileEmailAddress")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the NewEmailAddress input for this Choreo.</param>
         public void setNewEmailAddress(String value) {
             base.addInput ("NewEmailAddress", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateContactProfileEmailAddressResultSet containing execution metadata and results.</returns>
        new public UpdateContactProfileEmailAddressResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateContactProfileEmailAddressResultSet results = new JavaScriptSerializer().Deserialize<UpdateContactProfileEmailAddressResultSet>(json);
    ...
    /// </summary>
    public class UpdateContactProfileEmailAddressResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
