...
namespace Temboo.Library.GitHub.ReposAPI.Comments
{
    ...
    /// </summary>
    public class GetCommitComment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCommitComment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCommitComment(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Comments/GetCommitComment")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCommitCommentResultSet containing execution metadata and results.</returns>
        new public GetCommitCommentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCommitCommentResultSet results = new JavaScriptSerializer().Deserialize<GetCommitCommentResultSet>(json);
    ...
    /// </summary>
    public class GetCommitCommentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
