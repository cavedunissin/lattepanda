...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class DeleteActivityLog : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteActivityLog Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteActivityLog(TembooSession session) : base(session, "/Library/Fitbit/Activities/DeleteActivityLog")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ActivityLogID input for this Choreo.</param>
         public void setActivityLogID(String value) {
             base.addInput ("ActivityLogID", value);
         }
         /// <summary>
         /// (required, string) Deprecated (retained for backward compatibility only).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A DeleteActivityLogResultSet containing execution metadata and results.</returns>
        new public DeleteActivityLogResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteActivityLogResultSet results = new JavaScriptSerializer().Deserialize<DeleteActivityLogResultSet>(json);
    ...
    /// </summary>
    public class DeleteActivityLogResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
