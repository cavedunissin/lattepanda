...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class DeleteFavoriteFood : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteFavoriteFood Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteFavoriteFood(TembooSession session) : base(session, "/Library/Fitbit/Foods/DeleteFavoriteFood")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteFavoriteFoodResultSet containing execution metadata and results.</returns>
        new public DeleteFavoriteFoodResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteFavoriteFoodResultSet results = new JavaScriptSerializer().Deserialize<DeleteFavoriteFoodResultSet>(json);
    ...
    /// </summary>
    public class DeleteFavoriteFoodResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
