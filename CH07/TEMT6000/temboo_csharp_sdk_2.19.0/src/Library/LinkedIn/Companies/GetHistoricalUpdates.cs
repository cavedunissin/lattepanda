...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class GetHistoricalUpdates : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetHistoricalUpdates Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetHistoricalUpdates(TembooSession session) : base(session, "/Library/LinkedIn/Companies/GetHistoricalUpdates")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the UpdateKey input for this Choreo.</param>
         public void setUpdateKey(String value) {
             base.addInput ("UpdateKey", value);
         }
        ...
        /// </summary>
        /// <returns>A GetHistoricalUpdatesResultSet containing execution metadata and results.</returns>
        new public GetHistoricalUpdatesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetHistoricalUpdatesResultSet results = new JavaScriptSerializer().Deserialize<GetHistoricalUpdatesResultSet>(json);
    ...
    /// </summary>
    public class GetHistoricalUpdatesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
