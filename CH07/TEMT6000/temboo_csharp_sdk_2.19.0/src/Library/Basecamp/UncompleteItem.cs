...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class UncompleteItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UncompleteItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UncompleteItem(TembooSession session) : base(session, "/Library/Basecamp/UncompleteItem")
        {
        }
        ...
        /// </summary>
        /// <returns>A UncompleteItemResultSet containing execution metadata and results.</returns>
        new public UncompleteItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UncompleteItemResultSet results = new JavaScriptSerializer().Deserialize<UncompleteItemResultSet>(json);
    ...
    /// </summary>
    public class UncompleteItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Response" output from this Choreo execution
        /// <returns>String - There is no structrued response from uncomplete item requests.</returns>
        /// </summary>
