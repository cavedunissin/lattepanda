...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class GetBodyFat : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBodyFat Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBodyFat(TembooSession session) : base(session, "/Library/Fitbit/Body/GetBodyFat")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBodyFatResultSet containing execution metadata and results.</returns>
        new public GetBodyFatResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBodyFatResultSet results = new JavaScriptSerializer().Deserialize<GetBodyFatResultSet>(json);
    ...
    /// </summary>
    public class GetBodyFatResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
