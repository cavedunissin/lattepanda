...
namespace Temboo.Library.Amazon.CloudDrive.Account
{
    ...
    /// </summary>
    public class GetQuota : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetQuota Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetQuota(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Account/GetQuota")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetQuotaResultSet containing execution metadata and results.</returns>
        new public GetQuotaResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetQuotaResultSet results = new JavaScriptSerializer().Deserialize<GetQuotaResultSet>(json);
    ...
    /// </summary>
    public class GetQuotaResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
