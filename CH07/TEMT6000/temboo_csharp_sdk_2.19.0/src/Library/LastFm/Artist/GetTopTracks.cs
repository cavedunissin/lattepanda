...
namespace Temboo.Library.LastFm.Artist
{
    ...
    /// </summary>
    public class GetTopTracks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTopTracks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTopTracks(TembooSession session) : base(session, "/Library/LastFm/Artist/GetTopTracks")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTopTracksResultSet containing execution metadata and results.</returns>
        new public GetTopTracksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTopTracksResultSet results = new JavaScriptSerializer().Deserialize<GetTopTracksResultSet>(json);
    ...
    /// </summary>
    public class GetTopTracksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
