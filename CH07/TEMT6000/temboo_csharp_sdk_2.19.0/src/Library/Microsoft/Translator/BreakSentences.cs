...
namespace Temboo.Library.Microsoft.Translator
{
    ...
    /// </summary>
    public class BreakSentences : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the BreakSentences Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public BreakSentences(TembooSession session) : base(session, "/Library/Microsoft/Translator/BreakSentences")
        {
        }
        ...
        /// </summary>
        /// <returns>A BreakSentencesResultSet containing execution metadata and results.</returns>
        new public BreakSentencesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BreakSentencesResultSet results = new JavaScriptSerializer().Deserialize<BreakSentencesResultSet>(json);
    ...
    /// </summary>
    public class BreakSentencesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
