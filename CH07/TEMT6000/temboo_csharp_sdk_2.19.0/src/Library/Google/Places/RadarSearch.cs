...
namespace Temboo.Library.Google.Places
{
    ...
    /// </summary>
    public class RadarSearch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RadarSearch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RadarSearch(TembooSession session) : base(session, "/Library/Google/Places/RadarSearch")
        {
        }
         ...
         /// <summary>
         /// (required, integer) Specify the radius in meters for which Places results will be returned. Maximum radius is limited to 50,000 meters.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) Filter results by types, such as: bar, dentist.  Multiple types must be separated by the pipe ("|") symbol: bar|dentist|airport.   At least one of Keyword, Name or Types must be specified.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A RadarSearchResultSet containing execution metadata and results.</returns>
        new public RadarSearchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RadarSearchResultSet results = new JavaScriptSerializer().Deserialize<RadarSearchResultSet>(json);
    ...
    /// </summary>
    public class RadarSearchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
