...
namespace Temboo.Library.Microsoft.Excel.Table
{
    ...
    /// </summary>
    public class ListRows : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRows Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRows(TembooSession session) : base(session, "/Library/Microsoft/Excel/Table/ListRows")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRowsResultSet containing execution metadata and results.</returns>
        new public ListRowsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRowsResultSet results = new JavaScriptSerializer().Deserialize<ListRowsResultSet>(json);
    ...
    /// </summary>
    public class ListRowsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
