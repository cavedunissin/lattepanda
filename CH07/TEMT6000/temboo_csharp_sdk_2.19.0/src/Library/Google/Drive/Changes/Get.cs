...
namespace Temboo.Library.Google.Drive.Changes
{
    ...
    public class Get : Temboo.Core.Choreography
    {
        ...
        public Get(TembooSession session) : base(session, "/Library/Google/Drive/Changes/Get")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ChangeID input for this Choreo.</param>
         public void setChangeID(String value) {
             base.addInput ("ChangeID", value);
         }
         /// <summary>
