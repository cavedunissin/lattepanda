...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetFoodUnits : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFoodUnits Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFoodUnits(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetFoodUnits")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFoodUnitsResultSet containing execution metadata and results.</returns>
        new public GetFoodUnitsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFoodUnitsResultSet results = new JavaScriptSerializer().Deserialize<GetFoodUnitsResultSet>(json);
    ...
    /// </summary>
    public class GetFoodUnitsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
