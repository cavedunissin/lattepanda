...
namespace Temboo.Library.GitHub.ReposAPI.Collaborators
{
    ...
    /// </summary>
    public class RemoveCollaborator : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RemoveCollaborator Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RemoveCollaborator(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Collaborators/RemoveCollaborator")
        {
        }
        ...
        /// </summary>
        /// <returns>A RemoveCollaboratorResultSet containing execution metadata and results.</returns>
        new public RemoveCollaboratorResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RemoveCollaboratorResultSet results = new JavaScriptSerializer().Deserialize<RemoveCollaboratorResultSet>(json);
    ...
    /// </summary>
    public class RemoveCollaboratorResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
