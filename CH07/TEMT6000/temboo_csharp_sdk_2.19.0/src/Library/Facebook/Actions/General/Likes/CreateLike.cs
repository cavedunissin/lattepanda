...
namespace Temboo.Library.Facebook.Actions.General.Likes
{
    ...
    /// </summary>
    public class CreateLike : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateLike Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateLike(TembooSession session) : base(session, "/Library/Facebook/Actions/General/Likes/CreateLike")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateLikeResultSet containing execution metadata and results.</returns>
        new public CreateLikeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateLikeResultSet results = new JavaScriptSerializer().Deserialize<CreateLikeResultSet>(json);
    ...
    /// </summary>
    public class CreateLikeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
