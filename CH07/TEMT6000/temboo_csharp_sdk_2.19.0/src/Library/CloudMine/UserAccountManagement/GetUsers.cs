...
namespace Temboo.Library.CloudMine.UserAccountManagement
{
    ...
    /// </summary>
    public class GetUsers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUsers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUsers(TembooSession session) : base(session, "/Library/CloudMine/UserAccountManagement/GetUsers")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUsersResultSet containing execution metadata and results.</returns>
        new public GetUsersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUsersResultSet results = new JavaScriptSerializer().Deserialize<GetUsersResultSet>(json);
    ...
    /// </summary>
    public class GetUsersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
