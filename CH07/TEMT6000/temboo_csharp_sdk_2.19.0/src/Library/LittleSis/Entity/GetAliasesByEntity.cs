...
namespace Temboo.Library.LittleSis.Entity
{
    ...
    /// </summary>
    public class GetAliasesByEntity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAliasesByEntity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAliasesByEntity(TembooSession session) : base(session, "/Library/LittleSis/Entity/GetAliasesByEntity")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAliasesByEntityResultSet containing execution metadata and results.</returns>
        new public GetAliasesByEntityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAliasesByEntityResultSet results = new JavaScriptSerializer().Deserialize<GetAliasesByEntityResultSet>(json);
    ...
    /// </summary>
    public class GetAliasesByEntityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
