...
namespace Temboo.Library.Zendesk.UserIdentities
{
    ...
    /// </summary>
    public class ListUserIdentities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListUserIdentities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListUserIdentities(TembooSession session) : base(session, "/Library/Zendesk/UserIdentities/ListUserIdentities")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListUserIdentitiesResultSet containing execution metadata and results.</returns>
        new public ListUserIdentitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListUserIdentitiesResultSet results = new JavaScriptSerializer().Deserialize<ListUserIdentitiesResultSet>(json);
    ...
    /// </summary>
    public class ListUserIdentitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
