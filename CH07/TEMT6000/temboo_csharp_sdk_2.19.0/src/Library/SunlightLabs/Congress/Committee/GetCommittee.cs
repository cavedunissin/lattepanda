...
namespace Temboo.Library.SunlightLabs.Congress.Committee
{
    ...
    /// </summary>
    public class GetCommittee : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCommittee Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCommittee(TembooSession session) : base(session, "/Library/SunlightLabs/Congress/Committee/GetCommittee")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCommitteeResultSet containing execution metadata and results.</returns>
        new public GetCommitteeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCommitteeResultSet results = new JavaScriptSerializer().Deserialize<GetCommitteeResultSet>(json);
    ...
    /// </summary>
    public class GetCommitteeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
