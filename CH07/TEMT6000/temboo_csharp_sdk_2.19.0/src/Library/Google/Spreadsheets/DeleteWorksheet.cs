...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class DeleteWorksheet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteWorksheet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteWorksheet(TembooSession session) : base(session, "/Library/Google/Spreadsheets/DeleteWorksheet")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteWorksheetResultSet containing execution metadata and results.</returns>
        new public DeleteWorksheetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteWorksheetResultSet results = new JavaScriptSerializer().Deserialize<DeleteWorksheetResultSet>(json);
    ...
    /// </summary>
    public class DeleteWorksheetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
