...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class CurrentPerson : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CurrentPerson Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CurrentPerson(TembooSession session) : base(session, "/Library/Basecamp/CurrentPerson")
        {
        }
        ...
        /// </summary>
        /// <returns>A CurrentPersonResultSet containing execution metadata and results.</returns>
        new public CurrentPersonResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CurrentPersonResultSet results = new JavaScriptSerializer().Deserialize<CurrentPersonResultSet>(json);
    ...
    /// </summary>
    public class CurrentPersonResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
