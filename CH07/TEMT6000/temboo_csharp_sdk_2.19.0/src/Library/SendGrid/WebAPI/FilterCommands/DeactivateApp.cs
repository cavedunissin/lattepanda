...
namespace Temboo.Library.SendGrid.WebAPI.FilterCommands
{
    ...
    /// Deactivate an app.
    /// </summary>
    public class DeactivateApp : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeactivateApp Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeactivateApp(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/FilterCommands/DeactivateApp")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeactivateAppResultSet containing execution metadata and results.</returns>
        new public DeactivateAppResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeactivateAppResultSet results = new JavaScriptSerializer().Deserialize<DeactivateAppResultSet>(json);
    ...
    /// </summary>
    public class DeactivateAppResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
