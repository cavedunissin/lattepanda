...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class DenyFriendRequest : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DenyFriendRequest Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DenyFriendRequest(TembooSession session) : base(session, "/Library/Foursquare/Users/DenyFriendRequest")
        {
        }
        ...
        /// </summary>
        /// <returns>A DenyFriendRequestResultSet containing execution metadata and results.</returns>
        new public DenyFriendRequestResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DenyFriendRequestResultSet results = new JavaScriptSerializer().Deserialize<DenyFriendRequestResultSet>(json);
    ...
    /// </summary>
    public class DenyFriendRequestResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
