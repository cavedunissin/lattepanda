...
namespace Temboo.Library.Twilio.ShortCodes
{
    ...
    /// </summary>
    public class ListShortCodes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListShortCodes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListShortCodes(TembooSession session) : base(session, "/Library/Twilio/ShortCodes/ListShortCodes")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ShortCode input for this Choreo.</param>
         public void setShortCode(String value) {
             base.addInput ("ShortCode", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ListShortCodesResultSet containing execution metadata and results.</returns>
        new public ListShortCodesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListShortCodesResultSet results = new JavaScriptSerializer().Deserialize<ListShortCodesResultSet>(json);
    ...
    /// </summary>
    public class ListShortCodesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
