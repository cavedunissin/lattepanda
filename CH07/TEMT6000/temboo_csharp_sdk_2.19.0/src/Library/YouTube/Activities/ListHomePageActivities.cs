...
namespace Temboo.Library.YouTube.Activities
{
    ...
    /// </summary>
    public class ListHomePageActivities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListHomePageActivities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListHomePageActivities(TembooSession session) : base(session, "/Library/YouTube/Activities/ListHomePageActivities")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListHomePageActivitiesResultSet containing execution metadata and results.</returns>
        new public ListHomePageActivitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListHomePageActivitiesResultSet results = new JavaScriptSerializer().Deserialize<ListHomePageActivitiesResultSet>(json);
    ...
    /// </summary>
    public class ListHomePageActivitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
