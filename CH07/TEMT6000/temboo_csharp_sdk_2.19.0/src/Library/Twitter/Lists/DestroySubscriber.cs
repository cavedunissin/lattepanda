...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class DestroySubscriber : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DestroySubscriber Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DestroySubscriber(TembooSession session) : base(session, "/Library/Twitter/Lists/DestroySubscriber")
        {
        }
        ...
        /// </summary>
        /// <returns>A DestroySubscriberResultSet containing execution metadata and results.</returns>
        new public DestroySubscriberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DestroySubscriberResultSet results = new JavaScriptSerializer().Deserialize<DestroySubscriberResultSet>(json);
    ...
    /// </summary>
    public class DestroySubscriberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
