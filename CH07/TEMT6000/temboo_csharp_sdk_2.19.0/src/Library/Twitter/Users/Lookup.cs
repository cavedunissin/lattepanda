...
namespace Temboo.Library.Twitter.Users
{
    ...
    /// </summary>
    public class Lookup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Lookup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Lookup(TembooSession session) : base(session, "/Library/Twitter/Users/Lookup")
        {
        }
        ...
        /// </summary>
        /// <returns>A LookupResultSet containing execution metadata and results.</returns>
        new public LookupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LookupResultSet results = new JavaScriptSerializer().Deserialize<LookupResultSet>(json);
    ...
    /// </summary>
    public class LookupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
