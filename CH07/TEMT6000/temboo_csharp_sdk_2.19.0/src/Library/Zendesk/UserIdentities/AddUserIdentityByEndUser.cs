...
namespace Temboo.Library.Zendesk.UserIdentities
{
    ...
    /// </summary>
    public class AddUserIdentityByEndUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddUserIdentityByEndUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddUserIdentityByEndUser(TembooSession session) : base(session, "/Library/Zendesk/UserIdentities/AddUserIdentityByEndUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddUserIdentityByEndUserResultSet containing execution metadata and results.</returns>
        new public AddUserIdentityByEndUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddUserIdentityByEndUserResultSet results = new JavaScriptSerializer().Deserialize<AddUserIdentityByEndUserResultSet>(json);
    ...
    /// </summary>
    public class AddUserIdentityByEndUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
