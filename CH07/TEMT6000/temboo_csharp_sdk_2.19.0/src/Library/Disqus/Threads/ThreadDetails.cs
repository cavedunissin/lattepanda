...
namespace Temboo.Library.Disqus.Threads
{
    ...
    /// </summary>
    public class ThreadDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ThreadDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ThreadDetails(TembooSession session) : base(session, "/Library/Disqus/Threads/ThreadDetails")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Indicates the relations to include with your response.  Valid entries include: author, category, or forum.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A ThreadDetailsResultSet containing execution metadata and results.</returns>
        new public ThreadDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ThreadDetailsResultSet results = new JavaScriptSerializer().Deserialize<ThreadDetailsResultSet>(json);
    ...
    /// </summary>
    public class ThreadDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
