...
namespace Temboo.Library.Flickr.Favorites
{
    ...
    /// </summary>
    public class RemoveFromFavorites : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RemoveFromFavorites Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RemoveFromFavorites(TembooSession session) : base(session, "/Library/Flickr/Favorites/RemoveFromFavorites")
        {
        }
        ...
        /// </summary>
        /// <returns>A RemoveFromFavoritesResultSet containing execution metadata and results.</returns>
        new public RemoveFromFavoritesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RemoveFromFavoritesResultSet results = new JavaScriptSerializer().Deserialize<RemoveFromFavoritesResultSet>(json);
    ...
    /// </summary>
    public class RemoveFromFavoritesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
