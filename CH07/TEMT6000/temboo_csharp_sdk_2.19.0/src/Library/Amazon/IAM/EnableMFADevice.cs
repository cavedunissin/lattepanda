...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class EnableMFADevice : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EnableMFADevice Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EnableMFADevice(TembooSession session) : base(session, "/Library/Amazon/IAM/EnableMFADevice")
        {
        }
        ...
        /// </summary>
        /// <returns>A EnableMFADeviceResultSet containing execution metadata and results.</returns>
        new public EnableMFADeviceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EnableMFADeviceResultSet results = new JavaScriptSerializer().Deserialize<EnableMFADeviceResultSet>(json);
    ...
    /// </summary>
    public class EnableMFADeviceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
