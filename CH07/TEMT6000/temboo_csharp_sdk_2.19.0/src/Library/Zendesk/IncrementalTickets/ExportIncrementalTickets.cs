...
namespace Temboo.Library.Zendesk.IncrementalTickets
{
    /// <summary>
    /// ExportIncrementalTickets
    /// Returns a lightweight representation of what changed in the ticket "since you last asked".
    /// </summary>
    public class ExportIncrementalTickets : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ExportIncrementalTickets Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ExportIncrementalTickets(TembooSession session) : base(session, "/Library/Zendesk/IncrementalTickets/ExportIncrementalTickets")
        {
        }
        ...
        /// </summary>
        /// <returns>A ExportIncrementalTicketsResultSet containing execution metadata and results.</returns>
        new public ExportIncrementalTicketsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ExportIncrementalTicketsResultSet results = new JavaScriptSerializer().Deserialize<ExportIncrementalTicketsResultSet>(json);
    ...
    /// </summary>
    public class ExportIncrementalTicketsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
