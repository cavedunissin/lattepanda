...
namespace Temboo.Library.Amazon.CloudDrive.Files
{
    ...
    /// </summary>
    public class ListFiles : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListFiles Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListFiles(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Files/ListFiles")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListFilesResultSet containing execution metadata and results.</returns>
        new public ListFilesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListFilesResultSet results = new JavaScriptSerializer().Deserialize<ListFilesResultSet>(json);
    ...
    /// </summary>
    public class ListFilesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
