...
namespace Temboo.Library.Facebook.Actions.General.Follows
{
    ...
    /// </summary>
    public class CreateFollow : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateFollow Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateFollow(TembooSession session) : base(session, "/Library/Facebook/Actions/General/Follows/CreateFollow")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateFollowResultSet containing execution metadata and results.</returns>
        new public CreateFollowResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateFollowResultSet results = new JavaScriptSerializer().Deserialize<CreateFollowResultSet>(json);
    ...
    /// </summary>
    public class CreateFollowResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
