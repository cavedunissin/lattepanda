...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class GetFavoriteActivities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFavoriteActivities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFavoriteActivities(TembooSession session) : base(session, "/Library/Fitbit/Activities/GetFavoriteActivities")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFavoriteActivitiesResultSet containing execution metadata and results.</returns>
        new public GetFavoriteActivitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFavoriteActivitiesResultSet results = new JavaScriptSerializer().Deserialize<GetFavoriteActivitiesResultSet>(json);
    ...
    /// </summary>
    public class GetFavoriteActivitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
