...
namespace Temboo.Library.KhanAcademy.Badges
{
    ...
    /// </summary>
    public class GetBadges : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBadges Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBadges(TembooSession session) : base(session, "/Library/KhanAcademy/Badges/GetBadges")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBadgesResultSet containing execution metadata and results.</returns>
        new public GetBadgesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBadgesResultSet results = new JavaScriptSerializer().Deserialize<GetBadgesResultSet>(json);
    ...
    /// </summary>
    public class GetBadgesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
