...
namespace Temboo.Library.Amazon.CloudDrive.Trash
{
    /// <summary>
    /// AddToTrash
    /// Uses the Amazon Cloud Drive API to move a specific file or folder to the trash.
    /// </summary>
    public class AddToTrash : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddToTrash Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddToTrash(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Trash/AddToTrash")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddToTrashResultSet containing execution metadata and results.</returns>
        new public AddToTrashResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddToTrashResultSet results = new JavaScriptSerializer().Deserialize<AddToTrashResultSet>(json);
    ...
    /// </summary>
    public class AddToTrashResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
