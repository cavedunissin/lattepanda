...
namespace Temboo.Library.Disqus.Posts
{
    ...
    /// </summary>
    public class VoteOnPost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VoteOnPost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VoteOnPost(TembooSession session) : base(session, "/Library/Disqus/Posts/VoteOnPost")
        {
        }
        ...
        /// </summary>
        /// <returns>A VoteOnPostResultSet containing execution metadata and results.</returns>
        new public VoteOnPostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VoteOnPostResultSet results = new JavaScriptSerializer().Deserialize<VoteOnPostResultSet>(json);
    ...
    /// </summary>
    public class VoteOnPostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
