...
namespace Temboo.Library.Google.ComputeEngine.Zones
{
    ...
    /// </summary>
    public class GetZone : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetZone Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetZone(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Zones/GetZone")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetZoneResultSet containing execution metadata and results.</returns>
        new public GetZoneResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetZoneResultSet results = new JavaScriptSerializer().Deserialize<GetZoneResultSet>(json);
    ...
    /// </summary>
    public class GetZoneResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
