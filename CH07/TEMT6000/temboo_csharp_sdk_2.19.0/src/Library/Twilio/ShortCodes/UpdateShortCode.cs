...
namespace Temboo.Library.Twilio.ShortCodes
{
    /// <summary>
    /// UpdateShortCode
    /// Attempts to update an existing short code resource.
    /// </summary>
    public class UpdateShortCode : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateShortCode Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateShortCode(TembooSession session) : base(session, "/Library/Twilio/ShortCodes/UpdateShortCode")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ShortCodeSID input for this Choreo.</param>
         public void setShortCodeSID(String value) {
             base.addInput ("ShortCodeSID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateShortCodeResultSet containing execution metadata and results.</returns>
        new public UpdateShortCodeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateShortCodeResultSet results = new JavaScriptSerializer().Deserialize<UpdateShortCodeResultSet>(json);
    ...
    /// </summary>
    public class UpdateShortCodeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
