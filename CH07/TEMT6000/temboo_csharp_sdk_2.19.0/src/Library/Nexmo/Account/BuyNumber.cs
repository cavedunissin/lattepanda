...
namespace Temboo.Library.Nexmo.Account
{
    ...
    /// </summary>
    public class BuyNumber : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the BuyNumber Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public BuyNumber(TembooSession session) : base(session, "/Library/Nexmo/Account/BuyNumber")
        {
        }
        ...
        /// </summary>
        /// <returns>A BuyNumberResultSet containing execution metadata and results.</returns>
        new public BuyNumberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BuyNumberResultSet results = new JavaScriptSerializer().Deserialize<BuyNumberResultSet>(json);
    ...
    /// </summary>
    public class BuyNumberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
