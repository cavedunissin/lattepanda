...
namespace Temboo.Library.Bitly.LinkMetrics
{
    ...
    /// </summary>
    public class GetClicksForLink : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetClicksForLink Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetClicksForLink(TembooSession session) : base(session, "/Library/Bitly/LinkMetrics/GetClicksForLink")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetClicksForLinkResultSet containing execution metadata and results.</returns>
        new public GetClicksForLinkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetClicksForLinkResultSet results = new JavaScriptSerializer().Deserialize<GetClicksForLinkResultSet>(json);
    ...
    /// </summary>
    public class GetClicksForLinkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
