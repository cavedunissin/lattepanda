...
namespace Temboo.Library.Wordnik.Word
{
    ...
    /// </summary>
    public class GetDefinitions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetDefinitions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetDefinitions(TembooSession session) : base(session, "/Library/Wordnik/Word/GetDefinitions")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Dictionaries input for this Choreo.</param>
         public void setDictionaries(String value) {
             base.addInput ("Dictionaries", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the PartOfSpeech input for this Choreo.</param>
         public void setPartOfSpeech(String value) {
             base.addInput ("PartOfSpeech", value);
         }
         /// <summary>
         /// (optional, string) Returns related words with definitions when true. Defaults to false.
         /// </summary>
         /// <param name="value">Value of the RelatedWords input for this Choreo.</param>
         public void setRelatedWords(String value) {
             base.addInput ("RelatedWords", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetDefinitionsResultSet containing execution metadata and results.</returns>
        new public GetDefinitionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetDefinitionsResultSet results = new JavaScriptSerializer().Deserialize<GetDefinitionsResultSet>(json);
    ...
    /// </summary>
    public class GetDefinitionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
