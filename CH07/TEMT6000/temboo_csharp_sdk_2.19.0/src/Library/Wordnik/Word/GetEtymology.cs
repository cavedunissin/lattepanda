...
namespace Temboo.Library.Wordnik.Word
{
    ...
    /// </summary>
    public class GetEtymology : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEtymology Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEtymology(TembooSession session) : base(session, "/Library/Wordnik/Word/GetEtymology")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetEtymologyResultSet containing execution metadata and results.</returns>
        new public GetEtymologyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEtymologyResultSet results = new JavaScriptSerializer().Deserialize<GetEtymologyResultSet>(json);
    ...
    /// </summary>
    public class GetEtymologyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
