...
namespace Temboo.Library.Twilio.Accounts
{
    ...
    /// </summary>
    public class GetAccount : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAccount Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAccount(TembooSession session) : base(session, "/Library/Twilio/Accounts/GetAccount")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAccountResultSet containing execution metadata and results.</returns>
        new public GetAccountResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAccountResultSet results = new JavaScriptSerializer().Deserialize<GetAccountResultSet>(json);
    ...
    /// </summary>
    public class GetAccountResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
