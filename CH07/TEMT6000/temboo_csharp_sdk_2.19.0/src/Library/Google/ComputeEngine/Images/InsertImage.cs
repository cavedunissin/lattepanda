...
namespace Temboo.Library.Google.ComputeEngine.Images
{
    /// <summary>
    /// InsertImage
    /// Creates a new custom Image resource in the specified project.
    /// </summary>
    public class InsertImage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the InsertImage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public InsertImage(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Images/InsertImage")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ImageResource input for this Choreo.</param>
         public void setImageResource(String value) {
             base.addInput ("ImageResource", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the RawDiskSource input for this Choreo.</param>
         public void setRawDiskSource(String value) {
             base.addInput ("RawDiskSource", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A InsertImageResultSet containing execution metadata and results.</returns>
        new public InsertImageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InsertImageResultSet results = new JavaScriptSerializer().Deserialize<InsertImageResultSet>(json);
    ...
    /// </summary>
    public class InsertImageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
