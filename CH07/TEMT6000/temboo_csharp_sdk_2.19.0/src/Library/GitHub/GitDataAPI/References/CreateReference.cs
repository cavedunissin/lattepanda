...
namespace Temboo.Library.GitHub.GitDataAPI.References
{
    ...
    /// </summary>
    public class CreateReference : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateReference Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateReference(TembooSession session) : base(session, "/Library/GitHub/GitDataAPI/References/CreateReference")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateReferenceResultSet containing execution metadata and results.</returns>
        new public CreateReferenceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateReferenceResultSet results = new JavaScriptSerializer().Deserialize<CreateReferenceResultSet>(json);
    ...
    /// </summary>
    public class CreateReferenceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
