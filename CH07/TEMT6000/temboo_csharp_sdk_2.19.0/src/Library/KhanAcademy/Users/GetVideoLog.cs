...
namespace Temboo.Library.KhanAcademy.Users
{
    ...
    /// </summary>
    public class GetVideoLog : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetVideoLog Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetVideoLog(TembooSession session) : base(session, "/Library/KhanAcademy/Users/GetVideoLog")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetVideoLogResultSet containing execution metadata and results.</returns>
        new public GetVideoLogResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetVideoLogResultSet results = new JavaScriptSerializer().Deserialize<GetVideoLogResultSet>(json);
    ...
    /// </summary>
    public class GetVideoLogResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
