...
namespace Temboo.Library.Google.Calendar
{
    ...
    /// </summary>
    public class CreateCalendar : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateCalendar Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateCalendar(TembooSession session) : base(session, "/Library/Google/Calendar/CreateCalendar")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateCalendarResultSet containing execution metadata and results.</returns>
        new public CreateCalendarResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateCalendarResultSet results = new JavaScriptSerializer().Deserialize<CreateCalendarResultSet>(json);
    ...
    /// </summary>
    public class CreateCalendarResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
