...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class EditPhotoPostWithURL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EditPhotoPostWithURL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EditPhotoPostWithURL(TembooSession session) : base(session, "/Library/Tumblr/Post/EditPhotoPostWithURL")
        {
        }
        ...
        /// </summary>
        /// <returns>A EditPhotoPostWithURLResultSet containing execution metadata and results.</returns>
        new public EditPhotoPostWithURLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EditPhotoPostWithURLResultSet results = new JavaScriptSerializer().Deserialize<EditPhotoPostWithURLResultSet>(json);
    ...
    /// </summary>
    public class EditPhotoPostWithURLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
