...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetWeeklyAlbumChart : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetWeeklyAlbumChart Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetWeeklyAlbumChart(TembooSession session) : base(session, "/Library/LastFm/User/GetWeeklyAlbumChart")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetWeeklyAlbumChartResultSet containing execution metadata and results.</returns>
        new public GetWeeklyAlbumChartResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetWeeklyAlbumChartResultSet results = new JavaScriptSerializer().Deserialize<GetWeeklyAlbumChartResultSet>(json);
    ...
    /// </summary>
    public class GetWeeklyAlbumChartResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
