...
namespace Temboo.Library.YouTube.Activities
{
    ...
    /// </summary>
    public class ListActivitiesByChannel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListActivitiesByChannel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListActivitiesByChannel(TembooSession session) : base(session, "/Library/YouTube/Activities/ListActivitiesByChannel")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListActivitiesByChannelResultSet containing execution metadata and results.</returns>
        new public ListActivitiesByChannelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListActivitiesByChannelResultSet results = new JavaScriptSerializer().Deserialize<ListActivitiesByChannelResultSet>(json);
    ...
    /// </summary>
    public class ListActivitiesByChannelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
