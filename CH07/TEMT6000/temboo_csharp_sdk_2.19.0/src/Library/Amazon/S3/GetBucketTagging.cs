...
namespace Temboo.Library.Amazon.S3
{
    ...
    /// </summary>
    public class GetBucketTagging : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBucketTagging Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBucketTagging(TembooSession session) : base(session, "/Library/Amazon/S3/GetBucketTagging")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBucketTaggingResultSet containing execution metadata and results.</returns>
        new public GetBucketTaggingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBucketTaggingResultSet results = new JavaScriptSerializer().Deserialize<GetBucketTaggingResultSet>(json);
    ...
    /// </summary>
    public class GetBucketTaggingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
