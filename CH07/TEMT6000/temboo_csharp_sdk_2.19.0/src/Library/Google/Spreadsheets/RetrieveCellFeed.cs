...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class RetrieveCellFeed : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveCellFeed Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveCellFeed(TembooSession session) : base(session, "/Library/Google/Spreadsheets/RetrieveCellFeed")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveCellFeedResultSet containing execution metadata and results.</returns>
        new public RetrieveCellFeedResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveCellFeedResultSet results = new JavaScriptSerializer().Deserialize<RetrieveCellFeedResultSet>(json);
    ...
    /// </summary>
    public class RetrieveCellFeedResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
