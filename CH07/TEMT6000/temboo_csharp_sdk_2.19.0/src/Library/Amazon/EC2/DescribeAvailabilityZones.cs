...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DescribeAvailabilityZones : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DescribeAvailabilityZones Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DescribeAvailabilityZones(TembooSession session) : base(session, "/Library/Amazon/EC2/DescribeAvailabilityZones")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ZoneName input for this Choreo.</param>
         public void setZoneName(String value) {
             base.addInput ("ZoneName", value);
         }
        ...
        /// </summary>
        /// <returns>A DescribeAvailabilityZonesResultSet containing execution metadata and results.</returns>
        new public DescribeAvailabilityZonesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DescribeAvailabilityZonesResultSet results = new JavaScriptSerializer().Deserialize<DescribeAvailabilityZonesResultSet>(json);
    ...
    /// </summary>
    public class DescribeAvailabilityZonesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
