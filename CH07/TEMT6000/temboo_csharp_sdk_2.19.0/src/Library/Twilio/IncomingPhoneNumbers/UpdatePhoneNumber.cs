...
namespace Temboo.Library.Twilio.IncomingPhoneNumbers
{
    ...
    /// </summary>
    public class UpdatePhoneNumber : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdatePhoneNumber Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdatePhoneNumber(TembooSession session) : base(session, "/Library/Twilio/IncomingPhoneNumbers/UpdatePhoneNumber")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the IncomingPhoneNumberSID input for this Choreo.</param>
         public void setIncomingPhoneNumberSID(String value) {
             base.addInput ("IncomingPhoneNumberSID", value);
         }
         /// <summary>
         /// (optional, string) The unique 34 character id of the account to which you wish to transfer this phone number.
         /// </summary>
         /// <param name="value">Value of the NewAccountSID input for this Choreo.</param>
         public void setNewAccountSID(String value) {
             base.addInput ("NewAccountSID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdatePhoneNumberResultSet containing execution metadata and results.</returns>
        new public UpdatePhoneNumberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdatePhoneNumberResultSet results = new JavaScriptSerializer().Deserialize<UpdatePhoneNumberResultSet>(json);
    ...
    /// </summary>
    public class UpdatePhoneNumberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
