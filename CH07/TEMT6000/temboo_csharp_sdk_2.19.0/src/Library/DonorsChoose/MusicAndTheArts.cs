...
namespace Temboo.Library.DonorsChoose
{
    ...
    /// </summary>
    public class MusicAndTheArts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the MusicAndTheArts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public MusicAndTheArts(TembooSession session) : base(session, "/Library/DonorsChoose/MusicAndTheArts")
        {
        }
        ...
        /// </summary>
        /// <returns>A MusicAndTheArtsResultSet containing execution metadata and results.</returns>
        new public MusicAndTheArtsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MusicAndTheArtsResultSet results = new JavaScriptSerializer().Deserialize<MusicAndTheArtsResultSet>(json);
    ...
    /// </summary>
    public class MusicAndTheArtsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
