...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class ImportKeyPair : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ImportKeyPair Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ImportKeyPair(TembooSession session) : base(session, "/Library/Amazon/EC2/ImportKeyPair")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the PublicKeyMaterial input for this Choreo.</param>
         public void setPublicKeyMaterial(String value) {
             base.addInput ("PublicKeyMaterial", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ImportKeyPairResultSet containing execution metadata and results.</returns>
        new public ImportKeyPairResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ImportKeyPairResultSet results = new JavaScriptSerializer().Deserialize<ImportKeyPairResultSet>(json);
    ...
    /// </summary>
    public class ImportKeyPairResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
