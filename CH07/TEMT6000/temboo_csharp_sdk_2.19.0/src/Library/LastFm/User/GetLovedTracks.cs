...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetLovedTracks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLovedTracks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLovedTracks(TembooSession session) : base(session, "/Library/LastFm/User/GetLovedTracks")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLovedTracksResultSet containing execution metadata and results.</returns>
        new public GetLovedTracksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLovedTracksResultSet results = new JavaScriptSerializer().Deserialize<GetLovedTracksResultSet>(json);
    ...
    /// </summary>
    public class GetLovedTracksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
