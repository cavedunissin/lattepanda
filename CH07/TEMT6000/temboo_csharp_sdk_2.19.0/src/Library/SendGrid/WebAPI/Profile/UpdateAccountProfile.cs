...
namespace Temboo.Library.SendGrid.WebAPI.Profile
{
    ...
    /// </summary>
    public class UpdateAccountProfile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateAccountProfile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateAccountProfile(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Profile/UpdateAccountProfile")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateAccountProfileResultSet containing execution metadata and results.</returns>
        new public UpdateAccountProfileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateAccountProfileResultSet results = new JavaScriptSerializer().Deserialize<UpdateAccountProfileResultSet>(json);
    ...
    /// </summary>
    public class UpdateAccountProfileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
