...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class CompleteItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CompleteItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CompleteItem(TembooSession session) : base(session, "/Library/Basecamp/CompleteItem")
        {
        }
        ...
        /// </summary>
        /// <returns>A CompleteItemResultSet containing execution metadata and results.</returns>
        new public CompleteItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CompleteItemResultSet results = new JavaScriptSerializer().Deserialize<CompleteItemResultSet>(json);
    ...
    /// </summary>
    public class CompleteItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Response" output from this Choreo execution
        /// <returns>String - There is no structrued response from complete item requests.</returns>
        /// </summary>
