...
namespace Temboo.Library.Kiva.Lenders
{
    ...
    /// </summary>
    public class GetNewestLenders : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNewestLenders Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNewestLenders(TembooSession session) : base(session, "/Library/Kiva/Lenders/GetNewestLenders")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetNewestLendersResultSet containing execution metadata and results.</returns>
        new public GetNewestLendersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNewestLendersResultSet results = new JavaScriptSerializer().Deserialize<GetNewestLendersResultSet>(json);
    ...
    /// </summary>
    public class GetNewestLendersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
