...
namespace Temboo.Library.Dropbox.FileOperations
{
    ...
    public class CreateFolder : Temboo.Core.Choreography
    {
        ...
        public CreateFolder(TembooSession session) : base(session, "/Library/Dropbox/FileOperations/CreateFolder")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the NewFolderName input for this Choreo.</param>
         public void setNewFolderName(String value) {
             base.addInput ("NewFolderName", value);
         }
         /// <summary>
