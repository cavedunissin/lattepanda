...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class RetrieveListFeed : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveListFeed Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveListFeed(TembooSession session) : base(session, "/Library/Google/Spreadsheets/RetrieveListFeed")
        {
        }
         ...
         /// <summary>
         /// (required, string) The unique key of the spreadsheet associated with the feed you want to retrieve.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A RetrieveListFeedResultSet containing execution metadata and results.</returns>
        new public RetrieveListFeedResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveListFeedResultSet results = new JavaScriptSerializer().Deserialize<RetrieveListFeedResultSet>(json);
    ...
    /// </summary>
    public class RetrieveListFeedResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
