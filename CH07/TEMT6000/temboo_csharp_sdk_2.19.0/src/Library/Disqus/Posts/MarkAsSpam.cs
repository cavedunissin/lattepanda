...
namespace Temboo.Library.Disqus.Posts
{
    ...
    /// Mark a post as spam.
    /// </summary>
    public class MarkAsSpam : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the MarkAsSpam Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public MarkAsSpam(TembooSession session) : base(session, "/Library/Disqus/Posts/MarkAsSpam")
        {
        }
        ...
        /// </summary>
        /// <returns>A MarkAsSpamResultSet containing execution metadata and results.</returns>
        new public MarkAsSpamResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MarkAsSpamResultSet results = new JavaScriptSerializer().Deserialize<MarkAsSpamResultSet>(json);
    ...
    /// </summary>
    public class MarkAsSpamResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
