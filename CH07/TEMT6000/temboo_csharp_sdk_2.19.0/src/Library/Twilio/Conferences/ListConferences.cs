...
namespace Temboo.Library.Twilio.Conferences
{
    ...
    /// </summary>
    public class ListConferences : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListConferences Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListConferences(TembooSession session) : base(session, "/Library/Twilio/Conferences/ListConferences")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the DateCreated input for this Choreo.</param>
         public void setDateCreated(String value) {
             base.addInput ("DateCreated", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the DateUpdated input for this Choreo.</param>
         public void setDateUpdated(String value) {
             base.addInput ("DateUpdated", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ListConferencesResultSet containing execution metadata and results.</returns>
        new public ListConferencesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListConferencesResultSet results = new JavaScriptSerializer().Deserialize<ListConferencesResultSet>(json);
    ...
    /// </summary>
    public class ListConferencesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
