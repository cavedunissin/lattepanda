...
namespace Temboo.Library.YouTube.PlaylistItems
{
    ...
    /// </summary>
    public class ListItemsByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListItemsByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListItemsByID(TembooSession session) : base(session, "/Library/YouTube/PlaylistItems/ListItemsByID")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListItemsByIDResultSet containing execution metadata and results.</returns>
        new public ListItemsByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListItemsByIDResultSet results = new JavaScriptSerializer().Deserialize<ListItemsByIDResultSet>(json);
    ...
    /// </summary>
    public class ListItemsByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
