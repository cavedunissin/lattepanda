...
namespace Temboo.Library.Google.Sheets
{
    ...
    /// </summary>
    public class BatchUpdateValues : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the BatchUpdateValues Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public BatchUpdateValues(TembooSession session) : base(session, "/Library/Google/Sheets/BatchUpdateValues")
        {
        }
         ...
         /// <summary>
         /// (required, json) An array of JSON objects containing the ranges and values to update. See Choreo notes below for more details.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A BatchUpdateValuesResultSet containing execution metadata and results.</returns>
        new public BatchUpdateValuesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BatchUpdateValuesResultSet results = new JavaScriptSerializer().Deserialize<BatchUpdateValuesResultSet>(json);
    ...
    /// </summary>
    public class BatchUpdateValuesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
