...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class UncompleteEntry : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UncompleteEntry Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UncompleteEntry(TembooSession session) : base(session, "/Library/Basecamp/UncompleteEntry")
        {
        }
        ...
        /// </summary>
        /// <returns>A UncompleteEntryResultSet containing execution metadata and results.</returns>
        new public UncompleteEntryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UncompleteEntryResultSet results = new JavaScriptSerializer().Deserialize<UncompleteEntryResultSet>(json);
    ...
    /// </summary>
    public class UncompleteEntryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
