...
namespace Temboo.Library.Facebook.Actions.Books.Quotes
{
    ...
    /// </summary>
    public class CreateQuote : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateQuote Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateQuote(TembooSession session) : base(session, "/Library/Facebook/Actions/Books/Quotes/CreateQuote")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateQuoteResultSet containing execution metadata and results.</returns>
        new public CreateQuoteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateQuoteResultSet results = new JavaScriptSerializer().Deserialize<CreateQuoteResultSet>(json);
    ...
    /// </summary>
    public class CreateQuoteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
