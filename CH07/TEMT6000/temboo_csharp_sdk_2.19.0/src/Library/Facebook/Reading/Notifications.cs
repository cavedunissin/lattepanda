...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Notifications : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Notifications Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Notifications(TembooSession session) : base(session, "/Library/Facebook/Reading/Notifications")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The id of the profile to retrieve notifications for. Defaults to "me" indicating the authenticated user.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A NotificationsResultSet containing execution metadata and results.</returns>
        new public NotificationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            NotificationsResultSet results = new JavaScriptSerializer().Deserialize<NotificationsResultSet>(json);
    ...
    /// </summary>
    public class NotificationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
