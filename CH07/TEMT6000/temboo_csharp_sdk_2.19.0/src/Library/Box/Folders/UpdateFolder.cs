...
namespace Temboo.Library.Box.Folders
{
    ...
    /// </summary>
    public class UpdateFolder : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateFolder Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateFolder(TembooSession session) : base(session, "/Library/Box/Folders/UpdateFolder")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the FolderObject input for this Choreo.</param>
         public void setFolderObject(String value) {
             base.addInput ("FolderObject", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateFolderResultSet containing execution metadata and results.</returns>
        new public UpdateFolderResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateFolderResultSet results = new JavaScriptSerializer().Deserialize<UpdateFolderResultSet>(json);
    ...
    /// </summary>
    public class UpdateFolderResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
