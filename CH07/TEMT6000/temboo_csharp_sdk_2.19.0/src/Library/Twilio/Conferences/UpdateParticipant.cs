...
namespace Temboo.Library.Twilio.Conferences
{
    ...
    /// </summary>
    public class UpdateParticipant : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateParticipant Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateParticipant(TembooSession session) : base(session, "/Library/Twilio/Conferences/UpdateParticipant")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ConferenceSID input for this Choreo.</param>
         public void setConferenceSID(String value) {
             base.addInput ("ConferenceSID", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the Muted input for this Choreo.</param>
         public void setMuted(String value) {
             base.addInput ("Muted", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateParticipantResultSet containing execution metadata and results.</returns>
        new public UpdateParticipantResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateParticipantResultSet results = new JavaScriptSerializer().Deserialize<UpdateParticipantResultSet>(json);
    ...
    /// </summary>
    public class UpdateParticipantResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
