...
namespace Temboo.Library.Flickr.Tags
{
    ...
    /// </summary>
    public class ListPhotoTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListPhotoTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListPhotoTags(TembooSession session) : base(session, "/Library/Flickr/Tags/ListPhotoTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListPhotoTagsResultSet containing execution metadata and results.</returns>
        new public ListPhotoTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListPhotoTagsResultSet results = new JavaScriptSerializer().Deserialize<ListPhotoTagsResultSet>(json);
    ...
    /// </summary>
    public class ListPhotoTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
