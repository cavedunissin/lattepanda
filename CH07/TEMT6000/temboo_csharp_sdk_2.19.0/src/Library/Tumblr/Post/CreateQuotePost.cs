...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class CreateQuotePost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateQuotePost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateQuotePost(TembooSession session) : base(session, "/Library/Tumblr/Post/CreateQuotePost")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateQuotePostResultSet containing execution metadata and results.</returns>
        new public CreateQuotePostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateQuotePostResultSet results = new JavaScriptSerializer().Deserialize<CreateQuotePostResultSet>(json);
    ...
    /// </summary>
    public class CreateQuotePostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
