...
namespace Temboo.Library.Zendesk.Organizations
{
    ...
    /// </summary>
    public class GetOrganization : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetOrganization Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetOrganization(TembooSession session) : base(session, "/Library/Zendesk/Organizations/GetOrganization")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetOrganizationResultSet containing execution metadata and results.</returns>
        new public GetOrganizationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetOrganizationResultSet results = new JavaScriptSerializer().Deserialize<GetOrganizationResultSet>(json);
    ...
    /// </summary>
    public class GetOrganizationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
