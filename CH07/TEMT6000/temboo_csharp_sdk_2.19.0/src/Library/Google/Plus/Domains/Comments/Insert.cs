...
namespace Temboo.Library.Google.Plus.Domains.Comments
{
    /// <summary>
    /// Insert
    ...
    public class Insert : Temboo.Core.Choreography
    {
        ...
        public Insert(TembooSession session) : base(session, "/Library/Google/Plus/Domains/Comments/Insert")
        {
        }

         /// <summary>
         /// (optional, string) A JSON-formatted string containing the comment properties you wish to set. This can be used as an alternative to setting individual inputs representing resource properties.
         /// </summary>
         /// <param name="value">Value of the CommentResource input for this Choreo.</param>
         public void setCommentResource(String value) {
             base.addInput ("CommentResource", value);
         }
         /// <summary>
         ...
         /// <summary>
         /// (required, string) The ID of the activity to reply to.
         /// </summary>
