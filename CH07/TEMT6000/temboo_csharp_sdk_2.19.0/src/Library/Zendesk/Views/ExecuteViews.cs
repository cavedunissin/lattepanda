...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class ExecuteViews : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ExecuteViews Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ExecuteViews(TembooSession session) : base(session, "/Library/Zendesk/Views/ExecuteViews")
        {
        }
        ...
        /// </summary>
        /// <returns>A ExecuteViewsResultSet containing execution metadata and results.</returns>
        new public ExecuteViewsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ExecuteViewsResultSet results = new JavaScriptSerializer().Deserialize<ExecuteViewsResultSet>(json);
    ...
    /// </summary>
    public class ExecuteViewsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
