...
namespace Temboo.Library.Facebook.Actions.Video.Watches
{
    ...
    /// </summary>
    public class DeleteWatch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteWatch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteWatch(TembooSession session) : base(session, "/Library/Facebook/Actions/Video/Watches/DeleteWatch")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteWatchResultSet containing execution metadata and results.</returns>
        new public DeleteWatchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteWatchResultSet results = new JavaScriptSerializer().Deserialize<DeleteWatchResultSet>(json);
    ...
    /// </summary>
    public class DeleteWatchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
