...
namespace Temboo.Library.AuthorizeNet.CustomerInformationManager
{
    ...
    /// </summary>
    public class GetCustomerProfile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCustomerProfile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCustomerProfile(TembooSession session) : base(session, "/Library/AuthorizeNet/CustomerInformationManager/GetCustomerProfile")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCustomerProfileResultSet containing execution metadata and results.</returns>
        new public GetCustomerProfileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCustomerProfileResultSet results = new JavaScriptSerializer().Deserialize<GetCustomerProfileResultSet>(json);
    ...
    /// </summary>
    public class GetCustomerProfileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
