...
namespace Temboo.Library.Twilio.IncomingPhoneNumbers
{
    ...
    /// </summary>
    public class GetPhoneNumber : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPhoneNumber Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPhoneNumber(TembooSession session) : base(session, "/Library/Twilio/IncomingPhoneNumbers/GetPhoneNumber")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPhoneNumberResultSet containing execution metadata and results.</returns>
        new public GetPhoneNumberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPhoneNumberResultSet results = new JavaScriptSerializer().Deserialize<GetPhoneNumberResultSet>(json);
    ...
    /// </summary>
    public class GetPhoneNumberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
