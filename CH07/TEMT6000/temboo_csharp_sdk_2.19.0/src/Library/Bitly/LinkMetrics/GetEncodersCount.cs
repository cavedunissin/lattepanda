...
namespace Temboo.Library.Bitly.LinkMetrics
{
    ...
    /// </summary>
    public class GetEncodersCount : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEncodersCount Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEncodersCount(TembooSession session) : base(session, "/Library/Bitly/LinkMetrics/GetEncodersCount")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetEncodersCountResultSet containing execution metadata and results.</returns>
        new public GetEncodersCountResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEncodersCountResultSet results = new JavaScriptSerializer().Deserialize<GetEncodersCountResultSet>(json);
    ...
    /// </summary>
    public class GetEncodersCountResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
