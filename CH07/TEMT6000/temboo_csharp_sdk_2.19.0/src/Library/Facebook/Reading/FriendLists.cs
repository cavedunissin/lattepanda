...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class FriendLists : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FriendLists Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FriendLists(TembooSession session) : base(session, "/Library/Facebook/Reading/FriendLists")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The id of the profile to retrieve friends for. Defaults to "me" indicating the authenticated user.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A FriendListsResultSet containing execution metadata and results.</returns>
        new public FriendListsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FriendListsResultSet results = new JavaScriptSerializer().Deserialize<FriendListsResultSet>(json);
    ...
    /// </summary>
    public class FriendListsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
