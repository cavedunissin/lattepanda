...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class VideoUploads : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VideoUploads Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VideoUploads(TembooSession session) : base(session, "/Library/Facebook/Reading/VideoUploads")
        {
        }
        ...
        /// </summary>
        /// <returns>A VideoUploadsResultSet containing execution metadata and results.</returns>
        new public VideoUploadsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VideoUploadsResultSet results = new JavaScriptSerializer().Deserialize<VideoUploadsResultSet>(json);
    ...
    /// </summary>
    public class VideoUploadsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
