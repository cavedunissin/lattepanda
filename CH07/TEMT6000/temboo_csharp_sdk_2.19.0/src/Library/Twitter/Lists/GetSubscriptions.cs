...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class GetSubscriptions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSubscriptions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSubscriptions(TembooSession session) : base(session, "/Library/Twitter/Lists/GetSubscriptions")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSubscriptionsResultSet containing execution metadata and results.</returns>
        new public GetSubscriptionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSubscriptionsResultSet results = new JavaScriptSerializer().Deserialize<GetSubscriptionsResultSet>(json);
    ...
    /// </summary>
    public class GetSubscriptionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
