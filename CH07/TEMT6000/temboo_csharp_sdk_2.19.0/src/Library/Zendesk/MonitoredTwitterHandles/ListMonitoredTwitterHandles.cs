...
namespace Temboo.Library.Zendesk.MonitoredTwitterHandles
{
    /// <summary>
    ...
    /// </summary>
    public class ListMonitoredTwitterHandles : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMonitoredTwitterHandles Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMonitoredTwitterHandles(TembooSession session) : base(session, "/Library/Zendesk/MonitoredTwitterHandles/ListMonitoredTwitterHandles")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMonitoredTwitterHandlesResultSet containing execution metadata and results.</returns>
        new public ListMonitoredTwitterHandlesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMonitoredTwitterHandlesResultSet results = new JavaScriptSerializer().Deserialize<ListMonitoredTwitterHandlesResultSet>(json);
    ...
    /// </summary>
    public class ListMonitoredTwitterHandlesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
