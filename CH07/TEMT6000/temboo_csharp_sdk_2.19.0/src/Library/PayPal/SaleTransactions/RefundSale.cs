...
namespace Temboo.Library.PayPal.SaleTransactions
{
    ...
    /// </summary>
    public class RefundSale : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RefundSale Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RefundSale(TembooSession session) : base(session, "/Library/PayPal/SaleTransactions/RefundSale")
        {
        }
        ...
        /// </summary>
        /// <returns>A RefundSaleResultSet containing execution metadata and results.</returns>
        new public RefundSaleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RefundSaleResultSet results = new JavaScriptSerializer().Deserialize<RefundSaleResultSet>(json);
    ...
    /// </summary>
    public class RefundSaleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (string) The id of the refund. This can be used to lookup the refund later if needed.</returns>
        /// </summary>
        public String RefundID
        {
            get
            {
                return (String) base.Output["RefundID"];
            }
        }
        /// <summary> 
