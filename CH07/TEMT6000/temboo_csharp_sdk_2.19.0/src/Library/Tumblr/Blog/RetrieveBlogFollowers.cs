...
namespace Temboo.Library.Tumblr.Blog
{
    ...
    /// </summary>
    public class RetrieveBlogFollowers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveBlogFollowers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveBlogFollowers(TembooSession session) : base(session, "/Library/Tumblr/Blog/RetrieveBlogFollowers")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveBlogFollowersResultSet containing execution metadata and results.</returns>
        new public RetrieveBlogFollowersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveBlogFollowersResultSet results = new JavaScriptSerializer().Deserialize<RetrieveBlogFollowersResultSet>(json);
    ...
    /// </summary>
    public class RetrieveBlogFollowersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
