...
namespace Temboo.Library.Fitbit.Statistics
{
    ...
    /// </summary>
    public class GetActivityStats : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetActivityStats Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetActivityStats(TembooSession session) : base(session, "/Library/Fitbit/Statistics/GetActivityStats")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetActivityStatsResultSet containing execution metadata and results.</returns>
        new public GetActivityStatsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetActivityStatsResultSet results = new JavaScriptSerializer().Deserialize<GetActivityStatsResultSet>(json);
    ...
    /// </summary>
    public class GetActivityStatsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
