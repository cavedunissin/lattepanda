...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class GetAllListItems : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAllListItems Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAllListItems(TembooSession session) : base(session, "/Library/Basecamp/GetAllListItems")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAllListItemsResultSet containing execution metadata and results.</returns>
        new public GetAllListItemsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAllListItemsResultSet results = new JavaScriptSerializer().Deserialize<GetAllListItemsResultSet>(json);
    ...
    /// </summary>
    public class GetAllListItemsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
