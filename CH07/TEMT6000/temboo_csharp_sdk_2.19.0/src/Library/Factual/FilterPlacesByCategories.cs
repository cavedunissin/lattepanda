...
namespace Temboo.Library.Factual
{
    ...
    /// </summary>
    public class FilterPlacesByCategories : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FilterPlacesByCategories Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FilterPlacesByCategories(TembooSession session) : base(session, "/Library/Factual/FilterPlacesByCategories")
        {
        }
        ...
        /// </summary>
        /// <returns>A FilterPlacesByCategoriesResultSet containing execution metadata and results.</returns>
        new public FilterPlacesByCategoriesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FilterPlacesByCategoriesResultSet results = new JavaScriptSerializer().Deserialize<FilterPlacesByCategoriesResultSet>(json);
    ...
    /// </summary>
    public class FilterPlacesByCategoriesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
