...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class VideoTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VideoTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VideoTags(TembooSession session) : base(session, "/Library/Facebook/Reading/VideoTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A VideoTagsResultSet containing execution metadata and results.</returns>
        new public VideoTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VideoTagsResultSet results = new JavaScriptSerializer().Deserialize<VideoTagsResultSet>(json);
    ...
    /// </summary>
    public class VideoTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
