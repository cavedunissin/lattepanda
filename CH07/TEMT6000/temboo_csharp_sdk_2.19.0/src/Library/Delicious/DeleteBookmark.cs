...
namespace Temboo.Library.Delicious
{
    ...
    /// </summary>
    public class DeleteBookmark : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteBookmark Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteBookmark(TembooSession session) : base(session, "/Library/Delicious/DeleteBookmark")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteBookmarkResultSet containing execution metadata and results.</returns>
        new public DeleteBookmarkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteBookmarkResultSet results = new JavaScriptSerializer().Deserialize<DeleteBookmarkResultSet>(json);
    ...
    /// </summary>
    public class DeleteBookmarkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
