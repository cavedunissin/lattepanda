...
namespace Temboo.Library.Google.Gmail
{
    ...
    /// </summary>
    public class GetUnreadMailWithLabel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUnreadMailWithLabel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUnreadMailWithLabel(TembooSession session) : base(session, "/Library/Google/Gmail/GetUnreadMailWithLabel")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUnreadMailWithLabelResultSet containing execution metadata and results.</returns>
        new public GetUnreadMailWithLabelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUnreadMailWithLabelResultSet results = new JavaScriptSerializer().Deserialize<GetUnreadMailWithLabelResultSet>(json);
    ...
    /// </summary>
    public class GetUnreadMailWithLabelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "FullCount" output from this Choreo execution
        /// <returns>String - (integer) The number of unread messages. This is parsed from the Google XML response. Note the full count element may be 0 because this Choreography retrieves Gmail messages by a particular Label.</returns>
        /// </summary>
