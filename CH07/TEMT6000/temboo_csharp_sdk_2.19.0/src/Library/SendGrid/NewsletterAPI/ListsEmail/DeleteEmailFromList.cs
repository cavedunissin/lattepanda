...
namespace Temboo.Library.SendGrid.NewsletterAPI.ListsEmail
{
    ...
    /// </summary>
    public class DeleteEmailFromList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteEmailFromList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteEmailFromList(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/ListsEmail/DeleteEmailFromList")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteEmailFromListResultSet containing execution metadata and results.</returns>
        new public DeleteEmailFromListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteEmailFromListResultSet results = new JavaScriptSerializer().Deserialize<DeleteEmailFromListResultSet>(json);
    ...
    /// </summary>
    public class DeleteEmailFromListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
