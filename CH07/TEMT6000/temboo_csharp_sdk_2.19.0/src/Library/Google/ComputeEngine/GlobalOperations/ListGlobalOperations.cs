...
namespace Temboo.Library.Google.ComputeEngine.GlobalOperations
{
    ...
    /// </summary>
    public class ListGlobalOperations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGlobalOperations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGlobalOperations(TembooSession session) : base(session, "/Library/Google/ComputeEngine/GlobalOperations/ListGlobalOperations")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGlobalOperationsResultSet containing execution metadata and results.</returns>
        new public ListGlobalOperationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGlobalOperationsResultSet results = new JavaScriptSerializer().Deserialize<ListGlobalOperationsResultSet>(json);
    ...
    /// </summary>
    public class ListGlobalOperationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
