...
namespace Temboo.Library.Xively.APIKeys
{
    ...
    /// </summary>
    public class ReadKey : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadKey Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadKey(TembooSession session) : base(session, "/Library/Xively/APIKeys/ReadKey")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadKeyResultSet containing execution metadata and results.</returns>
        new public ReadKeyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadKeyResultSet results = new JavaScriptSerializer().Deserialize<ReadKeyResultSet>(json);
    ...
    /// </summary>
    public class ReadKeyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
