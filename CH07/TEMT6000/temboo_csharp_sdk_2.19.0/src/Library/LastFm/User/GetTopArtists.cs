...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetTopArtists : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTopArtists Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTopArtists(TembooSession session) : base(session, "/Library/LastFm/User/GetTopArtists")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTopArtistsResultSet containing execution metadata and results.</returns>
        new public GetTopArtistsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTopArtistsResultSet results = new JavaScriptSerializer().Deserialize<GetTopArtistsResultSet>(json);
    ...
    /// </summary>
    public class GetTopArtistsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
