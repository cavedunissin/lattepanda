...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class GetProjects : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetProjects Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetProjects(TembooSession session) : base(session, "/Library/Basecamp/GetProjects")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetProjectsResultSet containing execution metadata and results.</returns>
        new public GetProjectsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetProjectsResultSet results = new JavaScriptSerializer().Deserialize<GetProjectsResultSet>(json);
    ...
    /// </summary>
    public class GetProjectsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
