...
namespace Temboo.Library.PagerDuty.Incidents
{
    ...
    /// </summary>
    public class ResolveIncident : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ResolveIncident Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ResolveIncident(TembooSession session) : base(session, "/Library/PagerDuty/Incidents/ResolveIncident")
        {
        }
        ...
        /// </summary>
        /// <returns>A ResolveIncidentResultSet containing execution metadata and results.</returns>
        new public ResolveIncidentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ResolveIncidentResultSet results = new JavaScriptSerializer().Deserialize<ResolveIncidentResultSet>(json);
    ...
    /// </summary>
    public class ResolveIncidentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
