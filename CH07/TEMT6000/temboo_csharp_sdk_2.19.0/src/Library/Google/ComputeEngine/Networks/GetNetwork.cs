...
namespace Temboo.Library.Google.ComputeEngine.Networks
{
    ...
    /// </summary>
    public class GetNetwork : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNetwork Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNetwork(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Networks/GetNetwork")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetNetworkResultSet containing execution metadata and results.</returns>
        new public GetNetworkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNetworkResultSet results = new JavaScriptSerializer().Deserialize<GetNetworkResultSet>(json);
    ...
    /// </summary>
    public class GetNetworkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
