...
namespace Temboo.Library._23andMe
{
    ...
    /// </summary>
    public class Ancestry : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Ancestry Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Ancestry(TembooSession session) : base(session, "/Library/23andMe/Ancestry")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Threshold input for this Choreo.</param>
         public void setThreshold(String value) {
             base.addInput ("Threshold", value);
         }
        ...
        /// </summary>
        /// <returns>A AncestryResultSet containing execution metadata and results.</returns>
        new public AncestryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AncestryResultSet results = new JavaScriptSerializer().Deserialize<AncestryResultSet>(json);
    ...
    /// </summary>
    public class AncestryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
