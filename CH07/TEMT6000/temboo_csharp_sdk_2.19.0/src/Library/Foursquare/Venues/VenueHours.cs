...
namespace Temboo.Library.Foursquare.Venues
{
    ...
    /// </summary>
    public class VenueHours : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VenueHours Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VenueHours(TembooSession session) : base(session, "/Library/Foursquare/Venues/VenueHours")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the venue to retrieve hours for.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A VenueHoursResultSet containing execution metadata and results.</returns>
        new public VenueHoursResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VenueHoursResultSet results = new JavaScriptSerializer().Deserialize<VenueHoursResultSet>(json);
    ...
    /// </summary>
    public class VenueHoursResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
