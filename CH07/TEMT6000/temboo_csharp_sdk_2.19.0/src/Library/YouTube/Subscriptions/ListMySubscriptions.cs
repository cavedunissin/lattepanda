...
namespace Temboo.Library.YouTube.Subscriptions
{
    ...
    /// </summary>
    public class ListMySubscriptions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMySubscriptions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMySubscriptions(TembooSession session) : base(session, "/Library/YouTube/Subscriptions/ListMySubscriptions")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMySubscriptionsResultSet containing execution metadata and results.</returns>
        new public ListMySubscriptionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMySubscriptionsResultSet results = new JavaScriptSerializer().Deserialize<ListMySubscriptionsResultSet>(json);
    ...
    /// </summary>
    public class ListMySubscriptionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
