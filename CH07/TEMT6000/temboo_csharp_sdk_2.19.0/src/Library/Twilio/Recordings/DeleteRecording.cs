...
namespace Temboo.Library.Twilio.Recordings
{
    /// <summary>
    /// DeleteRecording
    /// Deletes a recording from your account.
    /// </summary>
    public class DeleteRecording : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRecording Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRecording(TembooSession session) : base(session, "/Library/Twilio/Recordings/DeleteRecording")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RecordingSID input for this Choreo.</param>
         public void setRecordingSID(String value) {
             base.addInput ("RecordingSID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DeleteRecordingResultSet containing execution metadata and results.</returns>
        new public DeleteRecordingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRecordingResultSet results = new JavaScriptSerializer().Deserialize<DeleteRecordingResultSet>(json);
    ...
    /// </summary>
    public class DeleteRecordingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
