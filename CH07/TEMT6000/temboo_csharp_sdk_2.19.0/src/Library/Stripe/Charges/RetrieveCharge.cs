...
namespace Temboo.Library.Stripe.Charges
{
    ...
    /// </summary>
    public class RetrieveCharge : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveCharge Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveCharge(TembooSession session) : base(session, "/Library/Stripe/Charges/RetrieveCharge")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveChargeResultSet containing execution metadata and results.</returns>
        new public RetrieveChargeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveChargeResultSet results = new JavaScriptSerializer().Deserialize<RetrieveChargeResultSet>(json);
    ...
    /// </summary>
    public class RetrieveChargeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
