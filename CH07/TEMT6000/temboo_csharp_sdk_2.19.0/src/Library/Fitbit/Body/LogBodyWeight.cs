...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class LogBodyWeight : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LogBodyWeight Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LogBodyWeight(TembooSession session) : base(session, "/Library/Fitbit/Body/LogBodyWeight")
        {
        }
        ...
        /// </summary>
        /// <returns>A LogBodyWeightResultSet containing execution metadata and results.</returns>
        new public LogBodyWeightResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LogBodyWeightResultSet results = new JavaScriptSerializer().Deserialize<LogBodyWeightResultSet>(json);
    ...
    /// </summary>
    public class LogBodyWeightResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
