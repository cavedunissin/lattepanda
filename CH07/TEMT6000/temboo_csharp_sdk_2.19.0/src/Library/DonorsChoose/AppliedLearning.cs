...
namespace Temboo.Library.DonorsChoose
{
    ...
    /// </summary>
    public class AppliedLearning : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AppliedLearning Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AppliedLearning(TembooSession session) : base(session, "/Library/DonorsChoose/AppliedLearning")
        {
        }
        ...
        /// </summary>
        /// <returns>A AppliedLearningResultSet containing execution metadata and results.</returns>
        new public AppliedLearningResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AppliedLearningResultSet results = new JavaScriptSerializer().Deserialize<AppliedLearningResultSet>(json);
    ...
    /// </summary>
    public class AppliedLearningResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
