...
namespace Temboo.Library.Facebook.Actions.Custom
{
    ...
    /// </summary>
    public class ReadActions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadActions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadActions(TembooSession session) : base(session, "/Library/Facebook/Actions/Custom/ReadActions")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadActionsResultSet containing execution metadata and results.</returns>
        new public ReadActionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadActionsResultSet results = new JavaScriptSerializer().Deserialize<ReadActionsResultSet>(json);
    ...
    /// </summary>
    public class ReadActionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
