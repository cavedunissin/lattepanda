...
namespace Temboo.Library.Box.Users
{
    ...
    /// </summary>
    public class GetCurrentUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCurrentUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCurrentUser(TembooSession session) : base(session, "/Library/Box/Users/GetCurrentUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCurrentUserResultSet containing execution metadata and results.</returns>
        new public GetCurrentUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCurrentUserResultSet results = new JavaScriptSerializer().Deserialize<GetCurrentUserResultSet>(json);
    ...
    /// </summary>
    public class GetCurrentUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
