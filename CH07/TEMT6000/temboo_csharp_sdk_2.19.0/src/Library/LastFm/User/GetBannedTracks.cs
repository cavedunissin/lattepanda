...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetBannedTracks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBannedTracks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBannedTracks(TembooSession session) : base(session, "/Library/LastFm/User/GetBannedTracks")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBannedTracksResultSet containing execution metadata and results.</returns>
        new public GetBannedTracksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBannedTracksResultSet results = new JavaScriptSerializer().Deserialize<GetBannedTracksResultSet>(json);
    ...
    /// </summary>
    public class GetBannedTracksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
