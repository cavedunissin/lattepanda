...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class PutRolePolicy : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PutRolePolicy Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PutRolePolicy(TembooSession session) : base(session, "/Library/Amazon/IAM/PutRolePolicy")
        {
        }
        ...
        /// </summary>
        /// <returns>A PutRolePolicyResultSet containing execution metadata and results.</returns>
        new public PutRolePolicyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PutRolePolicyResultSet results = new JavaScriptSerializer().Deserialize<PutRolePolicyResultSet>(json);
    ...
    /// </summary>
    public class PutRolePolicyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
