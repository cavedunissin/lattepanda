...
namespace Temboo.Library.Amazon.Marketplace.Inventory
{
    ...
    /// </summary>
    public class ListInventorySupplyBySKU : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListInventorySupplyBySKU Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListInventorySupplyBySKU(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Inventory/ListInventorySupplyBySKU")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListInventorySupplyBySKUResultSet containing execution metadata and results.</returns>
        new public ListInventorySupplyBySKUResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListInventorySupplyBySKUResultSet results = new JavaScriptSerializer().Deserialize<ListInventorySupplyBySKUResultSet>(json);
    ...
    /// </summary>
    public class ListInventorySupplyBySKUResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
