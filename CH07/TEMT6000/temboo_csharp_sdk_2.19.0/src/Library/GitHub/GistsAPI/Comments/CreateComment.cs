...
namespace Temboo.Library.GitHub.GistsAPI.Comments
{
    ...
    /// </summary>
    public class CreateComment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateComment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateComment(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Comments/CreateComment")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateCommentResultSet containing execution metadata and results.</returns>
        new public CreateCommentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateCommentResultSet results = new JavaScriptSerializer().Deserialize<CreateCommentResultSet>(json);
    ...
    /// </summary>
    public class CreateCommentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
