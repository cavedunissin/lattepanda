...
namespace Temboo.Library.NYTimes.TimesNewswire
{
    ...
    /// </summary>
    public class GetNewsItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNewsItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNewsItem(TembooSession session) : base(session, "/Library/NYTimes/TimesNewswire/GetNewsItem")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetNewsItemResultSet containing execution metadata and results.</returns>
        new public GetNewsItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNewsItemResultSet results = new JavaScriptSerializer().Deserialize<GetNewsItemResultSet>(json);
    ...
    /// </summary>
    public class GetNewsItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
