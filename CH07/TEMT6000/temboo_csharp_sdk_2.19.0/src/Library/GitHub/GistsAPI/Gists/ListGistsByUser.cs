...
namespace Temboo.Library.GitHub.GistsAPI.Gists
{
    ...
    /// </summary>
    public class ListGistsByUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGistsByUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGistsByUser(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Gists/ListGistsByUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGistsByUserResultSet containing execution metadata and results.</returns>
        new public ListGistsByUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGistsByUserResultSet results = new JavaScriptSerializer().Deserialize<ListGistsByUserResultSet>(json);
    ...
    /// </summary>
    public class ListGistsByUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
