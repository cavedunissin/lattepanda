...
namespace Temboo.Library.GitHub.GistsAPI.Gists
{
    ...
    /// </summary>
    public class UnstarGist : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnstarGist Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnstarGist(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Gists/UnstarGist")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnstarGistResultSet containing execution metadata and results.</returns>
        new public UnstarGistResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnstarGistResultSet results = new JavaScriptSerializer().Deserialize<UnstarGistResultSet>(json);
    ...
    /// </summary>
    public class UnstarGistResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
