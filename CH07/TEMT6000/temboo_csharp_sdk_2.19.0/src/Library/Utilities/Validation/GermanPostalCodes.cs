...
namespace Temboo.Library.Utilities.Validation
{
    ...
    /// </summary>
    public class GermanPostalCodes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GermanPostalCodes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GermanPostalCodes(TembooSession session) : base(session, "/Library/Utilities/Validation/GermanPostalCodes")
        {
        }
        ...
        /// </summary>
        /// <returns>A GermanPostalCodesResultSet containing execution metadata and results.</returns>
        new public GermanPostalCodesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GermanPostalCodesResultSet results = new JavaScriptSerializer().Deserialize<GermanPostalCodesResultSet>(json);
    ...
    /// </summary>
    public class GermanPostalCodesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
