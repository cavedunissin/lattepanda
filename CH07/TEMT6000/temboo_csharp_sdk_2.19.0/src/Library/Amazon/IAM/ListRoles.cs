...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListRoles : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRoles Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRoles(TembooSession session) : base(session, "/Library/Amazon/IAM/ListRoles")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRolesResultSet containing execution metadata and results.</returns>
        new public ListRolesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRolesResultSet results = new JavaScriptSerializer().Deserialize<ListRolesResultSet>(json);
    ...
    /// </summary>
    public class ListRolesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
