...
namespace Temboo.Library.UnlockPlaces
{
    ...
    /// </summary>
    public class ClosestMatchSearch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ClosestMatchSearch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ClosestMatchSearch(TembooSession session) : base(session, "/Library/UnlockPlaces/ClosestMatchSearch")
        {
        }
        ...
        /// </summary>
        /// <returns>A ClosestMatchSearchResultSet containing execution metadata and results.</returns>
        new public ClosestMatchSearchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ClosestMatchSearchResultSet results = new JavaScriptSerializer().Deserialize<ClosestMatchSearchResultSet>(json);
    ...
    /// </summary>
    public class ClosestMatchSearchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
