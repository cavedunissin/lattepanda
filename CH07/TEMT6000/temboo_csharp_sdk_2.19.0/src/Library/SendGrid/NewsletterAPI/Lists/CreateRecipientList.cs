...
namespace Temboo.Library.SendGrid.NewsletterAPI.Lists
{
    ...
    /// </summary>
    public class CreateRecipientList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateRecipientList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateRecipientList(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Lists/CreateRecipientList")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateRecipientListResultSet containing execution metadata and results.</returns>
        new public CreateRecipientListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateRecipientListResultSet results = new JavaScriptSerializer().Deserialize<CreateRecipientListResultSet>(json);
    ...
    /// </summary>
    public class CreateRecipientListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
