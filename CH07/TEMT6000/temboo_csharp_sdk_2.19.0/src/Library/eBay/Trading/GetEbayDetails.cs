...
namespace Temboo.Library.eBay.Trading
{
    ...
    /// </summary>
    public class GetEbayDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEbayDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEbayDetails(TembooSession session) : base(session, "/Library/eBay/Trading/GetEbayDetails")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the DetailName input for this Choreo.</param>
         public void setDetailName(String value) {
             base.addInput ("DetailName", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetEbayDetailsResultSet containing execution metadata and results.</returns>
        new public GetEbayDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEbayDetailsResultSet results = new JavaScriptSerializer().Deserialize<GetEbayDetailsResultSet>(json);
    ...
    /// </summary>
    public class GetEbayDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
