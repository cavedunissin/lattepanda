...
namespace Temboo.Library.SendGrid.WebAPI.Statistics
{
    ...
    /// </summary>
    public class RetrieveStatistics : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveStatistics Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveStatistics(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Statistics/RetrieveStatistics")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveStatisticsResultSet containing execution metadata and results.</returns>
        new public RetrieveStatisticsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveStatisticsResultSet results = new JavaScriptSerializer().Deserialize<RetrieveStatisticsResultSet>(json);
    ...
    /// </summary>
    public class RetrieveStatisticsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
