...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListInstanceProfiles : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListInstanceProfiles Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListInstanceProfiles(TembooSession session) : base(session, "/Library/Amazon/IAM/ListInstanceProfiles")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListInstanceProfilesResultSet containing execution metadata and results.</returns>
        new public ListInstanceProfilesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListInstanceProfilesResultSet results = new JavaScriptSerializer().Deserialize<ListInstanceProfilesResultSet>(json);
    ...
    /// </summary>
    public class ListInstanceProfilesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
