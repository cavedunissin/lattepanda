...
namespace Temboo.Library.Foursquare.Photos
{
    ...
    /// </summary>
    public class PhotoDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PhotoDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PhotoDetails(TembooSession session) : base(session, "/Library/Foursquare/Photos/PhotoDetails")
        {
        }
        ...
        /// </summary>
        /// <returns>A PhotoDetailsResultSet containing execution metadata and results.</returns>
        new public PhotoDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PhotoDetailsResultSet results = new JavaScriptSerializer().Deserialize<PhotoDetailsResultSet>(json);
    ...
    /// </summary>
    public class PhotoDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
