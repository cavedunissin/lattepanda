...
namespace Temboo.Library.Zendesk.TicketAudits
{
    ...
    /// </summary>
    public class ListAudits : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAudits Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAudits(TembooSession session) : base(session, "/Library/Zendesk/TicketAudits/ListAudits")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAuditsResultSet containing execution metadata and results.</returns>
        new public ListAuditsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAuditsResultSet results = new JavaScriptSerializer().Deserialize<ListAuditsResultSet>(json);
    ...
    /// </summary>
    public class ListAuditsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
