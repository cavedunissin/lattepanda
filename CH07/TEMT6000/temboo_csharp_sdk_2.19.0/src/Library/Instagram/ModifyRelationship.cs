...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class ModifyRelationship : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ModifyRelationship Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ModifyRelationship(TembooSession session) : base(session, "/Library/Instagram/ModifyRelationship")
        {
        }
        ...
        /// </summary>
        /// <returns>A ModifyRelationshipResultSet containing execution metadata and results.</returns>
        new public ModifyRelationshipResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ModifyRelationshipResultSet results = new JavaScriptSerializer().Deserialize<ModifyRelationshipResultSet>(json);
    ...
    /// </summary>
    public class ModifyRelationshipResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
