...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class RetrieveListRow : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveListRow Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveListRow(TembooSession session) : base(session, "/Library/Google/Spreadsheets/RetrieveListRow")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The entry's resource URL found in the link element of the entry. Can be retrieved by running the RetrieveListFeed Choreo. When this is provided, SpreadsheetKey, WorksheetId, and RowId are not needed.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) The unique ID of the row you want to retrieve. Required unless providing the Link input.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) The unique key of the spreadsheet associated with the row you want to retrieve. Required unless providing the Link input.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) The unique ID of the worksheet associated with the row you want to retrieve. Required unless providing the Link input.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A RetrieveListRowResultSet containing execution metadata and results.</returns>
        new public RetrieveListRowResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveListRowResultSet results = new JavaScriptSerializer().Deserialize<RetrieveListRowResultSet>(json);
    ...
    /// </summary>
    public class RetrieveListRowResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
