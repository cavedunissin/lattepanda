...
namespace Temboo.Library.Yahoo.YQL
{
    ...
    /// </summary>
    public class RunQuery : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RunQuery Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RunQuery(TembooSession session) : base(session, "/Library/Yahoo/YQL/RunQuery")
        {
        }
        ...
        /// </summary>
        /// <returns>A RunQueryResultSet containing execution metadata and results.</returns>
        new public RunQueryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RunQueryResultSet results = new JavaScriptSerializer().Deserialize<RunQueryResultSet>(json);
    ...
    /// </summary>
    public class RunQueryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
