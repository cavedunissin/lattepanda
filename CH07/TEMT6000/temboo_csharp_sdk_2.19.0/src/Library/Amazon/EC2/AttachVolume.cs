...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class AttachVolume : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AttachVolume Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AttachVolume(TembooSession session) : base(session, "/Library/Amazon/EC2/AttachVolume")
        {
        }
        ...
        /// </summary>
        /// <returns>A AttachVolumeResultSet containing execution metadata and results.</returns>
        new public AttachVolumeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AttachVolumeResultSet results = new JavaScriptSerializer().Deserialize<AttachVolumeResultSet>(json);
    ...
    /// </summary>
    public class AttachVolumeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
