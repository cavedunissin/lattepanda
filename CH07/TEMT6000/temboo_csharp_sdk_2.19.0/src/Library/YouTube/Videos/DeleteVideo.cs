...
namespace Temboo.Library.YouTube.Videos
{
    ...
    /// </summary>
    public class DeleteVideo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteVideo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteVideo(TembooSession session) : base(session, "/Library/YouTube/Videos/DeleteVideo")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteVideoResultSet containing execution metadata and results.</returns>
        new public DeleteVideoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteVideoResultSet results = new JavaScriptSerializer().Deserialize<DeleteVideoResultSet>(json);
    ...
    /// </summary>
    public class DeleteVideoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
