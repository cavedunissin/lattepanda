...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class CreateTicket : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateTicket Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateTicket(TembooSession session) : base(session, "/Library/Zendesk/Tickets/CreateTicket")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the TicketData input for this Choreo.</param>
         public void setTicketData(String value) {
             base.addInput ("TicketData", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreateTicketResultSet containing execution metadata and results.</returns>
        new public CreateTicketResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateTicketResultSet results = new JavaScriptSerializer().Deserialize<CreateTicketResultSet>(json);
    ...
    /// </summary>
    public class CreateTicketResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
