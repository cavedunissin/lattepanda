...
namespace Temboo.Library.Google.Drive.Changes
{
    /// <summary>
    /// List
    ...
    public class List : Temboo.Core.Choreography
    {
        ...
        public List(TembooSession session) : base(session, "/Library/Google/Drive/Changes/List")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the IncludeSubscribed input for this Choreo.</param>
         public void setIncludeSubscribed(String value) {
             base.addInput ("IncludeSubscribed", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the StartChangeID input for this Choreo.</param>
         public void setStartChangeID(String value) {
             base.addInput ("StartChangeID", value);
         }
