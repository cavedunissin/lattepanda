...
namespace Temboo.Library.Mixpanel.Profiles
{
    ...
    /// </summary>
    public class Add : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Add Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Add(TembooSession session) : base(session, "/Library/Mixpanel/Profiles/Add")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddResultSet containing execution metadata and results.</returns>
        new public AddResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddResultSet results = new JavaScriptSerializer().Deserialize<AddResultSet>(json);
    ...
    /// </summary>
    public class AddResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
