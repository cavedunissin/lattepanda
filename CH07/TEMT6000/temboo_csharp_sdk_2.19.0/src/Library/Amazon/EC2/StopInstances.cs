...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class StopInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the StopInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public StopInstances(TembooSession session) : base(session, "/Library/Amazon/EC2/StopInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A StopInstancesResultSet containing execution metadata and results.</returns>
        new public StopInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            StopInstancesResultSet results = new JavaScriptSerializer().Deserialize<StopInstancesResultSet>(json);
    ...
    /// </summary>
    public class StopInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
