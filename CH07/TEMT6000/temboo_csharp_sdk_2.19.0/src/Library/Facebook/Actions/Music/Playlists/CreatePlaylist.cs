...
namespace Temboo.Library.Facebook.Actions.Music.Playlists
{
    ...
    /// </summary>
    public class CreatePlaylist : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreatePlaylist Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreatePlaylist(TembooSession session) : base(session, "/Library/Facebook/Actions/Music/Playlists/CreatePlaylist")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreatePlaylistResultSet containing execution metadata and results.</returns>
        new public CreatePlaylistResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreatePlaylistResultSet results = new JavaScriptSerializer().Deserialize<CreatePlaylistResultSet>(json);
    ...
    /// </summary>
    public class CreatePlaylistResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
