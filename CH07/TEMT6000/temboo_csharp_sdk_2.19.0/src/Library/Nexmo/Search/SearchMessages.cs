...
namespace Temboo.Library.Nexmo.Search
{
    ...
    /// </summary>
    public class SearchMessages : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchMessages Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchMessages(TembooSession session) : base(session, "/Library/Nexmo/Search/SearchMessages")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the MessageIDs input for this Choreo.</param>
         public void setMessageIDs(String value) {
             base.addInput ("MessageIDs", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A SearchMessagesResultSet containing execution metadata and results.</returns>
        new public SearchMessagesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchMessagesResultSet results = new JavaScriptSerializer().Deserialize<SearchMessagesResultSet>(json);
    ...
    /// </summary>
    public class SearchMessagesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
