...
namespace Temboo.Library.Google.Sheets
{
    ...
    /// </summary>
    public class GetValues : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetValues Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetValues(TembooSession session) : base(session, "/Library/Google/Sheets/GetValues")
        {
        }
         ...
         /// <summary>
         /// (required, string) The A1 notation of the values to retrieve (e.g. Sheet1!A2:C3).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetValuesResultSet containing execution metadata and results.</returns>
        new public GetValuesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetValuesResultSet results = new JavaScriptSerializer().Deserialize<GetValuesResultSet>(json);
    ...
    /// </summary>
    public class GetValuesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
