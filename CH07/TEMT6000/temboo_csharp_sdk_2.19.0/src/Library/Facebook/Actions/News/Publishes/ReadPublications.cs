...
namespace Temboo.Library.Facebook.Actions.News.Publishes
{
    ...
    /// </summary>
    public class ReadPublications : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadPublications Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadPublications(TembooSession session) : base(session, "/Library/Facebook/Actions/News/Publishes/ReadPublications")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadPublicationsResultSet containing execution metadata and results.</returns>
        new public ReadPublicationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadPublicationsResultSet results = new JavaScriptSerializer().Deserialize<ReadPublicationsResultSet>(json);
    ...
    /// </summary>
    public class ReadPublicationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
