...
namespace Temboo.Library.YouTube.Channels
{
    ...
    /// </summary>
    public class ListMyChannels : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMyChannels Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMyChannels(TembooSession session) : base(session, "/Library/YouTube/Channels/ListMyChannels")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMyChannelsResultSet containing execution metadata and results.</returns>
        new public ListMyChannelsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMyChannelsResultSet results = new JavaScriptSerializer().Deserialize<ListMyChannelsResultSet>(json);
    ...
    /// </summary>
    public class ListMyChannelsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
