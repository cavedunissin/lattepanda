...
namespace Temboo.Library.Google.Drive.Files
{
    ...
    /// </summary>
    public class Untrash : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Untrash Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Untrash(TembooSession session) : base(session, "/Library/Google/Drive/Files/Untrash")
        {
        }
        ...
        /// </summary>
        /// <returns>A UntrashResultSet containing execution metadata and results.</returns>
        new public UntrashResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UntrashResultSet results = new JavaScriptSerializer().Deserialize<UntrashResultSet>(json);
    ...
    /// </summary>
    public class UntrashResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
