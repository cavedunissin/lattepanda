...
namespace Temboo.Library.KhanAcademy.Users
{
    ...
    /// </summary>
    public class GetUserExercises : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUserExercises Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUserExercises(TembooSession session) : base(session, "/Library/KhanAcademy/Users/GetUserExercises")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUserExercisesResultSet containing execution metadata and results.</returns>
        new public GetUserExercisesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUserExercisesResultSet results = new JavaScriptSerializer().Deserialize<GetUserExercisesResultSet>(json);
    ...
    /// </summary>
    public class GetUserExercisesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
