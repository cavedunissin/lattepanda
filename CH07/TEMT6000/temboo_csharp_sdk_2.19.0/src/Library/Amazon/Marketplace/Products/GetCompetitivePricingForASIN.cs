...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    /// </summary>
    public class GetCompetitivePricingForASIN : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCompetitivePricingForASIN Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCompetitivePricingForASIN(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/GetCompetitivePricingForASIN")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCompetitivePricingForASINResultSet containing execution metadata and results.</returns>
        new public GetCompetitivePricingForASINResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCompetitivePricingForASINResultSet results = new JavaScriptSerializer().Deserialize<GetCompetitivePricingForASINResultSet>(json);
    ...
    /// </summary>
    public class GetCompetitivePricingForASINResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
