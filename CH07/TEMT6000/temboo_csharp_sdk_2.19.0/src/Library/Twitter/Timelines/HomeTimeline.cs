...
namespace Temboo.Library.Twitter.Timelines
{
    ...
    /// </summary>
    public class HomeTimeline : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the HomeTimeline Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public HomeTimeline(TembooSession session) : base(session, "/Library/Twitter/Timelines/HomeTimeline")
        {
        }
        ...
        /// </summary>
        /// <returns>A HomeTimelineResultSet containing execution metadata and results.</returns>
        new public HomeTimelineResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            HomeTimelineResultSet results = new JavaScriptSerializer().Deserialize<HomeTimelineResultSet>(json);
    ...
    /// </summary>
    public class HomeTimelineResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
