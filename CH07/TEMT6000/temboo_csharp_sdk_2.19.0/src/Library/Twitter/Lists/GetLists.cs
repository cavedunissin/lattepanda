...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class GetLists : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLists Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLists(TembooSession session) : base(session, "/Library/Twitter/Lists/GetLists")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Reverse input for this Choreo.</param>
         public void setReverse(String value) {
             base.addInput ("Reverse", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetListsResultSet containing execution metadata and results.</returns>
        new public GetListsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetListsResultSet results = new JavaScriptSerializer().Deserialize<GetListsResultSet>(json);
    ...
    /// </summary>
    public class GetListsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
