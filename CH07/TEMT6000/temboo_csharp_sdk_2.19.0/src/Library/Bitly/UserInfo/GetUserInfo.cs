...
namespace Temboo.Library.Bitly.UserInfo
{
    ...
    /// </summary>
    public class GetUserInfo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUserInfo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUserInfo(TembooSession session) : base(session, "/Library/Bitly/UserInfo/GetUserInfo")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUserInfoResultSet containing execution metadata and results.</returns>
        new public GetUserInfoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUserInfoResultSet results = new JavaScriptSerializer().Deserialize<GetUserInfoResultSet>(json);
    ...
    /// </summary>
    public class GetUserInfoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
