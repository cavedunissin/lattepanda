...
namespace Temboo.Library.Twilio.ShortCodes
{
    ...
    /// </summary>
    public class GetShortCode : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetShortCode Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetShortCode(TembooSession session) : base(session, "/Library/Twilio/ShortCodes/GetShortCode")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetShortCodeResultSet containing execution metadata and results.</returns>
        new public GetShortCodeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetShortCodeResultSet results = new JavaScriptSerializer().Deserialize<GetShortCodeResultSet>(json);
    ...
    /// </summary>
    public class GetShortCodeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
