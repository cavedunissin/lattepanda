...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class GetMediaByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMediaByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMediaByID(TembooSession session) : base(session, "/Library/Instagram/GetMediaByID")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMediaByIDResultSet containing execution metadata and results.</returns>
        new public GetMediaByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMediaByIDResultSet results = new JavaScriptSerializer().Deserialize<GetMediaByIDResultSet>(json);
    ...
    /// </summary>
    public class GetMediaByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
