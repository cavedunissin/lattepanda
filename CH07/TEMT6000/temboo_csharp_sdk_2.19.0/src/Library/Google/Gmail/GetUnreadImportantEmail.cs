...
namespace Temboo.Library.Google.Gmail
{
    ...
    /// </summary>
    public class GetUnreadImportantEmail : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUnreadImportantEmail Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUnreadImportantEmail(TembooSession session) : base(session, "/Library/Google/Gmail/GetUnreadImportantEmail")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUnreadImportantEmailResultSet containing execution metadata and results.</returns>
        new public GetUnreadImportantEmailResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUnreadImportantEmailResultSet results = new JavaScriptSerializer().Deserialize<GetUnreadImportantEmailResultSet>(json);
    ...
    /// </summary>
    public class GetUnreadImportantEmailResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
