...
namespace Temboo.Library.Twitter.DirectMessages
{
    ...
    /// </summary>
    public class DestroyDirectMessage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DestroyDirectMessage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DestroyDirectMessage(TembooSession session) : base(session, "/Library/Twitter/DirectMessages/DestroyDirectMessage")
        {
        }
        ...
        /// </summary>
        /// <returns>A DestroyDirectMessageResultSet containing execution metadata and results.</returns>
        new public DestroyDirectMessageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DestroyDirectMessageResultSet results = new JavaScriptSerializer().Deserialize<DestroyDirectMessageResultSet>(json);
    ...
    /// </summary>
    public class DestroyDirectMessageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
