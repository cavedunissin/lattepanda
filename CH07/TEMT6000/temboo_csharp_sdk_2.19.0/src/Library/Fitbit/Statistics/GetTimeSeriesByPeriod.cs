...
namespace Temboo.Library.Fitbit.Statistics
{
    ...
    /// </summary>
    public class GetTimeSeriesByPeriod : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTimeSeriesByPeriod Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTimeSeriesByPeriod(TembooSession session) : base(session, "/Library/Fitbit/Statistics/GetTimeSeriesByPeriod")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTimeSeriesByPeriodResultSet containing execution metadata and results.</returns>
        new public GetTimeSeriesByPeriodResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTimeSeriesByPeriodResultSet results = new JavaScriptSerializer().Deserialize<GetTimeSeriesByPeriodResultSet>(json);
    ...
    /// </summary>
    public class GetTimeSeriesByPeriodResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
