...
namespace Temboo.Library.Microsoft.Translator
{
    ...
    /// </summary>
    public class GetTranslations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTranslations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTranslations(TembooSession session) : base(session, "/Library/Microsoft/Translator/GetTranslations")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTranslationsResultSet containing execution metadata and results.</returns>
        new public GetTranslationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTranslationsResultSet results = new JavaScriptSerializer().Deserialize<GetTranslationsResultSet>(json);
    ...
    /// </summary>
    public class GetTranslationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
