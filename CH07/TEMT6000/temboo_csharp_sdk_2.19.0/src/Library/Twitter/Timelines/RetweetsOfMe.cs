...
namespace Temboo.Library.Twitter.Timelines
{
    ...
    /// </summary>
    public class RetweetsOfMe : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetweetsOfMe Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetweetsOfMe(TembooSession session) : base(session, "/Library/Twitter/Timelines/RetweetsOfMe")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetweetsOfMeResultSet containing execution metadata and results.</returns>
        new public RetweetsOfMeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetweetsOfMeResultSet results = new JavaScriptSerializer().Deserialize<RetweetsOfMeResultSet>(json);
    ...
    /// </summary>
    public class RetweetsOfMeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
