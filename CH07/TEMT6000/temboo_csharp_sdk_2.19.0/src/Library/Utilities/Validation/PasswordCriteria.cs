...
namespace Temboo.Library.Utilities.Validation
{
    ...
    /// </summary>
    public class PasswordCriteria : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PasswordCriteria Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PasswordCriteria(TembooSession session) : base(session, "/Library/Utilities/Validation/PasswordCriteria")
        {
        }
        ...
        /// </summary>
        /// <returns>A PasswordCriteriaResultSet containing execution metadata and results.</returns>
        new public PasswordCriteriaResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PasswordCriteriaResultSet results = new JavaScriptSerializer().Deserialize<PasswordCriteriaResultSet>(json);
    ...
    /// </summary>
    public class PasswordCriteriaResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
