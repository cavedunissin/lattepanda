...
namespace Temboo.Library.Google.ComputeEngine.Instances
{
    ...
    /// </summary>
    public class GetSerialPortOutput : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSerialPortOutput Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSerialPortOutput(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Instances/GetSerialPortOutput")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSerialPortOutputResultSet containing execution metadata and results.</returns>
        new public GetSerialPortOutputResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSerialPortOutputResultSet results = new JavaScriptSerializer().Deserialize<GetSerialPortOutputResultSet>(json);
    ...
    /// </summary>
    public class GetSerialPortOutputResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
