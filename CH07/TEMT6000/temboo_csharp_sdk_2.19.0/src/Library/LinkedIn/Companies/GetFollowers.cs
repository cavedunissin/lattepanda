...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class GetFollowers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFollowers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFollowers(TembooSession session) : base(session, "/Library/LinkedIn/Companies/GetFollowers")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the SeniorityLevel input for this Choreo.</param>
         public void setSeniorityLevel(String value) {
             base.addInput ("SeniorityLevel", value);
         }
        ...
        /// </summary>
        /// <returns>A GetFollowersResultSet containing execution metadata and results.</returns>
        new public GetFollowersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFollowersResultSet results = new JavaScriptSerializer().Deserialize<GetFollowersResultSet>(json);
    ...
    /// </summary>
    public class GetFollowersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
