...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListAccountAliases : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAccountAliases Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAccountAliases(TembooSession session) : base(session, "/Library/Amazon/IAM/ListAccountAliases")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAccountAliasesResultSet containing execution metadata and results.</returns>
        new public ListAccountAliasesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAccountAliasesResultSet results = new JavaScriptSerializer().Deserialize<ListAccountAliasesResultSet>(json);
    ...
    /// </summary>
    public class ListAccountAliasesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
