...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListRolePolicies : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRolePolicies Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRolePolicies(TembooSession session) : base(session, "/Library/Amazon/IAM/ListRolePolicies")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRolePoliciesResultSet containing execution metadata and results.</returns>
        new public ListRolePoliciesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRolePoliciesResultSet results = new JavaScriptSerializer().Deserialize<ListRolePoliciesResultSet>(json);
    ...
    /// </summary>
    public class ListRolePoliciesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
