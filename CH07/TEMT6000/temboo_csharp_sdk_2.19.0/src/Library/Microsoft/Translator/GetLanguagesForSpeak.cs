...
namespace Temboo.Library.Microsoft.Translator
{
    ...
    /// </summary>
    public class GetLanguagesForSpeak : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLanguagesForSpeak Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLanguagesForSpeak(TembooSession session) : base(session, "/Library/Microsoft/Translator/GetLanguagesForSpeak")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLanguagesForSpeakResultSet containing execution metadata and results.</returns>
        new public GetLanguagesForSpeakResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLanguagesForSpeakResultSet results = new JavaScriptSerializer().Deserialize<GetLanguagesForSpeakResultSet>(json);
    ...
    /// </summary>
    public class GetLanguagesForSpeakResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
