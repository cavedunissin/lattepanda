...
namespace Temboo.Library.Salesforce.Passwords
{
    /// <summary>
    /// GetPasswordInfo
    /// Gets information on a user's password.
    /// </summary>
    public class GetPasswordInfo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPasswordInfo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPasswordInfo(TembooSession session) : base(session, "/Library/Salesforce/Passwords/GetPasswordInfo")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the user you're getting info for.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetPasswordInfoResultSet containing execution metadata and results.</returns>
        new public GetPasswordInfoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPasswordInfoResultSet results = new JavaScriptSerializer().Deserialize<GetPasswordInfoResultSet>(json);
    ...
    /// </summary>
    public class GetPasswordInfoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
