...
namespace Temboo.Library.Flickr.PhotoComments
{
    ...
    /// </summary>
    public class RemoveComment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RemoveComment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RemoveComment(TembooSession session) : base(session, "/Library/Flickr/PhotoComments/RemoveComment")
        {
        }
        ...
        /// </summary>
        /// <returns>A RemoveCommentResultSet containing execution metadata and results.</returns>
        new public RemoveCommentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RemoveCommentResultSet results = new JavaScriptSerializer().Deserialize<RemoveCommentResultSet>(json);
    ...
    /// </summary>
    public class RemoveCommentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
