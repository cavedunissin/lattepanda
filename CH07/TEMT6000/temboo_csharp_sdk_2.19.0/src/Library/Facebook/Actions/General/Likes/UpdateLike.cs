...
namespace Temboo.Library.Facebook.Actions.General.Likes
{
    ...
    /// </summary>
    public class UpdateLike : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateLike Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateLike(TembooSession session) : base(session, "/Library/Facebook/Actions/General/Likes/UpdateLike")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateLikeResultSet containing execution metadata and results.</returns>
        new public UpdateLikeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateLikeResultSet results = new JavaScriptSerializer().Deserialize<UpdateLikeResultSet>(json);
    ...
    /// </summary>
    public class UpdateLikeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
