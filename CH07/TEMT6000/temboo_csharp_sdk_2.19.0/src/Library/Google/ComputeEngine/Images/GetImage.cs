...
namespace Temboo.Library.Google.ComputeEngine.Images
{
    ...
    /// </summary>
    public class GetImage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetImage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetImage(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Images/GetImage")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetImageResultSet containing execution metadata and results.</returns>
        new public GetImageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetImageResultSet results = new JavaScriptSerializer().Deserialize<GetImageResultSet>(json);
    ...
    /// </summary>
    public class GetImageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
