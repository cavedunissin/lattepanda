...
namespace Temboo.Library.Google.ComputeEngine.Snapshots
{
    ...
    /// </summary>
    public class GetSnapshot : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSnapshot Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSnapshot(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Snapshots/GetSnapshot")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSnapshotResultSet containing execution metadata and results.</returns>
        new public GetSnapshotResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSnapshotResultSet results = new JavaScriptSerializer().Deserialize<GetSnapshotResultSet>(json);
    ...
    /// </summary>
    public class GetSnapshotResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
