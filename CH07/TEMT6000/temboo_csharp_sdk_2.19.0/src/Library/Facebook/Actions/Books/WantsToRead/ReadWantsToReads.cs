...
namespace Temboo.Library.Facebook.Actions.Books.WantsToRead
{
    ...
    /// </summary>
    public class ReadWantsToReads : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadWantsToReads Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadWantsToReads(TembooSession session) : base(session, "/Library/Facebook/Actions/Books/WantsToRead/ReadWantsToReads")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadWantsToReadsResultSet containing execution metadata and results.</returns>
        new public ReadWantsToReadsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadWantsToReadsResultSet results = new JavaScriptSerializer().Deserialize<ReadWantsToReadsResultSet>(json);
    ...
    /// </summary>
    public class ReadWantsToReadsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
