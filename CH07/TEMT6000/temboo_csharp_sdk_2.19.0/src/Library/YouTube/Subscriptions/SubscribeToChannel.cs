...
namespace Temboo.Library.YouTube.Subscriptions
{
    ...
    /// </summary>
    public class SubscribeToChannel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SubscribeToChannel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SubscribeToChannel(TembooSession session) : base(session, "/Library/YouTube/Subscriptions/SubscribeToChannel")
        {
        }
        ...
        /// </summary>
        /// <returns>A SubscribeToChannelResultSet containing execution metadata and results.</returns>
        new public SubscribeToChannelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SubscribeToChannelResultSet results = new JavaScriptSerializer().Deserialize<SubscribeToChannelResultSet>(json);
    ...
    /// </summary>
    public class SubscribeToChannelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
