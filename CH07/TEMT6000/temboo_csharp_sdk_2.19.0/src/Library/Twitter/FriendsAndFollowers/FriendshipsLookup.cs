...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class FriendshipsLookup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FriendshipsLookup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FriendshipsLookup(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/FriendshipsLookup")
        {
        }
        ...
        /// </summary>
        /// <returns>A FriendshipsLookupResultSet containing execution metadata and results.</returns>
        new public FriendshipsLookupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FriendshipsLookupResultSet results = new JavaScriptSerializer().Deserialize<FriendshipsLookupResultSet>(json);
    ...
    /// </summary>
    public class FriendshipsLookupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
