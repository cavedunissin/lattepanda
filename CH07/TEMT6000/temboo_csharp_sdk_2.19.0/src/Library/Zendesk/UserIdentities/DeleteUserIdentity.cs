...
namespace Temboo.Library.Zendesk.UserIdentities
{
    ...
    /// </summary>
    public class DeleteUserIdentity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteUserIdentity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteUserIdentity(TembooSession session) : base(session, "/Library/Zendesk/UserIdentities/DeleteUserIdentity")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteUserIdentityResultSet containing execution metadata and results.</returns>
        new public DeleteUserIdentityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteUserIdentityResultSet results = new JavaScriptSerializer().Deserialize<DeleteUserIdentityResultSet>(json);
    ...
    /// </summary>
    public class DeleteUserIdentityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
