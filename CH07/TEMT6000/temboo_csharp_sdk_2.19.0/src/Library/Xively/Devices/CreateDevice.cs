...
namespace Temboo.Library.Xively.Devices
{
    ...
    /// </summary>
    public class CreateDevice : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateDevice Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateDevice(TembooSession session) : base(session, "/Library/Xively/Devices/CreateDevice")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the SerialNumbers input for this Choreo.</param>
         public void setSerialNumbers(String value) {
             base.addInput ("SerialNumbers", value);
         }
        ...
        /// </summary>
        /// <returns>A CreateDeviceResultSet containing execution metadata and results.</returns>
        new public CreateDeviceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateDeviceResultSet results = new JavaScriptSerializer().Deserialize<CreateDeviceResultSet>(json);
    ...
    /// </summary>
    public class CreateDeviceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "ResponseStatusCode" output from this Choreo execution
        /// <returns>String - (integer) The response status code returned from Xively. For a successful device creation, the code should be 201.</returns>
        /// </summary>
