...
namespace Temboo.Library.Google.ComputeEngine.MachineTypes
{
    /// <summary>
    /// ListMachineTypes
    /// Retrieves the list of Machine Type resources for the specified project.
    /// </summary>
    public class ListMachineTypes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMachineTypes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMachineTypes(TembooSession session) : base(session, "/Library/Google/ComputeEngine/MachineTypes/ListMachineTypes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMachineTypesResultSet containing execution metadata and results.</returns>
        new public ListMachineTypesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMachineTypesResultSet results = new JavaScriptSerializer().Deserialize<ListMachineTypesResultSet>(json);
    ...
    /// </summary>
    public class ListMachineTypesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
