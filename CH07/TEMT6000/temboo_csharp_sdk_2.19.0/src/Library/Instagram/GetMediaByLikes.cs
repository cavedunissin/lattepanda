...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class GetMediaByLikes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMediaByLikes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMediaByLikes(TembooSession session) : base(session, "/Library/Instagram/GetMediaByLikes")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMediaByLikesResultSet containing execution metadata and results.</returns>
        new public GetMediaByLikesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMediaByLikesResultSet results = new JavaScriptSerializer().Deserialize<GetMediaByLikesResultSet>(json);
    ...
    /// </summary>
    public class GetMediaByLikesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
