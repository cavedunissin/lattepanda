...
namespace Temboo.Library.Klout.User
{
    ...
    /// </summary>
    public class Influence : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Influence Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Influence(TembooSession session) : base(session, "/Library/Klout/User/Influence")
        {
        }
        ...
        /// </summary>
        /// <returns>A InfluenceResultSet containing execution metadata and results.</returns>
        new public InfluenceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InfluenceResultSet results = new JavaScriptSerializer().Deserialize<InfluenceResultSet>(json);
    ...
    /// </summary>
    public class InfluenceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
