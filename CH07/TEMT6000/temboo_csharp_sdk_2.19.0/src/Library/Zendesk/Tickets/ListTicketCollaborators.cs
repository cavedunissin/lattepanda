...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class ListTicketCollaborators : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTicketCollaborators Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTicketCollaborators(TembooSession session) : base(session, "/Library/Zendesk/Tickets/ListTicketCollaborators")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTicketCollaboratorsResultSet containing execution metadata and results.</returns>
        new public ListTicketCollaboratorsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTicketCollaboratorsResultSet results = new JavaScriptSerializer().Deserialize<ListTicketCollaboratorsResultSet>(json);
    ...
    /// </summary>
    public class ListTicketCollaboratorsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
