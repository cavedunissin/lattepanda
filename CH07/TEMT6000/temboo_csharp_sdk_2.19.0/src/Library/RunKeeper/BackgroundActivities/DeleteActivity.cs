...
namespace Temboo.Library.RunKeeper.BackgroundActivities
{
    ...
    public class DeleteActivity : Temboo.Core.Choreography
    {
        ...
        public DeleteActivity(TembooSession session) : base(session, "/Library/RunKeeper/BackgroundActivities/DeleteActivity")
        {
        }
    ...
    public class DeleteActivityResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (boolean) Contains the string "true" when activities are successfully deleted.</returns>
        /// </summary>
