...
namespace Temboo.Library.Box.Collaborations
{
    ...
    /// </summary>
    public class GetPendingCollaborations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPendingCollaborations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPendingCollaborations(TembooSession session) : base(session, "/Library/Box/Collaborations/GetPendingCollaborations")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPendingCollaborationsResultSet containing execution metadata and results.</returns>
        new public GetPendingCollaborationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPendingCollaborationsResultSet results = new JavaScriptSerializer().Deserialize<GetPendingCollaborationsResultSet>(json);
    ...
    /// </summary>
    public class GetPendingCollaborationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
