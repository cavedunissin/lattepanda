...
namespace Temboo.Library.CorpWatch.Company
{
    ...
    /// </summary>
    public class GetCompanyFilings : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCompanyFilings Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCompanyFilings(TembooSession session) : base(session, "/Library/CorpWatch/Company/GetCompanyFilings")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCompanyFilingsResultSet containing execution metadata and results.</returns>
        new public GetCompanyFilingsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCompanyFilingsResultSet results = new JavaScriptSerializer().Deserialize<GetCompanyFilingsResultSet>(json);
    ...
    /// </summary>
    public class GetCompanyFilingsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
