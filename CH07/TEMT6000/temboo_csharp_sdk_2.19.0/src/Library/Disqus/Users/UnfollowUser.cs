...
namespace Temboo.Library.Disqus.Users
{
    ...
    /// </summary>
    public class UnfollowUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnfollowUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnfollowUser(TembooSession session) : base(session, "/Library/Disqus/Users/UnfollowUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnfollowUserResultSet containing execution metadata and results.</returns>
        new public UnfollowUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnfollowUserResultSet results = new JavaScriptSerializer().Deserialize<UnfollowUserResultSet>(json);
    ...
    /// </summary>
    public class UnfollowUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
