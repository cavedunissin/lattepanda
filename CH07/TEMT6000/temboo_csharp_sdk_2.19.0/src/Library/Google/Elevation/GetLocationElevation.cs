...
namespace Temboo.Library.Google.Elevation
{
    ...
    /// </summary>
    public class GetLocationElevation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLocationElevation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLocationElevation(TembooSession session) : base(session, "/Library/Google/Elevation/GetLocationElevation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLocationElevationResultSet containing execution metadata and results.</returns>
        new public GetLocationElevationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLocationElevationResultSet results = new JavaScriptSerializer().Deserialize<GetLocationElevationResultSet>(json);
    ...
    /// </summary>
    public class GetLocationElevationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
