...
namespace Temboo.Library.Google.ComputeEngine.Instances
{
    ...
    /// </summary>
    public class SetTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SetTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SetTags(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Instances/SetTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A SetTagsResultSet containing execution metadata and results.</returns>
        new public SetTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SetTagsResultSet results = new JavaScriptSerializer().Deserialize<SetTagsResultSet>(json);
    ...
    /// </summary>
    public class SetTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
