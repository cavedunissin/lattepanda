...
namespace Temboo.Library.Zendesk.Groups
{
    ...
    /// </summary>
    public class ListGroups : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGroups Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGroups(TembooSession session) : base(session, "/Library/Zendesk/Groups/ListGroups")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGroupsResultSet containing execution metadata and results.</returns>
        new public ListGroupsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGroupsResultSet results = new JavaScriptSerializer().Deserialize<ListGroupsResultSet>(json);
    ...
    /// </summary>
    public class ListGroupsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
