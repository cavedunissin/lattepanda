...
namespace Temboo.Library.Facebook.Actions.Fitness.Runs
{
    ...
    /// </summary>
    public class DeleteRun : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRun Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRun(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Runs/DeleteRun")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteRunResultSet containing execution metadata and results.</returns>
        new public DeleteRunResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRunResultSet results = new JavaScriptSerializer().Deserialize<DeleteRunResultSet>(json);
    ...
    /// </summary>
    public class DeleteRunResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
