...
namespace Temboo.Library.NYTimes.CampaignFinance.IndependentExpenditures
{
    ...
    /// </summary>
    public class IndependentExpenditureOnlyCommittees : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the IndependentExpenditureOnlyCommittees Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public IndependentExpenditureOnlyCommittees(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/IndependentExpenditures/IndependentExpenditureOnlyCommittees")
        {
        }
        ...
        /// </summary>
        /// <returns>A IndependentExpenditureOnlyCommitteesResultSet containing execution metadata and results.</returns>
        new public IndependentExpenditureOnlyCommitteesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            IndependentExpenditureOnlyCommitteesResultSet results = new JavaScriptSerializer().Deserialize<IndependentExpenditureOnlyCommitteesResultSet>(json);
    ...
    /// </summary>
    public class IndependentExpenditureOnlyCommitteesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
