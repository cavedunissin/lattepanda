...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class RetrieveSubmissionPosts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveSubmissionPosts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveSubmissionPosts(TembooSession session) : base(session, "/Library/Tumblr/Post/RetrieveSubmissionPosts")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveSubmissionPostsResultSet containing execution metadata and results.</returns>
        new public RetrieveSubmissionPostsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveSubmissionPostsResultSet results = new JavaScriptSerializer().Deserialize<RetrieveSubmissionPostsResultSet>(json);
    ...
    /// </summary>
    public class RetrieveSubmissionPostsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
