...
namespace Temboo.Library.RunKeeper.Weight
{
    ...
    public class RetrieveLatestEntry : Temboo.Core.Choreography
    {
        ...
        public RetrieveLatestEntry(TembooSession session) : base(session, "/Library/RunKeeper/Weight/RetrieveLatestEntry")
        {
        }
    ...
    public class RetrieveLatestEntryResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (date) The timestamp of the latest weight entry.</returns>
        /// </summary>
        ...
        /// <returns>String - (decimal) The latest weight entry.</returns>
        /// </summary>
        public String Weight
        {
            get
            {
                return (String) base.Output["Weight"];
            }
        }
        /// <summary> 
