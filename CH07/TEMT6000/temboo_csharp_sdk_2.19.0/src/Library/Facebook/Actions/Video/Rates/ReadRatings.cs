...
namespace Temboo.Library.Facebook.Actions.Video.Rates
{
    ...
    /// </summary>
    public class ReadRatings : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadRatings Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadRatings(TembooSession session) : base(session, "/Library/Facebook/Actions/Video/Rates/ReadRatings")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadRatingsResultSet containing execution metadata and results.</returns>
        new public ReadRatingsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadRatingsResultSet results = new JavaScriptSerializer().Deserialize<ReadRatingsResultSet>(json);
    ...
    /// </summary>
    public class ReadRatingsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
