...
namespace Temboo.Library.Dwolla.Transactions
{
    ...
    /// </summary>
    public class ByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ByID(TembooSession session) : base(session, "/Library/Dwolla/Transactions/ByID")
        {
        }
        ...
        /// </summary>
        /// <returns>A ByIDResultSet containing execution metadata and results.</returns>
        new public ByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ByIDResultSet results = new JavaScriptSerializer().Deserialize<ByIDResultSet>(json);
    ...
    /// </summary>
    public class ByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
