...
namespace Temboo.Library.Kiva.Lenders
{
    ...
    /// </summary>
    public class SearchLenders : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchLenders Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchLenders(TembooSession session) : base(session, "/Library/Kiva/Lenders/SearchLenders")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchLendersResultSet containing execution metadata and results.</returns>
        new public SearchLendersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchLendersResultSet results = new JavaScriptSerializer().Deserialize<SearchLendersResultSet>(json);
    ...
    /// </summary>
    public class SearchLendersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
