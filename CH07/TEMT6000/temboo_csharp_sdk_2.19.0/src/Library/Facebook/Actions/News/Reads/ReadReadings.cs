...
namespace Temboo.Library.Facebook.Actions.News.Reads
{
    /// <summary>
    /// ReadReadings
    /// Retrieves one or more news reading actions.
    /// </summary>
    public class ReadReadings : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadReadings Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadReadings(TembooSession session) : base(session, "/Library/Facebook/Actions/News/Reads/ReadReadings")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadReadingsResultSet containing execution metadata and results.</returns>
        new public ReadReadingsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadReadingsResultSet results = new JavaScriptSerializer().Deserialize<ReadReadingsResultSet>(json);
    ...
    /// </summary>
    public class ReadReadingsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
