...
namespace Temboo.Library.Google.Drive.Permissions
{
    ...
    public class Insert : Temboo.Core.Choreography
    {
        ...
        public Insert(TembooSession session) : base(session, "/Library/Google/Drive/Permissions/Insert")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the SendNotificationEmails input for this Choreo.</param>
         public void setSendNotificationEmails(String value) {
             base.addInput ("SendNotificationEmails", value);
         }
