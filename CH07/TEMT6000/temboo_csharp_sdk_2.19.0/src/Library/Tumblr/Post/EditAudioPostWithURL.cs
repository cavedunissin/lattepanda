...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class EditAudioPostWithURL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EditAudioPostWithURL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EditAudioPostWithURL(TembooSession session) : base(session, "/Library/Tumblr/Post/EditAudioPostWithURL")
        {
        }
        ...
        /// </summary>
        /// <returns>A EditAudioPostWithURLResultSet containing execution metadata and results.</returns>
        new public EditAudioPostWithURLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EditAudioPostWithURLResultSet results = new JavaScriptSerializer().Deserialize<EditAudioPostWithURLResultSet>(json);
    ...
    /// </summary>
    public class EditAudioPostWithURLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
