...
namespace Temboo.Library.GitHub.ReposAPI.Forks
{
    ...
    /// </summary>
    public class GetForks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetForks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetForks(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Forks/GetForks")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetForksResultSet containing execution metadata and results.</returns>
        new public GetForksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetForksResultSet results = new JavaScriptSerializer().Deserialize<GetForksResultSet>(json);
    ...
    /// </summary>
    public class GetForksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
