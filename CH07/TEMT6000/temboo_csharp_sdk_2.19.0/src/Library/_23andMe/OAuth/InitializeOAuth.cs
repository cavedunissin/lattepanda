...
namespace Temboo.Library._23andMe.OAuth
{
    /// <summary>
    /// InitializeOAuth
    ...
    public class InitializeOAuth : Temboo.Core.Choreography
    {
        ...
        public InitializeOAuth(TembooSession session) : base(session, "/Library/23andMe/OAuth/InitializeOAuth")
        {
        }
    ...
    public class InitializeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The authorization URL that the user needs to go to in order to grant access to your application.</returns>
        /// </summary>
