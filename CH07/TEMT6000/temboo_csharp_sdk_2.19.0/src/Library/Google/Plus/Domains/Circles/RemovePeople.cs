...
namespace Temboo.Library.Google.Plus.Domains.Circles
{
    /// <summary>
    /// RemovePeople
    /// Removes a person from a circle.
    /// </summary>
    public class RemovePeople : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RemovePeople Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RemovePeople(TembooSession session) : base(session, "/Library/Google/Plus/Domains/Circles/RemovePeople")
        {
        }
         ...
         /// <summary>
         /// (conditional, string) The ID of the circle to update.
         /// </summary>
         /// <param name="value">Value of the CircleID input for this Choreo.</param>
         public void setCircleID(String value) {
             base.addInput ("CircleID", value);
         }
         /// <summary>
         ...
         /// <summary>
         /// (conditional, string) Comma-seperated list of up to 10 email addresses of users to remove. Required unless providing a value for UserID.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) Comma-seperated list of up to 10 User IDs to remove. Required unless providing a value for Email.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A RemovePeopleResultSet containing execution metadata and results.</returns>
        new public RemovePeopleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RemovePeopleResultSet results = new JavaScriptSerializer().Deserialize<RemovePeopleResultSet>(json);
    ...
    /// </summary>
    public class RemovePeopleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (integer) The response status code returned from Google.</returns>
        /// </summary>
