...
namespace Temboo.Library.Zendesk.Users
{
    ...
    /// </summary>
    public class SuspendUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SuspendUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SuspendUser(TembooSession session) : base(session, "/Library/Zendesk/Users/SuspendUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A SuspendUserResultSet containing execution metadata and results.</returns>
        new public SuspendUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SuspendUserResultSet results = new JavaScriptSerializer().Deserialize<SuspendUserResultSet>(json);
    ...
    /// </summary>
    public class SuspendUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
