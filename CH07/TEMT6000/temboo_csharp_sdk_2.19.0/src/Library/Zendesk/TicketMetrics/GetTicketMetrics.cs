...
namespace Temboo.Library.Zendesk.TicketMetrics
{
    ...
    /// </summary>
    public class GetTicketMetrics : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTicketMetrics Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTicketMetrics(TembooSession session) : base(session, "/Library/Zendesk/TicketMetrics/GetTicketMetrics")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTicketMetricsResultSet containing execution metadata and results.</returns>
        new public GetTicketMetricsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTicketMetricsResultSet results = new JavaScriptSerializer().Deserialize<GetTicketMetricsResultSet>(json);
    ...
    /// </summary>
    public class GetTicketMetricsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
