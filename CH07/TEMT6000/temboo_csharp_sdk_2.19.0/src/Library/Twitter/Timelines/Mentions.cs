...
namespace Temboo.Library.Twitter.Timelines
{
    ...
    /// </summary>
    public class Mentions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Mentions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Mentions(TembooSession session) : base(session, "/Library/Twitter/Timelines/Mentions")
        {
        }
        ...
        /// </summary>
        /// <returns>A MentionsResultSet containing execution metadata and results.</returns>
        new public MentionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MentionsResultSet results = new JavaScriptSerializer().Deserialize<MentionsResultSet>(json);
    ...
    /// </summary>
    public class MentionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
