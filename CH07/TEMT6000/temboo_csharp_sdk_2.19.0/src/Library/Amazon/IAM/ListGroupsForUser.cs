...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListGroupsForUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGroupsForUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGroupsForUser(TembooSession session) : base(session, "/Library/Amazon/IAM/ListGroupsForUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGroupsForUserResultSet containing execution metadata and results.</returns>
        new public ListGroupsForUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGroupsForUserResultSet results = new JavaScriptSerializer().Deserialize<ListGroupsForUserResultSet>(json);
    ...
    /// </summary>
    public class ListGroupsForUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
