...
namespace Temboo.Library.Foursquare.Tips
{
    ...
    /// </summary>
    public class TipDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TipDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TipDetails(TembooSession session) : base(session, "/Library/Foursquare/Tips/TipDetails")
        {
        }
        ...
        /// </summary>
        /// <returns>A TipDetailsResultSet containing execution metadata and results.</returns>
        new public TipDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TipDetailsResultSet results = new JavaScriptSerializer().Deserialize<TipDetailsResultSet>(json);
    ...
    /// </summary>
    public class TipDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
