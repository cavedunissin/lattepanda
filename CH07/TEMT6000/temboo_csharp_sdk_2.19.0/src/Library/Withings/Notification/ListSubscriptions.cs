...
namespace Temboo.Library.Withings.Notification
{
    ...
    public class ListSubscriptions : Temboo.Core.Choreography
    {
        ...
        public ListSubscriptions(TembooSession session) : base(session, "/Library/Withings/Notification/ListSubscriptions")
        {
        }
         ...
         /// <summary>
         /// (optional, integer) Used to restrict the request to the given device type. Set to 1 for Bodyscale.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The ID of the user to list subscriptions for.
         /// </summary>
