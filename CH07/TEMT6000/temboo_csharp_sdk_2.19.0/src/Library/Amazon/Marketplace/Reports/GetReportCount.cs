...
namespace Temboo.Library.Amazon.Marketplace.Reports
{
    ...
    /// </summary>
    public class GetReportCount : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetReportCount Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetReportCount(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Reports/GetReportCount")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetReportCountResultSet containing execution metadata and results.</returns>
        new public GetReportCountResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetReportCountResultSet results = new JavaScriptSerializer().Deserialize<GetReportCountResultSet>(json);
    ...
    /// </summary>
    public class GetReportCountResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Count" output from this Choreo execution
        /// <returns>String - (integer) A non-negative integer. parsed from the Amazon response, that represents the total number of reports available to download.</returns>
        /// </summary>
        public String Count
        {
            get
