...
namespace Temboo.Library.NYTimes.RealEstate
{
    ...
    /// </summary>
    public class GetSalesPercentiles : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSalesPercentiles Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSalesPercentiles(TembooSession session) : base(session, "/Library/NYTimes/RealEstate/GetSalesPercentiles")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSalesPercentilesResultSet containing execution metadata and results.</returns>
        new public GetSalesPercentilesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSalesPercentilesResultSet results = new JavaScriptSerializer().Deserialize<GetSalesPercentilesResultSet>(json);
    ...
    /// </summary>
    public class GetSalesPercentilesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
