...
namespace Temboo.Library.GitHub.ReposAPI.Comments
{
    ...
    /// </summary>
    public class DeleteCommitComment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteCommitComment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteCommitComment(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Comments/DeleteCommitComment")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteCommitCommentResultSet containing execution metadata and results.</returns>
        new public DeleteCommitCommentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteCommitCommentResultSet results = new JavaScriptSerializer().Deserialize<DeleteCommitCommentResultSet>(json);
    ...
    /// </summary>
    public class DeleteCommitCommentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
