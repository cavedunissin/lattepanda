...
namespace Temboo.Library.CloudMine.FileStorage
{
    ...
    public class GetFile : Temboo.Core.Choreography
    {
        ...
        public GetFile(TembooSession session) : base(session, "/Library/CloudMine/FileStorage/GetFile")
        {
        }
         ...
         /// <summary>
         /// (optional, boolean) Returns the file content as Base64 encoded data when set to "true". This should be set to "true" when returning binary files. Defaults to "false".
         /// </summary>
    ...
    public class GetFileResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - The response from CloudMine.</returns>
        /// </summary>
