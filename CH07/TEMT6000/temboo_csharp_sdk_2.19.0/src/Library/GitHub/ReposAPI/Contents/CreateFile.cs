...
namespace Temboo.Library.GitHub.ReposAPI.Contents
{
    ...
    /// </summary>
    public class CreateFile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateFile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateFile(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Contents/CreateFile")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateFileResultSet containing execution metadata and results.</returns>
        new public CreateFileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateFileResultSet results = new JavaScriptSerializer().Deserialize<CreateFileResultSet>(json);
    ...
    /// </summary>
    public class CreateFileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
