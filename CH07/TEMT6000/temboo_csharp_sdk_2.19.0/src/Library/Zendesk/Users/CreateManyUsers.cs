...
namespace Temboo.Library.Zendesk.Users
{
    ...
    /// </summary>
    public class CreateManyUsers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateManyUsers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateManyUsers(TembooSession session) : base(session, "/Library/Zendesk/Users/CreateManyUsers")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Users input for this Choreo.</param>
         public void setUsers(String value) {
             base.addInput ("Users", value);
         }
        ...
        /// </summary>
        /// <returns>A CreateManyUsersResultSet containing execution metadata and results.</returns>
        new public CreateManyUsersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateManyUsersResultSet results = new JavaScriptSerializer().Deserialize<CreateManyUsersResultSet>(json);
    ...
    /// </summary>
    public class CreateManyUsersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
