...
namespace Temboo.Library.Google.ComputeEngine.Routes
{
    ...
    /// </summary>
    public class DeleteRoute : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRoute Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRoute(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Routes/DeleteRoute")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Route input for this Choreo.</param>
         public void setRoute(String value) {
             base.addInput ("Route", value);
         }
        ...
        /// </summary>
        /// <returns>A DeleteRouteResultSet containing execution metadata and results.</returns>
        new public DeleteRouteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRouteResultSet results = new JavaScriptSerializer().Deserialize<DeleteRouteResultSet>(json);
    ...
    /// </summary>
    public class DeleteRouteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
