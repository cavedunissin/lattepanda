...
namespace Temboo.Library.Fitbit.Devices
{
    ...
    /// </summary>
    public class GetDevices : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetDevices Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetDevices(TembooSession session) : base(session, "/Library/Fitbit/Devices/GetDevices")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetDevicesResultSet containing execution metadata and results.</returns>
        new public GetDevicesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetDevicesResultSet results = new JavaScriptSerializer().Deserialize<GetDevicesResultSet>(json);
    ...
    /// </summary>
    public class GetDevicesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
