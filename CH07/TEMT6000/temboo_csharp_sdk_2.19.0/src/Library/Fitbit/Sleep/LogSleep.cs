...
namespace Temboo.Library.Fitbit.Sleep
{
    ...
    /// </summary>
    public class LogSleep : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LogSleep Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LogSleep(TembooSession session) : base(session, "/Library/Fitbit/Sleep/LogSleep")
        {
        }
        ...
        /// </summary>
        /// <returns>A LogSleepResultSet containing execution metadata and results.</returns>
        new public LogSleepResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LogSleepResultSet results = new JavaScriptSerializer().Deserialize<LogSleepResultSet>(json);
    ...
    /// </summary>
    public class LogSleepResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
