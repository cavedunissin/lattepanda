...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetRecommendedEvents : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRecommendedEvents Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRecommendedEvents(TembooSession session) : base(session, "/Library/LastFm/User/GetRecommendedEvents")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRecommendedEventsResultSet containing execution metadata and results.</returns>
        new public GetRecommendedEventsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRecommendedEventsResultSet results = new JavaScriptSerializer().Deserialize<GetRecommendedEventsResultSet>(json);
    ...
    /// </summary>
    public class GetRecommendedEventsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
