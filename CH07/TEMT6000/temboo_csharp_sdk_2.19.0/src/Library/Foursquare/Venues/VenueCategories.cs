...
namespace Temboo.Library.Foursquare.Venues
{
    ...
    /// </summary>
    public class VenueCategories : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VenueCategories Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VenueCategories(TembooSession session) : base(session, "/Library/Foursquare/Venues/VenueCategories")
        {
        }
        ...
        /// </summary>
        /// <returns>A VenueCategoriesResultSet containing execution metadata and results.</returns>
        new public VenueCategoriesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VenueCategoriesResultSet results = new JavaScriptSerializer().Deserialize<VenueCategoriesResultSet>(json);
    ...
    /// </summary>
    public class VenueCategoriesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
