...
namespace Temboo.Library.Google.Gmail
{
    ...
    /// </summary>
    public class GetUnreadMail : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUnreadMail Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUnreadMail(TembooSession session) : base(session, "/Library/Google/Gmail/GetUnreadMail")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUnreadMailResultSet containing execution metadata and results.</returns>
        new public GetUnreadMailResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUnreadMailResultSet results = new JavaScriptSerializer().Deserialize<GetUnreadMailResultSet>(json);
    ...
    /// </summary>
    public class GetUnreadMailResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
