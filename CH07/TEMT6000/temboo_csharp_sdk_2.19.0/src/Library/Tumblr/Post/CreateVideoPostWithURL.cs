...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class CreateVideoPostWithURL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateVideoPostWithURL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateVideoPostWithURL(TembooSession session) : base(session, "/Library/Tumblr/Post/CreateVideoPostWithURL")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Embed input for this Choreo.</param>
         public void setEmbed(String value) {
             base.addInput ("Embed", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreateVideoPostWithURLResultSet containing execution metadata and results.</returns>
        new public CreateVideoPostWithURLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateVideoPostWithURLResultSet results = new JavaScriptSerializer().Deserialize<CreateVideoPostWithURLResultSet>(json);
    ...
    /// </summary>
    public class CreateVideoPostWithURLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
