...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class GetGroup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetGroup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetGroup(TembooSession session) : base(session, "/Library/Amazon/IAM/GetGroup")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetGroupResultSet containing execution metadata and results.</returns>
        new public GetGroupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetGroupResultSet results = new JavaScriptSerializer().Deserialize<GetGroupResultSet>(json);
    ...
    /// </summary>
    public class GetGroupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
