...
namespace Temboo.Library.Fitbit.Devices
{
    ...
    /// </summary>
    public class UpdateAlarm : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateAlarm Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateAlarm(TembooSession session) : base(session, "/Library/Fitbit/Devices/UpdateAlarm")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the alarm to update.
         /// </summary>
         ...
         /// <summary>
         /// (required, integer) The maximum snooze count.
         /// </summary>
         ...
         /// <summary>
         /// (required, integer) The number of minutes in between alarms when using the snooze option.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A UpdateAlarmResultSet containing execution metadata and results.</returns>
        new public UpdateAlarmResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateAlarmResultSet results = new JavaScriptSerializer().Deserialize<UpdateAlarmResultSet>(json);
    ...
    /// </summary>
    public class UpdateAlarmResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
