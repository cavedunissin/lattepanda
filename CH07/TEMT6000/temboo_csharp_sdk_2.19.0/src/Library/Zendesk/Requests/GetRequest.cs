...
namespace Temboo.Library.Zendesk.Requests
{
    ...
    /// </summary>
    public class GetRequest : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRequest Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRequest(TembooSession session) : base(session, "/Library/Zendesk/Requests/GetRequest")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRequestResultSet containing execution metadata and results.</returns>
        new public GetRequestResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRequestResultSet results = new JavaScriptSerializer().Deserialize<GetRequestResultSet>(json);
    ...
    /// </summary>
    public class GetRequestResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
