...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class IsAdmin : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the IsAdmin Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public IsAdmin(TembooSession session) : base(session, "/Library/LinkedIn/Companies/IsAdmin")
        {
        }
        ...
        /// </summary>
        /// <returns>A IsAdminResultSet containing execution metadata and results.</returns>
        new public IsAdminResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            IsAdminResultSet results = new JavaScriptSerializer().Deserialize<IsAdminResultSet>(json);
    ...
    /// </summary>
    public class IsAdminResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
