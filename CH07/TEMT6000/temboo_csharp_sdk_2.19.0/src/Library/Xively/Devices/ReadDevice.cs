...
namespace Temboo.Library.Xively.Devices
{
    ...
    /// </summary>
    public class ReadDevice : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadDevice Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadDevice(TembooSession session) : base(session, "/Library/Xively/Devices/ReadDevice")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadDeviceResultSet containing execution metadata and results.</returns>
        new public ReadDeviceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadDeviceResultSet results = new JavaScriptSerializer().Deserialize<ReadDeviceResultSet>(json);
    ...
    /// </summary>
    public class ReadDeviceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
