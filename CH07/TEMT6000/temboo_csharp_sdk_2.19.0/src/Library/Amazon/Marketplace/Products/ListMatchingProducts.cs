...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    /// </summary>
    public class ListMatchingProducts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMatchingProducts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMatchingProducts(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/ListMatchingProducts")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMatchingProductsResultSet containing execution metadata and results.</returns>
        new public ListMatchingProductsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMatchingProductsResultSet results = new JavaScriptSerializer().Deserialize<ListMatchingProductsResultSet>(json);
    ...
    /// </summary>
    public class ListMatchingProductsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
