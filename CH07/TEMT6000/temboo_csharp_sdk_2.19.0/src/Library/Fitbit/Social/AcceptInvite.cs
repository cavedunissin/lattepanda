...
namespace Temboo.Library.Fitbit.Social
{
    ...
    /// </summary>
    public class AcceptInvite : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AcceptInvite Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AcceptInvite(TembooSession session) : base(session, "/Library/Fitbit/Social/AcceptInvite")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Accept input for this Choreo.</param>
         public void setAccept(String value) {
             base.addInput ("Accept", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the FromUserID input for this Choreo.</param>
         public void setFromUserID(String value) {
             base.addInput ("FromUserID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A AcceptInviteResultSet containing execution metadata and results.</returns>
        new public AcceptInviteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AcceptInviteResultSet results = new JavaScriptSerializer().Deserialize<AcceptInviteResultSet>(json);
    ...
    /// </summary>
    public class AcceptInviteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
