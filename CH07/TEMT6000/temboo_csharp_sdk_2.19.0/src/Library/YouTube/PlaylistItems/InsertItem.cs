...
namespace Temboo.Library.YouTube.PlaylistItems
{
    ...
    /// </summary>
    public class InsertItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the InsertItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public InsertItem(TembooSession session) : base(session, "/Library/YouTube/PlaylistItems/InsertItem")
        {
        }
        ...
        /// </summary>
        /// <returns>A InsertItemResultSet containing execution metadata and results.</returns>
        new public InsertItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InsertItemResultSet results = new JavaScriptSerializer().Deserialize<InsertItemResultSet>(json);
    ...
    /// </summary>
    public class InsertItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
