...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class CreateMediaComment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateMediaComment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateMediaComment(TembooSession session) : base(session, "/Library/Instagram/CreateMediaComment")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateMediaCommentResultSet containing execution metadata and results.</returns>
        new public CreateMediaCommentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateMediaCommentResultSet results = new JavaScriptSerializer().Deserialize<CreateMediaCommentResultSet>(json);
    ...
    /// </summary>
    public class CreateMediaCommentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
