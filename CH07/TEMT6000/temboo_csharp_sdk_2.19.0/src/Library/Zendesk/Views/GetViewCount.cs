...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class GetViewCount : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetViewCount Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetViewCount(TembooSession session) : base(session, "/Library/Zendesk/Views/GetViewCount")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetViewCountResultSet containing execution metadata and results.</returns>
        new public GetViewCountResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetViewCountResultSet results = new JavaScriptSerializer().Deserialize<GetViewCountResultSet>(json);
    ...
    /// </summary>
    public class GetViewCountResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
