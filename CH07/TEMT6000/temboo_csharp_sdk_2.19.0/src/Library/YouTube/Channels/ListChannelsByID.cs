...
namespace Temboo.Library.YouTube.Channels
{
    ...
    /// </summary>
    public class ListChannelsByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListChannelsByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListChannelsByID(TembooSession session) : base(session, "/Library/YouTube/Channels/ListChannelsByID")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListChannelsByIDResultSet containing execution metadata and results.</returns>
        new public ListChannelsByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListChannelsByIDResultSet results = new JavaScriptSerializer().Deserialize<ListChannelsByIDResultSet>(json);
    ...
    /// </summary>
    public class ListChannelsByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
