...
namespace Temboo.Library.Twilio.Calls
{
    ...
    /// </summary>
    public class GetLastCallTo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLastCallTo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLastCallTo(TembooSession session) : base(session, "/Library/Twilio/Calls/GetLastCallTo")
        {
        }
         ...
         /// <summary>
         /// (required, string) Filters results for calls to this phone number or Client identifier.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetLastCallToResultSet containing execution metadata and results.</returns>
        new public GetLastCallToResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLastCallToResultSet results = new JavaScriptSerializer().Deserialize<GetLastCallToResultSet>(json);
    ...
    /// </summary>
    public class GetLastCallToResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
