...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class User : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the User Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public User(TembooSession session) : base(session, "/Library/Facebook/Reading/User")
        {
        }
        ...
        /// </summary>
        /// <returns>A UserResultSet containing execution metadata and results.</returns>
        new public UserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UserResultSet results = new JavaScriptSerializer().Deserialize<UserResultSet>(json);
    ...
    /// </summary>
    public class UserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
