...
namespace Temboo.Library.Twitter.Favorites
{
    ...
    /// </summary>
    public class DestroyFavorite : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DestroyFavorite Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DestroyFavorite(TembooSession session) : base(session, "/Library/Twitter/Favorites/DestroyFavorite")
        {
        }
        ...
        /// </summary>
        /// <returns>A DestroyFavoriteResultSet containing execution metadata and results.</returns>
        new public DestroyFavoriteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DestroyFavoriteResultSet results = new JavaScriptSerializer().Deserialize<DestroyFavoriteResultSet>(json);
    ...
    /// </summary>
    public class DestroyFavoriteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
