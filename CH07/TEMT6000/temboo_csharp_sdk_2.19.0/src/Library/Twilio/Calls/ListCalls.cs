...
namespace Temboo.Library.Twilio.Calls
{
    ...
    /// </summary>
    public class ListCalls : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCalls Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCalls(TembooSession session) : base(session, "/Library/Twilio/Calls/ListCalls")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Filters results for calls from this phone number or Client identifier.
         /// </summary>
         ...
         /// </summary>
         /// <param name="value">Value of the ParentCallSID input for this Choreo.</param>
         public void setParentCallSID(String value) {
             base.addInput ("ParentCallSID", value);
         }
         /// <summary>
         ...
         /// <summary>
         /// (optional, string) Filters results for calls to this phone number or Client identifier.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A ListCallsResultSet containing execution metadata and results.</returns>
        new public ListCallsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCallsResultSet results = new JavaScriptSerializer().Deserialize<ListCallsResultSet>(json);
    ...
    /// </summary>
    public class ListCallsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
