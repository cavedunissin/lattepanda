...
namespace Temboo.Library.Flickr.OAuth
{
    /// <summary>
    /// FinalizeOAuth
    ...
    public class FinalizeOAuth : Temboo.Core.Choreography
    {
        ...
        public FinalizeOAuth(TembooSession session) : base(session, "/Library/Flickr/OAuth/FinalizeOAuth")
        {
        }
    ...
    public class FinalizeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The Flickr NSID (user ID) associated with the access token that is being retrieved.</returns>
        /// </summary>
        ...
        /// <returns>String - (string) The Username associated with the access token that is being retrieved.</returns>
        /// </summary>
