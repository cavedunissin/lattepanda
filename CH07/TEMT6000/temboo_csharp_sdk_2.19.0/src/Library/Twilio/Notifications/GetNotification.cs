...
namespace Temboo.Library.Twilio.Notifications
{
    ...
    /// </summary>
    public class GetNotification : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNotification Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNotification(TembooSession session) : base(session, "/Library/Twilio/Notifications/GetNotification")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetNotificationResultSet containing execution metadata and results.</returns>
        new public GetNotificationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNotificationResultSet results = new JavaScriptSerializer().Deserialize<GetNotificationResultSet>(json);
    ...
    /// </summary>
    public class GetNotificationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
