...
namespace Temboo.Library.Facebook.Actions.General.Likes
{
    ...
    /// </summary>
    public class ReadLikes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadLikes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadLikes(TembooSession session) : base(session, "/Library/Facebook/Actions/General/Likes/ReadLikes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadLikesResultSet containing execution metadata and results.</returns>
        new public ReadLikesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadLikesResultSet results = new JavaScriptSerializer().Deserialize<ReadLikesResultSet>(json);
    ...
    /// </summary>
    public class ReadLikesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
