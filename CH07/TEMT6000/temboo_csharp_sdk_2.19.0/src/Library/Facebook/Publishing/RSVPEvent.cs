...
namespace Temboo.Library.Facebook.Publishing
{
    ...
    /// </summary>
    public class RSVPEvent : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RSVPEvent Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RSVPEvent(TembooSession session) : base(session, "/Library/Facebook/Publishing/RSVPEvent")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RSVP input for this Choreo.</param>
         public void setRSVP(String value) {
             base.addInput ("RSVP", value);
         }
        ...
        /// </summary>
        /// <returns>A RSVPEventResultSet containing execution metadata and results.</returns>
        new public RSVPEventResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RSVPEventResultSet results = new JavaScriptSerializer().Deserialize<RSVPEventResultSet>(json);
    ...
    /// </summary>
    public class RSVPEventResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
