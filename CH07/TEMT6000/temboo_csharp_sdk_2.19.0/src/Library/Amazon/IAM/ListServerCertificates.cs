...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListServerCertificates : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListServerCertificates Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListServerCertificates(TembooSession session) : base(session, "/Library/Amazon/IAM/ListServerCertificates")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListServerCertificatesResultSet containing execution metadata and results.</returns>
        new public ListServerCertificatesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListServerCertificatesResultSet results = new JavaScriptSerializer().Deserialize<ListServerCertificatesResultSet>(json);
    ...
    /// </summary>
    public class ListServerCertificatesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
