...
namespace Temboo.Library.Amazon.SQS
{
    ...
    /// </summary>
    public class ChangeMessageVisibility : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ChangeMessageVisibility Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ChangeMessageVisibility(TembooSession session) : base(session, "/Library/Amazon/SQS/ChangeMessageVisibility")
        {
        }
        ...
        /// </summary>
        /// <returns>A ChangeMessageVisibilityResultSet containing execution metadata and results.</returns>
        new public ChangeMessageVisibilityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ChangeMessageVisibilityResultSet results = new JavaScriptSerializer().Deserialize<ChangeMessageVisibilityResultSet>(json);
    ...
    /// </summary>
    public class ChangeMessageVisibilityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
