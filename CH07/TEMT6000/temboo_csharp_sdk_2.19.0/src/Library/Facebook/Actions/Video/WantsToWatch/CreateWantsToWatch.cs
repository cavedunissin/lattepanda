...
namespace Temboo.Library.Facebook.Actions.Video.WantsToWatch
{
    ...
    /// </summary>
    public class CreateWantsToWatch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateWantsToWatch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateWantsToWatch(TembooSession session) : base(session, "/Library/Facebook/Actions/Video/WantsToWatch/CreateWantsToWatch")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateWantsToWatchResultSet containing execution metadata and results.</returns>
        new public CreateWantsToWatchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateWantsToWatchResultSet results = new JavaScriptSerializer().Deserialize<CreateWantsToWatchResultSet>(json);
    ...
    /// </summary>
    public class CreateWantsToWatchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
