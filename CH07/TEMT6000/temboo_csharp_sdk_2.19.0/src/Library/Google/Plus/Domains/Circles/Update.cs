...
namespace Temboo.Library.Google.Plus.Domains.Circles
{
    ...
    public class Update : Temboo.Core.Choreography
    {
        ...
        public Update(TembooSession session) : base(session, "/Library/Google/Plus/Domains/Circles/Update")
        {
        }

         /// <summary>
         /// (optional, string) A JSON-formatted string containing the circle properties you wish to set. This can be used as an alternative to setting individual inputs representing resource properties.
         /// </summary>
         /// <param name="value">Value of the CircleResource input for this Choreo.</param>
         public void setCircleResource(String value) {
             base.addInput ("CircleResource", value);
         }
         /// <summary>
         ...
         /// <summary>
         /// (optional, string) A description for the new circle being created.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The circle name.
         /// </summary>
