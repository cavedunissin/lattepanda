...
namespace Temboo.Library.Foursquare.Checkins
{
    ...
    /// </summary>
    public class CheckinDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CheckinDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CheckinDetails(TembooSession session) : base(session, "/Library/Foursquare/Checkins/CheckinDetails")
        {
        }
        ...
        /// </summary>
        /// <returns>A CheckinDetailsResultSet containing execution metadata and results.</returns>
        new public CheckinDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CheckinDetailsResultSet results = new JavaScriptSerializer().Deserialize<CheckinDetailsResultSet>(json);
    ...
    /// </summary>
    public class CheckinDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
