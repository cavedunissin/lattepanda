...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class CreatePhotoPostWithURL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreatePhotoPostWithURL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreatePhotoPostWithURL(TembooSession session) : base(session, "/Library/Tumblr/Post/CreatePhotoPostWithURL")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreatePhotoPostWithURLResultSet containing execution metadata and results.</returns>
        new public CreatePhotoPostWithURLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreatePhotoPostWithURLResultSet results = new JavaScriptSerializer().Deserialize<CreatePhotoPostWithURLResultSet>(json);
    ...
    /// </summary>
    public class CreatePhotoPostWithURLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
