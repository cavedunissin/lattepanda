...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Music : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Music Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Music(TembooSession session) : base(session, "/Library/Facebook/Reading/Music")
        {
        }
        ...
        /// </summary>
        /// <returns>A MusicResultSet containing execution metadata and results.</returns>
        new public MusicResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MusicResultSet results = new JavaScriptSerializer().Deserialize<MusicResultSet>(json);
    ...
    /// </summary>
    public class MusicResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
