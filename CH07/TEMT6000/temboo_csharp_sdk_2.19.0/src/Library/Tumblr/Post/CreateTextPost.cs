...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class CreateTextPost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateTextPost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateTextPost(TembooSession session) : base(session, "/Library/Tumblr/Post/CreateTextPost")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateTextPostResultSet containing execution metadata and results.</returns>
        new public CreateTextPostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateTextPostResultSet results = new JavaScriptSerializer().Deserialize<CreateTextPostResultSet>(json);
    ...
    /// </summary>
    public class CreateTextPostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Response" output from this Choreo execution
        /// <returns>String - The format that the response should be in. Can be set to xml or json. Defaults to json.</returns>
        /// </summary>
