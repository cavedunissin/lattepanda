...
namespace Temboo.Library.Disqus.Forums
{
    ...
    /// </summary>
    public class ListModerators : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListModerators Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListModerators(TembooSession session) : base(session, "/Library/Disqus/Forums/ListModerators")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListModeratorsResultSet containing execution metadata and results.</returns>
        new public ListModeratorsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListModeratorsResultSet results = new JavaScriptSerializer().Deserialize<ListModeratorsResultSet>(json);
    ...
    /// </summary>
    public class ListModeratorsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
