...
namespace Temboo.Library.Disqus.Posts
{
    ...
    /// Remove a post.
    /// </summary>
    public class RemovePost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RemovePost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RemovePost(TembooSession session) : base(session, "/Library/Disqus/Posts/RemovePost")
        {
        }
        ...
        /// </summary>
        /// <returns>A RemovePostResultSet containing execution metadata and results.</returns>
        new public RemovePostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RemovePostResultSet results = new JavaScriptSerializer().Deserialize<RemovePostResultSet>(json);
    ...
    /// </summary>
    public class RemovePostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
