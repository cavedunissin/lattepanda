...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class ListActiveViews : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListActiveViews Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListActiveViews(TembooSession session) : base(session, "/Library/Zendesk/Views/ListActiveViews")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListActiveViewsResultSet containing execution metadata and results.</returns>
        new public ListActiveViewsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListActiveViewsResultSet results = new JavaScriptSerializer().Deserialize<ListActiveViewsResultSet>(json);
    ...
    /// </summary>
    public class ListActiveViewsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
