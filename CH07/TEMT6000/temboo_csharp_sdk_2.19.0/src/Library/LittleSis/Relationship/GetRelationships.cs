...
namespace Temboo.Library.LittleSis.Relationship
{
    ...
    /// </summary>
    public class GetRelationships : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRelationships Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRelationships(TembooSession session) : base(session, "/Library/LittleSis/Relationship/GetRelationships")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RelationshipID input for this Choreo.</param>
         public void setRelationshipID(String value) {
             base.addInput ("RelationshipID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetRelationshipsResultSet containing execution metadata and results.</returns>
        new public GetRelationshipsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRelationshipsResultSet results = new JavaScriptSerializer().Deserialize<GetRelationshipsResultSet>(json);
    ...
    /// </summary>
    public class GetRelationshipsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
