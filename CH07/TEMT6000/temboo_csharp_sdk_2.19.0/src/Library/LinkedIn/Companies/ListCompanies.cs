...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class ListCompanies : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCompanies Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCompanies(TembooSession session) : base(session, "/Library/LinkedIn/Companies/ListCompanies")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListCompaniesResultSet containing execution metadata and results.</returns>
        new public ListCompaniesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCompaniesResultSet results = new JavaScriptSerializer().Deserialize<ListCompaniesResultSet>(json);
    ...
    /// </summary>
    public class ListCompaniesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
