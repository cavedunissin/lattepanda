...
namespace Temboo.Library.Facebook.Actions.Fitness.Runs
{
    ...
    /// </summary>
    public class CreateRun : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateRun Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateRun(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Runs/CreateRun")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateRunResultSet containing execution metadata and results.</returns>
        new public CreateRunResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateRunResultSet results = new JavaScriptSerializer().Deserialize<CreateRunResultSet>(json);
    ...
    /// </summary>
    public class CreateRunResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
