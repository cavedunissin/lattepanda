...
namespace Temboo.Library.Foursquare.Lists
{
    ...
    /// </summary>
    public class ListDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListDetails(TembooSession session) : base(session, "/Library/Foursquare/Lists/ListDetails")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListDetailsResultSet containing execution metadata and results.</returns>
        new public ListDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListDetailsResultSet results = new JavaScriptSerializer().Deserialize<ListDetailsResultSet>(json);
    ...
    /// </summary>
    public class ListDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
