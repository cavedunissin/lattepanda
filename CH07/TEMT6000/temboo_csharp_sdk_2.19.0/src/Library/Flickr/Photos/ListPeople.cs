...
namespace Temboo.Library.Flickr.Photos
{
    ...
    /// </summary>
    public class ListPeople : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListPeople Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListPeople(TembooSession session) : base(session, "/Library/Flickr/Photos/ListPeople")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListPeopleResultSet containing execution metadata and results.</returns>
        new public ListPeopleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListPeopleResultSet results = new JavaScriptSerializer().Deserialize<ListPeopleResultSet>(json);
    ...
    /// </summary>
    public class ListPeopleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
