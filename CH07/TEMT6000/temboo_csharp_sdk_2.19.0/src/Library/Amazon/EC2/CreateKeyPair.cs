...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class CreateKeyPair : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateKeyPair Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateKeyPair(TembooSession session) : base(session, "/Library/Amazon/EC2/CreateKeyPair")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateKeyPairResultSet containing execution metadata and results.</returns>
        new public CreateKeyPairResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateKeyPairResultSet results = new JavaScriptSerializer().Deserialize<CreateKeyPairResultSet>(json);
    ...
    /// </summary>
    public class CreateKeyPairResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
