...
namespace Temboo.Library.PagerDuty.LogEntries
{
    ...
    /// </summary>
    public class ListLogEntries : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListLogEntries Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListLogEntries(TembooSession session) : base(session, "/Library/PagerDuty/LogEntries/ListLogEntries")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListLogEntriesResultSet containing execution metadata and results.</returns>
        new public ListLogEntriesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListLogEntriesResultSet results = new JavaScriptSerializer().Deserialize<ListLogEntriesResultSet>(json);
    ...
    /// </summary>
    public class ListLogEntriesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
