...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListMFADevices : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMFADevices Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMFADevices(TembooSession session) : base(session, "/Library/Amazon/IAM/ListMFADevices")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMFADevicesResultSet containing execution metadata and results.</returns>
        new public ListMFADevicesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMFADevicesResultSet results = new JavaScriptSerializer().Deserialize<ListMFADevicesResultSet>(json);
    ...
    /// </summary>
    public class ListMFADevicesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
