...
namespace Temboo.Library.Facebook.Actions.Fitness.Bikes
{
    ...
    /// </summary>
    public class CreateBike : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateBike Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateBike(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Bikes/CreateBike")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateBikeResultSet containing execution metadata and results.</returns>
        new public CreateBikeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateBikeResultSet results = new JavaScriptSerializer().Deserialize<CreateBikeResultSet>(json);
    ...
    /// </summary>
    public class CreateBikeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
