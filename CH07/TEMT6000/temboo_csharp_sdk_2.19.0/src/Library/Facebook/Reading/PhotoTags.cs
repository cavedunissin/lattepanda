...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class PhotoTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PhotoTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PhotoTags(TembooSession session) : base(session, "/Library/Facebook/Reading/PhotoTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A PhotoTagsResultSet containing execution metadata and results.</returns>
        new public PhotoTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PhotoTagsResultSet results = new JavaScriptSerializer().Deserialize<PhotoTagsResultSet>(json);
    ...
    /// </summary>
    public class PhotoTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
