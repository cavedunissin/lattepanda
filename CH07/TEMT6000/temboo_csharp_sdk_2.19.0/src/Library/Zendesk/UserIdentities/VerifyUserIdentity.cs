...
namespace Temboo.Library.Zendesk.UserIdentities
{
    ...
    /// </summary>
    public class VerifyUserIdentity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VerifyUserIdentity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VerifyUserIdentity(TembooSession session) : base(session, "/Library/Zendesk/UserIdentities/VerifyUserIdentity")
        {
        }
        ...
        /// </summary>
        /// <returns>A VerifyUserIdentityResultSet containing execution metadata and results.</returns>
        new public VerifyUserIdentityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VerifyUserIdentityResultSet results = new JavaScriptSerializer().Deserialize<VerifyUserIdentityResultSet>(json);
    ...
    /// </summary>
    public class VerifyUserIdentityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
