...
namespace Temboo.Library.USPS.DeliveryInformationAPI
{
    ...
    /// </summary>
    public class TrackConfirm : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TrackConfirm Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TrackConfirm(TembooSession session) : base(session, "/Library/USPS/DeliveryInformationAPI/TrackConfirm")
        {
        }
        ...
        /// </summary>
        /// <returns>A TrackConfirmResultSet containing execution metadata and results.</returns>
        new public TrackConfirmResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TrackConfirmResultSet results = new JavaScriptSerializer().Deserialize<TrackConfirmResultSet>(json);
    ...
    /// </summary>
    public class TrackConfirmResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
