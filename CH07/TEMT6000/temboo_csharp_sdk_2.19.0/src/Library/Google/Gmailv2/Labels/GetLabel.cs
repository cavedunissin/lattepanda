...
namespace Temboo.Library.Google.Gmailv2.Labels
{
    ...
    /// </summary>
    public class GetLabel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLabel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLabel(TembooSession session) : base(session, "/Library/Google/Gmailv2/Labels/GetLabel")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLabelResultSet containing execution metadata and results.</returns>
        new public GetLabelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLabelResultSet results = new JavaScriptSerializer().Deserialize<GetLabelResultSet>(json);
    ...
    /// </summary>
    public class GetLabelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
