...
namespace Temboo.Library.Twilio.Recordings
{
    ...
    /// </summary>
    public class GetLastRecording : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLastRecording Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLastRecording(TembooSession session) : base(session, "/Library/Twilio/Recordings/GetLastRecording")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLastRecordingResultSet containing execution metadata and results.</returns>
        new public GetLastRecordingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLastRecordingResultSet results = new JavaScriptSerializer().Deserialize<GetLastRecordingResultSet>(json);
    ...
    /// </summary>
    public class GetLastRecordingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
