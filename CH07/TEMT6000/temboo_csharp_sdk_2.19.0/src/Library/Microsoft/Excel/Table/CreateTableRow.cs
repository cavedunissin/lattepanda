...
namespace Temboo.Library.Microsoft.Excel.Table
{
    ...
    /// </summary>
    public class CreateTableRow : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateTableRow Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateTableRow(TembooSession session) : base(session, "/Library/Microsoft/Excel/Table/CreateTableRow")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateTableRowResultSet containing execution metadata and results.</returns>
        new public CreateTableRowResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateTableRowResultSet results = new JavaScriptSerializer().Deserialize<CreateTableRowResultSet>(json);
    ...
    /// </summary>
    public class CreateTableRowResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
