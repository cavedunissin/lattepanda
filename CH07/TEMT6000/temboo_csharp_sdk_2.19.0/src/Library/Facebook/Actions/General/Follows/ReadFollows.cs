...
namespace Temboo.Library.Facebook.Actions.General.Follows
{
    ...
    /// </summary>
    public class ReadFollows : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadFollows Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadFollows(TembooSession session) : base(session, "/Library/Facebook/Actions/General/Follows/ReadFollows")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadFollowsResultSet containing execution metadata and results.</returns>
        new public ReadFollowsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadFollowsResultSet results = new JavaScriptSerializer().Deserialize<ReadFollowsResultSet>(json);
    ...
    /// </summary>
    public class ReadFollowsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
