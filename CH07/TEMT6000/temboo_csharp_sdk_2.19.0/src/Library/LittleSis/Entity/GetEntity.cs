...
namespace Temboo.Library.LittleSis.Entity
{
    ...
    /// </summary>
    public class GetEntity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEntity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEntity(TembooSession session) : base(session, "/Library/LittleSis/Entity/GetEntity")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetEntityResultSet containing execution metadata and results.</returns>
        new public GetEntityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEntityResultSet results = new JavaScriptSerializer().Deserialize<GetEntityResultSet>(json);
    ...
    /// </summary>
    public class GetEntityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
