...
namespace Temboo.Library.Salesforce.Objects
{
    ...
    /// </summary>
    public class ListObjectTypes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListObjectTypes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListObjectTypes(TembooSession session) : base(session, "/Library/Salesforce/Objects/ListObjectTypes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListObjectTypesResultSet containing execution metadata and results.</returns>
        new public ListObjectTypesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListObjectTypesResultSet results = new JavaScriptSerializer().Deserialize<ListObjectTypesResultSet>(json);
    ...
    /// </summary>
    public class ListObjectTypesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
