...
namespace Temboo.Library.Amazon.SNS
{
    ...
    /// </summary>
    public class ListSubscriptionsByTopic : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListSubscriptionsByTopic Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListSubscriptionsByTopic(TembooSession session) : base(session, "/Library/Amazon/SNS/ListSubscriptionsByTopic")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListSubscriptionsByTopicResultSet containing execution metadata and results.</returns>
        new public ListSubscriptionsByTopicResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListSubscriptionsByTopicResultSet results = new JavaScriptSerializer().Deserialize<ListSubscriptionsByTopicResultSet>(json);
    ...
    /// </summary>
    public class ListSubscriptionsByTopicResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
