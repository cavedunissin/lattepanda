...
namespace Temboo.Library.Zendesk.TicketMetrics
{
    /// <summary>
    /// ListTicketMetrics
    /// Retrieves a list of metrics for all available tickets.
    /// </summary>
    public class ListTicketMetrics : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTicketMetrics Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTicketMetrics(TembooSession session) : base(session, "/Library/Zendesk/TicketMetrics/ListTicketMetrics")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTicketMetricsResultSet containing execution metadata and results.</returns>
        new public ListTicketMetricsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTicketMetricsResultSet results = new JavaScriptSerializer().Deserialize<ListTicketMetricsResultSet>(json);
    ...
    /// </summary>
    public class ListTicketMetricsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
