...
namespace Temboo.Library.Google.ComputeEngine.GlobalOperations
{
    ...
    /// </summary>
    public class GetGlobalOperation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetGlobalOperation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetGlobalOperation(TembooSession session) : base(session, "/Library/Google/ComputeEngine/GlobalOperations/GetGlobalOperation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetGlobalOperationResultSet containing execution metadata and results.</returns>
        new public GetGlobalOperationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetGlobalOperationResultSet results = new JavaScriptSerializer().Deserialize<GetGlobalOperationResultSet>(json);
    ...
    /// </summary>
    public class GetGlobalOperationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
