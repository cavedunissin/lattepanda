...
namespace Temboo.Library.Facebook.Actions.Fitness.Bikes
{
    ...
    /// </summary>
    public class ReadBikes : Temboo.Core.Choreography
    {
        ...
        public ReadBikes(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Bikes/ReadBikes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadBikesResultSet containing execution metadata and results.</returns>
        new public ReadBikesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadBikesResultSet results = new JavaScriptSerializer().Deserialize<ReadBikesResultSet>(json);
    ...
    /// </summary>
    public class ReadBikesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
