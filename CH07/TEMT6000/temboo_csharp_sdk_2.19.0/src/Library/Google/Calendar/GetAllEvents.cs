...
namespace Temboo.Library.Google.Calendar
{
    ...
    /// </summary>
    public class GetAllEvents : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAllEvents Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAllEvents(TembooSession session) : base(session, "/Library/Google/Calendar/GetAllEvents")
        {
        }
         ...
         /// <summary>
         /// (optional, integer) Maximum number of events returned on one result page.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetAllEventsResultSet containing execution metadata and results.</returns>
        new public GetAllEventsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAllEventsResultSet results = new JavaScriptSerializer().Deserialize<GetAllEventsResultSet>(json);
    ...
    /// </summary>
    public class GetAllEventsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
