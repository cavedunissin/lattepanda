...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class DeletePost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeletePost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeletePost(TembooSession session) : base(session, "/Library/Tumblr/Post/DeletePost")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeletePostResultSet containing execution metadata and results.</returns>
        new public DeletePostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeletePostResultSet results = new JavaScriptSerializer().Deserialize<DeletePostResultSet>(json);
    ...
    /// </summary>
    public class DeletePostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
