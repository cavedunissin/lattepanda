...
namespace Temboo.Library.Amazon.SQS
{
    ...
    /// </summary>
    public class SetQueueAttributes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SetQueueAttributes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SetQueueAttributes(TembooSession session) : base(session, "/Library/Amazon/SQS/SetQueueAttributes")
        {
        }
        ...
        /// </summary>
        /// <returns>A SetQueueAttributesResultSet containing execution metadata and results.</returns>
        new public SetQueueAttributesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SetQueueAttributesResultSet results = new JavaScriptSerializer().Deserialize<SetQueueAttributesResultSet>(json);
    ...
    /// </summary>
    public class SetQueueAttributesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
