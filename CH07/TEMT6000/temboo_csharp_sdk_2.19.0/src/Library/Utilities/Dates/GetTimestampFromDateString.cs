...
namespace Temboo.Library.Utilities.Dates
{
    ...
    /// </summary>
    public class GetTimestampFromDateString : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTimestampFromDateString Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTimestampFromDateString(TembooSession session) : base(session, "/Library/Utilities/Dates/GetTimestampFromDateString")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTimestampFromDateStringResultSet containing execution metadata and results.</returns>
        new public GetTimestampFromDateStringResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTimestampFromDateStringResultSet results = new JavaScriptSerializer().Deserialize<GetTimestampFromDateStringResultSet>(json);
    ...
    /// </summary>
    public class GetTimestampFromDateStringResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
