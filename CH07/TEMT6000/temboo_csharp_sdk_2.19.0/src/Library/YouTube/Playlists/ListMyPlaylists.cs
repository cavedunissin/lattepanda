...
namespace Temboo.Library.YouTube.Playlists
{
    ...
    /// </summary>
    public class ListMyPlaylists : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMyPlaylists Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMyPlaylists(TembooSession session) : base(session, "/Library/YouTube/Playlists/ListMyPlaylists")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMyPlaylistsResultSet containing execution metadata and results.</returns>
        new public ListMyPlaylistsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMyPlaylistsResultSet results = new JavaScriptSerializer().Deserialize<ListMyPlaylistsResultSet>(json);
    ...
    /// </summary>
    public class ListMyPlaylistsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
