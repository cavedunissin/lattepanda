...
namespace Temboo.Library.Dropbox.FilesAndMetadata
{
    ...
    /// </summary>
    public class LatestCursor : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LatestCursor Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LatestCursor(TembooSession session) : base(session, "/Library/Dropbox/FilesAndMetadata/LatestCursor")
        {
        }
        ...
        /// </summary>
        /// <returns>A LatestCursorResultSet containing execution metadata and results.</returns>
        new public LatestCursorResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LatestCursorResultSet results = new JavaScriptSerializer().Deserialize<LatestCursorResultSet>(json);
    ...
    /// </summary>
    public class LatestCursorResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
