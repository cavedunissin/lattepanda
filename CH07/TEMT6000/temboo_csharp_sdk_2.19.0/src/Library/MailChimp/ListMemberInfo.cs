...
namespace Temboo.Library.MailChimp
{
    ...
    /// </summary>
    public class ListMemberInfo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMemberInfo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMemberInfo(TembooSession session) : base(session, "/Library/MailChimp/ListMemberInfo")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMemberInfoResultSet containing execution metadata and results.</returns>
        new public ListMemberInfoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMemberInfoResultSet results = new JavaScriptSerializer().Deserialize<ListMemberInfoResultSet>(json);
    ...
    /// </summary>
    public class ListMemberInfoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
