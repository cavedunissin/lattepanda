...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class GetCompanyUpdate : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCompanyUpdate Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCompanyUpdate(TembooSession session) : base(session, "/Library/LinkedIn/Companies/GetCompanyUpdate")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCompanyUpdateResultSet containing execution metadata and results.</returns>
        new public GetCompanyUpdateResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCompanyUpdateResultSet results = new JavaScriptSerializer().Deserialize<GetCompanyUpdateResultSet>(json);
    ...
    /// </summary>
    public class GetCompanyUpdateResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
