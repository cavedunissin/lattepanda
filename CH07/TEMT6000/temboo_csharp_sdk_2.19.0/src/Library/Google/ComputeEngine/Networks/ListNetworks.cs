...
namespace Temboo.Library.Google.ComputeEngine.Networks
{
    ...
    /// </summary>
    public class ListNetworks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListNetworks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListNetworks(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Networks/ListNetworks")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListNetworksResultSet containing execution metadata and results.</returns>
        new public ListNetworksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListNetworksResultSet results = new JavaScriptSerializer().Deserialize<ListNetworksResultSet>(json);
    ...
    /// </summary>
    public class ListNetworksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
