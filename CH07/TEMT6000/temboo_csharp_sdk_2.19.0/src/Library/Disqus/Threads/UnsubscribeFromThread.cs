...
namespace Temboo.Library.Disqus.Threads
{
    ...
    /// </summary>
    public class UnsubscribeFromThread : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnsubscribeFromThread Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnsubscribeFromThread(TembooSession session) : base(session, "/Library/Disqus/Threads/UnsubscribeFromThread")
        {
        }

         /// <summary>
         /// (conditional, string) The email address that will be unsubsribed from the thread.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) Forum Short Name (i.e., the subdomain of the Disqus Site URL) of a thread that is to be unsubscribed from. Required if setting either ThreadByIdentification, or ThreadByLink.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) The identifier for the thread that is to be unsubscribed from.  Note that a Forum must also be provided when using this parameter. If set, ThreadID and ThreadLink cannot be used.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) A link pointing to the thread that is to be unsubscribed from. Note that a Forum must also be provided when using this parameter. If set, ThreadID and ThreadIdentifier cannot be set.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A UnsubscribeFromThreadResultSet containing execution metadata and results.</returns>
        new public UnsubscribeFromThreadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnsubscribeFromThreadResultSet results = new JavaScriptSerializer().Deserialize<UnsubscribeFromThreadResultSet>(json);
    ...
    /// </summary>
    public class UnsubscribeFromThreadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
