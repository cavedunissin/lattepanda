...
namespace Temboo.Library.Zendesk.Users
{
    ...
    /// </summary>
    public class UpdateUserImage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateUserImage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateUserImage(TembooSession session) : base(session, "/Library/Zendesk/Users/UpdateUserImage")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateUserImageResultSet containing execution metadata and results.</returns>
        new public UpdateUserImageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateUserImageResultSet results = new JavaScriptSerializer().Deserialize<UpdateUserImageResultSet>(json);
    ...
    /// </summary>
    public class UpdateUserImageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Response" output from this Choreo execution
        /// <returns>String - (required, json) The response from Zendesk.</returns>
        /// </summary>
