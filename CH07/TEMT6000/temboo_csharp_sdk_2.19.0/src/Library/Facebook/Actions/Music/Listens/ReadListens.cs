...
namespace Temboo.Library.Facebook.Actions.Music.Listens
{
    ...
    /// </summary>
    public class ReadListens : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadListens Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadListens(TembooSession session) : base(session, "/Library/Facebook/Actions/Music/Listens/ReadListens")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadListensResultSet containing execution metadata and results.</returns>
        new public ReadListensResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadListensResultSet results = new JavaScriptSerializer().Deserialize<ReadListensResultSet>(json);
    ...
    /// </summary>
    public class ReadListensResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
