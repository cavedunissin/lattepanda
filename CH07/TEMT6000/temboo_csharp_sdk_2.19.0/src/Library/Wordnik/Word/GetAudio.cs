...
namespace Temboo.Library.Wordnik.Word
{
    ...
    /// </summary>
    public class GetAudio : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAudio Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAudio(TembooSession session) : base(session, "/Library/Wordnik/Word/GetAudio")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAudioResultSet containing execution metadata and results.</returns>
        new public GetAudioResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAudioResultSet results = new JavaScriptSerializer().Deserialize<GetAudioResultSet>(json);
    ...
    /// </summary>
    public class GetAudioResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
