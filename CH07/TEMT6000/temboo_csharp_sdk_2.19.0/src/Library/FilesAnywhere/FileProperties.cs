...
namespace Temboo.Library.FilesAnywhere
{
    ...
    /// </summary>
    public class FileProperties : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FileProperties Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FileProperties(TembooSession session) : base(session, "/Library/FilesAnywhere/FileProperties")
        {
        }
        ...
        /// </summary>
        /// <returns>A FilePropertiesResultSet containing execution metadata and results.</returns>
        new public FilePropertiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FilePropertiesResultSet results = new JavaScriptSerializer().Deserialize<FilePropertiesResultSet>(json);
    ...
    /// </summary>
    public class FilePropertiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
