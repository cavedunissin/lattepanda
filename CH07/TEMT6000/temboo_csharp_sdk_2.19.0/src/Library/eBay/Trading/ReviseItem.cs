...
namespace Temboo.Library.eBay.Trading
{
    ...
    /// </summary>
    public class ReviseItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReviseItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReviseItem(TembooSession session) : base(session, "/Library/eBay/Trading/ReviseItem")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ReviseItemRequest input for this Choreo.</param>
         public void setReviseItemRequest(String value) {
             base.addInput ("ReviseItemRequest", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ReviseItemResultSet containing execution metadata and results.</returns>
        new public ReviseItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReviseItemResultSet results = new JavaScriptSerializer().Deserialize<ReviseItemResultSet>(json);
    ...
    /// </summary>
    public class ReviseItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
