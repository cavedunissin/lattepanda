...
namespace Temboo.Library.Bitly.LinkMetrics
{
    ...
    /// </summary>
    public class GetCountryMetricsForLink : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCountryMetricsForLink Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCountryMetricsForLink(TembooSession session) : base(session, "/Library/Bitly/LinkMetrics/GetCountryMetricsForLink")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCountryMetricsForLinkResultSet containing execution metadata and results.</returns>
        new public GetCountryMetricsForLinkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCountryMetricsForLinkResultSet results = new JavaScriptSerializer().Deserialize<GetCountryMetricsForLinkResultSet>(json);
    ...
    /// </summary>
    public class GetCountryMetricsForLinkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
