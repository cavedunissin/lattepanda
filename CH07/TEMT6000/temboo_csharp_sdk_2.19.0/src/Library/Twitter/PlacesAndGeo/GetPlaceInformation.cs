...
namespace Temboo.Library.Twitter.PlacesAndGeo
{
    ...
    /// </summary>
    public class GetPlaceInformation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPlaceInformation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPlaceInformation(TembooSession session) : base(session, "/Library/Twitter/PlacesAndGeo/GetPlaceInformation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPlaceInformationResultSet containing execution metadata and results.</returns>
        new public GetPlaceInformationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPlaceInformationResultSet results = new JavaScriptSerializer().Deserialize<GetPlaceInformationResultSet>(json);
    ...
    /// </summary>
    public class GetPlaceInformationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
