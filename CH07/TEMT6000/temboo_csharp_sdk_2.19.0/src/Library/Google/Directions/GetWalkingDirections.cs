...
namespace Temboo.Library.Google.Directions
{
    ...
    /// </summary>
    public class GetWalkingDirections : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetWalkingDirections Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetWalkingDirections(TembooSession session) : base(session, "/Library/Google/Directions/GetWalkingDirections")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetWalkingDirectionsResultSet containing execution metadata and results.</returns>
        new public GetWalkingDirectionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetWalkingDirectionsResultSet results = new JavaScriptSerializer().Deserialize<GetWalkingDirectionsResultSet>(json);
    ...
    /// </summary>
    public class GetWalkingDirectionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
