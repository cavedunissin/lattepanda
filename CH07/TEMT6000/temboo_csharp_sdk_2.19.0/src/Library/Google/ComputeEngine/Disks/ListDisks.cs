...
namespace Temboo.Library.Google.ComputeEngine.Disks
{
    ...
    /// </summary>
    public class ListDisks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListDisks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListDisks(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Disks/ListDisks")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListDisksResultSet containing execution metadata and results.</returns>
        new public ListDisksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListDisksResultSet results = new JavaScriptSerializer().Deserialize<ListDisksResultSet>(json);
    ...
    /// </summary>
    public class ListDisksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
