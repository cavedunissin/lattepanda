...
namespace Temboo.Library.SendGrid.NewsletterAPI.Schedule
{
    ...
    /// </summary>
    public class DeleteScheduledDeliveryTime : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteScheduledDeliveryTime Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteScheduledDeliveryTime(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Schedule/DeleteScheduledDeliveryTime")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteScheduledDeliveryTimeResultSet containing execution metadata and results.</returns>
        new public DeleteScheduledDeliveryTimeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteScheduledDeliveryTimeResultSet results = new JavaScriptSerializer().Deserialize<DeleteScheduledDeliveryTimeResultSet>(json);
    ...
    /// </summary>
    public class DeleteScheduledDeliveryTimeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
