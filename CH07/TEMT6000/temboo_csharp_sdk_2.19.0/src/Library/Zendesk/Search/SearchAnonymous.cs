...
namespace Temboo.Library.Zendesk.Search
{
    ...
    /// </summary>
    public class SearchAnonymous : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchAnonymous Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchAnonymous(TembooSession session) : base(session, "/Library/Zendesk/Search/SearchAnonymous")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchAnonymousResultSet containing execution metadata and results.</returns>
        new public SearchAnonymousResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchAnonymousResultSet results = new JavaScriptSerializer().Deserialize<SearchAnonymousResultSet>(json);
    ...
    /// </summary>
    public class SearchAnonymousResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
