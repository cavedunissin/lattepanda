...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class AddFavoriteActivity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddFavoriteActivity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddFavoriteActivity(TembooSession session) : base(session, "/Library/Fitbit/Activities/AddFavoriteActivity")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddFavoriteActivityResultSet containing execution metadata and results.</returns>
        new public AddFavoriteActivityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddFavoriteActivityResultSet results = new JavaScriptSerializer().Deserialize<AddFavoriteActivityResultSet>(json);
    ...
    /// </summary>
    public class AddFavoriteActivityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
