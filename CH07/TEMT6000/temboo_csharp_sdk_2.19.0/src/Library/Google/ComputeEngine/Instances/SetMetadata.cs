...
namespace Temboo.Library.Google.ComputeEngine.Instances
{
    ...
    /// </summary>
    public class SetMetadata : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SetMetadata Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SetMetadata(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Instances/SetMetadata")
        {
        }
        ...
        /// </summary>
        /// <returns>A SetMetadataResultSet containing execution metadata and results.</returns>
        new public SetMetadataResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SetMetadataResultSet results = new JavaScriptSerializer().Deserialize<SetMetadataResultSet>(json);
    ...
    /// </summary>
    public class SetMetadataResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
