...
namespace Temboo.Library.Amazon.Marketplace.Reports
{
    ...
    /// </summary>
    public class MerchantListingsReport : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the MerchantListingsReport Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public MerchantListingsReport(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Reports/MerchantListingsReport")
        {
        }
        ...
        /// </summary>
        /// <returns>A MerchantListingsReportResultSet containing execution metadata and results.</returns>
        new public MerchantListingsReportResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MerchantListingsReportResultSet results = new JavaScriptSerializer().Deserialize<MerchantListingsReportResultSet>(json);
    ...
    /// </summary>
    public class MerchantListingsReportResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
