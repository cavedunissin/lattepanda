...
namespace Temboo.Library.FilesAnywhere
{
    ...
    /// List user volumes.
    /// </summary>
    public class ListUserVolumes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListUserVolumes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListUserVolumes(TembooSession session) : base(session, "/Library/FilesAnywhere/ListUserVolumes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListUserVolumesResultSet containing execution metadata and results.</returns>
        new public ListUserVolumesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListUserVolumesResultSet results = new JavaScriptSerializer().Deserialize<ListUserVolumesResultSet>(json);
    ...
    /// </summary>
    public class ListUserVolumesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
