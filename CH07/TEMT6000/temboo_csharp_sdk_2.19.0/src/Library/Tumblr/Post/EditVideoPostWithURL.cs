...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class EditVideoPostWithURL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EditVideoPostWithURL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EditVideoPostWithURL(TembooSession session) : base(session, "/Library/Tumblr/Post/EditVideoPostWithURL")
        {
        }
        ...
        /// </summary>
        /// <returns>A EditVideoPostWithURLResultSet containing execution metadata and results.</returns>
        new public EditVideoPostWithURLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EditVideoPostWithURLResultSet results = new JavaScriptSerializer().Deserialize<EditVideoPostWithURLResultSet>(json);
    ...
    /// </summary>
    public class EditVideoPostWithURLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
