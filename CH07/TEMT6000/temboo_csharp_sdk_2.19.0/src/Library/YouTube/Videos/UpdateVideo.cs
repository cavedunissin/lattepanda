...
namespace Temboo.Library.YouTube.Videos
{
    /// <summary>
    /// UpdateVideo
    /// Updates a video's metadata.
    /// </summary>
    public class UpdateVideo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateVideo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateVideo(TembooSession session) : base(session, "/Library/YouTube/Videos/UpdateVideo")
        {
        }

         /// <summary>
         /// (required, json) A JSON representation of the video resource containing fields to update. The id key for the video is required for updates. See documentation for examples.
         /// </summary>
         /// <param name="value">Value of the VideoMetadata input for this Choreo.</param>
         public void setVideoMetadata(String value) {
             base.addInput ("VideoMetadata", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateVideoResultSet containing execution metadata and results.</returns>
        new public UpdateVideoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateVideoResultSet results = new JavaScriptSerializer().Deserialize<UpdateVideoResultSet>(json);
    ...
    /// </summary>
    public class UpdateVideoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
