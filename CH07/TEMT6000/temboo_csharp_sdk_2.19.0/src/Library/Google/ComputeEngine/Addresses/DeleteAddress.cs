...
namespace Temboo.Library.Google.ComputeEngine.Addresses
{
    ...
    /// </summary>
    public class DeleteAddress : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteAddress Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteAddress(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Addresses/DeleteAddress")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteAddressResultSet containing execution metadata and results.</returns>
        new public DeleteAddressResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteAddressResultSet results = new JavaScriptSerializer().Deserialize<DeleteAddressResultSet>(json);
    ...
    /// </summary>
    public class DeleteAddressResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
