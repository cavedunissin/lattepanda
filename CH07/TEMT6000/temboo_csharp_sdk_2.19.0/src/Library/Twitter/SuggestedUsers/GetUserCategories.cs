...
namespace Temboo.Library.Twitter.SuggestedUsers
{
    ...
    /// </summary>
    public class GetUserCategories : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUserCategories Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUserCategories(TembooSession session) : base(session, "/Library/Twitter/SuggestedUsers/GetUserCategories")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUserCategoriesResultSet containing execution metadata and results.</returns>
        new public GetUserCategoriesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUserCategoriesResultSet results = new JavaScriptSerializer().Deserialize<GetUserCategoriesResultSet>(json);
    ...
    /// </summary>
    public class GetUserCategoriesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
