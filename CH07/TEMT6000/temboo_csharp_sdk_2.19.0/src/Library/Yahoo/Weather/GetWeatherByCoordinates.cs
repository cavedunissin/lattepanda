...
namespace Temboo.Library.Yahoo.Weather
{
    ...
    /// </summary>
    public class GetWeatherByCoordinates : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetWeatherByCoordinates Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetWeatherByCoordinates(TembooSession session) : base(session, "/Library/Yahoo/Weather/GetWeatherByCoordinates")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetWeatherByCoordinatesResultSet containing execution metadata and results.</returns>
        new public GetWeatherByCoordinatesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetWeatherByCoordinatesResultSet results = new JavaScriptSerializer().Deserialize<GetWeatherByCoordinatesResultSet>(json);
    ...
    /// </summary>
    public class GetWeatherByCoordinatesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
