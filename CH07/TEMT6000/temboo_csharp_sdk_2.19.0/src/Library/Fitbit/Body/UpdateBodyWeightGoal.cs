...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class UpdateBodyWeightGoal : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateBodyWeightGoal Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateBodyWeightGoal(TembooSession session) : base(session, "/Library/Fitbit/Body/UpdateBodyWeightGoal")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the StartWeight input for this Choreo.</param>
         public void setStartWeight(String value) {
             base.addInput ("StartWeight", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the Weight input for this Choreo.</param>
         public void setWeight(String value) {
             base.addInput ("Weight", value);
         }
        ...
        /// </summary>
        /// <returns>A UpdateBodyWeightGoalResultSet containing execution metadata and results.</returns>
        new public UpdateBodyWeightGoalResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateBodyWeightGoalResultSet results = new JavaScriptSerializer().Deserialize<UpdateBodyWeightGoalResultSet>(json);
    ...
    /// </summary>
    public class UpdateBodyWeightGoalResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
