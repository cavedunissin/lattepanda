...
namespace Temboo.Library.Stripe.Invoices
{
    ...
    /// </summary>
    public class RetrieveInvoice : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveInvoice Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveInvoice(TembooSession session) : base(session, "/Library/Stripe/Invoices/RetrieveInvoice")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveInvoiceResultSet containing execution metadata and results.</returns>
        new public RetrieveInvoiceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveInvoiceResultSet results = new JavaScriptSerializer().Deserialize<RetrieveInvoiceResultSet>(json);
    ...
    /// </summary>
    public class RetrieveInvoiceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
