...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class RetrieveSpreadsheetDetailsByName : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveSpreadsheetDetailsByName Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveSpreadsheetDetailsByName(TembooSession session) : base(session, "/Library/Google/Spreadsheets/RetrieveSpreadsheetDetailsByName")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveSpreadsheetDetailsByNameResultSet containing execution metadata and results.</returns>
        new public RetrieveSpreadsheetDetailsByNameResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveSpreadsheetDetailsByNameResultSet results = new JavaScriptSerializer().Deserialize<RetrieveSpreadsheetDetailsByNameResultSet>(json);
    ...
    /// </summary>
    public class RetrieveSpreadsheetDetailsByNameResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "SpreadsheetDetails" output from this Choreo execution
        /// <returns>String - The spreadsheet details including spreadsheet name and key. Worksheet names and IDs associated with the spreadsheet are also included.</returns>
        /// </summary>
        public String SpreadsheetDetails
        {
            get
            {
                return (String) base.Output["SpreadsheetDetails"];
            }
        }
        /// <summary> 
