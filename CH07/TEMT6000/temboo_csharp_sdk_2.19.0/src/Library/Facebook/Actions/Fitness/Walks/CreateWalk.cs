...
namespace Temboo.Library.Facebook.Actions.Fitness.Walks
{
    ...
    /// </summary>
    public class CreateWalk : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateWalk Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateWalk(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Walks/CreateWalk")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateWalkResultSet containing execution metadata and results.</returns>
        new public CreateWalkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateWalkResultSet results = new JavaScriptSerializer().Deserialize<CreateWalkResultSet>(json);
    ...
    /// </summary>
    public class CreateWalkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
