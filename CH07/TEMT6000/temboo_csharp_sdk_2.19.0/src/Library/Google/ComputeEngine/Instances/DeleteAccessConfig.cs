...
namespace Temboo.Library.Google.ComputeEngine.Instances
{
    ...
    /// </summary>
    public class DeleteAccessConfig : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteAccessConfig Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteAccessConfig(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Instances/DeleteAccessConfig")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the AccessConfig input for this Choreo.</param>
         public void setAccessConfig(String value) {
             base.addInput ("AccessConfig", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DeleteAccessConfigResultSet containing execution metadata and results.</returns>
        new public DeleteAccessConfigResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteAccessConfigResultSet results = new JavaScriptSerializer().Deserialize<DeleteAccessConfigResultSet>(json);
    ...
    /// </summary>
    public class DeleteAccessConfigResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
