...
namespace Temboo.Library.Kiva.Loans
{
    ...
    /// </summary>
    public class GetNewestLoans : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNewestLoans Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNewestLoans(TembooSession session) : base(session, "/Library/Kiva/Loans/GetNewestLoans")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetNewestLoansResultSet containing execution metadata and results.</returns>
        new public GetNewestLoansResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNewestLoansResultSet results = new JavaScriptSerializer().Deserialize<GetNewestLoansResultSet>(json);
    ...
    /// </summary>
    public class GetNewestLoansResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
