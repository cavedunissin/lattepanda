...
namespace Temboo.Library.SendGrid.NewsletterAPI.Schedule
{
    ...
    /// </summary>
    public class GetNewsletterScheduleTime : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNewsletterScheduleTime Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNewsletterScheduleTime(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Schedule/GetNewsletterScheduleTime")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetNewsletterScheduleTimeResultSet containing execution metadata and results.</returns>
        new public GetNewsletterScheduleTimeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNewsletterScheduleTimeResultSet results = new JavaScriptSerializer().Deserialize<GetNewsletterScheduleTimeResultSet>(json);
    ...
    /// </summary>
    public class GetNewsletterScheduleTimeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
