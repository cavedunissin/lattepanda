...
namespace Temboo.Library.Twitter.Trends
{
    ...
    /// </summary>
    public class Available : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Available Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Available(TembooSession session) : base(session, "/Library/Twitter/Trends/Available")
        {
        }
        ...
        /// </summary>
        /// <returns>A AvailableResultSet containing execution metadata and results.</returns>
        new public AvailableResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AvailableResultSet results = new JavaScriptSerializer().Deserialize<AvailableResultSet>(json);
    ...
    /// </summary>
    public class AvailableResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
