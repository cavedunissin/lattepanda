...
namespace Temboo.Library.Fitbit.Social
{
    ...
    /// </summary>
    public class GetInvites : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetInvites Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetInvites(TembooSession session) : base(session, "/Library/Fitbit/Social/GetInvites")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetInvitesResultSet containing execution metadata and results.</returns>
        new public GetInvitesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetInvitesResultSet results = new JavaScriptSerializer().Deserialize<GetInvitesResultSet>(json);
    ...
    /// </summary>
    public class GetInvitesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
