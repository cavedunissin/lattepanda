...
namespace Temboo.Library.GitHub.ReposAPI.Commits
{
    ...
    /// </summary>
    public class CompareCommits : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CompareCommits Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CompareCommits(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Commits/CompareCommits")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Base input for this Choreo.</param>
         public void setBase(String value) {
             base.addInput ("Base", value);
         }
         /// <summary>
         /// (required, string) The head commit.
         /// </summary>
         /// <param name="value">Value of the Head input for this Choreo.</param>
         public void setHead(String value) {
             base.addInput ("Head", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CompareCommitsResultSet containing execution metadata and results.</returns>
        new public CompareCommitsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CompareCommitsResultSet results = new JavaScriptSerializer().Deserialize<CompareCommitsResultSet>(json);
    ...
    /// </summary>
    public class CompareCommitsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
