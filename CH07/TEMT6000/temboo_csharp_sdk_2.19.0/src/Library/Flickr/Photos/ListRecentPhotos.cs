...
namespace Temboo.Library.Flickr.Photos
{
    ...
    /// </summary>
    public class ListRecentPhotos : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRecentPhotos Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRecentPhotos(TembooSession session) : base(session, "/Library/Flickr/Photos/ListRecentPhotos")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRecentPhotosResultSet containing execution metadata and results.</returns>
        new public ListRecentPhotosResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRecentPhotosResultSet results = new JavaScriptSerializer().Deserialize<ListRecentPhotosResultSet>(json);
    ...
    /// </summary>
    public class ListRecentPhotosResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
