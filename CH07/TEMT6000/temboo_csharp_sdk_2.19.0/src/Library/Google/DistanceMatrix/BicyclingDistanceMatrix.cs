...
namespace Temboo.Library.Google.DistanceMatrix
{
    ...
    /// </summary>
    public class BicyclingDistanceMatrix : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the BicyclingDistanceMatrix Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public BicyclingDistanceMatrix(TembooSession session) : base(session, "/Library/Google/DistanceMatrix/BicyclingDistanceMatrix")
        {
        }
        ...
        /// </summary>
        /// <returns>A BicyclingDistanceMatrixResultSet containing execution metadata and results.</returns>
        new public BicyclingDistanceMatrixResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BicyclingDistanceMatrixResultSet results = new JavaScriptSerializer().Deserialize<BicyclingDistanceMatrixResultSet>(json);
    ...
    /// </summary>
    public class BicyclingDistanceMatrixResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
