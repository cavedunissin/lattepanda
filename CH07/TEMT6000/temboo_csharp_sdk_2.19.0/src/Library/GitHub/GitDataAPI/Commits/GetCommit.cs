...
namespace Temboo.Library.GitHub.GitDataAPI.Commits
{
    /// <summary>
    /// GetCommit
    /// Retrieves a specified commit from a repo.
    /// </summary>
    public class GetCommit : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCommit Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCommit(TembooSession session) : base(session, "/Library/GitHub/GitDataAPI/Commits/GetCommit")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCommitResultSet containing execution metadata and results.</returns>
        new public GetCommitResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCommitResultSet results = new JavaScriptSerializer().Deserialize<GetCommitResultSet>(json);
    ...
    /// </summary>
    public class GetCommitResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
