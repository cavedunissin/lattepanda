...
namespace Temboo.Library.Dropbox.FilesAndMetadata
{
    ...
    /// </summary>
    public class CreateCopyRef : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateCopyRef Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateCopyRef(TembooSession session) : base(session, "/Library/Dropbox/FilesAndMetadata/CreateCopyRef")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateCopyRefResultSet containing execution metadata and results.</returns>
        new public CreateCopyRefResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateCopyRefResultSet results = new JavaScriptSerializer().Deserialize<CreateCopyRefResultSet>(json);
    ...
    /// </summary>
    public class CreateCopyRefResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
