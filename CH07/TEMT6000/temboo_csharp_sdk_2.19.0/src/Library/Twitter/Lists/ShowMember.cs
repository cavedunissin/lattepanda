...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class ShowMember : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ShowMember Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ShowMember(TembooSession session) : base(session, "/Library/Twitter/Lists/ShowMember")
        {
        }
        ...
        /// </summary>
        /// <returns>A ShowMemberResultSet containing execution metadata and results.</returns>
        new public ShowMemberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ShowMemberResultSet results = new JavaScriptSerializer().Deserialize<ShowMemberResultSet>(json);
    ...
    /// </summary>
    public class ShowMemberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
