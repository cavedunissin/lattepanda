...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class UpdateGroup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateGroup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateGroup(TembooSession session) : base(session, "/Library/Amazon/IAM/UpdateGroup")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the NewGroupName input for this Choreo.</param>
         public void setNewGroupName(String value) {
             base.addInput ("NewGroupName", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateGroupResultSet containing execution metadata and results.</returns>
        new public UpdateGroupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateGroupResultSet results = new JavaScriptSerializer().Deserialize<UpdateGroupResultSet>(json);
    ...
    /// </summary>
    public class UpdateGroupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
