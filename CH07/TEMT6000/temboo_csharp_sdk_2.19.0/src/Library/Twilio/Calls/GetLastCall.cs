...
namespace Temboo.Library.Twilio.Calls
{
    ...
    /// </summary>
    public class GetLastCall : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLastCall Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLastCall(TembooSession session) : base(session, "/Library/Twilio/Calls/GetLastCall")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLastCallResultSet containing execution metadata and results.</returns>
        new public GetLastCallResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLastCallResultSet results = new JavaScriptSerializer().Deserialize<GetLastCallResultSet>(json);
    ...
    /// </summary>
    public class GetLastCallResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
