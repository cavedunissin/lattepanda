...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class ExportViews : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ExportViews Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ExportViews(TembooSession session) : base(session, "/Library/Zendesk/Views/ExportViews")
        {
        }
        ...
        /// </summary>
        /// <returns>A ExportViewsResultSet containing execution metadata and results.</returns>
        new public ExportViewsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ExportViewsResultSet results = new JavaScriptSerializer().Deserialize<ExportViewsResultSet>(json);
    ...
    /// </summary>
    public class ExportViewsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
