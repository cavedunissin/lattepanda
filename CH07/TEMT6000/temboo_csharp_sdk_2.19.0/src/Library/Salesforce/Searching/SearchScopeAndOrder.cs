...
namespace Temboo.Library.Salesforce.Searching
{
    /// <summary>
    /// SearchScopeAndOrder
    /// Executes the specified SOSL search in the default global search scope of a logged-in user.
    /// </summary>
    public class SearchScopeAndOrder : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchScopeAndOrder Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchScopeAndOrder(TembooSession session) : base(session, "/Library/Salesforce/Searching/SearchScopeAndOrder")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchScopeAndOrderResultSet containing execution metadata and results.</returns>
        new public SearchScopeAndOrderResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchScopeAndOrderResultSet results = new JavaScriptSerializer().Deserialize<SearchScopeAndOrderResultSet>(json);
    ...
    /// </summary>
    public class SearchScopeAndOrderResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
