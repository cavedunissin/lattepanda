...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Movies : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Movies Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Movies(TembooSession session) : base(session, "/Library/Facebook/Reading/Movies")
        {
        }
        ...
        /// </summary>
        /// <returns>A MoviesResultSet containing execution metadata and results.</returns>
        new public MoviesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MoviesResultSet results = new JavaScriptSerializer().Deserialize<MoviesResultSet>(json);
    ...
    /// </summary>
    public class MoviesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
