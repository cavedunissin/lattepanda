...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class GetRecentActivities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRecentActivities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRecentActivities(TembooSession session) : base(session, "/Library/Fitbit/Activities/GetRecentActivities")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRecentActivitiesResultSet containing execution metadata and results.</returns>
        new public GetRecentActivitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRecentActivitiesResultSet results = new JavaScriptSerializer().Deserialize<GetRecentActivitiesResultSet>(json);
    ...
    /// </summary>
    public class GetRecentActivitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
