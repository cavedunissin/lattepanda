...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class GetMembers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMembers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMembers(TembooSession session) : base(session, "/Library/Twitter/Lists/GetMembers")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMembersResultSet containing execution metadata and results.</returns>
        new public GetMembersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMembersResultSet results = new JavaScriptSerializer().Deserialize<GetMembersResultSet>(json);
    ...
    /// </summary>
    public class GetMembersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
