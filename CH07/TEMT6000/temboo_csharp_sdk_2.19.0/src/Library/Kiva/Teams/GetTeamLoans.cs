...
namespace Temboo.Library.Kiva.Teams
{
    ...
    /// </summary>
    public class GetTeamLoans : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTeamLoans Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTeamLoans(TembooSession session) : base(session, "/Library/Kiva/Teams/GetTeamLoans")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTeamLoansResultSet containing execution metadata and results.</returns>
        new public GetTeamLoansResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTeamLoansResultSet results = new JavaScriptSerializer().Deserialize<GetTeamLoansResultSet>(json);
    ...
    /// </summary>
    public class GetTeamLoansResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
