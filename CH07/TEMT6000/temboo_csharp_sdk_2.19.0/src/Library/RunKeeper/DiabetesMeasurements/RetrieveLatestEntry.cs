...
namespace Temboo.Library.RunKeeper.DiabetesMeasurements
{
    ...
    public class RetrieveLatestEntry : Temboo.Core.Choreography
    {
        ...
        public RetrieveLatestEntry(TembooSession session) : base(session, "/Library/RunKeeper/DiabetesMeasurements/RetrieveLatestEntry")
        {
        }
    ...
    {
        /// <summary> 
        /// Retrieve the value for the "Insulin" output from this Choreo execution
        /// <returns>String - (decimal) The value of the measured quantity in U (omitted if not available).</returns>
        /// </summary>
        public String Insulin
        {
            get
            {
                return (String) base.Output["Insulin"];
            }
        }
        /// <summary> 
