...
namespace Temboo.Library.Amazon.Marketplace.Orders
{
    ...
    /// </summary>
    public class ListOrderItems : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListOrderItems Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListOrderItems(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Orders/ListOrderItems")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the AmazonOrderId input for this Choreo.</param>
         public void setAmazonOrderId(String value) {
             base.addInput ("AmazonOrderId", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ListOrderItemsResultSet containing execution metadata and results.</returns>
        new public ListOrderItemsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListOrderItemsResultSet results = new JavaScriptSerializer().Deserialize<ListOrderItemsResultSet>(json);
    ...
    /// </summary>
    public class ListOrderItemsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
