...
namespace Temboo.Library.Google.Directions
{
    ...
    /// </summary>
    public class GetDrivingDirections : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetDrivingDirections Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetDrivingDirections(TembooSession session) : base(session, "/Library/Google/Directions/GetDrivingDirections")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetDrivingDirectionsResultSet containing execution metadata and results.</returns>
        new public GetDrivingDirectionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetDrivingDirectionsResultSet results = new JavaScriptSerializer().Deserialize<GetDrivingDirectionsResultSet>(json);
    ...
    /// </summary>
    public class GetDrivingDirectionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
