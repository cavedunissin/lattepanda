...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class ListAllTickets : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllTickets Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllTickets(TembooSession session) : base(session, "/Library/Zendesk/Tickets/ListAllTickets")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllTicketsResultSet containing execution metadata and results.</returns>
        new public ListAllTicketsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllTicketsResultSet results = new JavaScriptSerializer().Deserialize<ListAllTicketsResultSet>(json);
    ...
    /// </summary>
    public class ListAllTicketsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
