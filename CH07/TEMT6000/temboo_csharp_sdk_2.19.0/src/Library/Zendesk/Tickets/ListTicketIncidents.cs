...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class ListTicketIncidents : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTicketIncidents Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTicketIncidents(TembooSession session) : base(session, "/Library/Zendesk/Tickets/ListTicketIncidents")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTicketIncidentsResultSet containing execution metadata and results.</returns>
        new public ListTicketIncidentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTicketIncidentsResultSet results = new JavaScriptSerializer().Deserialize<ListTicketIncidentsResultSet>(json);
    ...
    /// </summary>
    public class ListTicketIncidentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
