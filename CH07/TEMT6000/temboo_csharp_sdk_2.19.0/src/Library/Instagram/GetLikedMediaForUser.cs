...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class GetLikedMediaForUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLikedMediaForUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLikedMediaForUser(TembooSession session) : base(session, "/Library/Instagram/GetLikedMediaForUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLikedMediaForUserResultSet containing execution metadata and results.</returns>
        new public GetLikedMediaForUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLikedMediaForUserResultSet results = new JavaScriptSerializer().Deserialize<GetLikedMediaForUserResultSet>(json);
    ...
    /// </summary>
    public class GetLikedMediaForUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
