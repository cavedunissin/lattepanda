...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class RebootInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RebootInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RebootInstances(TembooSession session) : base(session, "/Library/Amazon/EC2/RebootInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A RebootInstancesResultSet containing execution metadata and results.</returns>
        new public RebootInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RebootInstancesResultSet results = new JavaScriptSerializer().Deserialize<RebootInstancesResultSet>(json);
    ...
    /// </summary>
    public class RebootInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
