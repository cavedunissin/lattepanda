...
namespace Temboo.Library.Mixpanel.Profiles
{
    ...
    /// </summary>
    public class SetOnce : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SetOnce Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SetOnce(TembooSession session) : base(session, "/Library/Mixpanel/Profiles/SetOnce")
        {
        }
        ...
        /// </summary>
        /// <returns>A SetOnceResultSet containing execution metadata and results.</returns>
        new public SetOnceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SetOnceResultSet results = new JavaScriptSerializer().Deserialize<SetOnceResultSet>(json);
    ...
    /// </summary>
    public class SetOnceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
