...
namespace Temboo.Library.Facebook.Actions.Fitness.Bikes
{
    ...
    /// </summary>
    public class UpdateBike : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateBike Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateBike(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Bikes/UpdateBike")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateBikeResultSet containing execution metadata and results.</returns>
        new public UpdateBikeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateBikeResultSet results = new JavaScriptSerializer().Deserialize<UpdateBikeResultSet>(json);
    ...
    /// </summary>
    public class UpdateBikeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
