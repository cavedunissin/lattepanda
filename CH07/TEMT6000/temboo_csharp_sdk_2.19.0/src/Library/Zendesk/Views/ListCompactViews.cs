...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class ListCompactViews : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCompactViews Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCompactViews(TembooSession session) : base(session, "/Library/Zendesk/Views/ListCompactViews")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListCompactViewsResultSet containing execution metadata and results.</returns>
        new public ListCompactViewsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCompactViewsResultSet results = new JavaScriptSerializer().Deserialize<ListCompactViewsResultSet>(json);
    ...
    /// </summary>
    public class ListCompactViewsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
