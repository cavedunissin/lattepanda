...
namespace Temboo.Library.Flickr.Places
{
    ...
    /// </summary>
    public class FindByKeyword : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FindByKeyword Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FindByKeyword(TembooSession session) : base(session, "/Library/Flickr/Places/FindByKeyword")
        {
        }
        ...
        /// </summary>
        /// <returns>A FindByKeywordResultSet containing execution metadata and results.</returns>
        new public FindByKeywordResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FindByKeywordResultSet results = new JavaScriptSerializer().Deserialize<FindByKeywordResultSet>(json);
    ...
    /// </summary>
    public class FindByKeywordResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
