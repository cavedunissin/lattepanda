...
namespace Temboo.Library.Twilio.Conferences
{
    ...
    /// </summary>
    public class DeleteParticipant : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteParticipant Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteParticipant(TembooSession session) : base(session, "/Library/Twilio/Conferences/DeleteParticipant")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteParticipantResultSet containing execution metadata and results.</returns>
        new public DeleteParticipantResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteParticipantResultSet results = new JavaScriptSerializer().Deserialize<DeleteParticipantResultSet>(json);
    ...
    /// </summary>
    public class DeleteParticipantResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
