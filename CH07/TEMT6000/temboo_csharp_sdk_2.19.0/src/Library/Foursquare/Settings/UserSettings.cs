...
namespace Temboo.Library.Foursquare.Settings
{
    ...
    /// </summary>
    public class UserSettings : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UserSettings Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UserSettings(TembooSession session) : base(session, "/Library/Foursquare/Settings/UserSettings")
        {
        }
        ...
        /// </summary>
        /// <returns>A UserSettingsResultSet containing execution metadata and results.</returns>
        new public UserSettingsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UserSettingsResultSet results = new JavaScriptSerializer().Deserialize<UserSettingsResultSet>(json);
    ...
    /// </summary>
    public class UserSettingsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
