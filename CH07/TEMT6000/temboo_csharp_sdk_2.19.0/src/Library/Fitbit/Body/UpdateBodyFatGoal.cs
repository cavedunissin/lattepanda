...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class UpdateBodyFatGoal : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateBodyFatGoal Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateBodyFatGoal(TembooSession session) : base(session, "/Library/Fitbit/Body/UpdateBodyFatGoal")
        {
        }
         ...
         /// <summary>
         /// (required, decimal) Target body fat in %;  Fitbit currently only accepts whole numbers.
         /// </summary>
         /// <param name="value">Value of the BodyFat input for this Choreo.</param>
         public void setBodyFat(String value) {
             base.addInput ("BodyFat", value);
         }
         /// <summary>
         /// (required, string) Deprecated (retained for backward compatibility only).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A UpdateBodyFatGoalResultSet containing execution metadata and results.</returns>
        new public UpdateBodyFatGoalResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateBodyFatGoalResultSet results = new JavaScriptSerializer().Deserialize<UpdateBodyFatGoalResultSet>(json);
    ...
    /// </summary>
    public class UpdateBodyFatGoalResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
