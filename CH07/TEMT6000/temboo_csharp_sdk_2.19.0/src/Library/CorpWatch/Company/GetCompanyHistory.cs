...
namespace Temboo.Library.CorpWatch.Company
{
    ...
    /// </summary>
    public class GetCompanyHistory : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCompanyHistory Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCompanyHistory(TembooSession session) : base(session, "/Library/CorpWatch/Company/GetCompanyHistory")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCompanyHistoryResultSet containing execution metadata and results.</returns>
        new public GetCompanyHistoryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCompanyHistoryResultSet results = new JavaScriptSerializer().Deserialize<GetCompanyHistoryResultSet>(json);
    ...
    /// </summary>
    public class GetCompanyHistoryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
