...
namespace Temboo.Library.Google.ComputeEngine.Disks
{
    ...
    /// </summary>
    public class GetDisk : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetDisk Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetDisk(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Disks/GetDisk")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetDiskResultSet containing execution metadata and results.</returns>
        new public GetDiskResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetDiskResultSet results = new JavaScriptSerializer().Deserialize<GetDiskResultSet>(json);
    ...
    /// </summary>
    public class GetDiskResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
