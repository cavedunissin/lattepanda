...
namespace Temboo.Library.YouTube.Channels
{
    ...
    /// </summary>
    public class ListMySubscribers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListMySubscribers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListMySubscribers(TembooSession session) : base(session, "/Library/YouTube/Channels/ListMySubscribers")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListMySubscribersResultSet containing execution metadata and results.</returns>
        new public ListMySubscribersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListMySubscribersResultSet results = new JavaScriptSerializer().Deserialize<ListMySubscribersResultSet>(json);
    ...
    /// </summary>
    public class ListMySubscribersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
