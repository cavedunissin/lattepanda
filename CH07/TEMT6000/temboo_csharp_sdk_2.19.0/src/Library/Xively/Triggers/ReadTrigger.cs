...
namespace Temboo.Library.Xively.Triggers
{
    ...
    /// </summary>
    public class ReadTrigger : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadTrigger Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadTrigger(TembooSession session) : base(session, "/Library/Xively/Triggers/ReadTrigger")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadTriggerResultSet containing execution metadata and results.</returns>
        new public ReadTriggerResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadTriggerResultSet results = new JavaScriptSerializer().Deserialize<ReadTriggerResultSet>(json);
    ...
    /// </summary>
    public class ReadTriggerResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
