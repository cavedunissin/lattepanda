...
namespace Temboo.Library.Fitbit.OAuth
{
    ...
    public class InitializeOAuth : Temboo.Core.Choreography
    {
        ...
        public InitializeOAuth(TembooSession session) : base(session, "/Library/Fitbit/OAuth/InitializeOAuth")
        {
        }

         /// <summary>
         /// (required, string) The OAuth 2.0 Client ID provided by Fitbit.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) A space-delimited list of the permissions you are requesting. See Choreo notes for a list of valid values for this input.
         /// </summary>
    ...
    public class InitializeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) Deprecated (retained for backward compatibility only).</returns>
        /// </summary>
