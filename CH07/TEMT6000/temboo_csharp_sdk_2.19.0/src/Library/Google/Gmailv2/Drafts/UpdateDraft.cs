...
namespace Temboo.Library.Google.Gmailv2.Drafts
{
    ...
    /// </summary>
    public class UpdateDraft : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateDraft Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateDraft(TembooSession session) : base(session, "/Library/Google/Gmailv2/Drafts/UpdateDraft")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateDraftResultSet containing execution metadata and results.</returns>
        new public UpdateDraftResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateDraftResultSet results = new JavaScriptSerializer().Deserialize<UpdateDraftResultSet>(json);
    ...
    /// </summary>
    public class UpdateDraftResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
