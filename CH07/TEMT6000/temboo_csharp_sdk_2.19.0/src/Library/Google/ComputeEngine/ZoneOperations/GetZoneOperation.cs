...
namespace Temboo.Library.Google.ComputeEngine.ZoneOperations
{
    ...
    /// </summary>
    public class GetZoneOperation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetZoneOperation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetZoneOperation(TembooSession session) : base(session, "/Library/Google/ComputeEngine/ZoneOperations/GetZoneOperation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetZoneOperationResultSet containing execution metadata and results.</returns>
        new public GetZoneOperationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetZoneOperationResultSet results = new JavaScriptSerializer().Deserialize<GetZoneOperationResultSet>(json);
    ...
    /// </summary>
    public class GetZoneOperationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
