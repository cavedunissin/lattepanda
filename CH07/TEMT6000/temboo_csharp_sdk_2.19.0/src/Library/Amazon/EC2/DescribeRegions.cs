...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DescribeRegions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DescribeRegions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DescribeRegions(TembooSession session) : base(session, "/Library/Amazon/EC2/DescribeRegions")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RegionName input for this Choreo.</param>
         public void setRegionName(String value) {
             base.addInput ("RegionName", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DescribeRegionsResultSet containing execution metadata and results.</returns>
        new public DescribeRegionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DescribeRegionsResultSet results = new JavaScriptSerializer().Deserialize<DescribeRegionsResultSet>(json);
    ...
    /// </summary>
    public class DescribeRegionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
