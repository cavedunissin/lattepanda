...
namespace Temboo.Library.Zendesk.TicketAudits
{
    ...
    /// </summary>
    public class ChangeCommentFromPublicToPrivate : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ChangeCommentFromPublicToPrivate Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ChangeCommentFromPublicToPrivate(TembooSession session) : base(session, "/Library/Zendesk/TicketAudits/ChangeCommentFromPublicToPrivate")
        {
        }
        ...
        /// </summary>
        /// <returns>A ChangeCommentFromPublicToPrivateResultSet containing execution metadata and results.</returns>
        new public ChangeCommentFromPublicToPrivateResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ChangeCommentFromPublicToPrivateResultSet results = new JavaScriptSerializer().Deserialize<ChangeCommentFromPublicToPrivateResultSet>(json);
    ...
    /// </summary>
    public class ChangeCommentFromPublicToPrivateResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
