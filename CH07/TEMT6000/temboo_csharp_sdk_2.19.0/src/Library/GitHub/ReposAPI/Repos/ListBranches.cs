...
namespace Temboo.Library.GitHub.ReposAPI.Repos
{
    ...
    /// </summary>
    public class ListBranches : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListBranches Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListBranches(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Repos/ListBranches")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListBranchesResultSet containing execution metadata and results.</returns>
        new public ListBranchesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListBranchesResultSet results = new JavaScriptSerializer().Deserialize<ListBranchesResultSet>(json);
    ...
    /// </summary>
    public class ListBranchesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
