...
namespace Temboo.Library.Klout.User
{
    ...
    /// </summary>
    public class Score : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Score Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Score(TembooSession session) : base(session, "/Library/Klout/User/Score")
        {
        }
        ...
        /// </summary>
        /// <returns>A ScoreResultSet containing execution metadata and results.</returns>
        new public ScoreResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ScoreResultSet results = new JavaScriptSerializer().Deserialize<ScoreResultSet>(json);
    ...
    /// </summary>
    public class ScoreResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
