...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class RetrieveWorksheet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveWorksheet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveWorksheet(TembooSession session) : base(session, "/Library/Google/Spreadsheets/RetrieveWorksheet")
        {
        }
         ...
         /// <summary>
         /// (required, string) The unique key of the spreadsheet associated with the worksheet you want to retrieve. Required unless SpreadsheetName and WorksheetName are supplied.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) The name of the spreadsheet to retrieve. This and WorksheetName can be used as an alternative to SpreadsheetKey and WorksheetId to lookup spreadsheet details by name.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) The name of the worksheet to retrieve. This and SpreadsheetName can be used as an alternative to SpreadsheetKey and WorksheetId to lookup spreadsheet details by name.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A RetrieveWorksheetResultSet containing execution metadata and results.</returns>
        new public RetrieveWorksheetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveWorksheetResultSet results = new JavaScriptSerializer().Deserialize<RetrieveWorksheetResultSet>(json);
    ...
    /// </summary>
    public class RetrieveWorksheetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (multiline) The response from Google.</returns>
        /// </summary>
