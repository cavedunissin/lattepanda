...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class DeleteBodyWeightLog : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteBodyWeightLog Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteBodyWeightLog(TembooSession session) : base(session, "/Library/Fitbit/Body/DeleteBodyWeightLog")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the BodyWeightLogID input for this Choreo.</param>
         public void setBodyWeightLogID(String value) {
             base.addInput ("BodyWeightLogID", value);
         }
         /// <summary>
         /// (required, string) Deprecated (retained for backward compatibility only).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A DeleteBodyWeightLogResultSet containing execution metadata and results.</returns>
        new public DeleteBodyWeightLogResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteBodyWeightLogResultSet results = new JavaScriptSerializer().Deserialize<DeleteBodyWeightLogResultSet>(json);
    ...
    /// </summary>
    public class DeleteBodyWeightLogResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
