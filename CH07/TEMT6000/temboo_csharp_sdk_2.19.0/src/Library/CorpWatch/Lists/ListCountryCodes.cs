...
namespace Temboo.Library.CorpWatch.Lists
{
    ...
    /// </summary>
    public class ListCountryCodes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCountryCodes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCountryCodes(TembooSession session) : base(session, "/Library/CorpWatch/Lists/ListCountryCodes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListCountryCodesResultSet containing execution metadata and results.</returns>
        new public ListCountryCodesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCountryCodesResultSet results = new JavaScriptSerializer().Deserialize<ListCountryCodesResultSet>(json);
    ...
    /// </summary>
    public class ListCountryCodesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
