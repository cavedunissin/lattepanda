...
namespace Temboo.Library.LastFm.User
{
    ...
    /// </summary>
    public class GetWeeklyTrackChart : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetWeeklyTrackChart Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetWeeklyTrackChart(TembooSession session) : base(session, "/Library/LastFm/User/GetWeeklyTrackChart")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetWeeklyTrackChartResultSet containing execution metadata and results.</returns>
        new public GetWeeklyTrackChartResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetWeeklyTrackChartResultSet results = new JavaScriptSerializer().Deserialize<GetWeeklyTrackChartResultSet>(json);
    ...
    /// </summary>
    public class GetWeeklyTrackChartResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
