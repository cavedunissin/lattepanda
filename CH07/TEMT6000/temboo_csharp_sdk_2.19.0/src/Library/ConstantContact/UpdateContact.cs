...
namespace Temboo.Library.ConstantContact
{
    ...
    public class UpdateContact : Temboo.Core.Choreography
    {
        ...
        public UpdateContact(TembooSession session) : base(session, "/Library/ConstantContact/UpdateContact")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the UpdatedContactXML input for this Choreo.</param>
         public void setUpdatedContactXML(String value) {
             base.addInput ("UpdatedContactXML", value);
         }
         /// <summary>
    ...
    public class UpdateContactResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (xml) The response from Constant Contact. Note that a successful update returns no content.</returns>
        /// </summary>
