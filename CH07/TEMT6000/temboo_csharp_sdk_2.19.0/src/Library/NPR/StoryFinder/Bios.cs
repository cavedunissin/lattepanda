...
namespace Temboo.Library.NPR.StoryFinder
{
    ...
    /// </summary>
    public class Bios : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Bios Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Bios(TembooSession session) : base(session, "/Library/NPR/StoryFinder/Bios")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Personality input for this Choreo.</param>
         public void setPersonality(String value) {
             base.addInput ("Personality", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A BiosResultSet containing execution metadata and results.</returns>
        new public BiosResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BiosResultSet results = new JavaScriptSerializer().Deserialize<BiosResultSet>(json);
    ...
    /// </summary>
    public class BiosResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Id" output from this Choreo execution
        /// <returns>String - (integer) The ID of the personality specified. This is only returned when the Personality input is specified. When personalities are specified, this will be a list of IDs separated by commas.</returns>
        /// </summary>
        public String Id
        {
            get
