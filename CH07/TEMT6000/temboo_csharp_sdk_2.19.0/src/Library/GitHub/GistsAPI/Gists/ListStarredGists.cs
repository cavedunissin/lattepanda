...
namespace Temboo.Library.GitHub.GistsAPI.Gists
{
    ...
    /// </summary>
    public class ListStarredGists : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListStarredGists Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListStarredGists(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Gists/ListStarredGists")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListStarredGistsResultSet containing execution metadata and results.</returns>
        new public ListStarredGistsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListStarredGistsResultSet results = new JavaScriptSerializer().Deserialize<ListStarredGistsResultSet>(json);
    ...
    /// </summary>
    public class ListStarredGistsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
