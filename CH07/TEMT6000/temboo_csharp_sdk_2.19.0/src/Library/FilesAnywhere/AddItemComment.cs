...
namespace Temboo.Library.FilesAnywhere
{
    ...
    /// </summary>
    public class AddItemComment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddItemComment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddItemComment(TembooSession session) : base(session, "/Library/FilesAnywhere/AddItemComment")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddItemCommentResultSet containing execution metadata and results.</returns>
        new public AddItemCommentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddItemCommentResultSet results = new JavaScriptSerializer().Deserialize<AddItemCommentResultSet>(json);
    ...
    /// </summary>
    public class AddItemCommentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
