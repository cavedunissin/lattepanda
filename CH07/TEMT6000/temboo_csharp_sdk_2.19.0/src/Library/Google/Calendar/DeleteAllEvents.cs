...
namespace Temboo.Library.Google.Calendar
{
    ...
    /// </summary>
    public class DeleteAllEvents : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteAllEvents Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteAllEvents(TembooSession session) : base(session, "/Library/Google/Calendar/DeleteAllEvents")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteAllEventsResultSet containing execution metadata and results.</returns>
        new public DeleteAllEventsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteAllEventsResultSet results = new JavaScriptSerializer().Deserialize<DeleteAllEventsResultSet>(json);
    ...
    /// </summary>
    public class DeleteAllEventsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
