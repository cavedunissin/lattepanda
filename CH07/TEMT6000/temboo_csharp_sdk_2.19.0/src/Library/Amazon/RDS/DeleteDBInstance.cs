...
namespace Temboo.Library.Amazon.RDS
{
    ...
    /// </summary>
    public class DeleteDBInstance : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteDBInstance Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteDBInstance(TembooSession session) : base(session, "/Library/Amazon/RDS/DeleteDBInstance")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteDBInstanceResultSet containing execution metadata and results.</returns>
        new public DeleteDBInstanceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteDBInstanceResultSet results = new JavaScriptSerializer().Deserialize<DeleteDBInstanceResultSet>(json);
    ...
    /// </summary>
    public class DeleteDBInstanceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
