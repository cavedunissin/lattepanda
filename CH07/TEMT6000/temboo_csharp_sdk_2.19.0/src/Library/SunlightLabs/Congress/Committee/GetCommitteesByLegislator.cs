...
namespace Temboo.Library.SunlightLabs.Congress.Committee
{
    ...
    /// </summary>
    public class GetCommitteesByLegislator : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCommitteesByLegislator Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCommitteesByLegislator(TembooSession session) : base(session, "/Library/SunlightLabs/Congress/Committee/GetCommitteesByLegislator")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCommitteesByLegislatorResultSet containing execution metadata and results.</returns>
        new public GetCommitteesByLegislatorResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCommitteesByLegislatorResultSet results = new JavaScriptSerializer().Deserialize<GetCommitteesByLegislatorResultSet>(json);
    ...
    /// </summary>
    public class GetCommitteesByLegislatorResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
