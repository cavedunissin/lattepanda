...
namespace Temboo.Library.Facebook.Actions.Video.WantsToWatch
{
    ...
    /// </summary>
    public class ReadWantsToWatch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadWantsToWatch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadWantsToWatch(TembooSession session) : base(session, "/Library/Facebook/Actions/Video/WantsToWatch/ReadWantsToWatch")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadWantsToWatchResultSet containing execution metadata and results.</returns>
        new public ReadWantsToWatchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadWantsToWatchResultSet results = new JavaScriptSerializer().Deserialize<ReadWantsToWatchResultSet>(json);
    ...
    /// </summary>
    public class ReadWantsToWatchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
