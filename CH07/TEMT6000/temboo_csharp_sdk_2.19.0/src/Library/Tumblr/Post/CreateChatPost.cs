...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class CreateChatPost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateChatPost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateChatPost(TembooSession session) : base(session, "/Library/Tumblr/Post/CreateChatPost")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Conversation input for this Choreo.</param>
         public void setConversation(String value) {
             base.addInput ("Conversation", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreateChatPostResultSet containing execution metadata and results.</returns>
        new public CreateChatPostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateChatPostResultSet results = new JavaScriptSerializer().Deserialize<CreateChatPostResultSet>(json);
    ...
    /// </summary>
    public class CreateChatPostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Response" output from this Choreo execution
        /// <returns>String - (string) The response from Tumblr. Default is JSON, can be set to XML by entering 'xml' in ResponseFormat.</returns>
        /// </summary>
