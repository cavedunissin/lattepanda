...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class GetActivities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetActivities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetActivities(TembooSession session) : base(session, "/Library/Fitbit/Activities/GetActivities")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetActivitiesResultSet containing execution metadata and results.</returns>
        new public GetActivitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetActivitiesResultSet results = new JavaScriptSerializer().Deserialize<GetActivitiesResultSet>(json);
    ...
    /// </summary>
    public class GetActivitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
