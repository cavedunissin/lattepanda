...
namespace Temboo.Library.Google.Gmailv2.Drafts
{
    ...
    /// </summary>
    public class ListDrafts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListDrafts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListDrafts(TembooSession session) : base(session, "/Library/Google/Gmailv2/Drafts/ListDrafts")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListDraftsResultSet containing execution metadata and results.</returns>
        new public ListDraftsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListDraftsResultSet results = new JavaScriptSerializer().Deserialize<ListDraftsResultSet>(json);
    ...
    /// </summary>
    public class ListDraftsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
