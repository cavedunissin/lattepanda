...
namespace Temboo.Library.GitHub.ReposAPI.Contents
{
    ...
    /// </summary>
    public class GetContents : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetContents Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetContents(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Contents/GetContents")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The name of the commit/branch/tag. Defaults to the repository’s default branch (usually master).
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetContentsResultSet containing execution metadata and results.</returns>
        new public GetContentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetContentsResultSet results = new JavaScriptSerializer().Deserialize<GetContentsResultSet>(json);
    ...
    /// </summary>
    public class GetContentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
