...
namespace Temboo.Library.Google.Drive.Revisions
{
    /// <summary>
    /// Delete
    /// Removes a revision.
    ...
    public class Delete : Temboo.Core.Choreography
    {
        ...
        public Delete(TembooSession session) : base(session, "/Library/Google/Drive/Revisions/Delete")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RevisionID input for this Choreo.</param>
         public void setRevisionID(String value) {
             base.addInput ("RevisionID", value);
         }
