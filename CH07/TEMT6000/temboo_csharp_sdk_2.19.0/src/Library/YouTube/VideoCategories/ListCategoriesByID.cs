...
namespace Temboo.Library.YouTube.VideoCategories
{
    ...
    /// </summary>
    public class ListCategoriesByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCategoriesByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCategoriesByID(TembooSession session) : base(session, "/Library/YouTube/VideoCategories/ListCategoriesByID")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListCategoriesByIDResultSet containing execution metadata and results.</returns>
        new public ListCategoriesByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCategoriesByIDResultSet results = new JavaScriptSerializer().Deserialize<ListCategoriesByIDResultSet>(json);
    ...
    /// </summary>
    public class ListCategoriesByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
