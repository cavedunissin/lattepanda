...
namespace Temboo.Library.Twilio.Recordings
{
    ...
    /// </summary>
    public class GetRecording : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRecording Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRecording(TembooSession session) : base(session, "/Library/Twilio/Recordings/GetRecording")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRecordingResultSet containing execution metadata and results.</returns>
        new public GetRecordingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRecordingResultSet results = new JavaScriptSerializer().Deserialize<GetRecordingResultSet>(json);
    ...
    /// </summary>
    public class GetRecordingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
