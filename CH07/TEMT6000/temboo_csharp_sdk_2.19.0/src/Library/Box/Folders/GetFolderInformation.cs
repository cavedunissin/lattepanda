...
namespace Temboo.Library.Box.Folders
{
    ...
    /// </summary>
    public class GetFolderInformation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFolderInformation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFolderInformation(TembooSession session) : base(session, "/Library/Box/Folders/GetFolderInformation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFolderInformationResultSet containing execution metadata and results.</returns>
        new public GetFolderInformationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFolderInformationResultSet results = new JavaScriptSerializer().Deserialize<GetFolderInformationResultSet>(json);
    ...
    /// </summary>
    public class GetFolderInformationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
