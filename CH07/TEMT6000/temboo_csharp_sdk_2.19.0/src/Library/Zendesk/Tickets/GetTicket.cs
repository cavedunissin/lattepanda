...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class GetTicket : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTicket Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTicket(TembooSession session) : base(session, "/Library/Zendesk/Tickets/GetTicket")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTicketResultSet containing execution metadata and results.</returns>
        new public GetTicketResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTicketResultSet results = new JavaScriptSerializer().Deserialize<GetTicketResultSet>(json);
    ...
    /// </summary>
    public class GetTicketResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
