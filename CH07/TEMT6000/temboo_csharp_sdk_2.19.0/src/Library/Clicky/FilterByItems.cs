...
namespace Temboo.Library.Clicky
{
    ...
    /// </summary>
    public class FilterByItems : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FilterByItems Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FilterByItems(TembooSession session) : base(session, "/Library/Clicky/FilterByItems")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Item input for this Choreo.</param>
         public void setItem(String value) {
             base.addInput ("Item", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A FilterByItemsResultSet containing execution metadata and results.</returns>
        new public FilterByItemsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FilterByItemsResultSet results = new JavaScriptSerializer().Deserialize<FilterByItemsResultSet>(json);
    ...
    /// </summary>
    public class FilterByItemsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
