...
namespace Temboo.Library.Zendesk.Organizations
{
    ...
    /// </summary>
    public class DeleteOrganization : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteOrganization Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteOrganization(TembooSession session) : base(session, "/Library/Zendesk/Organizations/DeleteOrganization")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteOrganizationResultSet containing execution metadata and results.</returns>
        new public DeleteOrganizationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteOrganizationResultSet results = new JavaScriptSerializer().Deserialize<DeleteOrganizationResultSet>(json);
    ...
    /// </summary>
    public class DeleteOrganizationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
