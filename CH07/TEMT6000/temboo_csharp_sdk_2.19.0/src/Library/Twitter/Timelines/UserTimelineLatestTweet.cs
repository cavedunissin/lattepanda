...
namespace Temboo.Library.Twitter.Timelines
{
    ...
    /// </summary>
    public class UserTimelineLatestTweet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UserTimelineLatestTweet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UserTimelineLatestTweet(TembooSession session) : base(session, "/Library/Twitter/Timelines/UserTimelineLatestTweet")
        {
        }
        ...
        /// </summary>
        /// <returns>A UserTimelineLatestTweetResultSet containing execution metadata and results.</returns>
        new public UserTimelineLatestTweetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UserTimelineLatestTweetResultSet results = new JavaScriptSerializer().Deserialize<UserTimelineLatestTweetResultSet>(json);
    ...
    /// </summary>
    public class UserTimelineLatestTweetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
