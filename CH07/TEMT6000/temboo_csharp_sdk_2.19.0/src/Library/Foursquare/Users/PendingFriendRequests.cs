...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class PendingFriendRequests : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PendingFriendRequests Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PendingFriendRequests(TembooSession session) : base(session, "/Library/Foursquare/Users/PendingFriendRequests")
        {
        }
        ...
        /// </summary>
        /// <returns>A PendingFriendRequestsResultSet containing execution metadata and results.</returns>
        new public PendingFriendRequestsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PendingFriendRequestsResultSet results = new JavaScriptSerializer().Deserialize<PendingFriendRequestsResultSet>(json);
    ...
    /// </summary>
    public class PendingFriendRequestsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
