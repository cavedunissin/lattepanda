...
namespace Temboo.Library.GitHub.ReposAPI.Repos
{
    ...
    /// </summary>
    public class DeleteRepo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRepo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRepo(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Repos/DeleteRepo")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteRepoResultSet containing execution metadata and results.</returns>
        new public DeleteRepoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRepoResultSet results = new JavaScriptSerializer().Deserialize<DeleteRepoResultSet>(json);
    ...
    /// </summary>
    public class DeleteRepoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
