...
namespace Temboo.Library.Amazon.CloudDrive.Files
{
    ...
    /// </summary>
    public class GetFileMetadata : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFileMetadata Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFileMetadata(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Files/GetFileMetadata")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the TempLink input for this Choreo.</param>
         public void setTempLink(String value) {
             base.addInput ("TempLink", value);
         }
        ...
        /// </summary>
        /// <returns>A GetFileMetadataResultSet containing execution metadata and results.</returns>
        new public GetFileMetadataResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFileMetadataResultSet results = new JavaScriptSerializer().Deserialize<GetFileMetadataResultSet>(json);
    ...
    /// </summary>
    public class GetFileMetadataResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
