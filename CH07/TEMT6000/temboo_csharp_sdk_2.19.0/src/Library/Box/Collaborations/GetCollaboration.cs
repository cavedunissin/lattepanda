...
namespace Temboo.Library.Box.Collaborations
{
    ...
    /// </summary>
    public class GetCollaboration : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCollaboration Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCollaboration(TembooSession session) : base(session, "/Library/Box/Collaborations/GetCollaboration")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCollaborationResultSet containing execution metadata and results.</returns>
        new public GetCollaborationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCollaborationResultSet results = new JavaScriptSerializer().Deserialize<GetCollaborationResultSet>(json);
    ...
    /// </summary>
    public class GetCollaborationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
