...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListUserPolicies : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListUserPolicies Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListUserPolicies(TembooSession session) : base(session, "/Library/Amazon/IAM/ListUserPolicies")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListUserPoliciesResultSet containing execution metadata and results.</returns>
        new public ListUserPoliciesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListUserPoliciesResultSet results = new JavaScriptSerializer().Deserialize<ListUserPoliciesResultSet>(json);
    ...
    /// </summary>
    public class ListUserPoliciesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
