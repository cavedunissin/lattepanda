...
namespace Temboo.Library.NYTimes.CampaignFinance.PresidentialCampaigns
{
    ...
    /// </summary>
    public class PresidentialCandidateTotals : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PresidentialCandidateTotals Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PresidentialCandidateTotals(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/PresidentialCampaigns/PresidentialCandidateTotals")
        {
        }
        ...
        /// </summary>
        /// <returns>A PresidentialCandidateTotalsResultSet containing execution metadata and results.</returns>
        new public PresidentialCandidateTotalsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PresidentialCandidateTotalsResultSet results = new JavaScriptSerializer().Deserialize<PresidentialCandidateTotalsResultSet>(json);
    ...
    /// </summary>
    public class PresidentialCandidateTotalsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
