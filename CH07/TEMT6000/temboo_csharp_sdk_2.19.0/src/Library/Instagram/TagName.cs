...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class TagName : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TagName Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TagName(TembooSession session) : base(session, "/Library/Instagram/TagName")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the TagName input for this Choreo.</param>
         public void setTagName(String value) {
             base.addInput ("TagName", value);
         }
        ...
        /// </summary>
        /// <returns>A TagNameResultSet containing execution metadata and results.</returns>
        new public TagNameResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TagNameResultSet results = new JavaScriptSerializer().Deserialize<TagNameResultSet>(json);
    ...
    /// </summary>
    public class TagNameResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
