...
namespace Temboo.Library.Foursquare.Venues
{
    ...
    /// </summary>
    public class VenueLinks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VenueLinks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VenueLinks(TembooSession session) : base(session, "/Library/Foursquare/Venues/VenueLinks")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the venue to retrieve URLs for.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A VenueLinksResultSet containing execution metadata and results.</returns>
        new public VenueLinksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VenueLinksResultSet results = new JavaScriptSerializer().Deserialize<VenueLinksResultSet>(json);
    ...
    /// </summary>
    public class VenueLinksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
