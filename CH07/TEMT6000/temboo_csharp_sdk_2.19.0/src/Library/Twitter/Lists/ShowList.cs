...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class ShowList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ShowList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ShowList(TembooSession session) : base(session, "/Library/Twitter/Lists/ShowList")
        {
        }
        ...
        /// </summary>
        /// <returns>A ShowListResultSet containing execution metadata and results.</returns>
        new public ShowListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ShowListResultSet results = new JavaScriptSerializer().Deserialize<ShowListResultSet>(json);
    ...
    /// </summary>
    public class ShowListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
