...
namespace Temboo.Library.Salesforce.Objects
{
    ...
    /// </summary>
    public class GetObjectMetadata : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetObjectMetadata Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetObjectMetadata(TembooSession session) : base(session, "/Library/Salesforce/Objects/GetObjectMetadata")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetObjectMetadataResultSet containing execution metadata and results.</returns>
        new public GetObjectMetadataResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetObjectMetadataResultSet results = new JavaScriptSerializer().Deserialize<GetObjectMetadataResultSet>(json);
    ...
    /// </summary>
    public class GetObjectMetadataResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
