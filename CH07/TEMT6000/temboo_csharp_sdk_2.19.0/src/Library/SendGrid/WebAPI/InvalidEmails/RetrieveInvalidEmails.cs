...
namespace Temboo.Library.SendGrid.WebAPI.InvalidEmails
{
    ...
    /// </summary>
    public class RetrieveInvalidEmails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveInvalidEmails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveInvalidEmails(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/InvalidEmails/RetrieveInvalidEmails")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveInvalidEmailsResultSet containing execution metadata and results.</returns>
        new public RetrieveInvalidEmailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveInvalidEmailsResultSet results = new JavaScriptSerializer().Deserialize<RetrieveInvalidEmailsResultSet>(json);
    ...
    /// </summary>
    public class RetrieveInvalidEmailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
