...
namespace Temboo.Library.Utilities.HTTP
{
    ...
    public class Post : Temboo.Core.Choreography
    {
        ...
        public Post(TembooSession session) : base(session, "/Library/Utilities/HTTP/Post")
        {
        }

         /// <summary>
         /// (optional, multiline) The Base64 encoded content of a file that should be specified as the request body. This input should be used instead of the RequestBody input when posting binary data.
         /// </summary>
         /// <param name="value">Value of the EncodedData input for this Choreo.</param>
         public void setEncodedData(String value) {
             base.addInput ("EncodedData", value);
         }
         /// <summary>
         /// (optional, multiline) The request body for the POST. This input is used when the request body is text e.g. application/json, application/xml, plain/text, etc. Use the EncodedData input when posting binary.
         /// </summary>
