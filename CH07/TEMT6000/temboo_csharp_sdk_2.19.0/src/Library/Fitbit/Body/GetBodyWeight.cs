...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class GetBodyWeight : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBodyWeight Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBodyWeight(TembooSession session) : base(session, "/Library/Fitbit/Body/GetBodyWeight")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBodyWeightResultSet containing execution metadata and results.</returns>
        new public GetBodyWeightResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBodyWeightResultSet results = new JavaScriptSerializer().Deserialize<GetBodyWeightResultSet>(json);
    ...
    /// </summary>
    public class GetBodyWeightResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
