...
namespace Temboo.Library.Twilio.Calls
{
    ...
    /// </summary>
    public class GetCall : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCall Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCall(TembooSession session) : base(session, "/Library/Twilio/Calls/GetCall")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCallResultSet containing execution metadata and results.</returns>
        new public GetCallResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCallResultSet results = new JavaScriptSerializer().Deserialize<GetCallResultSet>(json);
    ...
    /// </summary>
    public class GetCallResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
