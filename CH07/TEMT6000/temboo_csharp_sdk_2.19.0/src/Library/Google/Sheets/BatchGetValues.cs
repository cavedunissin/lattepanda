...
namespace Temboo.Library.Google.Sheets
{
    ...
    /// </summary>
    public class BatchGetValues : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the BatchGetValues Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public BatchGetValues(TembooSession session) : base(session, "/Library/Google/Sheets/BatchGetValues")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Indicates the dimension that results should use. Valid values are ROWS (the default) or COLUMNS.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The A1 notation of the values to retrieve formatted as an array (e.g. ["Sheet1!A2:C3"]). Note, this input supports up to 10 ranges.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A BatchGetValuesResultSet containing execution metadata and results.</returns>
        new public BatchGetValuesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BatchGetValuesResultSet results = new JavaScriptSerializer().Deserialize<BatchGetValuesResultSet>(json);
    ...
    /// </summary>
    public class BatchGetValuesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
