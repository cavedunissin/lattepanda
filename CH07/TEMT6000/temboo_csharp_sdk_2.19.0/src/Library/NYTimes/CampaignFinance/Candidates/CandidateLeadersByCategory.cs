...
namespace Temboo.Library.NYTimes.CampaignFinance.Candidates
{
    /// <summary>
    /// CandidateLeadersByCategory
    /// Retrieve a list of the 20 top candidates in terms of contributions received.
    /// </summary>
    public class CandidateLeadersByCategory : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CandidateLeadersByCategory Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CandidateLeadersByCategory(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Candidates/CandidateLeadersByCategory")
        {
        }
        ...
        /// </summary>
        /// <returns>A CandidateLeadersByCategoryResultSet containing execution metadata and results.</returns>
        new public CandidateLeadersByCategoryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CandidateLeadersByCategoryResultSet results = new JavaScriptSerializer().Deserialize<CandidateLeadersByCategoryResultSet>(json);
    ...
    /// </summary>
    public class CandidateLeadersByCategoryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
