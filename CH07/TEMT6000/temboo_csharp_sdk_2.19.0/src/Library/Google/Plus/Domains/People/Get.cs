...
namespace Temboo.Library.Google.Plus.Domains.People
{
    ...
    public class Get : Temboo.Core.Choreography
    {
        ...
        public Get(TembooSession session) : base(session, "/Library/Google/Plus/Domains/People/Get")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the user to get. The value "me" is set as the default to indicate the authenticated user.
         /// </summary>
