...
namespace Temboo.Library.UnlockPlaces
{
    ...
    /// </summary>
    public class UniqueNameSearch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UniqueNameSearch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UniqueNameSearch(TembooSession session) : base(session, "/Library/UnlockPlaces/UniqueNameSearch")
        {
        }
        ...
        /// </summary>
        /// <returns>A UniqueNameSearchResultSet containing execution metadata and results.</returns>
        new public UniqueNameSearchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UniqueNameSearchResultSet results = new JavaScriptSerializer().Deserialize<UniqueNameSearchResultSet>(json);
    ...
    /// </summary>
    public class UniqueNameSearchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
