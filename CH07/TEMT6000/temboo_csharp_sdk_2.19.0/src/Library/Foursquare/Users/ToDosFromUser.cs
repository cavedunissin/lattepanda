...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class ToDosFromUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ToDosFromUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ToDosFromUser(TembooSession session) : base(session, "/Library/Foursquare/Users/ToDosFromUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A ToDosFromUserResultSet containing execution metadata and results.</returns>
        new public ToDosFromUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ToDosFromUserResultSet results = new JavaScriptSerializer().Deserialize<ToDosFromUserResultSet>(json);
    ...
    /// </summary>
    public class ToDosFromUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
