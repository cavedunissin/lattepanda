...
namespace Temboo.Library.Google.ComputeEngine.Routes
{
    ...
    /// </summary>
    public class ListRoutes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRoutes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRoutes(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Routes/ListRoutes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRoutesResultSet containing execution metadata and results.</returns>
        new public ListRoutesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRoutesResultSet results = new JavaScriptSerializer().Deserialize<ListRoutesResultSet>(json);
    ...
    /// </summary>
    public class ListRoutesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
