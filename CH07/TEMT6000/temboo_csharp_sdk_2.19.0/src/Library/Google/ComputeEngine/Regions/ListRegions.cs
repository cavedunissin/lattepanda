...
namespace Temboo.Library.Google.ComputeEngine.Regions
{
    /// <summary>
    /// ListRegions
    /// Retrieves the list of Regions available to the specified project.
    /// </summary>
    public class ListRegions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListRegions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListRegions(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Regions/ListRegions")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListRegionsResultSet containing execution metadata and results.</returns>
        new public ListRegionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListRegionsResultSet results = new JavaScriptSerializer().Deserialize<ListRegionsResultSet>(json);
    ...
    /// </summary>
    public class ListRegionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
