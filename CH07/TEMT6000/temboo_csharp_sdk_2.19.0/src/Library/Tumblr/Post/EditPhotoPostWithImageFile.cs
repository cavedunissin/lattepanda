...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class EditPhotoPostWithImageFile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EditPhotoPostWithImageFile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EditPhotoPostWithImageFile(TembooSession session) : base(session, "/Library/Tumblr/Post/EditPhotoPostWithImageFile")
        {
        }
        ...
        /// </summary>
        /// <returns>A EditPhotoPostWithImageFileResultSet containing execution metadata and results.</returns>
        new public EditPhotoPostWithImageFileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EditPhotoPostWithImageFileResultSet results = new JavaScriptSerializer().Deserialize<EditPhotoPostWithImageFileResultSet>(json);
    ...
    /// </summary>
    public class EditPhotoPostWithImageFileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
