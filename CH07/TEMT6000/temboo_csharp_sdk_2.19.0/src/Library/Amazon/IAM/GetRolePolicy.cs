...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class GetRolePolicy : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRolePolicy Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRolePolicy(TembooSession session) : base(session, "/Library/Amazon/IAM/GetRolePolicy")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRolePolicyResultSet containing execution metadata and results.</returns>
        new public GetRolePolicyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRolePolicyResultSet results = new JavaScriptSerializer().Deserialize<GetRolePolicyResultSet>(json);
    ...
    /// </summary>
    public class GetRolePolicyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
