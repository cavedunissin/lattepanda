...
namespace Temboo.Library.GitHub.GitDataAPI.Tags
{
    ...
    /// </summary>
    public class GetTag : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTag Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTag(TembooSession session) : base(session, "/Library/GitHub/GitDataAPI/Tags/GetTag")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTagResultSet containing execution metadata and results.</returns>
        new public GetTagResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTagResultSet results = new JavaScriptSerializer().Deserialize<GetTagResultSet>(json);
    ...
    /// </summary>
    public class GetTagResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
