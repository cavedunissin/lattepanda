...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class GetBodyWeightGoal : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBodyWeightGoal Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBodyWeightGoal(TembooSession session) : base(session, "/Library/Fitbit/Body/GetBodyWeightGoal")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBodyWeightGoalResultSet containing execution metadata and results.</returns>
        new public GetBodyWeightGoalResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBodyWeightGoalResultSet results = new JavaScriptSerializer().Deserialize<GetBodyWeightGoalResultSet>(json);
    ...
    /// </summary>
    public class GetBodyWeightGoalResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
