...
namespace Temboo.Library.Foursquare.Venues
{
    ...
    /// </summary>
    public class Similar : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Similar Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Similar(TembooSession session) : base(session, "/Library/Foursquare/Venues/Similar")
        {
        }
        ...
        /// </summary>
        /// <returns>A SimilarResultSet containing execution metadata and results.</returns>
        new public SimilarResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SimilarResultSet results = new JavaScriptSerializer().Deserialize<SimilarResultSet>(json);
    ...
    /// </summary>
    public class SimilarResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
