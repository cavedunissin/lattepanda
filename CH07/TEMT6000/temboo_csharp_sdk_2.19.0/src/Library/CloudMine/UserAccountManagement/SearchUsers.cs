...
namespace Temboo.Library.CloudMine.UserAccountManagement
{
    ...
    /// </summary>
    public class SearchUsers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchUsers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchUsers(TembooSession session) : base(session, "/Library/CloudMine/UserAccountManagement/SearchUsers")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchUsersResultSet containing execution metadata and results.</returns>
        new public SearchUsersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchUsersResultSet results = new JavaScriptSerializer().Deserialize<SearchUsersResultSet>(json);
    ...
    /// </summary>
    public class SearchUsersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
