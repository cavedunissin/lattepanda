...
namespace Temboo.Library.Flickr.Tags
{
    ...
    /// </summary>
    public class ListUserTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListUserTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListUserTags(TembooSession session) : base(session, "/Library/Flickr/Tags/ListUserTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListUserTagsResultSet containing execution metadata and results.</returns>
        new public ListUserTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListUserTagsResultSet results = new JavaScriptSerializer().Deserialize<ListUserTagsResultSet>(json);
    ...
    /// </summary>
    public class ListUserTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
