...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class StructuredQuery : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the StructuredQuery Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public StructuredQuery(TembooSession session) : base(session, "/Library/Google/Spreadsheets/StructuredQuery")
        {
        }
        ...
        /// </summary>
        /// <returns>A StructuredQueryResultSet containing execution metadata and results.</returns>
        new public StructuredQueryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            StructuredQueryResultSet results = new JavaScriptSerializer().Deserialize<StructuredQueryResultSet>(json);
    ...
    /// </summary>
    public class StructuredQueryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
