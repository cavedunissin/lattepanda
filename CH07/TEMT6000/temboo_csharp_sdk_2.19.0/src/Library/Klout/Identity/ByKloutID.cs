...
namespace Temboo.Library.Klout.Identity
{
    ...
    /// </summary>
    public class ByKloutID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ByKloutID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ByKloutID(TembooSession session) : base(session, "/Library/Klout/Identity/ByKloutID")
        {
        }
        ...
        /// </summary>
        /// <returns>A ByKloutIDResultSet containing execution metadata and results.</returns>
        new public ByKloutIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ByKloutIDResultSet results = new JavaScriptSerializer().Deserialize<ByKloutIDResultSet>(json);
    ...
    /// </summary>
    public class ByKloutIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
