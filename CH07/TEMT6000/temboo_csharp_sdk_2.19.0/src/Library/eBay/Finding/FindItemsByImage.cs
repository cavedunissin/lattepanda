...
namespace Temboo.Library.eBay.Finding
{
    ...
    /// </summary>
    public class FindItemsByImage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FindItemsByImage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FindItemsByImage(TembooSession session) : base(session, "/Library/eBay/Finding/FindItemsByImage")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the FindItemsByImageRequest input for this Choreo.</param>
         public void setFindItemsByImageRequest(String value) {
             base.addInput ("FindItemsByImageRequest", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A FindItemsByImageResultSet containing execution metadata and results.</returns>
        new public FindItemsByImageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FindItemsByImageResultSet results = new JavaScriptSerializer().Deserialize<FindItemsByImageResultSet>(json);
    ...
    /// </summary>
    public class FindItemsByImageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
