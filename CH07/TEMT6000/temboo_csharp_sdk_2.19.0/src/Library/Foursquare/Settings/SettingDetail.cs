...
namespace Temboo.Library.Foursquare.Settings
{
    ...
    /// </summary>
    public class SettingDetail : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SettingDetail Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SettingDetail(TembooSession session) : base(session, "/Library/Foursquare/Settings/SettingDetail")
        {
        }
        ...
        /// </summary>
        /// <returns>A SettingDetailResultSet containing execution metadata and results.</returns>
        new public SettingDetailResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SettingDetailResultSet results = new JavaScriptSerializer().Deserialize<SettingDetailResultSet>(json);
    ...
    /// </summary>
    public class SettingDetailResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
