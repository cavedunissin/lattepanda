...
namespace Temboo.Library.Mixpanel.DataExport.Properties
{
    ...
    /// </summary>
    public class TopValues : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TopValues Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TopValues(TembooSession session) : base(session, "/Library/Mixpanel/DataExport/Properties/TopValues")
        {
        }
        ...
        /// </summary>
        /// <returns>A TopValuesResultSet containing execution metadata and results.</returns>
        new public TopValuesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TopValuesResultSet results = new JavaScriptSerializer().Deserialize<TopValuesResultSet>(json);
    ...
    /// </summary>
    public class TopValuesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
