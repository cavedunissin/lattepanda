...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class GetObject : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetObject Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetObject(TembooSession session) : base(session, "/Library/Facebook/Reading/GetObject")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetObjectResultSet containing execution metadata and results.</returns>
        new public GetObjectResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetObjectResultSet results = new JavaScriptSerializer().Deserialize<GetObjectResultSet>(json);
    ...
    /// </summary>
    public class GetObjectResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
