...
namespace Temboo.Library.Stripe.Customers
{
    ...
    /// </summary>
    public class ListAllCustomers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllCustomers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllCustomers(TembooSession session) : base(session, "/Library/Stripe/Customers/ListAllCustomers")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllCustomersResultSet containing execution metadata and results.</returns>
        new public ListAllCustomersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllCustomersResultSet results = new JavaScriptSerializer().Deserialize<ListAllCustomersResultSet>(json);
    ...
    /// </summary>
    public class ListAllCustomersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
