...
namespace Temboo.Library.Google.Drive.Files
{
    ...
    /// </summary>
    public class Touch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Touch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Touch(TembooSession session) : base(session, "/Library/Google/Drive/Files/Touch")
        {
        }
        ...
        /// </summary>
        /// <returns>A TouchResultSet containing execution metadata and results.</returns>
        new public TouchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TouchResultSet results = new JavaScriptSerializer().Deserialize<TouchResultSet>(json);
    ...
    /// </summary>
    public class TouchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
