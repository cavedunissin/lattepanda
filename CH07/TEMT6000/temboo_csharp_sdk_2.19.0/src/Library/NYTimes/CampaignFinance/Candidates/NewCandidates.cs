...
namespace Temboo.Library.NYTimes.CampaignFinance.Candidates
{
    ...
    /// </summary>
    public class NewCandidates : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the NewCandidates Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public NewCandidates(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Candidates/NewCandidates")
        {
        }
        ...
        /// </summary>
        /// <returns>A NewCandidatesResultSet containing execution metadata and results.</returns>
        new public NewCandidatesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            NewCandidatesResultSet results = new JavaScriptSerializer().Deserialize<NewCandidatesResultSet>(json);
    ...
    /// </summary>
    public class NewCandidatesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
