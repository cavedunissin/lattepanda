...
namespace Temboo.Library.LastFm.Artist
{
    ...
    /// </summary>
    public class GetShouts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetShouts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetShouts(TembooSession session) : base(session, "/Library/LastFm/Artist/GetShouts")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetShoutsResultSet containing execution metadata and results.</returns>
        new public GetShoutsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetShoutsResultSet results = new JavaScriptSerializer().Deserialize<GetShoutsResultSet>(json);
    ...
    /// </summary>
    public class GetShoutsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
