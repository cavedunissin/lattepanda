...
namespace Temboo.Library.eBay.Finding
{
    ...
    /// </summary>
    public class FindCompletedItems : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FindCompletedItems Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FindCompletedItems(TembooSession session) : base(session, "/Library/eBay/Finding/FindCompletedItems")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the FindCompletedItemsRequest input for this Choreo.</param>
         public void setFindCompletedItemsRequest(String value) {
             base.addInput ("FindCompletedItemsRequest", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A FindCompletedItemsResultSet containing execution metadata and results.</returns>
        new public FindCompletedItemsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FindCompletedItemsResultSet results = new JavaScriptSerializer().Deserialize<FindCompletedItemsResultSet>(json);
    ...
    /// </summary>
    public class FindCompletedItemsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
