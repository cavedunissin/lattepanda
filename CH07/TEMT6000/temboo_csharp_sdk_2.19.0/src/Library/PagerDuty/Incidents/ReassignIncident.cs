...
namespace Temboo.Library.PagerDuty.Incidents
{
    ...
    /// </summary>
    public class ReassignIncident : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReassignIncident Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReassignIncident(TembooSession session) : base(session, "/Library/PagerDuty/Incidents/ReassignIncident")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the EscalationLevel input for this Choreo.</param>
         public void setEscalationLevel(String value) {
             base.addInput ("EscalationLevel", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A ReassignIncidentResultSet containing execution metadata and results.</returns>
        new public ReassignIncidentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReassignIncidentResultSet results = new JavaScriptSerializer().Deserialize<ReassignIncidentResultSet>(json);
    ...
    /// </summary>
    public class ReassignIncidentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
