...
namespace Temboo.Library.Google.ComputeEngine.Zones
{
    /// <summary>
    /// ListZones
    /// Retrieves the list of Zone resources for the specified project.
    /// </summary>
    public class ListZones : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListZones Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListZones(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Zones/ListZones")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListZonesResultSet containing execution metadata and results.</returns>
        new public ListZonesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListZonesResultSet results = new JavaScriptSerializer().Deserialize<ListZonesResultSet>(json);
    ...
    /// </summary>
    public class ListZonesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
