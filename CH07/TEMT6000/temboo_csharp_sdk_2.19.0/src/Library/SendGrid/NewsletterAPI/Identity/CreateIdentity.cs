...
namespace Temboo.Library.SendGrid.NewsletterAPI.Identity
{
    ...
    /// </summary>
    public class CreateIdentity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateIdentity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateIdentity(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Identity/CreateIdentity")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateIdentityResultSet containing execution metadata and results.</returns>
        new public CreateIdentityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateIdentityResultSet results = new JavaScriptSerializer().Deserialize<CreateIdentityResultSet>(json);
    ...
    /// </summary>
    public class CreateIdentityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
