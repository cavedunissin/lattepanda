...
namespace Temboo.Library.Google.Gmailv2.Labels
{
    /// <summary>
    /// CreateLabel
    /// Creates a new label.
    /// </summary>
    public class CreateLabel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateLabel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateLabel(TembooSession session) : base(session, "/Library/Google/Gmailv2/Labels/CreateLabel")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the LabelListVisibility input for this Choreo.</param>
         public void setLabelListVisibility(String value) {
             base.addInput ("LabelListVisibility", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the MessageListVisibility input for this Choreo.</param>
         public void setMessageListVisibility(String value) {
             base.addInput ("MessageListVisibility", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreateLabelResultSet containing execution metadata and results.</returns>
        new public CreateLabelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateLabelResultSet results = new JavaScriptSerializer().Deserialize<CreateLabelResultSet>(json);
    ...
    /// </summary>
    public class CreateLabelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
