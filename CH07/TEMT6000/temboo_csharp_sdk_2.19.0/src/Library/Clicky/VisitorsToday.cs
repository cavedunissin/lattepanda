...
namespace Temboo.Library.Clicky
{
    ...
    /// </summary>
    public class VisitorsToday : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VisitorsToday Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VisitorsToday(TembooSession session) : base(session, "/Library/Clicky/VisitorsToday")
        {
        }
        ...
        /// </summary>
        /// <returns>A VisitorsTodayResultSet containing execution metadata and results.</returns>
        new public VisitorsTodayResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VisitorsTodayResultSet results = new JavaScriptSerializer().Deserialize<VisitorsTodayResultSet>(json);
    ...
    /// </summary>
    public class VisitorsTodayResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
