...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class GetLikes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLikes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLikes(TembooSession session) : base(session, "/Library/LinkedIn/Companies/GetLikes")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLikesResultSet containing execution metadata and results.</returns>
        new public GetLikesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLikesResultSet results = new JavaScriptSerializer().Deserialize<GetLikesResultSet>(json);
    ...
    /// </summary>
    public class GetLikesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
