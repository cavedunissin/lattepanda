...
namespace Temboo.Library.Amazon.RDS
{
    ...
    /// </summary>
    public class RestoreDBInstanceFromDBSnapshot : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RestoreDBInstanceFromDBSnapshot Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RestoreDBInstanceFromDBSnapshot(TembooSession session) : base(session, "/Library/Amazon/RDS/RestoreDBInstanceFromDBSnapshot")
        {
        }
        ...
        /// </summary>
        /// <returns>A RestoreDBInstanceFromDBSnapshotResultSet containing execution metadata and results.</returns>
        new public RestoreDBInstanceFromDBSnapshotResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RestoreDBInstanceFromDBSnapshotResultSet results = new JavaScriptSerializer().Deserialize<RestoreDBInstanceFromDBSnapshotResultSet>(json);
    ...
    /// </summary>
    public class RestoreDBInstanceFromDBSnapshotResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
