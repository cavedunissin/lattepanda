...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListSigningCertificates : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListSigningCertificates Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListSigningCertificates(TembooSession session) : base(session, "/Library/Amazon/IAM/ListSigningCertificates")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListSigningCertificatesResultSet containing execution metadata and results.</returns>
        new public ListSigningCertificatesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListSigningCertificatesResultSet results = new JavaScriptSerializer().Deserialize<ListSigningCertificatesResultSet>(json);
    ...
    /// </summary>
    public class ListSigningCertificatesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
