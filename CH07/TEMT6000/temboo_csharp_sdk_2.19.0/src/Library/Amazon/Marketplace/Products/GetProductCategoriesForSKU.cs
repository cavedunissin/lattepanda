...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    /// </summary>
    public class GetProductCategoriesForSKU : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetProductCategoriesForSKU Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetProductCategoriesForSKU(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/GetProductCategoriesForSKU")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetProductCategoriesForSKUResultSet containing execution metadata and results.</returns>
        new public GetProductCategoriesForSKUResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetProductCategoriesForSKUResultSet results = new JavaScriptSerializer().Deserialize<GetProductCategoriesForSKUResultSet>(json);
    ...
    /// </summary>
    public class GetProductCategoriesForSKUResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
