...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class UpdateListRows : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateListRows Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateListRows(TembooSession session) : base(session, "/Library/Google/Spreadsheets/UpdateListRows")
        {
        }
         ...
         /// <summary>
         /// (conditional, string) The unique id of the row you want to update. Required unless providing the Link input.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) The unique key of the spreadsheet that contains the worksheet you want to update. Required unless providing the Link input.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) The unique ID of the worksheet that you want to update. Required unless providing the Link input.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A UpdateListRowsResultSet containing execution metadata and results.</returns>
        new public UpdateListRowsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateListRowsResultSet results = new JavaScriptSerializer().Deserialize<UpdateListRowsResultSet>(json);
    ...
    /// </summary>
    public class UpdateListRowsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
