...
namespace Temboo.Library.Zendesk.Requests
{
    ...
    /// </summary>
    public class ListUserRequests : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListUserRequests Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListUserRequests(TembooSession session) : base(session, "/Library/Zendesk/Requests/ListUserRequests")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListUserRequestsResultSet containing execution metadata and results.</returns>
        new public ListUserRequestsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListUserRequestsResultSet results = new JavaScriptSerializer().Deserialize<ListUserRequestsResultSet>(json);
    ...
    /// </summary>
    public class ListUserRequestsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
