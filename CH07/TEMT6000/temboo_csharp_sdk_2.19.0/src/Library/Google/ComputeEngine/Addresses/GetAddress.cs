...
namespace Temboo.Library.Google.ComputeEngine.Addresses
{
    ...
    /// </summary>
    public class GetAddress : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAddress Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAddress(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Addresses/GetAddress")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAddressResultSet containing execution metadata and results.</returns>
        new public GetAddressResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAddressResultSet results = new JavaScriptSerializer().Deserialize<GetAddressResultSet>(json);
    ...
    /// </summary>
    public class GetAddressResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
