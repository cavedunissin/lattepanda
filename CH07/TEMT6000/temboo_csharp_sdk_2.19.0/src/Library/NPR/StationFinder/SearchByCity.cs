...
namespace Temboo.Library.NPR.StationFinder
{
    ...
    /// </summary>
    public class SearchByCity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchByCity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchByCity(TembooSession session) : base(session, "/Library/NPR/StationFinder/SearchByCity")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchByCityResultSet containing execution metadata and results.</returns>
        new public SearchByCityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchByCityResultSet results = new JavaScriptSerializer().Deserialize<SearchByCityResultSet>(json);
    ...
    /// </summary>
    public class SearchByCityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
