...
namespace Temboo.Library.Fitbit.OAuth
{
    ...
    public class RefreshToken : Temboo.Core.Choreography
    {
        ...
        public RefreshToken(TembooSession session) : base(session, "/Library/Fitbit/OAuth/RefreshToken")
        {
        }

         /// <summary>
         /// (required, string) The OAuth 2.0 Client ID provided by the Fitbit.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The OAuth 2.0 Client Secret provided by Fitbit.
         /// </summary>
