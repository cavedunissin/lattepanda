...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class GetStatuses : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetStatuses Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetStatuses(TembooSession session) : base(session, "/Library/Twitter/Lists/GetStatuses")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the IncludeEntitities input for this Choreo.</param>
         public void setIncludeEntitities(String value) {
             base.addInput ("IncludeEntitities", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetStatusesResultSet containing execution metadata and results.</returns>
        new public GetStatusesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetStatusesResultSet results = new JavaScriptSerializer().Deserialize<GetStatusesResultSet>(json);
    ...
    /// </summary>
    public class GetStatusesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
