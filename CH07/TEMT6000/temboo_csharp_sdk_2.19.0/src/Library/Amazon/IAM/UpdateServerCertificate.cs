...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class UpdateServerCertificate : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateServerCertificate Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateServerCertificate(TembooSession session) : base(session, "/Library/Amazon/IAM/UpdateServerCertificate")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the NewServerCertificateName input for this Choreo.</param>
         public void setNewServerCertificateName(String value) {
             base.addInput ("NewServerCertificateName", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateServerCertificateResultSet containing execution metadata and results.</returns>
        new public UpdateServerCertificateResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateServerCertificateResultSet results = new JavaScriptSerializer().Deserialize<UpdateServerCertificateResultSet>(json);
    ...
    /// </summary>
    public class UpdateServerCertificateResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
