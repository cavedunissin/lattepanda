...
namespace Temboo.Library.Google.ComputeEngine.GlobalOperations
{
    /// <summary>
    /// DeleteGlobalOperation
    /// Deletes the specified Global Operation.
    /// </summary>
    public class DeleteGlobalOperation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteGlobalOperation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteGlobalOperation(TembooSession session) : base(session, "/Library/Google/ComputeEngine/GlobalOperations/DeleteGlobalOperation")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Operation input for this Choreo.</param>
         public void setOperation(String value) {
             base.addInput ("Operation", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DeleteGlobalOperationResultSet containing execution metadata and results.</returns>
        new public DeleteGlobalOperationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteGlobalOperationResultSet results = new JavaScriptSerializer().Deserialize<DeleteGlobalOperationResultSet>(json);
    ...
    /// </summary>
    public class DeleteGlobalOperationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
