...
namespace Temboo.Library.Zendesk.Tags
{
    /// <summary>
    /// ListTags
    /// Retrieves the most popular recent tags in decreasing popularity.
    /// </summary>
    public class ListTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTags(TembooSession session) : base(session, "/Library/Zendesk/Tags/ListTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTagsResultSet containing execution metadata and results.</returns>
        new public ListTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTagsResultSet results = new JavaScriptSerializer().Deserialize<ListTagsResultSet>(json);
    ...
    /// </summary>
    public class ListTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
