...
namespace Temboo.Library.Salesforce.Resources
{
    /// <summary>
    /// GetResources
    /// List available resources for a specified API version.
    /// </summary>
    public class GetResources : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetResources Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetResources(TembooSession session) : base(session, "/Library/Salesforce/Resources/GetResources")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The API version number to retrieve resources for. Defaults to "v28.0".
         /// </summary>
         /// <param name="value">Value of the Version input for this Choreo.</param>
         public void setVersion(String value) {
             base.addInput ("Version", value);
         }
        ...
        /// </summary>
        /// <returns>A GetResourcesResultSet containing execution metadata and results.</returns>
        new public GetResourcesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetResourcesResultSet results = new JavaScriptSerializer().Deserialize<GetResourcesResultSet>(json);
    ...
    /// </summary>
    public class GetResourcesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
