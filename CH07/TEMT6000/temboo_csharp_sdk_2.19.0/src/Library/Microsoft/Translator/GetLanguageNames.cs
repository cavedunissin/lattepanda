...
namespace Temboo.Library.Microsoft.Translator
{
    ...
    /// </summary>
    public class GetLanguageNames : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLanguageNames Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLanguageNames(TembooSession session) : base(session, "/Library/Microsoft/Translator/GetLanguageNames")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the LanguageCodes input for this Choreo.</param>
         public void setLanguageCodes(String value) {
             base.addInput ("LanguageCodes", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetLanguageNamesResultSet containing execution metadata and results.</returns>
        new public GetLanguageNamesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLanguageNamesResultSet results = new JavaScriptSerializer().Deserialize<GetLanguageNamesResultSet>(json);
    ...
    /// </summary>
    public class GetLanguageNamesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
