...
namespace Temboo.Library.Google.ComputeEngine.ZoneOperations
{
    /// <summary>
    /// DeleteZoneOperation
    /// Deletes the specified Zone Operation resource.
    /// </summary>
    public class DeleteZoneOperation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteZoneOperation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteZoneOperation(TembooSession session) : base(session, "/Library/Google/ComputeEngine/ZoneOperations/DeleteZoneOperation")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteZoneOperationResultSet containing execution metadata and results.</returns>
        new public DeleteZoneOperationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteZoneOperationResultSet results = new JavaScriptSerializer().Deserialize<DeleteZoneOperationResultSet>(json);
    ...
    /// </summary>
    public class DeleteZoneOperationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
