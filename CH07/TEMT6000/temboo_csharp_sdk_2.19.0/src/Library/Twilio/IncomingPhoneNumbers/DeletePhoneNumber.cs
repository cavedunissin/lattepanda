...
namespace Temboo.Library.Twilio.IncomingPhoneNumbers
{
    ...
    /// </summary>
    public class DeletePhoneNumber : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeletePhoneNumber Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeletePhoneNumber(TembooSession session) : base(session, "/Library/Twilio/IncomingPhoneNumbers/DeletePhoneNumber")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeletePhoneNumberResultSet containing execution metadata and results.</returns>
        new public DeletePhoneNumberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeletePhoneNumberResultSet results = new JavaScriptSerializer().Deserialize<DeletePhoneNumberResultSet>(json);
    ...
    /// </summary>
    public class DeletePhoneNumberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
