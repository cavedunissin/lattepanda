...
namespace Temboo.Library.LittleSis.Entity
{
    ...
    /// </summary>
    public class GetRelationshipsByEntity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRelationshipsByEntity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRelationshipsByEntity(TembooSession session) : base(session, "/Library/LittleSis/Entity/GetRelationshipsByEntity")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRelationshipsByEntityResultSet containing execution metadata and results.</returns>
        new public GetRelationshipsByEntityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRelationshipsByEntityResultSet results = new JavaScriptSerializer().Deserialize<GetRelationshipsByEntityResultSet>(json);
    ...
    /// </summary>
    public class GetRelationshipsByEntityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
