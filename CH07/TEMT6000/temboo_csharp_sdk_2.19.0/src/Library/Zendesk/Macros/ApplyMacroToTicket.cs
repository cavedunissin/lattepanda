...
namespace Temboo.Library.Zendesk.Macros
{
    ...
    /// </summary>
    public class ApplyMacroToTicket : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ApplyMacroToTicket Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ApplyMacroToTicket(TembooSession session) : base(session, "/Library/Zendesk/Macros/ApplyMacroToTicket")
        {
        }
        ...
        /// </summary>
        /// <returns>A ApplyMacroToTicketResultSet containing execution metadata and results.</returns>
        new public ApplyMacroToTicketResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ApplyMacroToTicketResultSet results = new JavaScriptSerializer().Deserialize<ApplyMacroToTicketResultSet>(json);
    ...
    /// </summary>
    public class ApplyMacroToTicketResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
