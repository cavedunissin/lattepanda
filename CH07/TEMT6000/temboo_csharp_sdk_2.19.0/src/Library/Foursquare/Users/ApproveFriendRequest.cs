...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class ApproveFriendRequest : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ApproveFriendRequest Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ApproveFriendRequest(TembooSession session) : base(session, "/Library/Foursquare/Users/ApproveFriendRequest")
        {
        }
        ...
        /// </summary>
        /// <returns>A ApproveFriendRequestResultSet containing execution metadata and results.</returns>
        new public ApproveFriendRequestResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ApproveFriendRequestResultSet results = new JavaScriptSerializer().Deserialize<ApproveFriendRequestResultSet>(json);
    ...
    /// </summary>
    public class ApproveFriendRequestResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
