...
namespace Temboo.Library.eBay.Trading
{
    ...
    /// </summary>
    public class GetEbayOfficialTime : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEbayOfficialTime Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEbayOfficialTime(TembooSession session) : base(session, "/Library/eBay/Trading/GetEbayOfficialTime")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetEbayOfficialTimeResultSet containing execution metadata and results.</returns>
        new public GetEbayOfficialTimeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEbayOfficialTimeResultSet results = new JavaScriptSerializer().Deserialize<GetEbayOfficialTimeResultSet>(json);
    ...
    /// </summary>
    public class GetEbayOfficialTimeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
