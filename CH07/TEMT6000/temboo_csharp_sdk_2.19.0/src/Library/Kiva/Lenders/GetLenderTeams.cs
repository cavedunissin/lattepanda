...
namespace Temboo.Library.Kiva.Lenders
{
    ...
    /// </summary>
    public class GetLenderTeams : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLenderTeams Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLenderTeams(TembooSession session) : base(session, "/Library/Kiva/Lenders/GetLenderTeams")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLenderTeamsResultSet containing execution metadata and results.</returns>
        new public GetLenderTeamsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLenderTeamsResultSet results = new JavaScriptSerializer().Deserialize<GetLenderTeamsResultSet>(json);
    ...
    /// </summary>
    public class GetLenderTeamsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
