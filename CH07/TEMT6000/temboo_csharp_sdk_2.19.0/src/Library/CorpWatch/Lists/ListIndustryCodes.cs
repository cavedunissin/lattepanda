...
namespace Temboo.Library.CorpWatch.Lists
{
    ...
    /// </summary>
    public class ListIndustryCodes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListIndustryCodes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListIndustryCodes(TembooSession session) : base(session, "/Library/CorpWatch/Lists/ListIndustryCodes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListIndustryCodesResultSet containing execution metadata and results.</returns>
        new public ListIndustryCodesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListIndustryCodesResultSet results = new JavaScriptSerializer().Deserialize<ListIndustryCodesResultSet>(json);
    ...
    /// </summary>
    public class ListIndustryCodesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
