...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    public class DeleteRow : Temboo.Core.Choreography
    {
        ...
        public DeleteRow(TembooSession session) : base(session, "/Library/Google/Spreadsheets/DeleteRow")
        {
        }
         ...
         /// <summary>
         /// (conditional, boolean) When set to "true", the last row in the list will be deleted. The Row input is ignored when using this flag.
         /// </summary>
         /// <param name="value">Value of the DeleteLast input for this Choreo.</param>
         public void setDeleteLast(String value) {
             base.addInput ("DeleteLast", value);
         }
         /// <summary>
         /// (conditional, password) Deprecated (retained for backward compatibility only).
         /// </summary>
         ...
         /// <summary>
         /// (conditional, integer) The number of the row to delete. Required unless using the DeleteLast flag. Note that row 1 (the column header row) cannot be deleted.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The unique key of the spreadsheet associated with the row you want to delete. This can be found in the URL when viewing the spreadsheet. Required unless SpreadsheetName and WorksheetName are supplied.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) The name of the spreadsheet to delete a row from. This and WorksheetName can be used as an alternative to SpreadsheetKey and WorksheetId to lookup spreadsheet details by name.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The unique ID of the worksheet that you want to delete from. Typically, Sheet1 has the id of "od6". Required unless SpreadsheetName and WorksheetName are supplied.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) The name of the worksheet to delete a row from. This and SpreadsheetName can be used as an alternative to SpreadsheetKey and WorksheetId to lookup spreadsheet details by name.
         /// </summary>
