...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class RetrieveSpreadsheets : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveSpreadsheets Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveSpreadsheets(TembooSession session) : base(session, "/Library/Google/Spreadsheets/RetrieveSpreadsheets")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveSpreadsheetsResultSet containing execution metadata and results.</returns>
        new public RetrieveSpreadsheetsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveSpreadsheetsResultSet results = new JavaScriptSerializer().Deserialize<RetrieveSpreadsheetsResultSet>(json);
    ...
    /// </summary>
    public class RetrieveSpreadsheetsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
