...
namespace Temboo.Library.SendGrid.WebAPI.Profile
{
    ...
    /// </summary>
    public class UpdateUsername : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateUsername Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateUsername(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Profile/UpdateUsername")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateUsernameResultSet containing execution metadata and results.</returns>
        new public UpdateUsernameResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateUsernameResultSet results = new JavaScriptSerializer().Deserialize<UpdateUsernameResultSet>(json);
    ...
    /// </summary>
    public class UpdateUsernameResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
