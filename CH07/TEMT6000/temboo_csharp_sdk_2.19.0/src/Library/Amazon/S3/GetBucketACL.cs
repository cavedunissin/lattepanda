...
namespace Temboo.Library.Amazon.S3
{
    ...
    /// </summary>
    public class GetBucketACL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBucketACL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBucketACL(TembooSession session) : base(session, "/Library/Amazon/S3/GetBucketACL")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetBucketACLResultSet containing execution metadata and results.</returns>
        new public GetBucketACLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBucketACLResultSet results = new JavaScriptSerializer().Deserialize<GetBucketACLResultSet>(json);
    ...
    /// </summary>
    public class GetBucketACLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
