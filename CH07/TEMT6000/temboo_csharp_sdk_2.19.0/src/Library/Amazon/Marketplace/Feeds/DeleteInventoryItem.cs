...
namespace Temboo.Library.Amazon.Marketplace.Feeds
{
    ...
    /// </summary>
    public class DeleteInventoryItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteInventoryItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteInventoryItem(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Feeds/DeleteInventoryItem")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteInventoryItemResultSet containing execution metadata and results.</returns>
        new public DeleteInventoryItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteInventoryItemResultSet results = new JavaScriptSerializer().Deserialize<DeleteInventoryItemResultSet>(json);
    ...
    /// </summary>
    public class DeleteInventoryItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
