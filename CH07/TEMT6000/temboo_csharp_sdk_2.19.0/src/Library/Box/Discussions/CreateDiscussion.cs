...
namespace Temboo.Library.Box.Discussions
{
    ...
    /// </summary>
    public class CreateDiscussion : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateDiscussion Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateDiscussion(TembooSession session) : base(session, "/Library/Box/Discussions/CreateDiscussion")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateDiscussionResultSet containing execution metadata and results.</returns>
        new public CreateDiscussionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateDiscussionResultSet results = new JavaScriptSerializer().Deserialize<CreateDiscussionResultSet>(json);
    ...
    /// </summary>
    public class CreateDiscussionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
