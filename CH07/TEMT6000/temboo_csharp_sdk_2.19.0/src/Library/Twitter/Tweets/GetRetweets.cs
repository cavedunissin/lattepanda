...
namespace Temboo.Library.Twitter.Tweets
{
    ...
    /// </summary>
    public class GetRetweets : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRetweets Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRetweets(TembooSession session) : base(session, "/Library/Twitter/Tweets/GetRetweets")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRetweetsResultSet containing execution metadata and results.</returns>
        new public GetRetweetsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRetweetsResultSet results = new JavaScriptSerializer().Deserialize<GetRetweetsResultSet>(json);
    ...
    /// </summary>
    public class GetRetweetsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
