...
namespace Temboo.Library.Google.Calendar
{
    ...
    /// </summary>
    public class GetCalendar : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCalendar Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCalendar(TembooSession session) : base(session, "/Library/Google/Calendar/GetCalendar")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCalendarResultSet containing execution metadata and results.</returns>
        new public GetCalendarResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCalendarResultSet results = new JavaScriptSerializer().Deserialize<GetCalendarResultSet>(json);
    ...
    /// </summary>
    public class GetCalendarResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
