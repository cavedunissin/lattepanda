...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class GetRole : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRole Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRole(TembooSession session) : base(session, "/Library/Amazon/IAM/GetRole")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRoleResultSet containing execution metadata and results.</returns>
        new public GetRoleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRoleResultSet results = new JavaScriptSerializer().Deserialize<GetRoleResultSet>(json);
    ...
    /// </summary>
    public class GetRoleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
