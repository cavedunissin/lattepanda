...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class UpdateActivityWeeklyGoals : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateActivityWeeklyGoals Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateActivityWeeklyGoals(TembooSession session) : base(session, "/Library/Fitbit/Activities/UpdateActivityWeeklyGoals")
        {
        }
         ...
         /// <summary>
         /// (conditional, decimal) The desired distance for a weekly activity goal.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, integer) The number of floors walked for a weekly activity goal.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, integer) The number of steps to take for a weekly activity goal.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A UpdateActivityWeeklyGoalsResultSet containing execution metadata and results.</returns>
        new public UpdateActivityWeeklyGoalsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateActivityWeeklyGoalsResultSet results = new JavaScriptSerializer().Deserialize<UpdateActivityWeeklyGoalsResultSet>(json);
    ...
    /// </summary>
    public class UpdateActivityWeeklyGoalsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
