...
namespace Temboo.Library.LastFm.Artist
{
    ...
    /// </summary>
    public class GetTopFans : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTopFans Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTopFans(TembooSession session) : base(session, "/Library/LastFm/Artist/GetTopFans")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTopFansResultSet containing execution metadata and results.</returns>
        new public GetTopFansResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTopFansResultSet results = new JavaScriptSerializer().Deserialize<GetTopFansResultSet>(json);
    ...
    /// </summary>
    public class GetTopFansResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
