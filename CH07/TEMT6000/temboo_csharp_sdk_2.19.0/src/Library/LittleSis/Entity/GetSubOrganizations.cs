...
namespace Temboo.Library.LittleSis.Entity
{
    ...
    /// </summary>
    public class GetSubOrganizations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSubOrganizations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSubOrganizations(TembooSession session) : base(session, "/Library/LittleSis/Entity/GetSubOrganizations")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSubOrganizationsResultSet containing execution metadata and results.</returns>
        new public GetSubOrganizationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSubOrganizationsResultSet results = new JavaScriptSerializer().Deserialize<GetSubOrganizationsResultSet>(json);
    ...
    /// </summary>
    public class GetSubOrganizationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
