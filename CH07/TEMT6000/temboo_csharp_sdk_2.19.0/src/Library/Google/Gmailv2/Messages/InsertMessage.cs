...
namespace Temboo.Library.Google.Gmailv2.Messages
{
    ...
    /// </summary>
    public class InsertMessage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the InsertMessage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public InsertMessage(TembooSession session) : base(session, "/Library/Google/Gmailv2/Messages/InsertMessage")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the LabelIDs input for this Choreo.</param>
         public void setLabelIDs(String value) {
             base.addInput ("LabelIDs", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A InsertMessageResultSet containing execution metadata and results.</returns>
        new public InsertMessageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InsertMessageResultSet results = new JavaScriptSerializer().Deserialize<InsertMessageResultSet>(json);
    ...
    /// </summary>
    public class InsertMessageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
