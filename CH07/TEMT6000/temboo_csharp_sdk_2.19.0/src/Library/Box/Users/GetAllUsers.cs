...
namespace Temboo.Library.Box.Users
{
    ...
    /// </summary>
    public class GetAllUsers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAllUsers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAllUsers(TembooSession session) : base(session, "/Library/Box/Users/GetAllUsers")
        {
        }
         ...
         /// <summary>
         /// (optional, string) A string used to filter the results to only users starting with the filter_term in either the name or the login.
         /// </summary>
         /// <param name="value">Value of the FilterTerm input for this Choreo.</param>
         public void setFilterTerm(String value) {
             base.addInput ("FilterTerm", value);
         }
         /// <summary>
         /// (optional, integer) The number of records to return.
         /// </summary>
         ...
         /// <summary>
         /// (optional, integer) The record at which to start. Defaults to 0.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetAllUsersResultSet containing execution metadata and results.</returns>
        new public GetAllUsersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAllUsersResultSet results = new JavaScriptSerializer().Deserialize<GetAllUsersResultSet>(json);
    ...
    /// </summary>
    public class GetAllUsersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
