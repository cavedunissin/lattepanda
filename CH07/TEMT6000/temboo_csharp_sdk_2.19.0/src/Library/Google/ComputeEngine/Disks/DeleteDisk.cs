...
namespace Temboo.Library.Google.ComputeEngine.Disks
{
    ...
    /// </summary>
    public class DeleteDisk : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteDisk Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteDisk(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Disks/DeleteDisk")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteDiskResultSet containing execution metadata and results.</returns>
        new public DeleteDiskResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteDiskResultSet results = new JavaScriptSerializer().Deserialize<DeleteDiskResultSet>(json);
    ...
    /// </summary>
    public class DeleteDiskResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
