...
namespace Temboo.Library.AuthorizeNet.TransactionDetailsAPI
{
    ...
    /// </summary>
    public class GetBatchStatistics : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetBatchStatistics Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetBatchStatistics(TembooSession session) : base(session, "/Library/AuthorizeNet/TransactionDetailsAPI/GetBatchStatistics")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the BatchId input for this Choreo.</param>
         public void setBatchId(String value) {
             base.addInput ("BatchId", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetBatchStatisticsResultSet containing execution metadata and results.</returns>
        new public GetBatchStatisticsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetBatchStatisticsResultSet results = new JavaScriptSerializer().Deserialize<GetBatchStatisticsResultSet>(json);
    ...
    /// </summary>
    public class GetBatchStatisticsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
