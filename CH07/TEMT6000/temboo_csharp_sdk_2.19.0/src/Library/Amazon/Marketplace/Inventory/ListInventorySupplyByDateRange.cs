...
namespace Temboo.Library.Amazon.Marketplace.Inventory
{
    /// <summary>
    ...
    /// </summary>
    public class ListInventorySupplyByDateRange : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListInventorySupplyByDateRange Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListInventorySupplyByDateRange(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Inventory/ListInventorySupplyByDateRange")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ResponseGroup input for this Choreo.</param>
         public void setResponseGroup(String value) {
             base.addInput ("ResponseGroup", value);
         }
        ...
        /// </summary>
        /// <returns>A ListInventorySupplyByDateRangeResultSet containing execution metadata and results.</returns>
        new public ListInventorySupplyByDateRangeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListInventorySupplyByDateRangeResultSet results = new JavaScriptSerializer().Deserialize<ListInventorySupplyByDateRangeResultSet>(json);
    ...
    /// </summary>
    public class ListInventorySupplyByDateRangeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
