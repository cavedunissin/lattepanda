...
namespace Temboo.Library.Google.Gmailv2.Messages
{
    ...
    /// </summary>
    public class UnTrashMessage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnTrashMessage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnTrashMessage(TembooSession session) : base(session, "/Library/Google/Gmailv2/Messages/UnTrashMessage")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnTrashMessageResultSet containing execution metadata and results.</returns>
        new public UnTrashMessageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnTrashMessageResultSet results = new JavaScriptSerializer().Deserialize<UnTrashMessageResultSet>(json);
    ...
    /// </summary>
    public class UnTrashMessageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
