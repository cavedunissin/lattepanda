...
namespace Temboo.Library.Twilio.SMSMessages
{
    ...
    /// </summary>
    public class GetMessagesThatContain : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMessagesThatContain Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMessagesThatContain(TembooSession session) : base(session, "/Library/Twilio/SMSMessages/GetMessagesThatContain")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Used to simplify the response. Valid values are: simple and verbose. When set to simple, an array of message strings is returned. Verbose mode returns an array of full object. Defaults to "simple".
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetMessagesThatContainResultSet containing execution metadata and results.</returns>
        new public GetMessagesThatContainResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMessagesThatContainResultSet results = new JavaScriptSerializer().Deserialize<GetMessagesThatContainResultSet>(json);
    ...
    /// </summary>
    public class GetMessagesThatContainResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
