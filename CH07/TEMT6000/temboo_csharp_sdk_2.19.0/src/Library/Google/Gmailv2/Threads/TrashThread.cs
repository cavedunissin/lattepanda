...
namespace Temboo.Library.Google.Gmailv2.Threads
{
    ...
    /// </summary>
    public class TrashThread : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TrashThread Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TrashThread(TembooSession session) : base(session, "/Library/Google/Gmailv2/Threads/TrashThread")
        {
        }
        ...
        /// </summary>
        /// <returns>A TrashThreadResultSet containing execution metadata and results.</returns>
        new public TrashThreadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TrashThreadResultSet results = new JavaScriptSerializer().Deserialize<TrashThreadResultSet>(json);
    ...
    /// </summary>
    public class TrashThreadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
