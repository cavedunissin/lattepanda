...
namespace Temboo.Library.Zendesk.Organizations
{
    ...
    /// </summary>
    public class ListOrganizations : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListOrganizations Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListOrganizations(TembooSession session) : base(session, "/Library/Zendesk/Organizations/ListOrganizations")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListOrganizationsResultSet containing execution metadata and results.</returns>
        new public ListOrganizationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListOrganizationsResultSet results = new JavaScriptSerializer().Deserialize<ListOrganizationsResultSet>(json);
    ...
    /// </summary>
    public class ListOrganizationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
