...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    /// </summary>
    public class GetMatchingProduct : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMatchingProduct Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMatchingProduct(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/GetMatchingProduct")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMatchingProductResultSet containing execution metadata and results.</returns>
        new public GetMatchingProductResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMatchingProductResultSet results = new JavaScriptSerializer().Deserialize<GetMatchingProductResultSet>(json);
    ...
    /// </summary>
    public class GetMatchingProductResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
