...
namespace Temboo.Library.Facebook.Actions.Fitness.Walks
{
    ...
    /// </summary>
    public class ReadWalks : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadWalks Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadWalks(TembooSession session) : base(session, "/Library/Facebook/Actions/Fitness/Walks/ReadWalks")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadWalksResultSet containing execution metadata and results.</returns>
        new public ReadWalksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadWalksResultSet results = new JavaScriptSerializer().Deserialize<ReadWalksResultSet>(json);
    ...
    /// </summary>
    public class ReadWalksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
