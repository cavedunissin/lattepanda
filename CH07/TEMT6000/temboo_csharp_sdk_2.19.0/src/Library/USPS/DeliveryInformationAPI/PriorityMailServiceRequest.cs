...
namespace Temboo.Library.USPS.DeliveryInformationAPI
{
    ...
    /// </summary>
    public class PriorityMailServiceRequest : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PriorityMailServiceRequest Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PriorityMailServiceRequest(TembooSession session) : base(session, "/Library/USPS/DeliveryInformationAPI/PriorityMailServiceRequest")
        {
        }
        ...
        /// </summary>
        /// <returns>A PriorityMailServiceRequestResultSet containing execution metadata and results.</returns>
        new public PriorityMailServiceRequestResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PriorityMailServiceRequestResultSet results = new JavaScriptSerializer().Deserialize<PriorityMailServiceRequestResultSet>(json);
    ...
    /// </summary>
    public class PriorityMailServiceRequestResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
