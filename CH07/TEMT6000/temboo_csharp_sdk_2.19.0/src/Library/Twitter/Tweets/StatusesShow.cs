...
namespace Temboo.Library.Twitter.Tweets
{
    ...
    /// </summary>
    public class StatusesShow : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the StatusesShow Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public StatusesShow(TembooSession session) : base(session, "/Library/Twitter/Tweets/StatusesShow")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the IncludeMyRetweet input for this Choreo.</param>
         public void setIncludeMyRetweet(String value) {
             base.addInput ("IncludeMyRetweet", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A StatusesShowResultSet containing execution metadata and results.</returns>
        new public StatusesShowResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            StatusesShowResultSet results = new JavaScriptSerializer().Deserialize<StatusesShowResultSet>(json);
    ...
    /// </summary>
    public class StatusesShowResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
