...
namespace Temboo.Library.Flickr.Favorites
{
    ...
    /// </summary>
    public class GetContextForFavorite : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetContextForFavorite Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetContextForFavorite(TembooSession session) : base(session, "/Library/Flickr/Favorites/GetContextForFavorite")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetContextForFavoriteResultSet containing execution metadata and results.</returns>
        new public GetContextForFavoriteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetContextForFavoriteResultSet results = new JavaScriptSerializer().Deserialize<GetContextForFavoriteResultSet>(json);
    ...
    /// </summary>
    public class GetContextForFavoriteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
