...
namespace Temboo.Library.Google.Spreadsheets
{
    ...
    /// </summary>
    public class UpdateCells : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateCells Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateCells(TembooSession session) : base(session, "/Library/Google/Spreadsheets/UpdateCells")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the InputValue input for this Choreo.</param>
         public void setInputValue(String value) {
             base.addInput ("InputValue", value);
         }
         /// <summary>
         ...
         /// <summary>
         /// (required, string) The unique key of the spreadsheet associated with the cell you want to update.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A UpdateCellsResultSet containing execution metadata and results.</returns>
        new public UpdateCellsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateCellsResultSet results = new JavaScriptSerializer().Deserialize<UpdateCellsResultSet>(json);
    ...
    /// </summary>
    public class UpdateCellsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
