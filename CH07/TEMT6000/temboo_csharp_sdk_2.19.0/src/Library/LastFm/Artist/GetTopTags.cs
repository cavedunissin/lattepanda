...
namespace Temboo.Library.LastFm.Artist
{
    ...
    /// </summary>
    public class GetTopTags : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTopTags Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTopTags(TembooSession session) : base(session, "/Library/LastFm/Artist/GetTopTags")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTopTagsResultSet containing execution metadata and results.</returns>
        new public GetTopTagsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTopTagsResultSet results = new JavaScriptSerializer().Deserialize<GetTopTagsResultSet>(json);
    ...
    /// </summary>
    public class GetTopTagsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
