...
namespace Temboo.Library.EnviroFacts.UVForecast
{
    ...
    /// </summary>
    public class DailyUVByCity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DailyUVByCity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DailyUVByCity(TembooSession session) : base(session, "/Library/EnviroFacts/UVForecast/DailyUVByCity")
        {
        }
        ...
        /// </summary>
        /// <returns>A DailyUVByCityResultSet containing execution metadata and results.</returns>
        new public DailyUVByCityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DailyUVByCityResultSet results = new JavaScriptSerializer().Deserialize<DailyUVByCityResultSet>(json);
    ...
    /// </summary>
    public class DailyUVByCityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
