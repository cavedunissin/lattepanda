...
namespace Temboo.Library.Google.ComputeEngine.Snapshots
{
    /// <summary>
    /// DeleteSnapshot
    /// Deletes a specified Snapshot resource.
    /// </summary>
    public class DeleteSnapshot : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteSnapshot Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteSnapshot(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Snapshots/DeleteSnapshot")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Snapshot input for this Choreo.</param>
         public void setSnapshot(String value) {
             base.addInput ("Snapshot", value);
         }
        ...
        /// </summary>
        /// <returns>A DeleteSnapshotResultSet containing execution metadata and results.</returns>
        new public DeleteSnapshotResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteSnapshotResultSet results = new JavaScriptSerializer().Deserialize<DeleteSnapshotResultSet>(json);
    ...
    /// </summary>
    public class DeleteSnapshotResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
