...
namespace Temboo.Library.Utilities.Validation
{
    ...
    /// </summary>
    public class CanadianPostalCodes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CanadianPostalCodes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CanadianPostalCodes(TembooSession session) : base(session, "/Library/Utilities/Validation/CanadianPostalCodes")
        {
        }
        ...
        /// </summary>
        /// <returns>A CanadianPostalCodesResultSet containing execution metadata and results.</returns>
        new public CanadianPostalCodesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CanadianPostalCodesResultSet results = new JavaScriptSerializer().Deserialize<CanadianPostalCodesResultSet>(json);
    ...
    /// </summary>
    public class CanadianPostalCodesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
