...
namespace Temboo.Library.Utilities.Validation
{
    ...
    /// </summary>
    public class USPostalCodes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the USPostalCodes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public USPostalCodes(TembooSession session) : base(session, "/Library/Utilities/Validation/USPostalCodes")
        {
        }
        ...
        /// </summary>
        /// <returns>A USPostalCodesResultSet containing execution metadata and results.</returns>
        new public USPostalCodesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            USPostalCodesResultSet results = new JavaScriptSerializer().Deserialize<USPostalCodesResultSet>(json);
    ...
    /// </summary>
    public class USPostalCodesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
