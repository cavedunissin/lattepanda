...
namespace Temboo.Library.Zendesk.UserIdentities
{
    ...
    /// </summary>
    public class MakeUserIdentityThePrimary : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the MakeUserIdentityThePrimary Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public MakeUserIdentityThePrimary(TembooSession session) : base(session, "/Library/Zendesk/UserIdentities/MakeUserIdentityThePrimary")
        {
        }
        ...
        /// </summary>
        /// <returns>A MakeUserIdentityThePrimaryResultSet containing execution metadata and results.</returns>
        new public MakeUserIdentityThePrimaryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MakeUserIdentityThePrimaryResultSet results = new JavaScriptSerializer().Deserialize<MakeUserIdentityThePrimaryResultSet>(json);
    ...
    /// </summary>
    public class MakeUserIdentityThePrimaryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
