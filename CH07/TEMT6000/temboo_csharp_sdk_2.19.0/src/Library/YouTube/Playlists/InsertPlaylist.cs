...
namespace Temboo.Library.YouTube.Playlists
{
    ...
    /// Creates a playlist.
    /// </summary>
    public class InsertPlaylist : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the InsertPlaylist Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public InsertPlaylist(TembooSession session) : base(session, "/Library/YouTube/Playlists/InsertPlaylist")
        {
        }
        ...
        /// </summary>
        /// <returns>A InsertPlaylistResultSet containing execution metadata and results.</returns>
        new public InsertPlaylistResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InsertPlaylistResultSet results = new JavaScriptSerializer().Deserialize<InsertPlaylistResultSet>(json);
    ...
    /// </summary>
    public class InsertPlaylistResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
