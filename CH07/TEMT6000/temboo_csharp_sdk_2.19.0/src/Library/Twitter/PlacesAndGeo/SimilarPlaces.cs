...
namespace Temboo.Library.Twitter.PlacesAndGeo
{
    ...
    /// </summary>
    public class SimilarPlaces : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SimilarPlaces Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SimilarPlaces(TembooSession session) : base(session, "/Library/Twitter/PlacesAndGeo/SimilarPlaces")
        {
        }
        ...
        /// </summary>
        /// <returns>A SimilarPlacesResultSet containing execution metadata and results.</returns>
        new public SimilarPlacesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SimilarPlacesResultSet results = new JavaScriptSerializer().Deserialize<SimilarPlacesResultSet>(json);
    ...
    /// </summary>
    public class SimilarPlacesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
