...
namespace Temboo.Library.YouTube.Activities
{
    ...
    /// </summary>
    public class InsertActivity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the InsertActivity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public InsertActivity(TembooSession session) : base(session, "/Library/YouTube/Activities/InsertActivity")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ActivityMetadata input for this Choreo.</param>
         public void setActivityMetadata(String value) {
             base.addInput ("ActivityMetadata", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A InsertActivityResultSet containing execution metadata and results.</returns>
        new public InsertActivityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InsertActivityResultSet results = new JavaScriptSerializer().Deserialize<InsertActivityResultSet>(json);
    ...
    /// </summary>
    public class InsertActivityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
