...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class ListTicketsByOrganization : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTicketsByOrganization Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTicketsByOrganization(TembooSession session) : base(session, "/Library/Zendesk/Tickets/ListTicketsByOrganization")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTicketsByOrganizationResultSet containing execution metadata and results.</returns>
        new public ListTicketsByOrganizationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTicketsByOrganizationResultSet results = new JavaScriptSerializer().Deserialize<ListTicketsByOrganizationResultSet>(json);
    ...
    /// </summary>
    public class ListTicketsByOrganizationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
