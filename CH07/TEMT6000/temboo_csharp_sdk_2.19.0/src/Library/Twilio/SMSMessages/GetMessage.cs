...
namespace Temboo.Library.Twilio.SMSMessages
{
    ...
    /// </summary>
    public class GetMessage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMessage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMessage(TembooSession session) : base(session, "/Library/Twilio/SMSMessages/GetMessage")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the SMSMessageSID input for this Choreo.</param>
         public void setSMSMessageSID(String value) {
             base.addInput ("SMSMessageSID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetMessageResultSet containing execution metadata and results.</returns>
        new public GetMessageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMessageResultSet results = new JavaScriptSerializer().Deserialize<GetMessageResultSet>(json);
    ...
    /// </summary>
    public class GetMessageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
