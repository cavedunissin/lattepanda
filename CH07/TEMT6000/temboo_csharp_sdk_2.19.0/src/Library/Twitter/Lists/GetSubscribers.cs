...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class GetSubscribers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSubscribers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSubscribers(TembooSession session) : base(session, "/Library/Twitter/Lists/GetSubscribers")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSubscribersResultSet containing execution metadata and results.</returns>
        new public GetSubscribersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSubscribersResultSet results = new JavaScriptSerializer().Deserialize<GetSubscribersResultSet>(json);
    ...
    /// </summary>
    public class GetSubscribersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
