...
namespace Temboo.Library.Amazon.Marketplace.OutboundShipments
{
    ...
    /// </summary>
    public class CancelFulfillmentOrder : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CancelFulfillmentOrder Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CancelFulfillmentOrder(TembooSession session) : base(session, "/Library/Amazon/Marketplace/OutboundShipments/CancelFulfillmentOrder")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the SellerFulfillmentOrderId input for this Choreo.</param>
         public void setSellerFulfillmentOrderId(String value) {
             base.addInput ("SellerFulfillmentOrderId", value);
         }
        ...
        /// </summary>
        /// <returns>A CancelFulfillmentOrderResultSet containing execution metadata and results.</returns>
        new public CancelFulfillmentOrderResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CancelFulfillmentOrderResultSet results = new JavaScriptSerializer().Deserialize<CancelFulfillmentOrderResultSet>(json);
    ...
    /// </summary>
    public class CancelFulfillmentOrderResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
