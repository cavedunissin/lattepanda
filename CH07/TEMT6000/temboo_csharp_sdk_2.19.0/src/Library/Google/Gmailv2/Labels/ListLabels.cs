...
namespace Temboo.Library.Google.Gmailv2.Labels
{
    ...
    /// </summary>
    public class ListLabels : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListLabels Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListLabels(TembooSession session) : base(session, "/Library/Google/Gmailv2/Labels/ListLabels")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListLabelsResultSet containing execution metadata and results.</returns>
        new public ListLabelsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListLabelsResultSet results = new JavaScriptSerializer().Deserialize<ListLabelsResultSet>(json);
    ...
    /// </summary>
    public class ListLabelsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
