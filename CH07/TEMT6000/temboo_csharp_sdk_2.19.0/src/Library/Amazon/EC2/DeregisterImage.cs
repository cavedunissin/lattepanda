...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DeregisterImage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeregisterImage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeregisterImage(TembooSession session) : base(session, "/Library/Amazon/EC2/DeregisterImage")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeregisterImageResultSet containing execution metadata and results.</returns>
        new public DeregisterImageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeregisterImageResultSet results = new JavaScriptSerializer().Deserialize<DeregisterImageResultSet>(json);
    ...
    /// </summary>
    public class DeregisterImageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
