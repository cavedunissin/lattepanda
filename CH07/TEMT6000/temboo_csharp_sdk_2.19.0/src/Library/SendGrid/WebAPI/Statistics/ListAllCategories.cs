...
namespace Temboo.Library.SendGrid.WebAPI.Statistics
{
    ...
    /// </summary>
    public class ListAllCategories : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllCategories Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllCategories(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Statistics/ListAllCategories")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllCategoriesResultSet containing execution metadata and results.</returns>
        new public ListAllCategoriesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllCategoriesResultSet results = new JavaScriptSerializer().Deserialize<ListAllCategoriesResultSet>(json);
    ...
    /// </summary>
    public class ListAllCategoriesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
