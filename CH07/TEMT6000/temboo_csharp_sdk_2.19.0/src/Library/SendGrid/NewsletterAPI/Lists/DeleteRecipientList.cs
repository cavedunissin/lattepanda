...
namespace Temboo.Library.SendGrid.NewsletterAPI.Lists
{
    ...
    /// </summary>
    public class DeleteRecipientList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRecipientList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRecipientList(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Lists/DeleteRecipientList")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteRecipientListResultSet containing execution metadata and results.</returns>
        new public DeleteRecipientListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRecipientListResultSet results = new JavaScriptSerializer().Deserialize<DeleteRecipientListResultSet>(json);
    ...
    /// </summary>
    public class DeleteRecipientListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Response" output from this Choreo execution
        /// <returns>String - (string) The response from SendGrid. The format corresponds to the ResponseFormat input. Default is json.</returns>
        /// </summary>
