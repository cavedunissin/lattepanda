...
namespace Temboo.Library.LastFm.Artist
{
    ...
    /// </summary>
    public class GetPastEvents : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPastEvents Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPastEvents(TembooSession session) : base(session, "/Library/LastFm/Artist/GetPastEvents")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPastEventsResultSet containing execution metadata and results.</returns>
        new public GetPastEventsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPastEventsResultSet results = new JavaScriptSerializer().Deserialize<GetPastEventsResultSet>(json);
    ...
    /// </summary>
    public class GetPastEventsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
