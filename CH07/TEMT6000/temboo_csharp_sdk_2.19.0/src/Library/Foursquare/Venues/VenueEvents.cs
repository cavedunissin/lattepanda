...
namespace Temboo.Library.Foursquare.Venues
{
    ...
    /// </summary>
    public class VenueEvents : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VenueEvents Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VenueEvents(TembooSession session) : base(session, "/Library/Foursquare/Venues/VenueEvents")
        {
        }
        ...
        /// </summary>
        /// <returns>A VenueEventsResultSet containing execution metadata and results.</returns>
        new public VenueEventsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VenueEventsResultSet results = new JavaScriptSerializer().Deserialize<VenueEventsResultSet>(json);
    ...
    /// </summary>
    public class VenueEventsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
