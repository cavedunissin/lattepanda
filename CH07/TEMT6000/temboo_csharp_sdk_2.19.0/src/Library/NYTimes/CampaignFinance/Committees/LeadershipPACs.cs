...
namespace Temboo.Library.NYTimes.CampaignFinance.Committees
{
    ...
    /// </summary>
    public class LeadershipPACs : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LeadershipPACs Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LeadershipPACs(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Committees/LeadershipPACs")
        {
        }
        ...
        /// </summary>
        /// <returns>A LeadershipPACsResultSet containing execution metadata and results.</returns>
        new public LeadershipPACsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LeadershipPACsResultSet results = new JavaScriptSerializer().Deserialize<LeadershipPACsResultSet>(json);
    ...
    /// </summary>
    public class LeadershipPACsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
