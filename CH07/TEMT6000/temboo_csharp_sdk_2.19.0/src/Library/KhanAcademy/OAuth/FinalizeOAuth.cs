...
namespace Temboo.Library.KhanAcademy.OAuth
{
    /// <summary>
    /// FinalizeOAuth
    ...
    public class FinalizeOAuth : Temboo.Core.Choreography
    {
        ...
        public FinalizeOAuth(TembooSession session) : base(session, "/Library/KhanAcademy/OAuth/FinalizeOAuth")
        {
        }
    ...
    public class FinalizeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The OAuth Token retrieved during the OAuth process.</returns>
        /// </summary>
        public String OAuthToken
        {
            get
            {
                return (String) base.Output["OAuthToken"];
            }
        }
        /// <summary> 
        /// Retrieve the value for the "OAuthTokenSecret" output from this Choreo execution
        /// <returns>String - (string) The OAuth Token Secret retrieved during the OAuth process.</returns>
        /// </summary>
