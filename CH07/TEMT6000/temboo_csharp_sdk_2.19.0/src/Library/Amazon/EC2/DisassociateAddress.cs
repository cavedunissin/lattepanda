...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DisassociateAddress : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DisassociateAddress Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DisassociateAddress(TembooSession session) : base(session, "/Library/Amazon/EC2/DisassociateAddress")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the AssociationId input for this Choreo.</param>
         public void setAssociationId(String value) {
             base.addInput ("AssociationId", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DisassociateAddressResultSet containing execution metadata and results.</returns>
        new public DisassociateAddressResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DisassociateAddressResultSet results = new JavaScriptSerializer().Deserialize<DisassociateAddressResultSet>(json);
    ...
    /// </summary>
    public class DisassociateAddressResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
