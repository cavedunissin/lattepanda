...
namespace Temboo.Library.SendGrid.WebAPI.Unsubscribes
{
    ...
    /// </summary>
    public class GetUnsubscribesList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUnsubscribesList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUnsubscribesList(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Unsubscribes/GetUnsubscribesList")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUnsubscribesListResultSet containing execution metadata and results.</returns>
        new public GetUnsubscribesListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUnsubscribesListResultSet results = new JavaScriptSerializer().Deserialize<GetUnsubscribesListResultSet>(json);
    ...
    /// </summary>
    public class GetUnsubscribesListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
