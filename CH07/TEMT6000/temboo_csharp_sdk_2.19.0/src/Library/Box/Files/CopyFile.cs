...
namespace Temboo.Library.Box.Files
{
    ...
    /// </summary>
    public class CopyFile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CopyFile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CopyFile(TembooSession session) : base(session, "/Library/Box/Files/CopyFile")
        {
        }
        ...
        /// </summary>
        /// <returns>A CopyFileResultSet containing execution metadata and results.</returns>
        new public CopyFileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CopyFileResultSet results = new JavaScriptSerializer().Deserialize<CopyFileResultSet>(json);
    ...
    /// </summary>
    public class CopyFileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
