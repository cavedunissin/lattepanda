...
namespace Temboo.Library.PagerDuty.Reports
{
    ...
    /// </summary>
    public class IncidentsPerTime : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the IncidentsPerTime Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public IncidentsPerTime(TembooSession session) : base(session, "/Library/PagerDuty/Reports/IncidentsPerTime")
        {
        }
        ...
        /// </summary>
        /// <returns>A IncidentsPerTimeResultSet containing execution metadata and results.</returns>
        new public IncidentsPerTimeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            IncidentsPerTimeResultSet results = new JavaScriptSerializer().Deserialize<IncidentsPerTimeResultSet>(json);
    ...
    /// </summary>
    public class IncidentsPerTimeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
