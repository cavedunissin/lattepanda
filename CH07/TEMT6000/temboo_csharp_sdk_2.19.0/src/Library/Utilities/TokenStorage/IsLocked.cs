...
namespace Temboo.Library.Utilities.TokenStorage
{
    ...
    /// </summary>
    public class IsLocked : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the IsLocked Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public IsLocked(TembooSession session) : base(session, "/Library/Utilities/TokenStorage/IsLocked")
        {
        }
        ...
        /// </summary>
        /// <returns>A IsLockedResultSet containing execution metadata and results.</returns>
        new public IsLockedResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            IsLockedResultSet results = new JavaScriptSerializer().Deserialize<IsLockedResultSet>(json);
    ...
    /// </summary>
    public class IsLockedResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
