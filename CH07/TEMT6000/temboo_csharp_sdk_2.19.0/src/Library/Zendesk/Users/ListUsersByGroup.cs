...
namespace Temboo.Library.Zendesk.Users
{
    ...
    /// </summary>
    public class ListUsersByGroup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListUsersByGroup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListUsersByGroup(TembooSession session) : base(session, "/Library/Zendesk/Users/ListUsersByGroup")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListUsersByGroupResultSet containing execution metadata and results.</returns>
        new public ListUsersByGroupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListUsersByGroupResultSet results = new JavaScriptSerializer().Deserialize<ListUsersByGroupResultSet>(json);
    ...
    /// </summary>
    public class ListUsersByGroupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
