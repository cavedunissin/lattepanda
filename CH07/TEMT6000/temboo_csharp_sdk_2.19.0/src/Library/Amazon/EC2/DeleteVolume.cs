...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DeleteVolume : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteVolume Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteVolume(TembooSession session) : base(session, "/Library/Amazon/EC2/DeleteVolume")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteVolumeResultSet containing execution metadata and results.</returns>
        new public DeleteVolumeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteVolumeResultSet results = new JavaScriptSerializer().Deserialize<DeleteVolumeResultSet>(json);
    ...
    /// </summary>
    public class DeleteVolumeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
