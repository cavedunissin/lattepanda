...
namespace Temboo.Library.Facebook.Actions.Books.Rates
{
    ...
    /// </summary>
    public class DeleteRating : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRating Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRating(TembooSession session) : base(session, "/Library/Facebook/Actions/Books/Rates/DeleteRating")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteRatingResultSet containing execution metadata and results.</returns>
        new public DeleteRatingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRatingResultSet results = new JavaScriptSerializer().Deserialize<DeleteRatingResultSet>(json);
    ...
    /// </summary>
    public class DeleteRatingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
