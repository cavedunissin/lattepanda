...
namespace Temboo.Library.Google.ComputeEngine.Routes
{
    ...
    /// </summary>
    public class GetRoute : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRoute Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRoute(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Routes/GetRoute")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRouteResultSet containing execution metadata and results.</returns>
        new public GetRouteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRouteResultSet results = new JavaScriptSerializer().Deserialize<GetRouteResultSet>(json);
    ...
    /// </summary>
    public class GetRouteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
