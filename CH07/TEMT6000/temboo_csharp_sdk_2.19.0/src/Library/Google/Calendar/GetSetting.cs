...
namespace Temboo.Library.Google.Calendar
{
    ...
    /// </summary>
    public class GetSetting : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSetting Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSetting(TembooSession session) : base(session, "/Library/Google/Calendar/GetSetting")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSettingResultSet containing execution metadata and results.</returns>
        new public GetSettingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSettingResultSet results = new JavaScriptSerializer().Deserialize<GetSettingResultSet>(json);
    ...
    /// </summary>
    public class GetSettingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
