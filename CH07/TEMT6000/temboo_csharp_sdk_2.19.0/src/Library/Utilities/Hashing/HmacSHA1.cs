...
namespace Temboo.Library.Utilities.Hashing
{
    ...
    /// </summary>
    public class HmacSHA1 : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the HmacSHA1 Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public HmacSHA1(TembooSession session) : base(session, "/Library/Utilities/Hashing/HmacSHA1")
        {
        }
        ...
        /// </summary>
        /// <returns>A HmacSHA1ResultSet containing execution metadata and results.</returns>
        new public HmacSHA1ResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            HmacSHA1ResultSet results = new JavaScriptSerializer().Deserialize<HmacSHA1ResultSet>(json);
    ...
    /// </summary>
    public class HmacSHA1ResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
