...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    /// </summary>
    public class GetLowestOfferListingsForASIN : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLowestOfferListingsForASIN Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLowestOfferListingsForASIN(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/GetLowestOfferListingsForASIN")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ASIN input for this Choreo.</param>
         public void setASIN(String value) {
             base.addInput ("ASIN", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetLowestOfferListingsForASINResultSet containing execution metadata and results.</returns>
        new public GetLowestOfferListingsForASINResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLowestOfferListingsForASINResultSet results = new JavaScriptSerializer().Deserialize<GetLowestOfferListingsForASINResultSet>(json);
    ...
    /// </summary>
    public class GetLowestOfferListingsForASINResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
