...
namespace Temboo.Library.Google.Gmailv2.History
{
    /// <summary>
    /// ListHistory
    /// Lists the history of all changes to the given mailbox.
    /// </summary>
    public class ListHistory : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListHistory Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListHistory(TembooSession session) : base(session, "/Library/Google/Gmailv2/History/ListHistory")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListHistoryResultSet containing execution metadata and results.</returns>
        new public ListHistoryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListHistoryResultSet results = new JavaScriptSerializer().Deserialize<ListHistoryResultSet>(json);
    ...
    /// </summary>
    public class ListHistoryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
