...
namespace Temboo.Library.Twilio.Applications
{
    ...
    /// </summary>
    public class ListApplications : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListApplications Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListApplications(TembooSession session) : base(session, "/Library/Twilio/Applications/ListApplications")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListApplicationsResultSet containing execution metadata and results.</returns>
        new public ListApplicationsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListApplicationsResultSet results = new JavaScriptSerializer().Deserialize<ListApplicationsResultSet>(json);
    ...
    /// </summary>
    public class ListApplicationsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
