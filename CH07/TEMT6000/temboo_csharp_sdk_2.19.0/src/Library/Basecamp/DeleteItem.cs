...
namespace Temboo.Library.Basecamp
{
    ...
    public class DeleteItem : Temboo.Core.Choreography
    {
        ...
        public DeleteItem(TembooSession session) : base(session, "/Library/Basecamp/DeleteItem")
        {
        }
    ...
    public class DeleteItemResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - No structured response is returned for delete item requests.</returns>
        /// </summary>
