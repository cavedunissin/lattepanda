...
namespace Temboo.Library.Google.ComputeEngine.Addresses
{
    /// <summary>
    /// InsertAddress
    /// Creates an Address resource in the specified project.
    /// </summary>
    public class InsertAddress : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the InsertAddress Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public InsertAddress(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Addresses/InsertAddress")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the AddressResource input for this Choreo.</param>
         public void setAddressResource(String value) {
             base.addInput ("AddressResource", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A InsertAddressResultSet containing execution metadata and results.</returns>
        new public InsertAddressResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InsertAddressResultSet results = new JavaScriptSerializer().Deserialize<InsertAddressResultSet>(json);
    ...
    /// </summary>
    public class InsertAddressResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
