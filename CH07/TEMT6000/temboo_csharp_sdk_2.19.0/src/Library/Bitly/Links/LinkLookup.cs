...
namespace Temboo.Library.Bitly.Links
{
    ...
    /// </summary>
    public class LinkLookup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LinkLookup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LinkLookup(TembooSession session) : base(session, "/Library/Bitly/Links/LinkLookup")
        {
        }
        ...
        /// </summary>
        /// <returns>A LinkLookupResultSet containing execution metadata and results.</returns>
        new public LinkLookupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LinkLookupResultSet results = new JavaScriptSerializer().Deserialize<LinkLookupResultSet>(json);
    ...
    /// </summary>
    public class LinkLookupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
