...
namespace Temboo.Library.Google.ComputeEngine.Images
{
    ...
    /// </summary>
    public class DeleteImage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteImage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteImage(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Images/DeleteImage")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Image input for this Choreo.</param>
         public void setImage(String value) {
             base.addInput ("Image", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DeleteImageResultSet containing execution metadata and results.</returns>
        new public DeleteImageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteImageResultSet results = new JavaScriptSerializer().Deserialize<DeleteImageResultSet>(json);
    ...
    /// </summary>
    public class DeleteImageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
