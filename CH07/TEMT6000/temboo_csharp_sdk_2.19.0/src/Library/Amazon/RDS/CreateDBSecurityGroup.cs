...
namespace Temboo.Library.Amazon.RDS
{
    ...
    /// </summary>
    public class CreateDBSecurityGroup : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateDBSecurityGroup Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateDBSecurityGroup(TembooSession session) : base(session, "/Library/Amazon/RDS/CreateDBSecurityGroup")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the DBSecurityGroupDescription input for this Choreo.</param>
         public void setDBSecurityGroupDescription(String value) {
             base.addInput ("DBSecurityGroupDescription", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreateDBSecurityGroupResultSet containing execution metadata and results.</returns>
        new public CreateDBSecurityGroupResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateDBSecurityGroupResultSet results = new JavaScriptSerializer().Deserialize<CreateDBSecurityGroupResultSet>(json);
    ...
    /// </summary>
    public class CreateDBSecurityGroupResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
