...
namespace Temboo.Library.Amazon.CloudDrive.Children
{
    ...
    /// </summary>
    public class RemoveChild : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RemoveChild Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RemoveChild(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Children/RemoveChild")
        {
        }
        ...
        /// </summary>
        /// <returns>A RemoveChildResultSet containing execution metadata and results.</returns>
        new public RemoveChildResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RemoveChildResultSet results = new JavaScriptSerializer().Deserialize<RemoveChildResultSet>(json);
    ...
    /// </summary>
    public class RemoveChildResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
