...
namespace Temboo.Library.Dropbox.FileOperations
{
    ...
    /// </summary>
    public class MoveFileOrFolder : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the MoveFileOrFolder Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public MoveFileOrFolder(TembooSession session) : base(session, "/Library/Dropbox/FileOperations/MoveFileOrFolder")
        {
        }
        ...
        /// </summary>
        /// <returns>A MoveFileOrFolderResultSet containing execution metadata and results.</returns>
        new public MoveFileOrFolderResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MoveFileOrFolderResultSet results = new JavaScriptSerializer().Deserialize<MoveFileOrFolderResultSet>(json);
    ...
    /// </summary>
    public class MoveFileOrFolderResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
