...
namespace Temboo.Library.Google.ComputeEngine.Snapshots
{
    ...
    /// </summary>
    public class ListSnapshots : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListSnapshots Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListSnapshots(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Snapshots/ListSnapshots")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListSnapshotsResultSet containing execution metadata and results.</returns>
        new public ListSnapshotsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListSnapshotsResultSet results = new JavaScriptSerializer().Deserialize<ListSnapshotsResultSet>(json);
    ...
    /// </summary>
    public class ListSnapshotsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
