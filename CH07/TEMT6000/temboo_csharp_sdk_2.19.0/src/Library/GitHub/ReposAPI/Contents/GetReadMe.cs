...
namespace Temboo.Library.GitHub.ReposAPI.Contents
{
    ...
    /// </summary>
    public class GetReadMe : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetReadMe Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetReadMe(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Contents/GetReadMe")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetReadMeResultSet containing execution metadata and results.</returns>
        new public GetReadMeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetReadMeResultSet results = new JavaScriptSerializer().Deserialize<GetReadMeResultSet>(json);
    ...
    /// </summary>
    public class GetReadMeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
