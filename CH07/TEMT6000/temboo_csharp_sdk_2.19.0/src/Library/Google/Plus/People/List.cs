...
namespace Temboo.Library.Google.Plus.People
{
    /// <summary>
    /// List
    ...
    public class List : Temboo.Core.Choreography
    {
        ...
        public List(TembooSession session) : base(session, "/Library/Google/Plus/People/List")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The order to return people in. Valid values are: alphabetical and best.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) The ID of the person to get the collection of people for. The value "me" is set as the default to indicate the authenticated user.
         /// </summary>
