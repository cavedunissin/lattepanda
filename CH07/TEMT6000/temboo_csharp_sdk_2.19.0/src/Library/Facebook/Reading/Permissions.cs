...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Permissions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Permissions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Permissions(TembooSession session) : base(session, "/Library/Facebook/Reading/Permissions")
        {
        }
        ...
        /// </summary>
        /// <returns>A PermissionsResultSet containing execution metadata and results.</returns>
        new public PermissionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PermissionsResultSet results = new JavaScriptSerializer().Deserialize<PermissionsResultSet>(json);
    ...
    /// </summary>
    public class PermissionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
