...
namespace Temboo.Library.Google.ComputeEngine.Projects
{
    /// <summary>
    /// SetCommonInstanceMetadata
    /// Sets metadata common to all instances within the specified Project.
    /// </summary>
    public class SetCommonInstanceMetadata : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SetCommonInstanceMetadata Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SetCommonInstanceMetadata(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Projects/SetCommonInstanceMetadata")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Fingerprint input for this Choreo.</param>
         public void setFingerprint(String value) {
             base.addInput ("Fingerprint", value);
         }
         /// <summary>
         /// (conditional, json) An array of key/value pairs. The max size of all keys and values is 512 KB.
         /// </summary>
         /// <param name="value">Value of the Items input for this Choreo.</param>
         public void setItems(String value) {
             base.addInput ("Items", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A SetCommonInstanceMetadataResultSet containing execution metadata and results.</returns>
        new public SetCommonInstanceMetadataResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SetCommonInstanceMetadataResultSet results = new JavaScriptSerializer().Deserialize<SetCommonInstanceMetadataResultSet>(json);
    ...
    /// </summary>
    public class SetCommonInstanceMetadataResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
