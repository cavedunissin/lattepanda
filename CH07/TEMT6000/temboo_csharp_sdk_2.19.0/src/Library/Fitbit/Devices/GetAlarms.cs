...
namespace Temboo.Library.Fitbit.Devices
{
    ...
    /// </summary>
    public class GetAlarms : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAlarms Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAlarms(TembooSession session) : base(session, "/Library/Fitbit/Devices/GetAlarms")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAlarmsResultSet containing execution metadata and results.</returns>
        new public GetAlarmsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAlarmsResultSet results = new JavaScriptSerializer().Deserialize<GetAlarmsResultSet>(json);
    ...
    /// </summary>
    public class GetAlarmsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
