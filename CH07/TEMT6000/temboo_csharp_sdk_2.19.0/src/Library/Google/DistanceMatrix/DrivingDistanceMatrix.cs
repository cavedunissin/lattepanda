...
namespace Temboo.Library.Google.DistanceMatrix
{
    ...
    /// </summary>
    public class DrivingDistanceMatrix : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DrivingDistanceMatrix Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DrivingDistanceMatrix(TembooSession session) : base(session, "/Library/Google/DistanceMatrix/DrivingDistanceMatrix")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Avoid input for this Choreo.</param>
         public void setAvoid(String value) {
             base.addInput ("Avoid", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DrivingDistanceMatrixResultSet containing execution metadata and results.</returns>
        new public DrivingDistanceMatrixResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DrivingDistanceMatrixResultSet results = new JavaScriptSerializer().Deserialize<DrivingDistanceMatrixResultSet>(json);
    ...
    /// </summary>
    public class DrivingDistanceMatrixResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (integer) The duration of this route, expressed in seconds.</returns>
        /// </summary>
