...
namespace Temboo.Library.LinkedIn.OAuth
{
    /// <summary>
    /// InitializeOAuth
    ...
    public class InitializeOAuth : Temboo.Core.Choreography
    {
        ...
        public InitializeOAuth(TembooSession session) : base(session, "/Library/LinkedIn/OAuth/InitializeOAuth")
        {
        }
    ...
    public class InitializeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The temporary OAuth Token Secret that can be exchanged for a final token secret using the FinalizeOAuth Choreo.</returns>
        /// </summary>
