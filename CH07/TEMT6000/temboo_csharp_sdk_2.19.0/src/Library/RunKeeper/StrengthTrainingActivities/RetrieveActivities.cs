...
namespace Temboo.Library.RunKeeper.StrengthTrainingActivities
{
    ...
    /// </summary>
    public class RetrieveActivities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveActivities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveActivities(TembooSession session) : base(session, "/Library/RunKeeper/StrengthTrainingActivities/RetrieveActivities")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveActivitiesResultSet containing execution metadata and results.</returns>
        new public RetrieveActivitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveActivitiesResultSet results = new JavaScriptSerializer().Deserialize<RetrieveActivitiesResultSet>(json);
    ...
    /// </summary>
    public class RetrieveActivitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
