...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class GetComments : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetComments Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetComments(TembooSession session) : base(session, "/Library/LinkedIn/Companies/GetComments")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCommentsResultSet containing execution metadata and results.</returns>
        new public GetCommentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCommentsResultSet results = new JavaScriptSerializer().Deserialize<GetCommentsResultSet>(json);
    ...
    /// </summary>
    public class GetCommentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
