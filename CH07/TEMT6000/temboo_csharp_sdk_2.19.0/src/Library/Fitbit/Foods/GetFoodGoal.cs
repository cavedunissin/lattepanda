...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetFoodGoal : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFoodGoal Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFoodGoal(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetFoodGoal")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFoodGoalResultSet containing execution metadata and results.</returns>
        new public GetFoodGoalResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFoodGoalResultSet results = new JavaScriptSerializer().Deserialize<GetFoodGoalResultSet>(json);
    ...
    /// </summary>
    public class GetFoodGoalResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
