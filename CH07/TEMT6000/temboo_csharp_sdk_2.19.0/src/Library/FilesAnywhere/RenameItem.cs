...
namespace Temboo.Library.FilesAnywhere
{
    ...
    /// Rename an item.
    /// </summary>
    public class RenameItem : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RenameItem Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RenameItem(TembooSession session) : base(session, "/Library/FilesAnywhere/RenameItem")
        {
        }
        ...
        /// </summary>
        /// <returns>A RenameItemResultSet containing execution metadata and results.</returns>
        new public RenameItemResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RenameItemResultSet results = new JavaScriptSerializer().Deserialize<RenameItemResultSet>(json);
    ...
    /// </summary>
    public class RenameItemResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
