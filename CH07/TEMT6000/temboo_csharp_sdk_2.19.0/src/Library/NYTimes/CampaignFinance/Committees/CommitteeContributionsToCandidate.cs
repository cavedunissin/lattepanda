...
namespace Temboo.Library.NYTimes.CampaignFinance.Committees
{
    ...
    /// </summary>
    public class CommitteeContributionsToCandidate : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CommitteeContributionsToCandidate Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CommitteeContributionsToCandidate(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Committees/CommitteeContributionsToCandidate")
        {
        }
        ...
        /// </summary>
        /// <returns>A CommitteeContributionsToCandidateResultSet containing execution metadata and results.</returns>
        new public CommitteeContributionsToCandidateResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CommitteeContributionsToCandidateResultSet results = new JavaScriptSerializer().Deserialize<CommitteeContributionsToCandidateResultSet>(json);
    ...
    /// </summary>
    public class CommitteeContributionsToCandidateResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
