...
namespace Temboo.Library.Yelp
{
    ...
    /// </summary>
    public class SearchByNeighborhood : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchByNeighborhood Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchByNeighborhood(TembooSession session) : base(session, "/Library/Yelp/SearchByNeighborhood")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Neighborhood input for this Choreo.</param>
         public void setNeighborhood(String value) {
             base.addInput ("Neighborhood", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A SearchByNeighborhoodResultSet containing execution metadata and results.</returns>
        new public SearchByNeighborhoodResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchByNeighborhoodResultSet results = new JavaScriptSerializer().Deserialize<SearchByNeighborhoodResultSet>(json);
    ...
    /// </summary>
    public class SearchByNeighborhoodResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
