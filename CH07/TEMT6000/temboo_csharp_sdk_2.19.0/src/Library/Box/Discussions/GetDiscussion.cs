...
namespace Temboo.Library.Box.Discussions
{
    ...
    /// </summary>
    public class GetDiscussion : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetDiscussion Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetDiscussion(TembooSession session) : base(session, "/Library/Box/Discussions/GetDiscussion")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetDiscussionResultSet containing execution metadata and results.</returns>
        new public GetDiscussionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetDiscussionResultSet results = new JavaScriptSerializer().Deserialize<GetDiscussionResultSet>(json);
    ...
    /// </summary>
    public class GetDiscussionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
