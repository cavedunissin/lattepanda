...
namespace Temboo.Library.Google.Sheets
{
    ...
    /// </summary>
    public class CopyToSheet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CopyToSheet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CopyToSheet(TembooSession session) : base(session, "/Library/Google/Sheets/CopyToSheet")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the spreadsheet to copy the sheet to.
         /// </summary>
         /// <param name="value">Value of the DestinationSpreadsheetID input for this Choreo.</param>
         public void setDestinationSpreadsheetID(String value) {
             base.addInput ("DestinationSpreadsheetID", value);
         }
         /// <summary>
         ...
         /// <summary>
         /// (required, integer) The ID of the sheet to copy. SheetIDs can be retrieved using the GetSpreadsheet Choreo.
         /// </summary>
         /// <param name="value">Value of the SheetID input for this Choreo.</param>
         public void setSheetID(String value) {
             base.addInput ("SheetID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CopyToSheetResultSet containing execution metadata and results.</returns>
        new public CopyToSheetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CopyToSheetResultSet results = new JavaScriptSerializer().Deserialize<CopyToSheetResultSet>(json);
    ...
    /// </summary>
    public class CopyToSheetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
