...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class GetActivityWeeklyGoals : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetActivityWeeklyGoals Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetActivityWeeklyGoals(TembooSession session) : base(session, "/Library/Fitbit/Activities/GetActivityWeeklyGoals")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetActivityWeeklyGoalsResultSet containing execution metadata and results.</returns>
        new public GetActivityWeeklyGoalsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetActivityWeeklyGoalsResultSet results = new JavaScriptSerializer().Deserialize<GetActivityWeeklyGoalsResultSet>(json);
    ...
    /// </summary>
    public class GetActivityWeeklyGoalsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Distance" output from this Choreo execution
        /// <returns>String - (decimal) The distance specified as the weekly goal.</returns>
        /// </summary>
        ...
        /// <returns>String - (integer) The number of floors specified as a weekly goal.</returns>
        /// </summary>
        public String Floors
        {
            get
            {
                return (String) base.Output["Floors"];
            }
        }
        /// <summary> 
        /// Retrieve the value for the "Steps" output from this Choreo execution
        /// <returns>String - (integer) The number of steps specified for a weekly goal.</returns>
        /// </summary>
        public String Steps
        {
            get
