...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Accounts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Accounts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Accounts(TembooSession session) : base(session, "/Library/Facebook/Reading/Accounts")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The id of the user to retrieve account info for. Defaults to "me" indicating the authenticated user.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A AccountsResultSet containing execution metadata and results.</returns>
        new public AccountsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AccountsResultSet results = new JavaScriptSerializer().Deserialize<AccountsResultSet>(json);
    ...
    /// </summary>
    public class AccountsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
