...
namespace Temboo.Library.Foursquare.Users
{
    ...
    /// </summary>
    public class PhotosFromUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PhotosFromUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PhotosFromUser(TembooSession session) : base(session, "/Library/Foursquare/Users/PhotosFromUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A PhotosFromUserResultSet containing execution metadata and results.</returns>
        new public PhotosFromUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PhotosFromUserResultSet results = new JavaScriptSerializer().Deserialize<PhotosFromUserResultSet>(json);
    ...
    /// </summary>
    public class PhotosFromUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
