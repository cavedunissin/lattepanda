...
namespace Temboo.Library.Microsoft.Excel.Range
{
    ...
    /// </summary>
    public class GetLastColumn : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLastColumn Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLastColumn(TembooSession session) : base(session, "/Library/Microsoft/Excel/Range/GetLastColumn")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLastColumnResultSet containing execution metadata and results.</returns>
        new public GetLastColumnResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLastColumnResultSet results = new JavaScriptSerializer().Deserialize<GetLastColumnResultSet>(json);
    ...
    /// </summary>
    public class GetLastColumnResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
