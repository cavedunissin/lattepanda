...
namespace Temboo.Library.GitHub.ReposAPI.Collaborators
{
    ...
    /// </summary>
    public class ListCollaborators : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCollaborators Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCollaborators(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Collaborators/ListCollaborators")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListCollaboratorsResultSet containing execution metadata and results.</returns>
        new public ListCollaboratorsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCollaboratorsResultSet results = new JavaScriptSerializer().Deserialize<ListCollaboratorsResultSet>(json);
    ...
    /// </summary>
    public class ListCollaboratorsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
