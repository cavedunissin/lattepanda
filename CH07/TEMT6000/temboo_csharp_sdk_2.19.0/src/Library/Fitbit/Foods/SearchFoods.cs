...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class SearchFoods : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchFoods Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchFoods(TembooSession session) : base(session, "/Library/Fitbit/Foods/SearchFoods")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchFoodsResultSet containing execution metadata and results.</returns>
        new public SearchFoodsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchFoodsResultSet results = new JavaScriptSerializer().Deserialize<SearchFoodsResultSet>(json);
    ...
    /// </summary>
    public class SearchFoodsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
