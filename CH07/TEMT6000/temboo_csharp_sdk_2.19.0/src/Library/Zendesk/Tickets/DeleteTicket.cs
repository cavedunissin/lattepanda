...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class DeleteTicket : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteTicket Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteTicket(TembooSession session) : base(session, "/Library/Zendesk/Tickets/DeleteTicket")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteTicketResultSet containing execution metadata and results.</returns>
        new public DeleteTicketResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteTicketResultSet results = new JavaScriptSerializer().Deserialize<DeleteTicketResultSet>(json);
    ...
    /// </summary>
    public class DeleteTicketResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
