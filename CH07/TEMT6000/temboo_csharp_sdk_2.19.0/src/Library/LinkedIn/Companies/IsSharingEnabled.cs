...
namespace Temboo.Library.LinkedIn.Companies
{
    ...
    /// </summary>
    public class IsSharingEnabled : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the IsSharingEnabled Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public IsSharingEnabled(TembooSession session) : base(session, "/Library/LinkedIn/Companies/IsSharingEnabled")
        {
        }
        ...
        /// </summary>
        /// <returns>A IsSharingEnabledResultSet containing execution metadata and results.</returns>
        new public IsSharingEnabledResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            IsSharingEnabledResultSet results = new JavaScriptSerializer().Deserialize<IsSharingEnabledResultSet>(json);
    ...
    /// </summary>
    public class IsSharingEnabledResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
