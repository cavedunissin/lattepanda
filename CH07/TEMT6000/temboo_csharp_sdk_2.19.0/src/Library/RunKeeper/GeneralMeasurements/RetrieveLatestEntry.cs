...
namespace Temboo.Library.RunKeeper.GeneralMeasurements
{
    ...
    public class RetrieveLatestEntry : Temboo.Core.Choreography
    {
        ...
        public RetrieveLatestEntry(TembooSession session) : base(session, "/Library/RunKeeper/GeneralMeasurements/RetrieveLatestEntry")
        {
        }
    ...
    public class RetrieveLatestEntryResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (date) The timestamp for the entry.</returns>
        /// </summary>
        ...
        /// <summary> 
        /// Retrieve the value for the "TotalCholesterol" output from this Choreo execution
        /// <returns>String - (decimal) The value of the measured quantity in mg/dL (omitted if not available).</returns>
        /// </summary>
        public String TotalCholesterol
        {
            get
            {
                return (String) base.Output["TotalCholesterol"];
            }
        }
        /// <summary> 
        /// Retrieve the value for the "URI" output from this Choreo execution
        /// <returns>String - (string) The URI of the entry.</returns>
        /// </summary>
        public String URI
        {
            get
