...
namespace Temboo.Library.Amazon.CloudDrive.Properties
{
    ...
    /// </summary>
    public class AddProperty : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddProperty Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddProperty(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Properties/AddProperty")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddPropertyResultSet containing execution metadata and results.</returns>
        new public AddPropertyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddPropertyResultSet results = new JavaScriptSerializer().Deserialize<AddPropertyResultSet>(json);
    ...
    /// </summary>
    public class AddPropertyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
