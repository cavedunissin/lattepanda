...
namespace Temboo.Library.Foursquare.Lists
{
    ...
    /// Creates a new list.
    /// </summary>
    public class AddList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddList(TembooSession session) : base(session, "/Library/Foursquare/Lists/AddList")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddListResultSet containing execution metadata and results.</returns>
        new public AddListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddListResultSet results = new JavaScriptSerializer().Deserialize<AddListResultSet>(json);
    ...
    /// </summary>
    public class AddListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
