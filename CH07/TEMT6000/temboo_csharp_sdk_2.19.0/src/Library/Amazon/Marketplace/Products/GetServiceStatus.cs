...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    public class GetServiceStatus : Temboo.Core.Choreography
    {
        ...
        public GetServiceStatus(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/GetServiceStatus")
        {
        }
    ...
    public class GetServiceStatusResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The service status parsed from the Amazon response.</returns>
        /// </summary>
