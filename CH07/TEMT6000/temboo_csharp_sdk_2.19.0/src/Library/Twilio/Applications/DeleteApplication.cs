...
namespace Temboo.Library.Twilio.Applications
{
    ...
    /// </summary>
    public class DeleteApplication : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteApplication Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteApplication(TembooSession session) : base(session, "/Library/Twilio/Applications/DeleteApplication")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteApplicationResultSet containing execution metadata and results.</returns>
        new public DeleteApplicationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteApplicationResultSet results = new JavaScriptSerializer().Deserialize<DeleteApplicationResultSet>(json);
    ...
    /// </summary>
    public class DeleteApplicationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
