...
namespace Temboo.Library.Google.Plus.Domains.Circles
{
    ...
    /// </summary>
    public class AddPeople : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddPeople Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddPeople(TembooSession session) : base(session, "/Library/Google/Plus/Domains/Circles/AddPeople")
        {
        }
         ...
         /// <summary>
         /// (conditional, string) Comma-seperated list of up to 10 email addresses to add. Required unless providing a value for UserID.
         /// </summary>
         ...
         /// <summary>
         /// (conditional, string) Comma-seperated list of up to 10 User IDs to add. Required unless providing a value for Email.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A AddPeopleResultSet containing execution metadata and results.</returns>
        new public AddPeopleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddPeopleResultSet results = new JavaScriptSerializer().Deserialize<AddPeopleResultSet>(json);
    ...
    /// </summary>
    public class AddPeopleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
