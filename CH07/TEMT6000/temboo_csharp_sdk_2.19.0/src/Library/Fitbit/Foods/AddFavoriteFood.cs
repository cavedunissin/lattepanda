...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class AddFavoriteFood : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddFavoriteFood Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddFavoriteFood(TembooSession session) : base(session, "/Library/Fitbit/Foods/AddFavoriteFood")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddFavoriteFoodResultSet containing execution metadata and results.</returns>
        new public AddFavoriteFoodResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddFavoriteFoodResultSet results = new JavaScriptSerializer().Deserialize<AddFavoriteFoodResultSet>(json);
    ...
    /// </summary>
    public class AddFavoriteFoodResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
