...
namespace Temboo.Library.LastFm.Artist
{
    ...
    /// </summary>
    public class GetPodcast : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPodcast Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPodcast(TembooSession session) : base(session, "/Library/LastFm/Artist/GetPodcast")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPodcastResultSet containing execution metadata and results.</returns>
        new public GetPodcastResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPodcastResultSet results = new JavaScriptSerializer().Deserialize<GetPodcastResultSet>(json);
    ...
    /// </summary>
    public class GetPodcastResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
