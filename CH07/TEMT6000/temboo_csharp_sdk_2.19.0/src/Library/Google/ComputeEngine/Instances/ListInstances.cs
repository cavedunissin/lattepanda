...
namespace Temboo.Library.Google.ComputeEngine.Instances
{
    ...
    /// </summary>
    public class ListInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListInstances(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Instances/ListInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListInstancesResultSet containing execution metadata and results.</returns>
        new public ListInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListInstancesResultSet results = new JavaScriptSerializer().Deserialize<ListInstancesResultSet>(json);
    ...
    /// </summary>
    public class ListInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
