...
namespace Temboo.Library.SendGrid.NewsletterAPI.Identity
{
    ...
    /// </summary>
    public class GetIdentityInfo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetIdentityInfo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetIdentityInfo(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Identity/GetIdentityInfo")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetIdentityInfoResultSet containing execution metadata and results.</returns>
        new public GetIdentityInfoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetIdentityInfoResultSet results = new JavaScriptSerializer().Deserialize<GetIdentityInfoResultSet>(json);
    ...
    /// </summary>
    public class GetIdentityInfoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
