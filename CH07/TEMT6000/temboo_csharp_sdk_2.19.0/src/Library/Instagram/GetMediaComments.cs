...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class GetMediaComments : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMediaComments Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMediaComments(TembooSession session) : base(session, "/Library/Instagram/GetMediaComments")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMediaCommentsResultSet containing execution metadata and results.</returns>
        new public GetMediaCommentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMediaCommentsResultSet results = new JavaScriptSerializer().Deserialize<GetMediaCommentsResultSet>(json);
    ...
    /// </summary>
    public class GetMediaCommentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
