...
namespace Temboo.Library.Zendesk.ActivityStream
{
    ...
    /// </summary>
    public class ShowActivity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ShowActivity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ShowActivity(TembooSession session) : base(session, "/Library/Zendesk/ActivityStream/ShowActivity")
        {
        }
        ...
        /// </summary>
        /// <returns>A ShowActivityResultSet containing execution metadata and results.</returns>
        new public ShowActivityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ShowActivityResultSet results = new JavaScriptSerializer().Deserialize<ShowActivityResultSet>(json);
    ...
    /// </summary>
    public class ShowActivityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
