...
namespace Temboo.Library.Twitter.Favorites
{
    ...
    /// </summary>
    public class CreateFavorite : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateFavorite Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateFavorite(TembooSession session) : base(session, "/Library/Twitter/Favorites/CreateFavorite")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateFavoriteResultSet containing execution metadata and results.</returns>
        new public CreateFavoriteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateFavoriteResultSet results = new JavaScriptSerializer().Deserialize<CreateFavoriteResultSet>(json);
    ...
    /// </summary>
    public class CreateFavoriteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
