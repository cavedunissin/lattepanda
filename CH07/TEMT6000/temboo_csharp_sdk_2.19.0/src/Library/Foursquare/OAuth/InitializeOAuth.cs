...
namespace Temboo.Library.Foursquare.OAuth
{
    /// <summary>
    /// InitializeOAuth
    ...
    public class InitializeOAuth : Temboo.Core.Choreography
    {
        ...
        public InitializeOAuth(TembooSession session) : base(session, "/Library/Foursquare/OAuth/InitializeOAuth")
        {
        }
    ...
    public class InitializeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        public String AuthorizeURL
        {
            get
            {
                return (String) base.Output["AuthorizeURL"];
            }
        }
        /// <summary> 
