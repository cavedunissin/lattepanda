...
namespace Temboo.Library.SendGrid.NewsletterAPI.Newsletter
{
    ...
    /// </summary>
    public class DeleteNewsletter : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteNewsletter Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteNewsletter(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Newsletter/DeleteNewsletter")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteNewsletterResultSet containing execution metadata and results.</returns>
        new public DeleteNewsletterResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteNewsletterResultSet results = new JavaScriptSerializer().Deserialize<DeleteNewsletterResultSet>(json);
    ...
    /// </summary>
    public class DeleteNewsletterResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
