...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class GetFriendsByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFriendsByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFriendsByID(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/GetFriendsByID")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFriendsByIDResultSet containing execution metadata and results.</returns>
        new public GetFriendsByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFriendsByIDResultSet results = new JavaScriptSerializer().Deserialize<GetFriendsByIDResultSet>(json);
    ...
    /// </summary>
    public class GetFriendsByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
