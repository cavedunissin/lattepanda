...
namespace Temboo.Library.Google.ComputeEngine.MachineTypes
{
    ...
    /// </summary>
    public class GetMachineType : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMachineType Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMachineType(TembooSession session) : base(session, "/Library/Google/ComputeEngine/MachineTypes/GetMachineType")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMachineTypeResultSet containing execution metadata and results.</returns>
        new public GetMachineTypeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMachineTypeResultSet results = new JavaScriptSerializer().Deserialize<GetMachineTypeResultSet>(json);
    ...
    /// </summary>
    public class GetMachineTypeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
