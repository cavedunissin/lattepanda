...
namespace Temboo.Library.Salesforce.Passwords
{
    ...
    public class ResetPassword : Temboo.Core.Choreography
    {
        ...
        public ResetPassword(TembooSession session) : base(session, "/Library/Salesforce/Passwords/ResetPassword")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the user whos password you are resetting.
         /// </summary>
    ...
    public class ResetPasswordResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) New password returned from Salesforce.</returns>
        /// </summary>
        public String NewPassword
        {
            get
            {
                return (String) base.Output["NewPassword"];
            }
        }
        /// <summary> 
