...
namespace Temboo.Library.Foursquare.Lists
{
    ...
    /// </summary>
    public class UnfollowList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnfollowList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnfollowList(TembooSession session) : base(session, "/Library/Foursquare/Lists/UnfollowList")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnfollowListResultSet containing execution metadata and results.</returns>
        new public UnfollowListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnfollowListResultSet results = new JavaScriptSerializer().Deserialize<UnfollowListResultSet>(json);
    ...
    /// </summary>
    public class UnfollowListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
