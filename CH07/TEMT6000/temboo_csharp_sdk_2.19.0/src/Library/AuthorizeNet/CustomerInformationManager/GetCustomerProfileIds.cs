...
namespace Temboo.Library.AuthorizeNet.CustomerInformationManager
{
    ...
    /// </summary>
    public class GetCustomerProfileIds : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCustomerProfileIds Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCustomerProfileIds(TembooSession session) : base(session, "/Library/AuthorizeNet/CustomerInformationManager/GetCustomerProfileIds")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCustomerProfileIdsResultSet containing execution metadata and results.</returns>
        new public GetCustomerProfileIdsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCustomerProfileIdsResultSet results = new JavaScriptSerializer().Deserialize<GetCustomerProfileIdsResultSet>(json);
    ...
    /// </summary>
    public class GetCustomerProfileIdsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
