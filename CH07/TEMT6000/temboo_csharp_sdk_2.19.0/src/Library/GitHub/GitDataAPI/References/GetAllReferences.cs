...
namespace Temboo.Library.GitHub.GitDataAPI.References
{
    ...
    /// </summary>
    public class GetAllReferences : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAllReferences Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAllReferences(TembooSession session) : base(session, "/Library/GitHub/GitDataAPI/References/GetAllReferences")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAllReferencesResultSet containing execution metadata and results.</returns>
        new public GetAllReferencesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAllReferencesResultSet results = new JavaScriptSerializer().Deserialize<GetAllReferencesResultSet>(json);
    ...
    /// </summary>
    public class GetAllReferencesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
