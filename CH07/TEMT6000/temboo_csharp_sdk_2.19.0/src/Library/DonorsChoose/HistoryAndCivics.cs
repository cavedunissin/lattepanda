...
namespace Temboo.Library.DonorsChoose
{
    ...
    /// </summary>
    public class HistoryAndCivics : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the HistoryAndCivics Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public HistoryAndCivics(TembooSession session) : base(session, "/Library/DonorsChoose/HistoryAndCivics")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ShowCounts input for this Choreo.</param>
         public void setShowCounts(String value) {
             base.addInput ("ShowCounts", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A HistoryAndCivicsResultSet containing execution metadata and results.</returns>
        new public HistoryAndCivicsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            HistoryAndCivicsResultSet results = new JavaScriptSerializer().Deserialize<HistoryAndCivicsResultSet>(json);
    ...
    /// </summary>
    public class HistoryAndCivicsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
