...
namespace Temboo.Library.Mixpanel.Profiles
{
    ...
    /// </summary>
    public class Unset : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Unset Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Unset(TembooSession session) : base(session, "/Library/Mixpanel/Profiles/Unset")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnsetResultSet containing execution metadata and results.</returns>
        new public UnsetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnsetResultSet results = new JavaScriptSerializer().Deserialize<UnsetResultSet>(json);
    ...
    /// </summary>
    public class UnsetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
