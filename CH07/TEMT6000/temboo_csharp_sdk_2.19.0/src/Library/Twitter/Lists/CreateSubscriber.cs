...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class CreateSubscriber : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateSubscriber Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateSubscriber(TembooSession session) : base(session, "/Library/Twitter/Lists/CreateSubscriber")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateSubscriberResultSet containing execution metadata and results.</returns>
        new public CreateSubscriberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateSubscriberResultSet results = new JavaScriptSerializer().Deserialize<CreateSubscriberResultSet>(json);
    ...
    /// </summary>
    public class CreateSubscriberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
