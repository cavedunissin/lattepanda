...
namespace Temboo.Library.Salesforce.Searching
{
    ...
    public class Search : Temboo.Core.Choreography
    {
        ...
        public Search(TembooSession session) : base(session, "/Library/Salesforce/Searching/Search")
        {
        }
         ...
         /// <summary>
         /// (required, string) The SOSL statement used to retrieve the set of records matching a specific criteria (e.g. FIND {joe})
         /// </summary>
         /// <param name="value">Value of the SOSL input for this Choreo.</param>
         public void setSOSL(String value) {
             base.addInput ("SOSL", value);
         }
