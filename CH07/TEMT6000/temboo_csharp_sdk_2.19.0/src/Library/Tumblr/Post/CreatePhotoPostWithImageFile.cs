...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class CreatePhotoPostWithImageFile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreatePhotoPostWithImageFile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreatePhotoPostWithImageFile(TembooSession session) : base(session, "/Library/Tumblr/Post/CreatePhotoPostWithImageFile")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreatePhotoPostWithImageFileResultSet containing execution metadata and results.</returns>
        new public CreatePhotoPostWithImageFileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreatePhotoPostWithImageFileResultSet results = new JavaScriptSerializer().Deserialize<CreatePhotoPostWithImageFileResultSet>(json);
    ...
    /// </summary>
    public class CreatePhotoPostWithImageFileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
