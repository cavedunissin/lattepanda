...
namespace Temboo.Library.YouTube.Videos
{
    ...
    /// </summary>
    public class ListVideosByID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListVideosByID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListVideosByID(TembooSession session) : base(session, "/Library/YouTube/Videos/ListVideosByID")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListVideosByIDResultSet containing execution metadata and results.</returns>
        new public ListVideosByIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListVideosByIDResultSet results = new JavaScriptSerializer().Deserialize<ListVideosByIDResultSet>(json);
    ...
    /// </summary>
    public class ListVideosByIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
