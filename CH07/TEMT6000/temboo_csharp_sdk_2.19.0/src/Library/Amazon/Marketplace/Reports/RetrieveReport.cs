...
namespace Temboo.Library.Amazon.Marketplace.Reports
{
    ...
    /// </summary>
    public class RetrieveReport : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveReport Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveReport(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Reports/RetrieveReport")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveReportResultSet containing execution metadata and results.</returns>
        new public RetrieveReportResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveReportResultSet results = new JavaScriptSerializer().Deserialize<RetrieveReportResultSet>(json);
    ...
    /// </summary>
    public class RetrieveReportResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Report" output from this Choreo execution
        /// <returns>String - The report contents.</returns>
        /// </summary>
