...
namespace Temboo.Library.Google.Gmailv2.Labels
{
    ...
    /// </summary>
    public class UpdateLabel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateLabel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateLabel(TembooSession session) : base(session, "/Library/Google/Gmailv2/Labels/UpdateLabel")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateLabelResultSet containing execution metadata and results.</returns>
        new public UpdateLabelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateLabelResultSet results = new JavaScriptSerializer().Deserialize<UpdateLabelResultSet>(json);
    ...
    /// </summary>
    public class UpdateLabelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
