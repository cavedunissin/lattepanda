...
namespace Temboo.Library.Twilio.Calls
{
    ...
    /// </summary>
    public class GetLastCallFrom : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLastCallFrom Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLastCallFrom(TembooSession session) : base(session, "/Library/Twilio/Calls/GetLastCallFrom")
        {
        }
         ...
         /// <summary>
         /// (required, string) Filters results for calls from this phone number or Client identifier.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetLastCallFromResultSet containing execution metadata and results.</returns>
        new public GetLastCallFromResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLastCallFromResultSet results = new JavaScriptSerializer().Deserialize<GetLastCallFromResultSet>(json);
    ...
    /// </summary>
    public class GetLastCallFromResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
