...
namespace Temboo.Library.Google.Gmailv2.Messages
{
    ...
    /// </summary>
    public class ModifyMessage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ModifyMessage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ModifyMessage(TembooSession session) : base(session, "/Library/Google/Gmailv2/Messages/ModifyMessage")
        {
        }
        ...
        /// </summary>
        /// <returns>A ModifyMessageResultSet containing execution metadata and results.</returns>
        new public ModifyMessageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ModifyMessageResultSet results = new JavaScriptSerializer().Deserialize<ModifyMessageResultSet>(json);
    ...
    /// </summary>
    public class ModifyMessageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
