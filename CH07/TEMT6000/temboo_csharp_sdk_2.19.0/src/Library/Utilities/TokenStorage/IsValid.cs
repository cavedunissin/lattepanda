...
namespace Temboo.Library.Utilities.TokenStorage
{
    ...
    /// </summary>
    public class IsValid : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the IsValid Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public IsValid(TembooSession session) : base(session, "/Library/Utilities/TokenStorage/IsValid")
        {
        }
        ...
        /// </summary>
        /// <returns>A IsValidResultSet containing execution metadata and results.</returns>
        new public IsValidResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            IsValidResultSet results = new JavaScriptSerializer().Deserialize<IsValidResultSet>(json);
    ...
    /// </summary>
    public class IsValidResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
