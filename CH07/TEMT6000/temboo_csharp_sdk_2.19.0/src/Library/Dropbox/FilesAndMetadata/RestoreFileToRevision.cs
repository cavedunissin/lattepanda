...
namespace Temboo.Library.Dropbox.FilesAndMetadata
{
    ...
    /// </summary>
    public class RestoreFileToRevision : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RestoreFileToRevision Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RestoreFileToRevision(TembooSession session) : base(session, "/Library/Dropbox/FilesAndMetadata/RestoreFileToRevision")
        {
        }
        ...
        /// </summary>
        /// <returns>A RestoreFileToRevisionResultSet containing execution metadata and results.</returns>
        new public RestoreFileToRevisionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RestoreFileToRevisionResultSet results = new JavaScriptSerializer().Deserialize<RestoreFileToRevisionResultSet>(json);
    ...
    /// </summary>
    public class RestoreFileToRevisionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
