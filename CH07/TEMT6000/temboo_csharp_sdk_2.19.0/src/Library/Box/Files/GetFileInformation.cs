...
namespace Temboo.Library.Box.Files
{
    ...
    /// </summary>
    public class GetFileInformation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFileInformation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFileInformation(TembooSession session) : base(session, "/Library/Box/Files/GetFileInformation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFileInformationResultSet containing execution metadata and results.</returns>
        new public GetFileInformationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFileInformationResultSet results = new JavaScriptSerializer().Deserialize<GetFileInformationResultSet>(json);
    ...
    /// </summary>
    public class GetFileInformationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
