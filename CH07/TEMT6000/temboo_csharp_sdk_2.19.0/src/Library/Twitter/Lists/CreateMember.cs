...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class CreateMember : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateMember Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateMember(TembooSession session) : base(session, "/Library/Twitter/Lists/CreateMember")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateMemberResultSet containing execution metadata and results.</returns>
        new public CreateMemberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateMemberResultSet results = new JavaScriptSerializer().Deserialize<CreateMemberResultSet>(json);
    ...
    /// </summary>
    public class CreateMemberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
