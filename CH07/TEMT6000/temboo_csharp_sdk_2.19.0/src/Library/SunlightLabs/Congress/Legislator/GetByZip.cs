...
namespace Temboo.Library.SunlightLabs.Congress.Legislator
{
    ...
    /// </summary>
    public class GetByZip : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetByZip Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetByZip(TembooSession session) : base(session, "/Library/SunlightLabs/Congress/Legislator/GetByZip")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetByZipResultSet containing execution metadata and results.</returns>
        new public GetByZipResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetByZipResultSet results = new JavaScriptSerializer().Deserialize<GetByZipResultSet>(json);
    ...
    /// </summary>
    public class GetByZipResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
