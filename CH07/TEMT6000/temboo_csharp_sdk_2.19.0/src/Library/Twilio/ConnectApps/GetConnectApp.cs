...
namespace Temboo.Library.Twilio.ConnectApps
{
    ...
    /// </summary>
    public class GetConnectApp : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetConnectApp Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetConnectApp(TembooSession session) : base(session, "/Library/Twilio/ConnectApps/GetConnectApp")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetConnectAppResultSet containing execution metadata and results.</returns>
        new public GetConnectAppResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetConnectAppResultSet results = new JavaScriptSerializer().Deserialize<GetConnectAppResultSet>(json);
    ...
    /// </summary>
    public class GetConnectAppResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
