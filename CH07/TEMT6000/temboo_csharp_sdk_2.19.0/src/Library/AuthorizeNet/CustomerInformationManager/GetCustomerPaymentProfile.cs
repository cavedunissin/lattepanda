...
namespace Temboo.Library.AuthorizeNet.CustomerInformationManager
{
    ...
    /// </summary>
    public class GetCustomerPaymentProfile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCustomerPaymentProfile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCustomerPaymentProfile(TembooSession session) : base(session, "/Library/AuthorizeNet/CustomerInformationManager/GetCustomerPaymentProfile")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the CustomerPaymentProfileId input for this Choreo.</param>
         public void setCustomerPaymentProfileId(String value) {
             base.addInput ("CustomerPaymentProfileId", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetCustomerPaymentProfileResultSet containing execution metadata and results.</returns>
        new public GetCustomerPaymentProfileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCustomerPaymentProfileResultSet results = new JavaScriptSerializer().Deserialize<GetCustomerPaymentProfileResultSet>(json);
    ...
    /// </summary>
    public class GetCustomerPaymentProfileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
