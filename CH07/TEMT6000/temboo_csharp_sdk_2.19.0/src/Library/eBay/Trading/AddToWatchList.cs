...
namespace Temboo.Library.eBay.Trading
{
    ...
    /// </summary>
    public class AddToWatchList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddToWatchList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddToWatchList(TembooSession session) : base(session, "/Library/eBay/Trading/AddToWatchList")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddToWatchListResultSet containing execution metadata and results.</returns>
        new public AddToWatchListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddToWatchListResultSet results = new JavaScriptSerializer().Deserialize<AddToWatchListResultSet>(json);
    ...
    /// </summary>
    public class AddToWatchListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
