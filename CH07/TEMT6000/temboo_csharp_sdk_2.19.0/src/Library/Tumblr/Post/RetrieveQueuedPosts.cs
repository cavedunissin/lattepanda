...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class RetrieveQueuedPosts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveQueuedPosts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveQueuedPosts(TembooSession session) : base(session, "/Library/Tumblr/Post/RetrieveQueuedPosts")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveQueuedPostsResultSet containing execution metadata and results.</returns>
        new public RetrieveQueuedPostsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveQueuedPostsResultSet results = new JavaScriptSerializer().Deserialize<RetrieveQueuedPostsResultSet>(json);
    ...
    /// </summary>
    public class RetrieveQueuedPostsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
