...
namespace Temboo.Library.Google.Gmailv2.Drafts
{
    ...
    /// </summary>
    public class GetDraft : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetDraft Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetDraft(TembooSession session) : base(session, "/Library/Google/Gmailv2/Drafts/GetDraft")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetDraftResultSet containing execution metadata and results.</returns>
        new public GetDraftResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetDraftResultSet results = new JavaScriptSerializer().Deserialize<GetDraftResultSet>(json);
    ...
    /// </summary>
    public class GetDraftResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
