...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class OutgoingFriendships : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the OutgoingFriendships Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public OutgoingFriendships(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/OutgoingFriendships")
        {
        }
        ...
        /// </summary>
        /// <returns>A OutgoingFriendshipsResultSet containing execution metadata and results.</returns>
        new public OutgoingFriendshipsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            OutgoingFriendshipsResultSet results = new JavaScriptSerializer().Deserialize<OutgoingFriendshipsResultSet>(json);
    ...
    /// </summary>
    public class OutgoingFriendshipsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
