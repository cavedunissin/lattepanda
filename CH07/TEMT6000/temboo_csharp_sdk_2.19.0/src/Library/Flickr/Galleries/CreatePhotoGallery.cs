...
namespace Temboo.Library.Flickr.Galleries
{
    ...
    /// </summary>
    public class CreatePhotoGallery : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreatePhotoGallery Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreatePhotoGallery(TembooSession session) : base(session, "/Library/Flickr/Galleries/CreatePhotoGallery")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the PrimaryPhotoID input for this Choreo.</param>
         public void setPrimaryPhotoID(String value) {
             base.addInput ("PrimaryPhotoID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CreatePhotoGalleryResultSet containing execution metadata and results.</returns>
        new public CreatePhotoGalleryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreatePhotoGalleryResultSet results = new JavaScriptSerializer().Deserialize<CreatePhotoGalleryResultSet>(json);
    ...
    /// </summary>
    public class CreatePhotoGalleryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
