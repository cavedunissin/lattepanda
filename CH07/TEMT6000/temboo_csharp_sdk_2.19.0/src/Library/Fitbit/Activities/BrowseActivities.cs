...
namespace Temboo.Library.Fitbit.Activities
{
    ...
    /// </summary>
    public class BrowseActivities : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the BrowseActivities Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public BrowseActivities(TembooSession session) : base(session, "/Library/Fitbit/Activities/BrowseActivities")
        {
        }
        ...
        /// </summary>
        /// <returns>A BrowseActivitiesResultSet containing execution metadata and results.</returns>
        new public BrowseActivitiesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BrowseActivitiesResultSet results = new JavaScriptSerializer().Deserialize<BrowseActivitiesResultSet>(json);
    ...
    /// </summary>
    public class BrowseActivitiesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
