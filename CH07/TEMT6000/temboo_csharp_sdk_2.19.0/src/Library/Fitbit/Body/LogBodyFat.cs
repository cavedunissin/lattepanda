...
namespace Temboo.Library.Fitbit.Body
{
    ...
    /// </summary>
    public class LogBodyFat : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LogBodyFat Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LogBodyFat(TembooSession session) : base(session, "/Library/Fitbit/Body/LogBodyFat")
        {
        }
        ...
        /// </summary>
        /// <returns>A LogBodyFatResultSet containing execution metadata and results.</returns>
        new public LogBodyFatResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LogBodyFatResultSet results = new JavaScriptSerializer().Deserialize<LogBodyFatResultSet>(json);
    ...
    /// </summary>
    public class LogBodyFatResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
