...
namespace Temboo.Library.RunKeeper.DiabetesMeasurements
{
    /// <summary>
    /// RetrieveEntries
    /// Returns the feed for a user's diabetes measurements.
    /// </summary>
    public class RetrieveEntries : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveEntries Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveEntries(TembooSession session) : base(session, "/Library/RunKeeper/DiabetesMeasurements/RetrieveEntries")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveEntriesResultSet containing execution metadata and results.</returns>
        new public RetrieveEntriesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveEntriesResultSet results = new JavaScriptSerializer().Deserialize<RetrieveEntriesResultSet>(json);
    ...
    /// </summary>
    public class RetrieveEntriesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
