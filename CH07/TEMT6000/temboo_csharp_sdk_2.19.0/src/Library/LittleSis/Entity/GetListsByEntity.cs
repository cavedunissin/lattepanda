...
namespace Temboo.Library.LittleSis.Entity
{
    ...
    /// </summary>
    public class GetListsByEntity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetListsByEntity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetListsByEntity(TembooSession session) : base(session, "/Library/LittleSis/Entity/GetListsByEntity")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetListsByEntityResultSet containing execution metadata and results.</returns>
        new public GetListsByEntityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetListsByEntityResultSet results = new JavaScriptSerializer().Deserialize<GetListsByEntityResultSet>(json);
    ...
    /// </summary>
    public class GetListsByEntityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
