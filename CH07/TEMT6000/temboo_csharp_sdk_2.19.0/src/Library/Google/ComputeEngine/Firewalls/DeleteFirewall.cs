...
namespace Temboo.Library.Google.ComputeEngine.Firewalls
{
    ...
    /// </summary>
    public class DeleteFirewall : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteFirewall Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteFirewall(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Firewalls/DeleteFirewall")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteFirewallResultSet containing execution metadata and results.</returns>
        new public DeleteFirewallResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteFirewallResultSet results = new JavaScriptSerializer().Deserialize<DeleteFirewallResultSet>(json);
    ...
    /// </summary>
    public class DeleteFirewallResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
