...
namespace Temboo.Library.Twilio.IncomingPhoneNumbers
{
    ...
    /// </summary>
    public class ListPhoneNumbers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListPhoneNumbers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListPhoneNumbers(TembooSession session) : base(session, "/Library/Twilio/IncomingPhoneNumbers/ListPhoneNumbers")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListPhoneNumbersResultSet containing execution metadata and results.</returns>
        new public ListPhoneNumbersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListPhoneNumbersResultSet results = new JavaScriptSerializer().Deserialize<ListPhoneNumbersResultSet>(json);
    ...
    /// </summary>
    public class ListPhoneNumbersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
