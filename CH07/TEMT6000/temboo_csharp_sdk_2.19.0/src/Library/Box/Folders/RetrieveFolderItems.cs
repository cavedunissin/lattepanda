...
namespace Temboo.Library.Box.Folders
{
    ...
    /// </summary>
    public class RetrieveFolderItems : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveFolderItems Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveFolderItems(TembooSession session) : base(session, "/Library/Box/Folders/RetrieveFolderItems")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveFolderItemsResultSet containing execution metadata and results.</returns>
        new public RetrieveFolderItemsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveFolderItemsResultSet results = new JavaScriptSerializer().Deserialize<RetrieveFolderItemsResultSet>(json);
    ...
    /// </summary>
    public class RetrieveFolderItemsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
