...
namespace Temboo.Library.GitHub.ReposAPI.Collaborators
{
    ...
    /// </summary>
    public class AddCollaborator : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddCollaborator Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddCollaborator(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Collaborators/AddCollaborator")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddCollaboratorResultSet containing execution metadata and results.</returns>
        new public AddCollaboratorResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddCollaboratorResultSet results = new JavaScriptSerializer().Deserialize<AddCollaboratorResultSet>(json);
    ...
    /// </summary>
    public class AddCollaboratorResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
