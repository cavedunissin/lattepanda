...
namespace Temboo.Library.Mixpanel.DataExport.Segmentation
{
    ...
    /// </summary>
    public class Average : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Average Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Average(TembooSession session) : base(session, "/Library/Mixpanel/DataExport/Segmentation/Average")
        {
        }
        ...
        /// </summary>
        /// <returns>A AverageResultSet containing execution metadata and results.</returns>
        new public AverageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AverageResultSet results = new JavaScriptSerializer().Deserialize<AverageResultSet>(json);
    ...
    /// </summary>
    public class AverageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
