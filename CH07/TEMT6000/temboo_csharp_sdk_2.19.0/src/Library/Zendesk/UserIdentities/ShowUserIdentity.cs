...
namespace Temboo.Library.Zendesk.UserIdentities
{
    ...
    /// </summary>
    public class ShowUserIdentity : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ShowUserIdentity Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ShowUserIdentity(TembooSession session) : base(session, "/Library/Zendesk/UserIdentities/ShowUserIdentity")
        {
        }
        ...
        /// </summary>
        /// <returns>A ShowUserIdentityResultSet containing execution metadata and results.</returns>
        new public ShowUserIdentityResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ShowUserIdentityResultSet results = new JavaScriptSerializer().Deserialize<ShowUserIdentityResultSet>(json);
    ...
    /// </summary>
    public class ShowUserIdentityResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
