...
namespace Temboo.Library.Fitbit.Foods
{
    ...
    /// </summary>
    public class GetRecentFoods : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRecentFoods Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRecentFoods(TembooSession session) : base(session, "/Library/Fitbit/Foods/GetRecentFoods")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetRecentFoodsResultSet containing execution metadata and results.</returns>
        new public GetRecentFoodsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRecentFoodsResultSet results = new JavaScriptSerializer().Deserialize<GetRecentFoodsResultSet>(json);
    ...
    /// </summary>
    public class GetRecentFoodsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
