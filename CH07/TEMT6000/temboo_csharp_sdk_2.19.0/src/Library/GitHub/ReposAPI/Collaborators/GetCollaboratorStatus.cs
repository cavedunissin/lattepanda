...
namespace Temboo.Library.GitHub.ReposAPI.Collaborators
{
    /// <summary>
    /// GetCollaboratorStatus
    /// Checks to see if the provided user is a collaborator.
    /// </summary>
    public class GetCollaboratorStatus : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCollaboratorStatus Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCollaboratorStatus(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Collaborators/GetCollaboratorStatus")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Collaborator input for this Choreo.</param>
         public void setCollaborator(String value) {
             base.addInput ("Collaborator", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetCollaboratorStatusResultSet containing execution metadata and results.</returns>
        new public GetCollaboratorStatusResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCollaboratorStatusResultSet results = new JavaScriptSerializer().Deserialize<GetCollaboratorStatusResultSet>(json);
    ...
    /// </summary>
    public class GetCollaboratorStatusResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
