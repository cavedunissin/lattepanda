...
namespace Temboo.Library.Salesforce.Passwords
{
    ...
    public class ChangePassword : Temboo.Core.Choreography
    {
        ...
        public ChangePassword(TembooSession session) : base(session, "/Library/Salesforce/Passwords/ChangePassword")
        {
        }
         ...
         /// <summary>
         /// (required, string) The ID of the user whose password you want to change.
         /// </summary>
