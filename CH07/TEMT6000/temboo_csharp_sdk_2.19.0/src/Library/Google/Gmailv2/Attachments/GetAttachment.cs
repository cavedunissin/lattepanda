...
namespace Temboo.Library.Google.Gmailv2.Attachments
{
    /// <summary>
    /// GetAttachment
    /// Gets the specified message attachment.
    /// </summary>
    public class GetAttachment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAttachment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAttachment(TembooSession session) : base(session, "/Library/Google/Gmailv2/Attachments/GetAttachment")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAttachmentResultSet containing execution metadata and results.</returns>
        new public GetAttachmentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAttachmentResultSet results = new JavaScriptSerializer().Deserialize<GetAttachmentResultSet>(json);
    ...
    /// </summary>
    public class GetAttachmentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
