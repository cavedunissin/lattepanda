...
namespace Temboo.Library.NYTimes.CampaignFinance.Committees
{
    ...
    /// </summary>
    public class CommitteeFilings : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CommitteeFilings Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CommitteeFilings(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Committees/CommitteeFilings")
        {
        }
        ...
        /// </summary>
        /// <returns>A CommitteeFilingsResultSet containing execution metadata and results.</returns>
        new public CommitteeFilingsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CommitteeFilingsResultSet results = new JavaScriptSerializer().Deserialize<CommitteeFilingsResultSet>(json);
    ...
    /// </summary>
    public class CommitteeFilingsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
