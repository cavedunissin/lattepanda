...
namespace Temboo.Library.Uber.OAuth
{
    ...
    public class InitializeOAuth : Temboo.Core.Choreography
    {
        ...
        public InitializeOAuth(TembooSession session) : base(session, "/Library/Uber/OAuth/InitializeOAuth")
        {
        }
         ...
         /// <summary>
         /// (optional, string) A space-delimited list of scopes to requests access for. See Choreo notes for a list of valid scopes.
         /// </summary>
