...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class PutGroupPolicy : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PutGroupPolicy Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PutGroupPolicy(TembooSession session) : base(session, "/Library/Amazon/IAM/PutGroupPolicy")
        {
        }
        ...
        /// </summary>
        /// <returns>A PutGroupPolicyResultSet containing execution metadata and results.</returns>
        new public PutGroupPolicyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PutGroupPolicyResultSet results = new JavaScriptSerializer().Deserialize<PutGroupPolicyResultSet>(json);
    ...
    /// </summary>
    public class PutGroupPolicyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
