...
namespace Temboo.Library.Amazon.Marketplace.Orders
{
    ...
    /// </summary>
    public class GetOrder : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetOrder Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetOrder(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Orders/GetOrder")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetOrderResultSet containing execution metadata and results.</returns>
        new public GetOrderResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetOrderResultSet results = new JavaScriptSerializer().Deserialize<GetOrderResultSet>(json);
    ...
    /// </summary>
    public class GetOrderResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
