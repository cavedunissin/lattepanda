...
namespace Temboo.Library.SendGrid.WebAPI.Profile
{
    ...
    /// </summary>
    public class ViewAccountProfile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ViewAccountProfile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ViewAccountProfile(TembooSession session) : base(session, "/Library/SendGrid/WebAPI/Profile/ViewAccountProfile")
        {
        }
        ...
        /// </summary>
        /// <returns>A ViewAccountProfileResultSet containing execution metadata and results.</returns>
        new public ViewAccountProfileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ViewAccountProfileResultSet results = new JavaScriptSerializer().Deserialize<ViewAccountProfileResultSet>(json);
    ...
    /// </summary>
    public class ViewAccountProfileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
