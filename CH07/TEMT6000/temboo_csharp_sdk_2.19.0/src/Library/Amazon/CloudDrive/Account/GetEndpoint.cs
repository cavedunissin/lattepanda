...
namespace Temboo.Library.Amazon.CloudDrive.Account
{
    ...
    /// </summary>
    public class GetEndpoint : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEndpoint Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEndpoint(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Account/GetEndpoint")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetEndpointResultSet containing execution metadata and results.</returns>
        new public GetEndpointResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEndpointResultSet results = new JavaScriptSerializer().Deserialize<GetEndpointResultSet>(json);
    ...
    /// </summary>
    public class GetEndpointResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
