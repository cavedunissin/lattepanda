...
namespace Temboo.Library.Fitbit.Social
{
    ...
    /// </summary>
    public class GetFriendsLeaderboard : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFriendsLeaderboard Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFriendsLeaderboard(TembooSession session) : base(session, "/Library/Fitbit/Social/GetFriendsLeaderboard")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFriendsLeaderboardResultSet containing execution metadata and results.</returns>
        new public GetFriendsLeaderboardResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFriendsLeaderboardResultSet results = new JavaScriptSerializer().Deserialize<GetFriendsLeaderboardResultSet>(json);
    ...
    /// </summary>
    public class GetFriendsLeaderboardResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
