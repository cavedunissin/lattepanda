...
namespace Temboo.Library.Amazon.CloudDrive.Account
{
    ...
    /// </summary>
    public class GetAccountInfo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAccountInfo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAccountInfo(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Account/GetAccountInfo")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAccountInfoResultSet containing execution metadata and results.</returns>
        new public GetAccountInfoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAccountInfoResultSet results = new JavaScriptSerializer().Deserialize<GetAccountInfoResultSet>(json);
    ...
    /// </summary>
    public class GetAccountInfoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
