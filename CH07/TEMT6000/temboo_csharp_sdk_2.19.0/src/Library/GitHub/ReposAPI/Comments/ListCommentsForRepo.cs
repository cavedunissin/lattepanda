...
namespace Temboo.Library.GitHub.ReposAPI.Comments
{
    ...
    /// </summary>
    public class ListCommentsForRepo : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListCommentsForRepo Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListCommentsForRepo(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Comments/ListCommentsForRepo")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListCommentsForRepoResultSet containing execution metadata and results.</returns>
        new public ListCommentsForRepoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListCommentsForRepoResultSet results = new JavaScriptSerializer().Deserialize<ListCommentsForRepoResultSet>(json);
    ...
    /// </summary>
    public class ListCommentsForRepoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
