...
namespace Temboo.Library.Xively.APIKeys
{
    ...
    /// </summary>
    public class DeleteKey : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteKey Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteKey(TembooSession session) : base(session, "/Library/Xively/APIKeys/DeleteKey")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteKeyResultSet containing execution metadata and results.</returns>
        new public DeleteKeyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteKeyResultSet results = new JavaScriptSerializer().Deserialize<DeleteKeyResultSet>(json);
    ...
    /// </summary>
    public class DeleteKeyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "ResponseStatusCode" output from this Choreo execution
        /// <returns>String - (integer) The response status code returned from Xively. For a valid deletion, the code returned should be 200.</returns>
        /// </summary>
