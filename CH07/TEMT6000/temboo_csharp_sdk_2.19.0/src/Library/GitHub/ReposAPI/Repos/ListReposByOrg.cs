...
namespace Temboo.Library.GitHub.ReposAPI.Repos
{
    ...
    /// </summary>
    public class ListReposByOrg : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListReposByOrg Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListReposByOrg(TembooSession session) : base(session, "/Library/GitHub/ReposAPI/Repos/ListReposByOrg")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListReposByOrgResultSet containing execution metadata and results.</returns>
        new public ListReposByOrgResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListReposByOrgResultSet results = new JavaScriptSerializer().Deserialize<ListReposByOrgResultSet>(json);
    ...
    /// </summary>
    public class ListReposByOrgResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
