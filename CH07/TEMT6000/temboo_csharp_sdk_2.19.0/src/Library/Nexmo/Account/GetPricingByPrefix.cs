...
namespace Temboo.Library.Nexmo.Account
{
    ...
    /// </summary>
    public class GetPricingByPrefix : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPricingByPrefix Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPricingByPrefix(TembooSession session) : base(session, "/Library/Nexmo/Account/GetPricingByPrefix")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPricingByPrefixResultSet containing execution metadata and results.</returns>
        new public GetPricingByPrefixResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPricingByPrefixResultSet results = new JavaScriptSerializer().Deserialize<GetPricingByPrefixResultSet>(json);
    ...
    /// </summary>
    public class GetPricingByPrefixResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
