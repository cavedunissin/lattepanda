...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class MonitorInstances : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the MonitorInstances Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public MonitorInstances(TembooSession session) : base(session, "/Library/Amazon/EC2/MonitorInstances")
        {
        }
        ...
        /// </summary>
        /// <returns>A MonitorInstancesResultSet containing execution metadata and results.</returns>
        new public MonitorInstancesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            MonitorInstancesResultSet results = new JavaScriptSerializer().Deserialize<MonitorInstancesResultSet>(json);
    ...
    /// </summary>
    public class MonitorInstancesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
