...
namespace Temboo.Library.Zendesk.Organizations
{
    ...
    /// </summary>
    public class ListOrganizationsByUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListOrganizationsByUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListOrganizationsByUser(TembooSession session) : base(session, "/Library/Zendesk/Organizations/ListOrganizationsByUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListOrganizationsByUserResultSet containing execution metadata and results.</returns>
        new public ListOrganizationsByUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListOrganizationsByUserResultSet results = new JavaScriptSerializer().Deserialize<ListOrganizationsByUserResultSet>(json);
    ...
    /// </summary>
    public class ListOrganizationsByUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
