...
namespace Temboo.Library.Amazon.S3
{
    ...
    /// </summary>
    public class DeleteBucketPolicy : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteBucketPolicy Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteBucketPolicy(TembooSession session) : base(session, "/Library/Amazon/S3/DeleteBucketPolicy")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteBucketPolicyResultSet containing execution metadata and results.</returns>
        new public DeleteBucketPolicyResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteBucketPolicyResultSet results = new JavaScriptSerializer().Deserialize<DeleteBucketPolicyResultSet>(json);
    ...
    /// </summary>
    public class DeleteBucketPolicyResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
