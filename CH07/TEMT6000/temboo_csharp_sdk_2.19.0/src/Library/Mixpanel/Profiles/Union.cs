...
namespace Temboo.Library.Mixpanel.Profiles
{
    ...
    /// </summary>
    public class Union : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Union Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Union(TembooSession session) : base(session, "/Library/Mixpanel/Profiles/Union")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnionResultSet containing execution metadata and results.</returns>
        new public UnionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnionResultSet results = new JavaScriptSerializer().Deserialize<UnionResultSet>(json);
    ...
    /// </summary>
    public class UnionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
