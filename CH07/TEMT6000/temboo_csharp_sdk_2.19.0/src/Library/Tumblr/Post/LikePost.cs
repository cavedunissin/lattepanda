...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class LikePost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LikePost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LikePost(TembooSession session) : base(session, "/Library/Tumblr/Post/LikePost")
        {
        }
        ...
        /// </summary>
        /// <returns>A LikePostResultSet containing execution metadata and results.</returns>
        new public LikePostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LikePostResultSet results = new JavaScriptSerializer().Deserialize<LikePostResultSet>(json);
    ...
    /// </summary>
    public class LikePostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
