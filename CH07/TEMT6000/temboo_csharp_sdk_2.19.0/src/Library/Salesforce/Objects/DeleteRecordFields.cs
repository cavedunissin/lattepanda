...
namespace Temboo.Library.Salesforce.Objects
{
    ...
    /// </summary>
    public class DeleteRecordFields : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRecordFields Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRecordFields(TembooSession session) : base(session, "/Library/Salesforce/Objects/DeleteRecordFields")
        {
        }
         ...
         /// <summary>
         /// (required, string) Comma-separated list of up to 10 field names.
         /// </summary>
         ...
         /// <summary>
         /// (required, string) The id of the object that that is being modified.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A DeleteRecordFieldsResultSet containing execution metadata and results.</returns>
        new public DeleteRecordFieldsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRecordFieldsResultSet results = new JavaScriptSerializer().Deserialize<DeleteRecordFieldsResultSet>(json);
    ...
    /// </summary>
    public class DeleteRecordFieldsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
