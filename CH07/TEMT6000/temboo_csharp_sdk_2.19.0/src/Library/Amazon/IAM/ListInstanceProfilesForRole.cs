...
namespace Temboo.Library.Amazon.IAM
{
    ...
    /// </summary>
    public class ListInstanceProfilesForRole : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListInstanceProfilesForRole Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListInstanceProfilesForRole(TembooSession session) : base(session, "/Library/Amazon/IAM/ListInstanceProfilesForRole")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListInstanceProfilesForRoleResultSet containing execution metadata and results.</returns>
        new public ListInstanceProfilesForRoleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListInstanceProfilesForRoleResultSet results = new JavaScriptSerializer().Deserialize<ListInstanceProfilesForRoleResultSet>(json);
    ...
    /// </summary>
    public class ListInstanceProfilesForRoleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
