...
namespace Temboo.Library.Amazon.Marketplace.Products
{
    ...
    /// </summary>
    public class GetLowestOfferListingsForSKU : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLowestOfferListingsForSKU Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLowestOfferListingsForSKU(TembooSession session) : base(session, "/Library/Amazon/Marketplace/Products/GetLowestOfferListingsForSKU")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ExcludeMe input for this Choreo.</param>
         public void setExcludeMe(String value) {
             base.addInput ("ExcludeMe", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetLowestOfferListingsForSKUResultSet containing execution metadata and results.</returns>
        new public GetLowestOfferListingsForSKUResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLowestOfferListingsForSKUResultSet results = new JavaScriptSerializer().Deserialize<GetLowestOfferListingsForSKUResultSet>(json);
    ...
    /// </summary>
    public class GetLowestOfferListingsForSKUResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
