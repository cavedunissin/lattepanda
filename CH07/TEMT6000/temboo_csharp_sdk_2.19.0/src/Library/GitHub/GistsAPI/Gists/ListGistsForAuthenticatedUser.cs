...
namespace Temboo.Library.GitHub.GistsAPI.Gists
{
    ...
    /// </summary>
    public class ListGistsForAuthenticatedUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGistsForAuthenticatedUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGistsForAuthenticatedUser(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Gists/ListGistsForAuthenticatedUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGistsForAuthenticatedUserResultSet containing execution metadata and results.</returns>
        new public ListGistsForAuthenticatedUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGistsForAuthenticatedUserResultSet results = new JavaScriptSerializer().Deserialize<ListGistsForAuthenticatedUserResultSet>(json);
    ...
    /// </summary>
    public class ListGistsForAuthenticatedUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (decimal) The index for the previous page of results.</returns>
        /// </summary>
