...
namespace Temboo.Library.Dropbox.FilesAndMetadata
{
    ...
    /// </summary>
    public class GetFileRevisions : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFileRevisions Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFileRevisions(TembooSession session) : base(session, "/Library/Dropbox/FilesAndMetadata/GetFileRevisions")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RevisionLimit input for this Choreo.</param>
         public void setRevisionLimit(String value) {
             base.addInput ("RevisionLimit", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetFileRevisionsResultSet containing execution metadata and results.</returns>
        new public GetFileRevisionsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFileRevisionsResultSet results = new JavaScriptSerializer().Deserialize<GetFileRevisionsResultSet>(json);
    ...
    /// </summary>
    public class GetFileRevisionsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
