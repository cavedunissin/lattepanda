...
namespace Temboo.Library.Amazon.CloudDrive.Files
{
    ...
    /// </summary>
    public class OverwriteFile : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the OverwriteFile Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public OverwriteFile(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Files/OverwriteFile")
        {
        }
        ...
        /// </summary>
        /// <returns>A OverwriteFileResultSet containing execution metadata and results.</returns>
        new public OverwriteFileResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            OverwriteFileResultSet results = new JavaScriptSerializer().Deserialize<OverwriteFileResultSet>(json);
    ...
    /// </summary>
    public class OverwriteFileResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
