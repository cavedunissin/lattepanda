...
namespace Temboo.Library.Google.ComputeEngine.Addresses
{
    ...
    /// </summary>
    public class ListAddresses : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAddresses Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAddresses(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Addresses/ListAddresses")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAddressesResultSet containing execution metadata and results.</returns>
        new public ListAddressesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAddressesResultSet results = new JavaScriptSerializer().Deserialize<ListAddressesResultSet>(json);
    ...
    /// </summary>
    public class ListAddressesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
