...
namespace Temboo.Library.Nexmo.Account
{
    ...
    /// </summary>
    public class GetPricingByCountry : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPricingByCountry Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPricingByCountry(TembooSession session) : base(session, "/Library/Nexmo/Account/GetPricingByCountry")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPricingByCountryResultSet containing execution metadata and results.</returns>
        new public GetPricingByCountryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPricingByCountryResultSet results = new JavaScriptSerializer().Deserialize<GetPricingByCountryResultSet>(json);
    ...
    /// </summary>
    public class GetPricingByCountryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
