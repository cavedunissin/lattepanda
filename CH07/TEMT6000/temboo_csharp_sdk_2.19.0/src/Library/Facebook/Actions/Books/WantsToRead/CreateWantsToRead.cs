...
namespace Temboo.Library.Facebook.Actions.Books.WantsToRead
{
    ...
    /// </summary>
    public class CreateWantsToRead : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateWantsToRead Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateWantsToRead(TembooSession session) : base(session, "/Library/Facebook/Actions/Books/WantsToRead/CreateWantsToRead")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateWantsToReadResultSet containing execution metadata and results.</returns>
        new public CreateWantsToReadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateWantsToReadResultSet results = new JavaScriptSerializer().Deserialize<CreateWantsToReadResultSet>(json);
    ...
    /// </summary>
    public class CreateWantsToReadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
