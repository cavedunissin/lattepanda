...
namespace Temboo.Library.Google.ComputeEngine.Images
{
    ...
    /// </summary>
    public class ListImages : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListImages Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListImages(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Images/ListImages")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListImagesResultSet containing execution metadata and results.</returns>
        new public ListImagesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListImagesResultSet results = new JavaScriptSerializer().Deserialize<ListImagesResultSet>(json);
    ...
    /// </summary>
    public class ListImagesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
