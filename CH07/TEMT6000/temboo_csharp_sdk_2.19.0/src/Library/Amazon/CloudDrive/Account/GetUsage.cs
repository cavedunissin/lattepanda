...
namespace Temboo.Library.Amazon.CloudDrive.Account
{
    ...
    /// </summary>
    public class GetUsage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUsage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUsage(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Account/GetUsage")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUsageResultSet containing execution metadata and results.</returns>
        new public GetUsageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUsageResultSet results = new JavaScriptSerializer().Deserialize<GetUsageResultSet>(json);
    ...
    /// </summary>
    public class GetUsageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
