...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class IncomingFriendships : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the IncomingFriendships Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public IncomingFriendships(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/IncomingFriendships")
        {
        }
        ...
        /// </summary>
        /// <returns>A IncomingFriendshipsResultSet containing execution metadata and results.</returns>
        new public IncomingFriendshipsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            IncomingFriendshipsResultSet results = new JavaScriptSerializer().Deserialize<IncomingFriendshipsResultSet>(json);
    ...
    /// </summary>
    public class IncomingFriendshipsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
