...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class CreateLinkPost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateLinkPost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateLinkPost(TembooSession session) : base(session, "/Library/Tumblr/Post/CreateLinkPost")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateLinkPostResultSet containing execution metadata and results.</returns>
        new public CreateLinkPostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateLinkPostResultSet results = new JavaScriptSerializer().Deserialize<CreateLinkPostResultSet>(json);
    ...
    /// </summary>
    public class CreateLinkPostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
