...
namespace Temboo.Library.Amazon.SNS
{
    ...
    /// </summary>
    public class CreateTopic : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateTopic Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateTopic(TembooSession session) : base(session, "/Library/Amazon/SNS/CreateTopic")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateTopicResultSet containing execution metadata and results.</returns>
        new public CreateTopicResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateTopicResultSet results = new JavaScriptSerializer().Deserialize<CreateTopicResultSet>(json);
    ...
    /// </summary>
    public class CreateTopicResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
