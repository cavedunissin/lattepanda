...
namespace Temboo.Library.Stripe.Plans
{
    ...
    /// </summary>
    public class UpdatePlan : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdatePlan Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdatePlan(TembooSession session) : base(session, "/Library/Stripe/Plans/UpdatePlan")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdatePlanResultSet containing execution metadata and results.</returns>
        new public UpdatePlanResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdatePlanResultSet results = new JavaScriptSerializer().Deserialize<UpdatePlanResultSet>(json);
    ...
    /// </summary>
    public class UpdatePlanResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
