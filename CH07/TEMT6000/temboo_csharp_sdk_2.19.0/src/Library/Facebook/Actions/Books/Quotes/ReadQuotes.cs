...
namespace Temboo.Library.Facebook.Actions.Books.Quotes
{
    ...
    /// </summary>
    public class ReadQuotes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadQuotes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadQuotes(TembooSession session) : base(session, "/Library/Facebook/Actions/Books/Quotes/ReadQuotes")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadQuotesResultSet containing execution metadata and results.</returns>
        new public ReadQuotesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadQuotesResultSet results = new JavaScriptSerializer().Deserialize<ReadQuotesResultSet>(json);
    ...
    /// </summary>
    public class ReadQuotesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
