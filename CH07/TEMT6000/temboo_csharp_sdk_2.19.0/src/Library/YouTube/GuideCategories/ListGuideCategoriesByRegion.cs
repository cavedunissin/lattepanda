...
namespace Temboo.Library.YouTube.GuideCategories
{
    ...
    /// </summary>
    public class ListGuideCategoriesByRegion : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGuideCategoriesByRegion Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGuideCategoriesByRegion(TembooSession session) : base(session, "/Library/YouTube/GuideCategories/ListGuideCategoriesByRegion")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGuideCategoriesByRegionResultSet containing execution metadata and results.</returns>
        new public ListGuideCategoriesByRegionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGuideCategoriesByRegionResultSet results = new JavaScriptSerializer().Deserialize<ListGuideCategoriesByRegionResultSet>(json);
    ...
    /// </summary>
    public class ListGuideCategoriesByRegionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
