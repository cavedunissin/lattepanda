...
namespace Temboo.Library.Basecamp
{
    ...
    /// </summary>
    public class GetEntry : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetEntry Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetEntry(TembooSession session) : base(session, "/Library/Basecamp/GetEntry")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetEntryResultSet containing execution metadata and results.</returns>
        new public GetEntryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetEntryResultSet results = new JavaScriptSerializer().Deserialize<GetEntryResultSet>(json);
    ...
    /// </summary>
    public class GetEntryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
