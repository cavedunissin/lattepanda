...
namespace Temboo.Library.PayPal.Payments
{
    ...
    /// </summary>
    public class LookupPayment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LookupPayment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LookupPayment(TembooSession session) : base(session, "/Library/PayPal/Payments/LookupPayment")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the PaymentID input for this Choreo.</param>
         public void setPaymentID(String value) {
             base.addInput ("PaymentID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A LookupPaymentResultSet containing execution metadata and results.</returns>
        new public LookupPaymentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LookupPaymentResultSet results = new JavaScriptSerializer().Deserialize<LookupPaymentResultSet>(json);
    ...
    /// </summary>
    public class LookupPaymentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Currency" output from this Choreo execution
        /// <returns>String - (string) The payment currency.</returns>
        /// </summary>
        public String Currency
        {
            get
            {
                return (String) base.Output["Currency"];
            }
        }
        /// <summary> 
        ...
        /// <returns>String - (string) The state of the payment.</returns>
        /// </summary>
        public String PaymentState
        {
            get
            {
                return (String) base.Output["PaymentState"];
            }
        }
        /// <summary> 
        /// Retrieve the value for the "SaleState" output from this Choreo execution
        /// <returns>String - (string) The state of the sale.</returns>
        /// </summary>
        public String SaleState
        {
            get
            {
                return (String) base.Output["SaleState"];
            }
        }
        /// <summary> 
        /// Retrieve the value for the "Total" output from this Choreo execution
        /// <returns>String - (decimal) The total amount of the payment.</returns>
        /// </summary>
        public String Total
        {
            get
            {
                return (String) base.Output["Total"];
            }
        }
        /// <summary> 
