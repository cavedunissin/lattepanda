...
namespace Temboo.Library.Twilio.Notifications
{
    ...
    /// </summary>
    public class DeleteNotification : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteNotification Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteNotification(TembooSession session) : base(session, "/Library/Twilio/Notifications/DeleteNotification")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the NotificationSID input for this Choreo.</param>
         public void setNotificationSID(String value) {
             base.addInput ("NotificationSID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A DeleteNotificationResultSet containing execution metadata and results.</returns>
        new public DeleteNotificationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteNotificationResultSet results = new JavaScriptSerializer().Deserialize<DeleteNotificationResultSet>(json);
    ...
    /// </summary>
    public class DeleteNotificationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
