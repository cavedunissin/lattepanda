...
namespace Temboo.Library.Zendesk.Requests
{
    ...
    /// </summary>
    public class GetComment : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetComment Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetComment(TembooSession session) : base(session, "/Library/Zendesk/Requests/GetComment")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the RequestID input for this Choreo.</param>
         public void setRequestID(String value) {
             base.addInput ("RequestID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetCommentResultSet containing execution metadata and results.</returns>
        new public GetCommentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCommentResultSet results = new JavaScriptSerializer().Deserialize<GetCommentResultSet>(json);
    ...
    /// </summary>
    public class GetCommentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
