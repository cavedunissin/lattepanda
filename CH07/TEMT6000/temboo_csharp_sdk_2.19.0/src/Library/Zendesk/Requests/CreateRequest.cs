...
namespace Temboo.Library.Zendesk.Requests
{
    ...
    /// </summary>
    public class CreateRequest : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateRequest Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateRequest(TembooSession session) : base(session, "/Library/Zendesk/Requests/CreateRequest")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateRequestResultSet containing execution metadata and results.</returns>
        new public CreateRequestResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateRequestResultSet results = new JavaScriptSerializer().Deserialize<CreateRequestResultSet>(json);
    ...
    /// </summary>
    public class CreateRequestResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
