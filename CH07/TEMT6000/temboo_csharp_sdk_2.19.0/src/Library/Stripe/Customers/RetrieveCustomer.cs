...
namespace Temboo.Library.Stripe.Customers
{
    ...
    /// </summary>
    public class RetrieveCustomer : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveCustomer Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveCustomer(TembooSession session) : base(session, "/Library/Stripe/Customers/RetrieveCustomer")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveCustomerResultSet containing execution metadata and results.</returns>
        new public RetrieveCustomerResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveCustomerResultSet results = new JavaScriptSerializer().Deserialize<RetrieveCustomerResultSet>(json);
    ...
    /// </summary>
    public class RetrieveCustomerResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
