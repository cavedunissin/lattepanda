...
namespace Temboo.Library.Disqus.Forums
{
    ...
    /// </summary>
    public class GetForumDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetForumDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetForumDetails(TembooSession session) : base(session, "/Library/Disqus/Forums/GetForumDetails")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Indicates the relations to include with your response. Valid values: author.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetForumDetailsResultSet containing execution metadata and results.</returns>
        new public GetForumDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetForumDetailsResultSet results = new JavaScriptSerializer().Deserialize<GetForumDetailsResultSet>(json);
    ...
    /// </summary>
    public class GetForumDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
