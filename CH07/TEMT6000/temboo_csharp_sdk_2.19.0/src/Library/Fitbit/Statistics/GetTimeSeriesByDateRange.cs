...
namespace Temboo.Library.Fitbit.Statistics
{
    ...
    /// </summary>
    public class GetTimeSeriesByDateRange : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTimeSeriesByDateRange Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTimeSeriesByDateRange(TembooSession session) : base(session, "/Library/Fitbit/Statistics/GetTimeSeriesByDateRange")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTimeSeriesByDateRangeResultSet containing execution metadata and results.</returns>
        new public GetTimeSeriesByDateRangeResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTimeSeriesByDateRangeResultSet results = new JavaScriptSerializer().Deserialize<GetTimeSeriesByDateRangeResultSet>(json);
    ...
    /// </summary>
    public class GetTimeSeriesByDateRangeResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
