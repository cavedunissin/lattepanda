...
namespace Temboo.Library.Google.ComputeEngine.RegionOperations
{
    /// <summary>
    /// DeleteRegionOperation
    /// Deletes the specified operation within a region.
    /// </summary>
    public class DeleteRegionOperation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRegionOperation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRegionOperation(TembooSession session) : base(session, "/Library/Google/ComputeEngine/RegionOperations/DeleteRegionOperation")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteRegionOperationResultSet containing execution metadata and results.</returns>
        new public DeleteRegionOperationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRegionOperationResultSet results = new JavaScriptSerializer().Deserialize<DeleteRegionOperationResultSet>(json);
    ...
    /// </summary>
    public class DeleteRegionOperationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
