...
namespace Temboo.Library.eBay.Shopping
{
    ...
    /// </summary>
    public class GetMultipleItems : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetMultipleItems Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetMultipleItems(TembooSession session) : base(session, "/Library/eBay/Shopping/GetMultipleItems")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetMultipleItemsResultSet containing execution metadata and results.</returns>
        new public GetMultipleItemsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetMultipleItemsResultSet results = new JavaScriptSerializer().Deserialize<GetMultipleItemsResultSet>(json);
    ...
    /// </summary>
    public class GetMultipleItemsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
