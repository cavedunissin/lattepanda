...
namespace Temboo.Library._23andMe
{
    ...
    /// </summary>
    public class Names : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Names Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Names(TembooSession session) : base(session, "/Library/23andMe/Names")
        {
        }
        ...
        /// </summary>
        /// <returns>A NamesResultSet containing execution metadata and results.</returns>
        new public NamesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            NamesResultSet results = new JavaScriptSerializer().Deserialize<NamesResultSet>(json);
    ...
    /// </summary>
    public class NamesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
