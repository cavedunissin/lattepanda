...
namespace Temboo.Library.Google.Gmailv2.Threads
{
    ...
    /// </summary>
    public class GetThread : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetThread Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetThread(TembooSession session) : base(session, "/Library/Google/Gmailv2/Threads/GetThread")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetThreadResultSet containing execution metadata and results.</returns>
        new public GetThreadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetThreadResultSet results = new JavaScriptSerializer().Deserialize<GetThreadResultSet>(json);
    ...
    /// </summary>
    public class GetThreadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
