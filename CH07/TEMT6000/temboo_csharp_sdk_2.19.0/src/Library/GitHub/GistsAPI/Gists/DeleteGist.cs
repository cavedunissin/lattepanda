...
namespace Temboo.Library.GitHub.GistsAPI.Gists
{
    ...
    /// </summary>
    public class DeleteGist : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteGist Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteGist(TembooSession session) : base(session, "/Library/GitHub/GistsAPI/Gists/DeleteGist")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteGistResultSet containing execution metadata and results.</returns>
        new public DeleteGistResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteGistResultSet results = new JavaScriptSerializer().Deserialize<DeleteGistResultSet>(json);
    ...
    /// </summary>
    public class DeleteGistResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
