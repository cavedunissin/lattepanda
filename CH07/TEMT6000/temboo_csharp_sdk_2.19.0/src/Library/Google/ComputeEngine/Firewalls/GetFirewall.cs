...
namespace Temboo.Library.Google.ComputeEngine.Firewalls
{
    ...
    /// </summary>
    public class GetFirewall : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetFirewall Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetFirewall(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Firewalls/GetFirewall")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetFirewallResultSet containing execution metadata and results.</returns>
        new public GetFirewallResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetFirewallResultSet results = new JavaScriptSerializer().Deserialize<GetFirewallResultSet>(json);
    ...
    /// </summary>
    public class GetFirewallResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
