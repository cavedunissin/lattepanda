...
namespace Temboo.Library.SendGrid.NewsletterAPI.Lists
{
    ...
    /// </summary>
    public class RenameRecipientList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RenameRecipientList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RenameRecipientList(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Lists/RenameRecipientList")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the NewList input for this Choreo.</param>
         public void setNewList(String value) {
             base.addInput ("NewList", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A RenameRecipientListResultSet containing execution metadata and results.</returns>
        new public RenameRecipientListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RenameRecipientListResultSet results = new JavaScriptSerializer().Deserialize<RenameRecipientListResultSet>(json);
    ...
    /// </summary>
    public class RenameRecipientListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
