...
namespace Temboo.Library.Google.ComputeEngine.Networks
{
    ...
    /// </summary>
    public class DeleteNetwork : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteNetwork Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteNetwork(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Networks/DeleteNetwork")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteNetworkResultSet containing execution metadata and results.</returns>
        new public DeleteNetworkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteNetworkResultSet results = new JavaScriptSerializer().Deserialize<DeleteNetworkResultSet>(json);
    ...
    /// </summary>
    public class DeleteNetworkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
