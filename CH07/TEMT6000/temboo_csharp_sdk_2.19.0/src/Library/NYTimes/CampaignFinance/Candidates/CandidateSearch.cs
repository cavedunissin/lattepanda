...
namespace Temboo.Library.NYTimes.CampaignFinance.Candidates
{
    ...
    /// </summary>
    public class CandidateSearch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CandidateSearch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CandidateSearch(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Candidates/CandidateSearch")
        {
        }
        ...
        /// </summary>
        /// <returns>A CandidateSearchResultSet containing execution metadata and results.</returns>
        new public CandidateSearchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CandidateSearchResultSet results = new JavaScriptSerializer().Deserialize<CandidateSearchResultSet>(json);
    ...
    /// </summary>
    public class CandidateSearchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
