...
namespace Temboo.Library.Google.Plus.Domains.Activities
{
    ...
    public class List : Temboo.Core.Choreography
    {
        ...
        public List(TembooSession session) : base(session, "/Library/Google/Plus/Domains/Activities/List")
        {
        }
         ...
         /// <summary>
         /// (required, string) The collection of activities to list.  Valid values are: "user". Defaults to "user".
         /// </summary>
