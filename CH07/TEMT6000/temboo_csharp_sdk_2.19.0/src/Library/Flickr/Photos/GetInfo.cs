...
namespace Temboo.Library.Flickr.Photos
{
    ...
    public class GetInfo : Temboo.Core.Choreography
    {
        ...
        public GetInfo(TembooSession session) : base(session, "/Library/Flickr/Photos/GetInfo")
        {
        }
         ...
         /// <summary>
         /// (required, integer) The ID of the photo.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) The secret for the photo. If the correct secret is passed then permissions checking is skipped, and authenticating with OAuth tokens is not required.
         /// </summary>
         /// <param name="value">Value of the PhotoSecret input for this Choreo.</param>
         public void setPhotoSecret(String value) {
             base.addInput ("PhotoSecret", value);
         }
         /// <summary>
