...
namespace Temboo.Library.Zendesk.Tickets
{
    ...
    /// </summary>
    public class ListTicketsByUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTicketsByUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTicketsByUser(TembooSession session) : base(session, "/Library/Zendesk/Tickets/ListTicketsByUser")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the UserType input for this Choreo.</param>
         public void setUserType(String value) {
             base.addInput ("UserType", value);
         }
        ...
        /// </summary>
        /// <returns>A ListTicketsByUserResultSet containing execution metadata and results.</returns>
        new public ListTicketsByUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTicketsByUserResultSet results = new JavaScriptSerializer().Deserialize<ListTicketsByUserResultSet>(json);
    ...
    /// </summary>
    public class ListTicketsByUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
