...
namespace Temboo.Library.Twilio.Queues
{
    ...
    /// </summary>
    public class ListQueueMembers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListQueueMembers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListQueueMembers(TembooSession session) : base(session, "/Library/Twilio/Queues/ListQueueMembers")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListQueueMembersResultSet containing execution metadata and results.</returns>
        new public ListQueueMembersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListQueueMembersResultSet results = new JavaScriptSerializer().Deserialize<ListQueueMembersResultSet>(json);
    ...
    /// </summary>
    public class ListQueueMembersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
