...
namespace Temboo.Library.Google.Gmailv2.Threads
{
    ...
    /// </summary>
    public class DeleteThread : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteThread Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteThread(TembooSession session) : base(session, "/Library/Google/Gmailv2/Threads/DeleteThread")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteThreadResultSet containing execution metadata and results.</returns>
        new public DeleteThreadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteThreadResultSet results = new JavaScriptSerializer().Deserialize<DeleteThreadResultSet>(json);
    ...
    /// </summary>
    public class DeleteThreadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
