...
namespace Temboo.Library.Twitter.Users
{
    ...
    /// </summary>
    public class VerifyCredentials : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the VerifyCredentials Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public VerifyCredentials(TembooSession session) : base(session, "/Library/Twitter/Users/VerifyCredentials")
        {
        }
        ...
        /// </summary>
        /// <returns>A VerifyCredentialsResultSet containing execution metadata and results.</returns>
        new public VerifyCredentialsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            VerifyCredentialsResultSet results = new JavaScriptSerializer().Deserialize<VerifyCredentialsResultSet>(json);
    ...
    /// </summary>
    public class VerifyCredentialsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
