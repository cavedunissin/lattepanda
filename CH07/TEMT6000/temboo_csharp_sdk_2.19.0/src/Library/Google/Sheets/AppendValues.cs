...
namespace Temboo.Library.Google.Sheets
{
    ...
    /// </summary>
    public class AppendValues : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AppendValues Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AppendValues(TembooSession session) : base(session, "/Library/Google/Sheets/AppendValues")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Specifies how the input data should be inserted. Valid values are: INSERT_ROWS (the default) and OVERWRITE.
         /// </summary>
         /// <param name="value">Value of the InsertDataOption input for this Choreo.</param>
         public void setInsertDataOption(String value) {
             base.addInput ("InsertDataOption", value);
         }
         /// <summary>
         ...
         /// <summary>
         /// (optional, string) The A1 notation of a range to begin appending to. Defaults to "A1" (begins at the first row). Values will be appended at the first empty row of this range. See Choreos notes for more details.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A AppendValuesResultSet containing execution metadata and results.</returns>
        new public AppendValuesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AppendValuesResultSet results = new JavaScriptSerializer().Deserialize<AppendValuesResultSet>(json);
    ...
    /// </summary>
    public class AppendValuesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
