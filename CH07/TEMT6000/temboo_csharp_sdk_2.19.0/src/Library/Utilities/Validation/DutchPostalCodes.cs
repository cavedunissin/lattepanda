...
namespace Temboo.Library.Utilities.Validation
{
    ...
    /// </summary>
    public class DutchPostalCodes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DutchPostalCodes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DutchPostalCodes(TembooSession session) : base(session, "/Library/Utilities/Validation/DutchPostalCodes")
        {
        }
        ...
        /// </summary>
        /// <returns>A DutchPostalCodesResultSet containing execution metadata and results.</returns>
        new public DutchPostalCodesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DutchPostalCodesResultSet results = new JavaScriptSerializer().Deserialize<DutchPostalCodesResultSet>(json);
    ...
    /// </summary>
    public class DutchPostalCodesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
