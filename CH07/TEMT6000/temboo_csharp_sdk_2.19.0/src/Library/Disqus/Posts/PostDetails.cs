...
namespace Temboo.Library.Disqus.Posts
{
    ...
    /// </summary>
    public class PostDetails : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PostDetails Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PostDetails(TembooSession session) : base(session, "/Library/Disqus/Posts/PostDetails")
        {
        }
        ...
        /// </summary>
        /// <returns>A PostDetailsResultSet containing execution metadata and results.</returns>
        new public PostDetailsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PostDetailsResultSet results = new JavaScriptSerializer().Deserialize<PostDetailsResultSet>(json);
    ...
    /// </summary>
    public class PostDetailsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
