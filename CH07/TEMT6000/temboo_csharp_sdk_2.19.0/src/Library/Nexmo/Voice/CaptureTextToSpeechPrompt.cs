...
namespace Temboo.Library.Nexmo.Voice
{
    ...
    /// </summary>
    public class CaptureTextToSpeechPrompt : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CaptureTextToSpeechPrompt Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CaptureTextToSpeechPrompt(TembooSession session) : base(session, "/Library/Nexmo/Voice/CaptureTextToSpeechPrompt")
        {
        }
        ...
        /// </summary>
        /// <returns>A CaptureTextToSpeechPromptResultSet containing execution metadata and results.</returns>
        new public CaptureTextToSpeechPromptResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CaptureTextToSpeechPromptResultSet results = new JavaScriptSerializer().Deserialize<CaptureTextToSpeechPromptResultSet>(json);
    ...
    /// </summary>
    public class CaptureTextToSpeechPromptResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "CallbackData" output from this Choreo execution
        /// <returns>String - The Nexmo callback data retrieved after a user has entered a pin code. Note that this will only be returned when the CallbackURL input  is not provided.</returns>
        /// </summary>
        ...
        /// <returns>String - (integer) The digits that the call recipient entered into the keypad after receiving the call from Nexmo.</returns>
        /// </summary>
