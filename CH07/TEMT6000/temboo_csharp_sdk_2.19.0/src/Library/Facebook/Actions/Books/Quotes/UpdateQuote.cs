...
namespace Temboo.Library.Facebook.Actions.Books.Quotes
{
    /// <summary>
    /// UpdateQuote
    /// Updates an existing quote action.
    /// </summary>
    public class UpdateQuote : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateQuote Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateQuote(TembooSession session) : base(session, "/Library/Facebook/Actions/Books/Quotes/UpdateQuote")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateQuoteResultSet containing execution metadata and results.</returns>
        new public UpdateQuoteResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateQuoteResultSet results = new JavaScriptSerializer().Deserialize<UpdateQuoteResultSet>(json);
    ...
    /// </summary>
    public class UpdateQuoteResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
