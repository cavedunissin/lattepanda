...
namespace Temboo.Library.Bitly.Links
{
    ...
    /// </summary>
    public class ExpandURL : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ExpandURL Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ExpandURL(TembooSession session) : base(session, "/Library/Bitly/Links/ExpandURL")
        {
        }
        ...
        /// </summary>
        /// <returns>A ExpandURLResultSet containing execution metadata and results.</returns>
        new public ExpandURLResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ExpandURLResultSet results = new JavaScriptSerializer().Deserialize<ExpandURLResultSet>(json);
    ...
    /// </summary>
    public class ExpandURLResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
