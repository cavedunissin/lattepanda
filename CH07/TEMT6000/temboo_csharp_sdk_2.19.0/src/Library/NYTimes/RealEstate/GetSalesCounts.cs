...
namespace Temboo.Library.NYTimes.RealEstate
{
    ...
    /// </summary>
    public class GetSalesCounts : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetSalesCounts Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetSalesCounts(TembooSession session) : base(session, "/Library/NYTimes/RealEstate/GetSalesCounts")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetSalesCountsResultSet containing execution metadata and results.</returns>
        new public GetSalesCountsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetSalesCountsResultSet results = new JavaScriptSerializer().Deserialize<GetSalesCountsResultSet>(json);
    ...
    /// </summary>
    public class GetSalesCountsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
