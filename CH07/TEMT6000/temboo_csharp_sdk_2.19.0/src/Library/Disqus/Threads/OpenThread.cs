...
namespace Temboo.Library.Disqus.Threads
{
    ...
    /// Open a thread.
    /// </summary>
    public class OpenThread : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the OpenThread Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public OpenThread(TembooSession session) : base(session, "/Library/Disqus/Threads/OpenThread")
        {
        }
        ...
        /// </summary>
        /// <returns>A OpenThreadResultSet containing execution metadata and results.</returns>
        new public OpenThreadResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            OpenThreadResultSet results = new JavaScriptSerializer().Deserialize<OpenThreadResultSet>(json);
    ...
    /// </summary>
    public class OpenThreadResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
