...
namespace Temboo.Library.Nexmo.Search
{
    ...
    /// </summary>
    public class SearchNumbers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchNumbers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchNumbers(TembooSession session) : base(session, "/Library/Nexmo/Search/SearchNumbers")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchNumbersResultSet containing execution metadata and results.</returns>
        new public SearchNumbersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchNumbersResultSet results = new JavaScriptSerializer().Deserialize<SearchNumbersResultSet>(json);
    ...
    /// </summary>
    public class SearchNumbersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
