...
namespace Temboo.Library.Google.Plus.Domains.People
{
    ...
    /// </summary>
    public class ListByCircle : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListByCircle Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListByCircle(TembooSession session) : base(session, "/Library/Google/Plus/Domains/People/ListByCircle")
        {
        }
         ...
         /// <summary>
         /// (required, string) ID of the Circle to list people by.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A ListByCircleResultSet containing execution metadata and results.</returns>
        new public ListByCircleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListByCircleResultSet results = new JavaScriptSerializer().Deserialize<ListByCircleResultSet>(json);
    ...
    /// </summary>
    public class ListByCircleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
