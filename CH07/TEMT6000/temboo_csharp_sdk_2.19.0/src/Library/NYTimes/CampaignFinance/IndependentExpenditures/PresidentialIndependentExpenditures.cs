...
namespace Temboo.Library.NYTimes.CampaignFinance.IndependentExpenditures
{
    ...
    /// </summary>
    public class PresidentialIndependentExpenditures : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PresidentialIndependentExpenditures Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PresidentialIndependentExpenditures(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/IndependentExpenditures/PresidentialIndependentExpenditures")
        {
        }
        ...
        /// </summary>
        /// <returns>A PresidentialIndependentExpendituresResultSet containing execution metadata and results.</returns>
        new public PresidentialIndependentExpendituresResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PresidentialIndependentExpendituresResultSet results = new JavaScriptSerializer().Deserialize<PresidentialIndependentExpendituresResultSet>(json);
    ...
    /// </summary>
    public class PresidentialIndependentExpendituresResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
