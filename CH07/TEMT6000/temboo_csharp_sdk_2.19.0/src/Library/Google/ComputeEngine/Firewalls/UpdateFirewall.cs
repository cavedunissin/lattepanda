...
namespace Temboo.Library.Google.ComputeEngine.Firewalls
{
    ...
    /// </summary>
    public class UpdateFirewall : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateFirewall Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateFirewall(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Firewalls/UpdateFirewall")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Firewall input for this Choreo.</param>
         public void setFirewall(String value) {
             base.addInput ("Firewall", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateFirewallResultSet containing execution metadata and results.</returns>
        new public UpdateFirewallResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateFirewallResultSet results = new JavaScriptSerializer().Deserialize<UpdateFirewallResultSet>(json);
    ...
    /// </summary>
    public class UpdateFirewallResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
