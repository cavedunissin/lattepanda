...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class EditLinkPost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EditLinkPost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EditLinkPost(TembooSession session) : base(session, "/Library/Tumblr/Post/EditLinkPost")
        {
        }
        ...
        /// </summary>
        /// <returns>A EditLinkPostResultSet containing execution metadata and results.</returns>
        new public EditLinkPostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EditLinkPostResultSet results = new JavaScriptSerializer().Deserialize<EditLinkPostResultSet>(json);
    ...
    /// </summary>
    public class EditLinkPostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
