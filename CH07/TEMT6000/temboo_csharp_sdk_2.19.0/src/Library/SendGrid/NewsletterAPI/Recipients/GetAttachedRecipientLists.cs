...
namespace Temboo.Library.SendGrid.NewsletterAPI.Recipients
{
    ...
    /// </summary>
    public class GetAttachedRecipientLists : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetAttachedRecipientLists Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetAttachedRecipientLists(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Recipients/GetAttachedRecipientLists")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetAttachedRecipientListsResultSet containing execution metadata and results.</returns>
        new public GetAttachedRecipientListsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetAttachedRecipientListsResultSet results = new JavaScriptSerializer().Deserialize<GetAttachedRecipientListsResultSet>(json);
    ...
    /// </summary>
    public class GetAttachedRecipientListsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
