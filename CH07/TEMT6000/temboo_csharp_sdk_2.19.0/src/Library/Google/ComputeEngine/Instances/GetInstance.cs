...
namespace Temboo.Library.Google.ComputeEngine.Instances
{
    ...
    /// </summary>
    public class GetInstance : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetInstance Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetInstance(TembooSession session) : base(session, "/Library/Google/ComputeEngine/Instances/GetInstance")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetInstanceResultSet containing execution metadata and results.</returns>
        new public GetInstanceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetInstanceResultSet results = new JavaScriptSerializer().Deserialize<GetInstanceResultSet>(json);
    ...
    /// </summary>
    public class GetInstanceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
