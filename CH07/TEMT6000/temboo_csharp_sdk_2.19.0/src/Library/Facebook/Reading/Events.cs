...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Events : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Events Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Events(TembooSession session) : base(session, "/Library/Facebook/Reading/Events")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The event sub-category to return. Valid values are: attending, created, maybe, not_replied, or declined.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A EventsResultSet containing execution metadata and results.</returns>
        new public EventsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EventsResultSet results = new JavaScriptSerializer().Deserialize<EventsResultSet>(json);
    ...
    /// </summary>
    public class EventsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
