...
namespace Temboo.Library.Dropbox.FileOperations
{
    ...
    /// </summary>
    public class DeleteFileOrFolder : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteFileOrFolder Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteFileOrFolder(TembooSession session) : base(session, "/Library/Dropbox/FileOperations/DeleteFileOrFolder")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteFileOrFolderResultSet containing execution metadata and results.</returns>
        new public DeleteFileOrFolderResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteFileOrFolderResultSet results = new JavaScriptSerializer().Deserialize<DeleteFileOrFolderResultSet>(json);
    ...
    /// </summary>
    public class DeleteFileOrFolderResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
