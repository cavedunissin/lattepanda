...
namespace Temboo.Library.Facebook.Actions.Video.WantsToWatch
{
    /// <summary>
    /// UpdateWantsToWatch
    /// Updates an existing wants_to_watch action.
    /// </summary>
    public class UpdateWantsToWatch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateWantsToWatch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateWantsToWatch(TembooSession session) : base(session, "/Library/Facebook/Actions/Video/WantsToWatch/UpdateWantsToWatch")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the AiringEndTime input for this Choreo.</param>
         public void setAiringEndTime(String value) {
             base.addInput ("AiringEndTime", value);
         }
         /// <summary>
         /// (optional, string) The id of the video airing.
         /// </summary>
         /// <param name="value">Value of the AiringID input for this Choreo.</param>
         public void setAiringID(String value) {
             base.addInput ("AiringID", value);
         }
         /// <summary>
         /// (optional, date) The time that the airing begins.
         /// </summary>
         /// <param name="value">Value of the AiringStartTime input for this Choreo.</param>
         public void setAiringStartTime(String value) {
             base.addInput ("AiringStartTime", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateWantsToWatchResultSet containing execution metadata and results.</returns>
        new public UpdateWantsToWatchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateWantsToWatchResultSet results = new JavaScriptSerializer().Deserialize<UpdateWantsToWatchResultSet>(json);
    ...
    /// </summary>
    public class UpdateWantsToWatchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
