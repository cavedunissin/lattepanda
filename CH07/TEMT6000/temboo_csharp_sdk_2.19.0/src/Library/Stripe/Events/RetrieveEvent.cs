...
namespace Temboo.Library.Stripe.Events
{
    ...
    /// </summary>
    public class RetrieveEvent : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveEvent Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveEvent(TembooSession session) : base(session, "/Library/Stripe/Events/RetrieveEvent")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveEventResultSet containing execution metadata and results.</returns>
        new public RetrieveEventResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveEventResultSet results = new JavaScriptSerializer().Deserialize<RetrieveEventResultSet>(json);
    ...
    /// </summary>
    public class RetrieveEventResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
