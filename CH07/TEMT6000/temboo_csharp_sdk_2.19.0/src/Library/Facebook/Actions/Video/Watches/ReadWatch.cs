...
namespace Temboo.Library.Facebook.Actions.Video.Watches
{
    ...
    /// </summary>
    public class ReadWatch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ReadWatch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ReadWatch(TembooSession session) : base(session, "/Library/Facebook/Actions/Video/Watches/ReadWatch")
        {
        }
        ...
        /// </summary>
        /// <returns>A ReadWatchResultSet containing execution metadata and results.</returns>
        new public ReadWatchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ReadWatchResultSet results = new JavaScriptSerializer().Deserialize<ReadWatchResultSet>(json);
    ...
    /// </summary>
    public class ReadWatchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
