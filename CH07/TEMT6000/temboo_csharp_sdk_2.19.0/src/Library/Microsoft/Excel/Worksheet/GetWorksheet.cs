...
namespace Temboo.Library.Microsoft.Excel.Worksheet
{
    ...
    /// </summary>
    public class GetWorksheet : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetWorksheet Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetWorksheet(TembooSession session) : base(session, "/Library/Microsoft/Excel/Worksheet/GetWorksheet")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetWorksheetResultSet containing execution metadata and results.</returns>
        new public GetWorksheetResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetWorksheetResultSet results = new JavaScriptSerializer().Deserialize<GetWorksheetResultSet>(json);
    ...
    /// </summary>
    public class GetWorksheetResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
