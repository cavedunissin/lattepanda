...
namespace Temboo.Library.YouTube.Playlists
{
    ...
    /// </summary>
    public class ListPlaylistsByChannel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListPlaylistsByChannel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListPlaylistsByChannel(TembooSession session) : base(session, "/Library/YouTube/Playlists/ListPlaylistsByChannel")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListPlaylistsByChannelResultSet containing execution metadata and results.</returns>
        new public ListPlaylistsByChannelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListPlaylistsByChannelResultSet results = new JavaScriptSerializer().Deserialize<ListPlaylistsByChannelResultSet>(json);
    ...
    /// </summary>
    public class ListPlaylistsByChannelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
