...
namespace Temboo.Library.Twitter.FriendsAndFollowers
{
    ...
    /// </summary>
    public class ListFollowers : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListFollowers Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListFollowers(TembooSession session) : base(session, "/Library/Twitter/FriendsAndFollowers/ListFollowers")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListFollowersResultSet containing execution metadata and results.</returns>
        new public ListFollowersResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListFollowersResultSet results = new JavaScriptSerializer().Deserialize<ListFollowersResultSet>(json);
    ...
    /// </summary>
    public class ListFollowersResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
