...
namespace Temboo.Library.Google.Drive.Files
{
    ...
    /// </summary>
    public class Trash : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Trash Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Trash(TembooSession session) : base(session, "/Library/Google/Drive/Files/Trash")
        {
        }
        ...
        /// </summary>
        /// <returns>A TrashResultSet containing execution metadata and results.</returns>
        new public TrashResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TrashResultSet results = new JavaScriptSerializer().Deserialize<TrashResultSet>(json);
    ...
    /// </summary>
    public class TrashResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
