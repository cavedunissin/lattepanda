...
namespace Temboo.Library.NPR.StoryFinder
{
    ...
    /// </summary>
    public class Blogs : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Blogs Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Blogs(TembooSession session) : base(session, "/Library/NPR/StoryFinder/Blogs")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Blog input for this Choreo.</param>
         public void setBlog(String value) {
             base.addInput ("Blog", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A BlogsResultSet containing execution metadata and results.</returns>
        new public BlogsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BlogsResultSet results = new JavaScriptSerializer().Deserialize<BlogsResultSet>(json);
    ...
    /// </summary>
    public class BlogsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        /// Retrieve the value for the "Id" output from this Choreo execution
        /// <returns>String - (integer) The ID of the blog. This is only returned when the Blog input is specified. When multiple blogs are specified, this will be a list of IDs separated by commas.</returns>
        /// </summary>
        public String Id
        {
            get
