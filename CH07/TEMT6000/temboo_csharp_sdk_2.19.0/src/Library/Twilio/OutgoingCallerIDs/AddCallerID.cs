...
namespace Temboo.Library.Twilio.OutgoingCallerIDs
{
    ...
    /// </summary>
    public class AddCallerID : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the AddCallerID Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public AddCallerID(TembooSession session) : base(session, "/Library/Twilio/OutgoingCallerIDs/AddCallerID")
        {
        }
        ...
        /// </summary>
        /// <returns>A AddCallerIDResultSet containing execution metadata and results.</returns>
        new public AddCallerIDResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            AddCallerIDResultSet results = new JavaScriptSerializer().Deserialize<AddCallerIDResultSet>(json);
    ...
    /// </summary>
    public class AddCallerIDResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
