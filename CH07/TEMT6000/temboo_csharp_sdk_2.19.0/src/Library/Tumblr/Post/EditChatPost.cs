...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class EditChatPost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EditChatPost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EditChatPost(TembooSession session) : base(session, "/Library/Tumblr/Post/EditChatPost")
        {
        }
        ...
        /// </summary>
        /// <returns>A EditChatPostResultSet containing execution metadata and results.</returns>
        new public EditChatPostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EditChatPostResultSet results = new JavaScriptSerializer().Deserialize<EditChatPostResultSet>(json);
    ...
    /// </summary>
    public class EditChatPostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
