...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class UnlikeMedia : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UnlikeMedia Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UnlikeMedia(TembooSession session) : base(session, "/Library/Instagram/UnlikeMedia")
        {
        }
        ...
        /// </summary>
        /// <returns>A UnlikeMediaResultSet containing execution metadata and results.</returns>
        new public UnlikeMediaResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UnlikeMediaResultSet results = new JavaScriptSerializer().Deserialize<UnlikeMediaResultSet>(json);
    ...
    /// </summary>
    public class UnlikeMediaResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
