...
namespace Temboo.Library.Factual
{
    ...
    /// </summary>
    public class FilterPlacesByTopLevelCategory : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the FilterPlacesByTopLevelCategory Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public FilterPlacesByTopLevelCategory(TembooSession session) : base(session, "/Library/Factual/FilterPlacesByTopLevelCategory")
        {
        }
        ...
        /// </summary>
        /// <returns>A FilterPlacesByTopLevelCategoryResultSet containing execution metadata and results.</returns>
        new public FilterPlacesByTopLevelCategoryResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            FilterPlacesByTopLevelCategoryResultSet results = new JavaScriptSerializer().Deserialize<FilterPlacesByTopLevelCategoryResultSet>(json);
    ...
    /// </summary>
    public class FilterPlacesByTopLevelCategoryResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
