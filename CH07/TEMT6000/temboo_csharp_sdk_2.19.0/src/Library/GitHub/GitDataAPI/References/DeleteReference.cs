...
namespace Temboo.Library.GitHub.GitDataAPI.References
{
    ...
    /// </summary>
    public class DeleteReference : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteReference Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteReference(TembooSession session) : base(session, "/Library/GitHub/GitDataAPI/References/DeleteReference")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteReferenceResultSet containing execution metadata and results.</returns>
        new public DeleteReferenceResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteReferenceResultSet results = new JavaScriptSerializer().Deserialize<DeleteReferenceResultSet>(json);
    ...
    /// </summary>
    public class DeleteReferenceResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
