...
namespace Temboo.Library.Facebook.Actions.Video.Watches
{
    ...
    /// </summary>
    public class CreateWatch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateWatch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateWatch(TembooSession session) : base(session, "/Library/Facebook/Actions/Video/Watches/CreateWatch")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateWatchResultSet containing execution metadata and results.</returns>
        new public CreateWatchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateWatchResultSet results = new JavaScriptSerializer().Deserialize<CreateWatchResultSet>(json);
    ...
    /// </summary>
    public class CreateWatchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
