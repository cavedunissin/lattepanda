...
namespace Temboo.Library.AuthorizeNet.TransactionDetailsAPI
{
    ...
    /// </summary>
    public class GetTransactionList : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTransactionList Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTransactionList(TembooSession session) : base(session, "/Library/AuthorizeNet/TransactionDetailsAPI/GetTransactionList")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTransactionListResultSet containing execution metadata and results.</returns>
        new public GetTransactionListResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTransactionListResultSet results = new JavaScriptSerializer().Deserialize<GetTransactionListResultSet>(json);
    ...
    /// </summary>
    public class GetTransactionListResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
