...
namespace Temboo.Library.Dropbox.FilesAndMetadata
{
    ...
    /// </summary>
    public class GetShareableLink : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetShareableLink Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetShareableLink(TembooSession session) : base(session, "/Library/Dropbox/FilesAndMetadata/GetShareableLink")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetShareableLinkResultSet containing execution metadata and results.</returns>
        new public GetShareableLinkResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetShareableLinkResultSet results = new JavaScriptSerializer().Deserialize<GetShareableLinkResultSet>(json);
    ...
    /// </summary>
    public class GetShareableLinkResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
