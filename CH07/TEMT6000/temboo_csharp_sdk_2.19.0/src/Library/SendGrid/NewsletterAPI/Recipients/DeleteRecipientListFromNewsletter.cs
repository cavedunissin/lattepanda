...
namespace Temboo.Library.SendGrid.NewsletterAPI.Recipients
{
    ...
    /// </summary>
    public class DeleteRecipientListFromNewsletter : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteRecipientListFromNewsletter Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteRecipientListFromNewsletter(TembooSession session) : base(session, "/Library/SendGrid/NewsletterAPI/Recipients/DeleteRecipientListFromNewsletter")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteRecipientListFromNewsletterResultSet containing execution metadata and results.</returns>
        new public DeleteRecipientListFromNewsletterResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteRecipientListFromNewsletterResultSet results = new JavaScriptSerializer().Deserialize<DeleteRecipientListFromNewsletterResultSet>(json);
    ...
    /// </summary>
    public class DeleteRecipientListFromNewsletterResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
