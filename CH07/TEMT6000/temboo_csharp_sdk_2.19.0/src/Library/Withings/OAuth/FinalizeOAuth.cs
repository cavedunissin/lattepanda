...
namespace Temboo.Library.Withings.OAuth
{
    /// <summary>
    /// FinalizeOAuth
    ...
    public class FinalizeOAuth : Temboo.Core.Choreography
    {
        ...
        public FinalizeOAuth(TembooSession session) : base(session, "/Library/Withings/OAuth/FinalizeOAuth")
        {
        }
    ...
    public class FinalizeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The ID of the user who is associated with the OAuth credentials.</returns>
        /// </summary>
