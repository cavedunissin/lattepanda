...
namespace Temboo.Library.Zendesk.Requests
{
    ...
    /// </summary>
    public class ListOrganizationRequests : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListOrganizationRequests Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListOrganizationRequests(TembooSession session) : base(session, "/Library/Zendesk/Requests/ListOrganizationRequests")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListOrganizationRequestsResultSet containing execution metadata and results.</returns>
        new public ListOrganizationRequestsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListOrganizationRequestsResultSet results = new JavaScriptSerializer().Deserialize<ListOrganizationRequestsResultSet>(json);
    ...
    /// </summary>
    public class ListOrganizationRequestsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
