...
namespace Temboo.Library.NYTimes.CampaignFinance.Committees
{
    ...
    /// </summary>
    public class CommitteeSearch : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CommitteeSearch Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CommitteeSearch(TembooSession session) : base(session, "/Library/NYTimes/CampaignFinance/Committees/CommitteeSearch")
        {
        }
        ...
        /// </summary>
        /// <returns>A CommitteeSearchResultSet containing execution metadata and results.</returns>
        new public CommitteeSearchResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CommitteeSearchResultSet results = new JavaScriptSerializer().Deserialize<CommitteeSearchResultSet>(json);
    ...
    /// </summary>
    public class CommitteeSearchResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
