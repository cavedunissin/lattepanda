...
namespace Temboo.Library.CorpWatch.Company
{
    ...
    /// </summary>
    public class GetCompanyNames : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetCompanyNames Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetCompanyNames(TembooSession session) : base(session, "/Library/CorpWatch/Company/GetCompanyNames")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetCompanyNamesResultSet containing execution metadata and results.</returns>
        new public GetCompanyNamesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetCompanyNamesResultSet results = new JavaScriptSerializer().Deserialize<GetCompanyNamesResultSet>(json);
    ...
    /// </summary>
    public class GetCompanyNamesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
