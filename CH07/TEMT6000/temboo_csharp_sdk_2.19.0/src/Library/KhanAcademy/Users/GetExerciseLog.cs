...
namespace Temboo.Library.KhanAcademy.Users
{
    ...
    /// </summary>
    public class GetExerciseLog : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetExerciseLog Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetExerciseLog(TembooSession session) : base(session, "/Library/KhanAcademy/Users/GetExerciseLog")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetExerciseLogResultSet containing execution metadata and results.</returns>
        new public GetExerciseLogResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetExerciseLogResultSet results = new JavaScriptSerializer().Deserialize<GetExerciseLogResultSet>(json);
    ...
    /// </summary>
    public class GetExerciseLogResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
