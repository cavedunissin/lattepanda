...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class DescribeVolumes : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DescribeVolumes Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DescribeVolumes(TembooSession session) : base(session, "/Library/Amazon/EC2/DescribeVolumes")
        {
        }
        ...
        /// </summary>
        /// <returns>A DescribeVolumesResultSet containing execution metadata and results.</returns>
        new public DescribeVolumesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DescribeVolumesResultSet results = new JavaScriptSerializer().Deserialize<DescribeVolumesResultSet>(json);
    ...
    /// </summary>
    public class DescribeVolumesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
